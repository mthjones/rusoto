...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> GetByteMatchSetError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "WAFInternalErrorException" => GetByteMatchSetError::WAFInternalError(String::from(error_message)),"WAFInvalidAccountException" => GetByteMatchSetError::WAFInvalidAccount(String::from(error_message)),"WAFNonexistentItemException" => GetByteMatchSetError::WAFNonexistentItem(String::from(error_message)),"ValidationException" => GetByteMatchSetError::Validation(error_message.to_string()),_ => GetByteMatchSetError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for GetByteMatchSetError {
                    fn description(&self) -> &str {
                        match *self {
                            GetByteMatchSetError::WAFInternalError(ref cause) => cause,GetByteMatchSetError::WAFInvalidAccount(ref cause) => cause,GetByteMatchSetError::WAFNonexistentItem(ref cause) => cause,GetByteMatchSetError::Validation(ref cause) => cause,GetByteMatchSetError::Credentials(ref err) => err.description(),GetByteMatchSetError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),GetByteMatchSetError::Unknown(ref cause) => cause
                        }
                    }
                 }
                    ...
                    pub fn from_body(body: &str) -> GetIPSetError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "WAFInternalErrorException" => GetIPSetError::WAFInternalError(String::from(error_message)),"WAFInvalidAccountException" => GetIPSetError::WAFInvalidAccount(String::from(error_message)),"WAFNonexistentItemException" => GetIPSetError::WAFNonexistentItem(String::from(error_message)),"ValidationException" => GetIPSetError::Validation(error_message.to_string()),_ => GetIPSetError::Unknown(String::from(body))
                                }
                            },
...
Unknown(String)
                ...
                impl Error for GetSqlInjectionMatchSetError {
                    fn description(&self) -> &str {
                        match *self {
                            GetSqlInjectionMatchSetError::WAFInternalError(ref cause) => cause,GetSqlInjectionMatchSetError::WAFInvalidAccount(ref cause) => cause,GetSqlInjectionMatchSetError::WAFNonexistentItem(ref cause) => cause,GetSqlInjectionMatchSetError::Validation(ref cause) => cause,GetSqlInjectionMatchSetError::Credentials(ref err) => err.description(),GetSqlInjectionMatchSetError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),GetSqlInjectionMatchSetError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl Error for GetWebACLError {
                    fn description(&self) -> &str {
                        match *self {
                            GetWebACLError::WAFInternalError(ref cause) => cause,GetWebACLError::WAFInvalidAccount(ref cause) => cause,GetWebACLError::WAFNonexistentItem(ref cause) => cause,GetWebACLError::Validation(ref cause) => cause,GetWebACLError::Credentials(ref err) => err.description(),GetWebACLError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),GetWebACLError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> GetXssMatchSetError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "WAFInternalErrorException" => GetXssMatchSetError::WAFInternalError(String::from(error_message)),"WAFInvalidAccountException" => GetXssMatchSetError::WAFInvalidAccount(String::from(error_message)),"WAFNonexistentItemException" => GetXssMatchSetError::WAFNonexistentItem(String::from(error_message)),"ValidationException" => GetXssMatchSetError::Validation(error_message.to_string()),_ => GetXssMatchSetError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for GetXssMatchSetError {
                    fn description(&self) -> &str {
                        match *self {
                            GetXssMatchSetError::WAFInternalError(ref cause) => cause,GetXssMatchSetError::WAFInvalidAccount(ref cause) => cause,GetXssMatchSetError::WAFNonexistentItem(ref cause) => cause,GetXssMatchSetError::Validation(ref cause) => cause,GetXssMatchSetError::Credentials(ref err) => err.description(),GetXssMatchSetError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),GetXssMatchSetError::Unknown(ref cause) => cause
                        }
                    }
                 }
                    ...
                    pub fn from_body(body: &str) -> ListIPSetsError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "WAFInternalErrorException" => ListIPSetsError::WAFInternalError(String::from(error_message)),"WAFInvalidAccountException" => ListIPSetsError::WAFInvalidAccount(String::from(error_message)),"ValidationException" => ListIPSetsError::Validation(error_message.to_string()),_ => ListIPSetsError::Unknown(String::from(body))
                                }
                            },
                    ...
                    pub fn from_body(body: &str) -> ListRulesError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "WAFInternalErrorException" => ListRulesError::WAFInternalError(String::from(error_message)),"WAFInvalidAccountException" => ListRulesError::WAFInvalidAccount(String::from(error_message)),"ValidationException" => ListRulesError::Validation(error_message.to_string()),_ => ListRulesError::Unknown(String::from(body))
                                }
                            },
...
Unknown(String)
                ...
                impl Error for ListSqlInjectionMatchSetsError {
                    fn description(&self) -> &str {
                        match *self {
                            ListSqlInjectionMatchSetsError::WAFInternalError(ref cause) => cause,ListSqlInjectionMatchSetsError::WAFInvalidAccount(ref cause) => cause,ListSqlInjectionMatchSetsError::Validation(ref cause) => cause,ListSqlInjectionMatchSetsError::Credentials(ref err) => err.description(),ListSqlInjectionMatchSetsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),ListSqlInjectionMatchSetsError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl Error for ListWebACLsError {
                    fn description(&self) -> &str {
                        match *self {
                            ListWebACLsError::WAFInternalError(ref cause) => cause,ListWebACLsError::WAFInvalidAccount(ref cause) => cause,ListWebACLsError::Validation(ref cause) => cause,ListWebACLsError::Credentials(ref err) => err.description(),ListWebACLsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),ListWebACLsError::Unknown(ref cause) => cause
                        }
                    }
                 }
                    ...
                    pub fn from_body(body: &str) -> ListXssMatchSetsError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "WAFInternalErrorException" => ListXssMatchSetsError::WAFInternalError(String::from(error_message)),"WAFInvalidAccountException" => ListXssMatchSetsError::WAFInvalidAccount(String::from(error_message)),"ValidationException" => ListXssMatchSetsError::Validation(error_message.to_string()),_ => ListXssMatchSetsError::Unknown(String::from(body))
                                }
                            },
...
/// A client for the WAF API.
        ...
        impl<P, D> WafClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
            pub fn new(request_dispatcher: D, credentials_provider: P, region: region::Region) -> Self {
                ...
                pub fn create_byte_match_set(&self, input: &CreateByteMatchSetRequest)  -> Result<CreateByteMatchSetResponse, CreateByteMatchSetError> {
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn create_ip_set(&self, input: &CreateIPSetRequest)  -> Result<CreateIPSetResponse, CreateIPSetError> {
                    let mut request = SignedRequest::new("POST", "waf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn create_rule(&self, input: &CreateRuleRequest)  -> Result<CreateRuleResponse, CreateRuleError> {
                    let mut request = SignedRequest::new("POST", "waf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn create_size_constraint_set(&self, input: &CreateSizeConstraintSetRequest)  -> Result<CreateSizeConstraintSetResponse, CreateSizeConstraintSetError> {
                    let mut request = SignedRequest::new("POST", "waf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn create_sql_injection_match_set(&self, input: &CreateSqlInjectionMatchSetRequest)  -> Result<CreateSqlInjectionMatchSetResponse, CreateSqlInjectionMatchSetError> {
                    let mut request = SignedRequest::new("POST", "waf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn create_web_acl(&self, input: &CreateWebACLRequest)  -> Result<CreateWebACLResponse, CreateWebACLError> {
                    let mut request = SignedRequest::new("POST", "waf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn create_xss_match_set(&self, input: &CreateXssMatchSetRequest)  -> Result<CreateXssMatchSetResponse, CreateXssMatchSetError> {
                    let mut request = SignedRequest::new("POST", "waf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn delete_byte_match_set(&self, input: &DeleteByteMatchSetRequest)  -> Result<DeleteByteMatchSetResponse, DeleteByteMatchSetError> {
                    let mut request = SignedRequest::new("POST", "waf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn delete_ip_set(&self, input: &DeleteIPSetRequest)  -> Result<DeleteIPSetResponse, DeleteIPSetError> {
                    let mut request = SignedRequest::new("POST", "waf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn delete_rule(&self, input: &DeleteRuleRequest)  -> Result<DeleteRuleResponse, DeleteRuleError> {
                    let mut request = SignedRequest::new("POST", "waf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn delete_size_constraint_set(&self, input: &DeleteSizeConstraintSetRequest)  -> Result<DeleteSizeConstraintSetResponse, DeleteSizeConstraintSetError> {
                    let mut request = SignedRequest::new("POST", "waf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn delete_sql_injection_match_set(&self, input: &DeleteSqlInjectionMatchSetRequest)  -> Result<DeleteSqlInjectionMatchSetResponse, DeleteSqlInjectionMatchSetError> {
                    let mut request = SignedRequest::new("POST", "waf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn delete_web_acl(&self, input: &DeleteWebACLRequest)  -> Result<DeleteWebACLResponse, DeleteWebACLError> {
                    let mut request = SignedRequest::new("POST", "waf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn delete_xss_match_set(&self, input: &DeleteXssMatchSetRequest)  -> Result<DeleteXssMatchSetResponse, DeleteXssMatchSetError> {
                    let mut request = SignedRequest::new("POST", "waf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn get_byte_match_set(&self, input: &GetByteMatchSetRequest)  -> Result<GetByteMatchSetResponse, GetByteMatchSetError> {
                    let mut request = SignedRequest::new("POST", "waf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn get_change_token(&self, input: &GetChangeTokenRequest)  -> Result<GetChangeTokenResponse, GetChangeTokenError> {
                    let mut request = SignedRequest::new("POST", "waf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn get_change_token_status(&self, input: &GetChangeTokenStatusRequest)  -> Result<GetChangeTokenStatusResponse, GetChangeTokenStatusError> {
                    let mut request = SignedRequest::new("POST", "waf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn get_ip_set(&self, input: &GetIPSetRequest)  -> Result<GetIPSetResponse, GetIPSetError> {
                    let mut request = SignedRequest::new("POST", "waf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn get_rule(&self, input: &GetRuleRequest)  -> Result<GetRuleResponse, GetRuleError> {
                    let mut request = SignedRequest::new("POST", "waf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn get_sampled_requests(&self, input: &GetSampledRequestsRequest)  -> Result<GetSampledRequestsResponse, GetSampledRequestsError> {
                    let mut request = SignedRequest::new("POST", "waf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn get_size_constraint_set(&self, input: &GetSizeConstraintSetRequest)  -> Result<GetSizeConstraintSetResponse, GetSizeConstraintSetError> {
                    let mut request = SignedRequest::new("POST", "waf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn get_sql_injection_match_set(&self, input: &GetSqlInjectionMatchSetRequest)  -> Result<GetSqlInjectionMatchSetResponse, GetSqlInjectionMatchSetError> {
                    let mut request = SignedRequest::new("POST", "waf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn get_web_acl(&self, input: &GetWebACLRequest)  -> Result<GetWebACLResponse, GetWebACLError> {
                    let mut request = SignedRequest::new("POST", "waf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn get_xss_match_set(&self, input: &GetXssMatchSetRequest)  -> Result<GetXssMatchSetResponse, GetXssMatchSetError> {
                    let mut request = SignedRequest::new("POST", "waf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn list_byte_match_sets(&self, input: &ListByteMatchSetsRequest)  -> Result<ListByteMatchSetsResponse, ListByteMatchSetsError> {
                    let mut request = SignedRequest::new("POST", "waf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn list_ip_sets(&self, input: &ListIPSetsRequest)  -> Result<ListIPSetsResponse, ListIPSetsError> {
                    let mut request = SignedRequest::new("POST", "waf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn list_size_constraint_sets(&self, input: &ListSizeConstraintSetsRequest)  -> Result<ListSizeConstraintSetsResponse, ListSizeConstraintSetsError> {
                    let mut request = SignedRequest::new("POST", "waf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn list_sql_injection_match_sets(&self, input: &ListSqlInjectionMatchSetsRequest)  -> Result<ListSqlInjectionMatchSetsResponse, ListSqlInjectionMatchSetsError> {
                    let mut request = SignedRequest::new("POST", "waf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn list_web_ac_ls(&self, input: &ListWebACLsRequest)  -> Result<ListWebACLsResponse, ListWebACLsError> {
                    let mut request = SignedRequest::new("POST", "waf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn list_xss_match_sets(&self, input: &ListXssMatchSetsRequest)  -> Result<ListXssMatchSetsResponse, ListXssMatchSetsError> {
                    let mut request = SignedRequest::new("POST", "waf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn update_byte_match_set(&self, input: &UpdateByteMatchSetRequest)  -> Result<UpdateByteMatchSetResponse, UpdateByteMatchSetError> {
                    let mut request = SignedRequest::new("POST", "waf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn update_ip_set(&self, input: &UpdateIPSetRequest)  -> Result<UpdateIPSetResponse, UpdateIPSetError> {
                    let mut request = SignedRequest::new("POST", "waf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn update_rule(&self, input: &UpdateRuleRequest)  -> Result<UpdateRuleResponse, UpdateRuleError> {
                    let mut request = SignedRequest::new("POST", "waf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn update_size_constraint_set(&self, input: &UpdateSizeConstraintSetRequest)  -> Result<UpdateSizeConstraintSetResponse, UpdateSizeConstraintSetError> {
                    let mut request = SignedRequest::new("POST", "waf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn update_sql_injection_match_set(&self, input: &UpdateSqlInjectionMatchSetRequest)  -> Result<UpdateSqlInjectionMatchSetResponse, UpdateSqlInjectionMatchSetError> {
                    let mut request = SignedRequest::new("POST", "waf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn update_web_acl(&self, input: &UpdateWebACLRequest)  -> Result<UpdateWebACLResponse, UpdateWebACLError> {
                    let mut request = SignedRequest::new("POST", "waf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn update_xss_match_set(&self, input: &UpdateXssMatchSetRequest)  -> Result<UpdateXssMatchSetResponse, UpdateXssMatchSetError> {
                    let mut request = SignedRequest::new("POST", "waf", self.region, "/");
