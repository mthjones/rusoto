...
/// A client for the CloudHSM API.
        ...
        impl<P, D> CloudHsmClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
            pub fn new(request_dispatcher: D, credentials_provider: P, region: region::Region) -> Self {
                ...
                pub fn add_tags_to_resource(&self, input: &AddTagsToResourceRequest)  -> Result<AddTagsToResourceResponse, AddTagsToResourceError> {
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn create_hapg(&self, input: &CreateHapgRequest)  -> Result<CreateHapgResponse, CreateHapgError> {
                    let mut request = SignedRequest::new("POST", "cloudhsm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn create_hsm(&self, input: &CreateHsmRequest)  -> Result<CreateHsmResponse, CreateHsmError> {
                    let mut request = SignedRequest::new("POST", "cloudhsm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn create_luna_client(&self, input: &CreateLunaClientRequest)  -> Result<CreateLunaClientResponse, CreateLunaClientError> {
                    let mut request = SignedRequest::new("POST", "cloudhsm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn delete_hapg(&self, input: &DeleteHapgRequest)  -> Result<DeleteHapgResponse, DeleteHapgError> {
                    let mut request = SignedRequest::new("POST", "cloudhsm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn delete_hsm(&self, input: &DeleteHsmRequest)  -> Result<DeleteHsmResponse, DeleteHsmError> {
                    let mut request = SignedRequest::new("POST", "cloudhsm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn delete_luna_client(&self, input: &DeleteLunaClientRequest)  -> Result<DeleteLunaClientResponse, DeleteLunaClientError> {
                    let mut request = SignedRequest::new("POST", "cloudhsm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn describe_hapg(&self, input: &DescribeHapgRequest)  -> Result<DescribeHapgResponse, DescribeHapgError> {
                    let mut request = SignedRequest::new("POST", "cloudhsm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn describe_hsm(&self, input: &DescribeHsmRequest)  -> Result<DescribeHsmResponse, DescribeHsmError> {
                    let mut request = SignedRequest::new("POST", "cloudhsm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn describe_luna_client(&self, input: &DescribeLunaClientRequest)  -> Result<DescribeLunaClientResponse, DescribeLunaClientError> {
                    let mut request = SignedRequest::new("POST", "cloudhsm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn get_config(&self, input: &GetConfigRequest)  -> Result<GetConfigResponse, GetConfigError> {
                    let mut request = SignedRequest::new("POST", "cloudhsm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn list_available_zones(&self, input: &ListAvailableZonesRequest)  -> Result<ListAvailableZonesResponse, ListAvailableZonesError> {
                    let mut request = SignedRequest::new("POST", "cloudhsm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn list_hapgs(&self, input: &ListHapgsRequest)  -> Result<ListHapgsResponse, ListHapgsError> {
                    let mut request = SignedRequest::new("POST", "cloudhsm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn list_hsms(&self, input: &ListHsmsRequest)  -> Result<ListHsmsResponse, ListHsmsError> {
                    let mut request = SignedRequest::new("POST", "cloudhsm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn list_luna_clients(&self, input: &ListLunaClientsRequest)  -> Result<ListLunaClientsResponse, ListLunaClientsError> {
                    let mut request = SignedRequest::new("POST", "cloudhsm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn modify_hapg(&self, input: &ModifyHapgRequest)  -> Result<ModifyHapgResponse, ModifyHapgError> {
                    let mut request = SignedRequest::new("POST", "cloudhsm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn modify_hsm(&self, input: &ModifyHsmRequest)  -> Result<ModifyHsmResponse, ModifyHsmError> {
                    let mut request = SignedRequest::new("POST", "cloudhsm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn modify_luna_client(&self, input: &ModifyLunaClientRequest)  -> Result<ModifyLunaClientResponse, ModifyLunaClientError> {
                    let mut request = SignedRequest::new("POST", "cloudhsm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn remove_tags_from_resource(&self, input: &RemoveTagsFromResourceRequest)  -> Result<RemoveTagsFromResourceResponse, RemoveTagsFromResourceError> {
                    let mut request = SignedRequest::new("POST", "cloudhsm", self.region, "/");
