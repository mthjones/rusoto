                    ...
                    pub fn from_body(body: &str) -> CreateLogStreamError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InvalidParameterException" => CreateLogStreamError::InvalidParameter(String::from(error_message)),"ResourceAlreadyExistsException" => CreateLogStreamError::ResourceAlreadyExists(String::from(error_message)),"ResourceNotFoundException" => CreateLogStreamError::ResourceNotFound(String::from(error_message)),"ServiceUnavailableException" => CreateLogStreamError::ServiceUnavailable(String::from(error_message)),"ValidationException" => CreateLogStreamError::Validation(error_message.to_string()),_ => CreateLogStreamError::Unknown(String::from(body))
                                }
                            },
                    ...
                    pub fn from_body(body: &str) -> DescribeExportTasksError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InvalidParameterException" => DescribeExportTasksError::InvalidParameter(String::from(error_message)),"ServiceUnavailableException" => DescribeExportTasksError::ServiceUnavailable(String::from(error_message)),"ValidationException" => DescribeExportTasksError::Validation(error_message.to_string()),_ => DescribeExportTasksError::Unknown(String::from(body))
                                }
                            },
...
Unknown(String)
                ...
                impl Error for DescribeLogGroupsError {
                    fn description(&self) -> &str {
                        match *self {
                            DescribeLogGroupsError::InvalidParameter(ref cause) => cause,DescribeLogGroupsError::ServiceUnavailable(ref cause) => cause,DescribeLogGroupsError::Validation(ref cause) => cause,DescribeLogGroupsError::Credentials(ref err) => err.description(),DescribeLogGroupsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),DescribeLogGroupsError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> DescribeLogStreamsError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InvalidParameterException" => DescribeLogStreamsError::InvalidParameter(String::from(error_message)),"ResourceNotFoundException" => DescribeLogStreamsError::ResourceNotFound(String::from(error_message)),"ServiceUnavailableException" => DescribeLogStreamsError::ServiceUnavailable(String::from(error_message)),"ValidationException" => DescribeLogStreamsError::Validation(error_message.to_string()),_ => DescribeLogStreamsError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for DescribeLogStreamsError {
                    fn description(&self) -> &str {
                        match *self {
                            DescribeLogStreamsError::InvalidParameter(ref cause) => cause,DescribeLogStreamsError::ResourceNotFound(ref cause) => cause,DescribeLogStreamsError::ServiceUnavailable(ref cause) => cause,DescribeLogStreamsError::Validation(ref cause) => cause,DescribeLogStreamsError::Credentials(ref err) => err.description(),DescribeLogStreamsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),DescribeLogStreamsError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl Error for FilterLogEventsError {
                    fn description(&self) -> &str {
                        match *self {
                            FilterLogEventsError::InvalidParameter(ref cause) => cause,FilterLogEventsError::ResourceNotFound(ref cause) => cause,FilterLogEventsError::ServiceUnavailable(ref cause) => cause,FilterLogEventsError::Validation(ref cause) => cause,FilterLogEventsError::Credentials(ref err) => err.description(),FilterLogEventsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),FilterLogEventsError::Unknown(ref cause) => cause
                        }
                    }
                 }
                    ...
                    pub fn from_body(body: &str) -> GetLogEventsError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InvalidParameterException" => GetLogEventsError::InvalidParameter(String::from(error_message)),"ResourceNotFoundException" => GetLogEventsError::ResourceNotFound(String::from(error_message)),"ServiceUnavailableException" => GetLogEventsError::ServiceUnavailable(String::from(error_message)),"ValidationException" => GetLogEventsError::Validation(error_message.to_string()),_ => GetLogEventsError::Unknown(String::from(body))
                                }
                            },
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> PutDestinationError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InvalidParameterException" => PutDestinationError::InvalidParameter(String::from(error_message)),"OperationAbortedException" => PutDestinationError::OperationAborted(String::from(error_message)),"ServiceUnavailableException" => PutDestinationError::ServiceUnavailable(String::from(error_message)),"ValidationException" => PutDestinationError::Validation(error_message.to_string()),_ => PutDestinationError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for PutDestinationError {
                    fn description(&self) -> &str {
                        match *self {
                            PutDestinationError::InvalidParameter(ref cause) => cause,PutDestinationError::OperationAborted(ref cause) => cause,PutDestinationError::ServiceUnavailable(ref cause) => cause,PutDestinationError::Validation(ref cause) => cause,PutDestinationError::Credentials(ref err) => err.description(),PutDestinationError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),PutDestinationError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
/// A client for the Amazon CloudWatch Logs API.
        ...
        impl<P, D> CloudWatchLogsClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
            pub fn new(request_dispatcher: D, credentials_provider: P, region: region::Region) -> Self {
                ...
                pub fn cancel_export_task(&self, input: &CancelExportTaskRequest)  -> Result<(), CancelExportTaskError> {
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn create_export_task(&self, input: &CreateExportTaskRequest)  -> Result<CreateExportTaskResponse, CreateExportTaskError> {
                    let mut request = SignedRequest::new("POST", "logs", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn create_log_group(&self, input: &CreateLogGroupRequest)  -> Result<(), CreateLogGroupError> {
                    let mut request = SignedRequest::new("POST", "logs", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn create_log_stream(&self, input: &CreateLogStreamRequest)  -> Result<(), CreateLogStreamError> {
                    let mut request = SignedRequest::new("POST", "logs", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn delete_destination(&self, input: &DeleteDestinationRequest)  -> Result<(), DeleteDestinationError> {
                    let mut request = SignedRequest::new("POST", "logs", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn delete_log_group(&self, input: &DeleteLogGroupRequest)  -> Result<(), DeleteLogGroupError> {
                    let mut request = SignedRequest::new("POST", "logs", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn delete_log_stream(&self, input: &DeleteLogStreamRequest)  -> Result<(), DeleteLogStreamError> {
                    let mut request = SignedRequest::new("POST", "logs", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn delete_metric_filter(&self, input: &DeleteMetricFilterRequest)  -> Result<(), DeleteMetricFilterError> {
                    let mut request = SignedRequest::new("POST", "logs", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn delete_retention_policy(&self, input: &DeleteRetentionPolicyRequest)  -> Result<(), DeleteRetentionPolicyError> {
                    let mut request = SignedRequest::new("POST", "logs", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn delete_subscription_filter(&self, input: &DeleteSubscriptionFilterRequest)  -> Result<(), DeleteSubscriptionFilterError> {
                    let mut request = SignedRequest::new("POST", "logs", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn describe_destinations(&self, input: &DescribeDestinationsRequest)  -> Result<DescribeDestinationsResponse, DescribeDestinationsError> {
                    let mut request = SignedRequest::new("POST", "logs", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn describe_export_tasks(&self, input: &DescribeExportTasksRequest)  -> Result<DescribeExportTasksResponse, DescribeExportTasksError> {
                    let mut request = SignedRequest::new("POST", "logs", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn describe_log_groups(&self, input: &DescribeLogGroupsRequest)  -> Result<DescribeLogGroupsResponse, DescribeLogGroupsError> {
                    let mut request = SignedRequest::new("POST", "logs", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn describe_log_streams(&self, input: &DescribeLogStreamsRequest)  -> Result<DescribeLogStreamsResponse, DescribeLogStreamsError> {
                    let mut request = SignedRequest::new("POST", "logs", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn describe_metric_filters(&self, input: &DescribeMetricFiltersRequest)  -> Result<DescribeMetricFiltersResponse, DescribeMetricFiltersError> {
                    let mut request = SignedRequest::new("POST", "logs", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn describe_subscription_filters(&self, input: &DescribeSubscriptionFiltersRequest)  -> Result<DescribeSubscriptionFiltersResponse, DescribeSubscriptionFiltersError> {
                    let mut request = SignedRequest::new("POST", "logs", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn filter_log_events(&self, input: &FilterLogEventsRequest)  -> Result<FilterLogEventsResponse, FilterLogEventsError> {
                    let mut request = SignedRequest::new("POST", "logs", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn get_log_events(&self, input: &GetLogEventsRequest)  -> Result<GetLogEventsResponse, GetLogEventsError> {
                    let mut request = SignedRequest::new("POST", "logs", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn list_tags_log_group(&self, input: &ListTagsLogGroupRequest)  -> Result<ListTagsLogGroupResponse, ListTagsLogGroupError> {
                    let mut request = SignedRequest::new("POST", "logs", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn put_destination(&self, input: &PutDestinationRequest)  -> Result<PutDestinationResponse, PutDestinationError> {
                    let mut request = SignedRequest::new("POST", "logs", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn put_destination_policy(&self, input: &PutDestinationPolicyRequest)  -> Result<(), PutDestinationPolicyError> {
                    let mut request = SignedRequest::new("POST", "logs", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn put_log_events(&self, input: &PutLogEventsRequest)  -> Result<PutLogEventsResponse, PutLogEventsError> {
                    let mut request = SignedRequest::new("POST", "logs", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn put_metric_filter(&self, input: &PutMetricFilterRequest)  -> Result<(), PutMetricFilterError> {
                    let mut request = SignedRequest::new("POST", "logs", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn put_retention_policy(&self, input: &PutRetentionPolicyRequest)  -> Result<(), PutRetentionPolicyError> {
                    let mut request = SignedRequest::new("POST", "logs", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn put_subscription_filter(&self, input: &PutSubscriptionFilterRequest)  -> Result<(), PutSubscriptionFilterError> {
                    let mut request = SignedRequest::new("POST", "logs", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn tag_log_group(&self, input: &TagLogGroupRequest)  -> Result<(), TagLogGroupError> {
                    let mut request = SignedRequest::new("POST", "logs", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn test_metric_filter(&self, input: &TestMetricFilterRequest)  -> Result<TestMetricFilterResponse, TestMetricFilterError> {
                    let mut request = SignedRequest::new("POST", "logs", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn untag_log_group(&self, input: &UntagLogGroupRequest)  -> Result<(), UntagLogGroupError> {
                    let mut request = SignedRequest::new("POST", "logs", self.region, "/");
