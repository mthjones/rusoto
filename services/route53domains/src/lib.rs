...
Unknown(String)
                ...
                impl Error for CheckDomainAvailabilityError {
                    fn description(&self) -> &str {
                        match *self {
                            CheckDomainAvailabilityError::InvalidInput(ref cause) => cause,CheckDomainAvailabilityError::UnsupportedTLD(ref cause) => cause,CheckDomainAvailabilityError::Validation(ref cause) => cause,CheckDomainAvailabilityError::Credentials(ref err) => err.description(),CheckDomainAvailabilityError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),CheckDomainAvailabilityError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> DeleteTagsForDomainError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InvalidInput" => DeleteTagsForDomainError::InvalidInput(String::from(error_message)),"OperationLimitExceeded" => DeleteTagsForDomainError::OperationLimitExceeded(String::from(error_message)),"UnsupportedTLD" => DeleteTagsForDomainError::UnsupportedTLD(String::from(error_message)),"ValidationException" => DeleteTagsForDomainError::Validation(error_message.to_string()),_ => DeleteTagsForDomainError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for DeleteTagsForDomainError {
                    fn description(&self) -> &str {
                        match *self {
                            DeleteTagsForDomainError::InvalidInput(ref cause) => cause,DeleteTagsForDomainError::OperationLimitExceeded(ref cause) => cause,DeleteTagsForDomainError::UnsupportedTLD(ref cause) => cause,DeleteTagsForDomainError::Validation(ref cause) => cause,DeleteTagsForDomainError::Credentials(ref err) => err.description(),DeleteTagsForDomainError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),DeleteTagsForDomainError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl Error for DisableDomainAutoRenewError {
                    fn description(&self) -> &str {
                        match *self {
                            DisableDomainAutoRenewError::InvalidInput(ref cause) => cause,DisableDomainAutoRenewError::UnsupportedTLD(ref cause) => cause,DisableDomainAutoRenewError::Validation(ref cause) => cause,DisableDomainAutoRenewError::Credentials(ref err) => err.description(),DisableDomainAutoRenewError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),DisableDomainAutoRenewError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> GetContactReachabilityStatusError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InvalidInput" => GetContactReachabilityStatusError::InvalidInput(String::from(error_message)),"OperationLimitExceeded" => GetContactReachabilityStatusError::OperationLimitExceeded(String::from(error_message)),"UnsupportedTLD" => GetContactReachabilityStatusError::UnsupportedTLD(String::from(error_message)),"ValidationException" => GetContactReachabilityStatusError::Validation(error_message.to_string()),_ => GetContactReachabilityStatusError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for GetContactReachabilityStatusError {
                    fn description(&self) -> &str {
                        match *self {
                            GetContactReachabilityStatusError::InvalidInput(ref cause) => cause,GetContactReachabilityStatusError::OperationLimitExceeded(ref cause) => cause,GetContactReachabilityStatusError::UnsupportedTLD(ref cause) => cause,GetContactReachabilityStatusError::Validation(ref cause) => cause,GetContactReachabilityStatusError::Credentials(ref err) => err.description(),GetContactReachabilityStatusError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),GetContactReachabilityStatusError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl Error for ListTagsForDomainError {
                    fn description(&self) -> &str {
                        match *self {
                            ListTagsForDomainError::InvalidInput(ref cause) => cause,ListTagsForDomainError::OperationLimitExceeded(ref cause) => cause,ListTagsForDomainError::UnsupportedTLD(ref cause) => cause,ListTagsForDomainError::Validation(ref cause) => cause,ListTagsForDomainError::Credentials(ref err) => err.description(),ListTagsForDomainError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),ListTagsForDomainError::Unknown(ref cause) => cause
                        }
                    }
                 }
                    ...
                    pub fn from_body(body: &str) -> UpdateTagsForDomainError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InvalidInput" => UpdateTagsForDomainError::InvalidInput(String::from(error_message)),"OperationLimitExceeded" => UpdateTagsForDomainError::OperationLimitExceeded(String::from(error_message)),"UnsupportedTLD" => UpdateTagsForDomainError::UnsupportedTLD(String::from(error_message)),"ValidationException" => UpdateTagsForDomainError::Validation(error_message.to_string()),_ => UpdateTagsForDomainError::Unknown(String::from(body))
                                }
                            },
...
/// A client for the Amazon Route 53 Domains API.
        ...
        impl<P, D> Route53DomainsClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
            pub fn new(request_dispatcher: D, credentials_provider: P, region: region::Region) -> Self {
                ...
                pub fn check_domain_availability(&self, input: &CheckDomainAvailabilityRequest)  -> Result<CheckDomainAvailabilityResponse, CheckDomainAvailabilityError> {
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn delete_tags_for_domain(&self, input: &DeleteTagsForDomainRequest)  -> Result<DeleteTagsForDomainResponse, DeleteTagsForDomainError> {
                    let mut request = SignedRequest::new("POST", "route53domains", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn disable_domain_auto_renew(&self, input: &DisableDomainAutoRenewRequest)  -> Result<DisableDomainAutoRenewResponse, DisableDomainAutoRenewError> {
                    let mut request = SignedRequest::new("POST", "route53domains", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn disable_domain_transfer_lock(&self, input: &DisableDomainTransferLockRequest)  -> Result<DisableDomainTransferLockResponse, DisableDomainTransferLockError> {
                    let mut request = SignedRequest::new("POST", "route53domains", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn enable_domain_auto_renew(&self, input: &EnableDomainAutoRenewRequest)  -> Result<EnableDomainAutoRenewResponse, EnableDomainAutoRenewError> {
                    let mut request = SignedRequest::new("POST", "route53domains", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn enable_domain_transfer_lock(&self, input: &EnableDomainTransferLockRequest)  -> Result<EnableDomainTransferLockResponse, EnableDomainTransferLockError> {
                    let mut request = SignedRequest::new("POST", "route53domains", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn get_contact_reachability_status(&self, input: &GetContactReachabilityStatusRequest)  -> Result<GetContactReachabilityStatusResponse, GetContactReachabilityStatusError> {
                    let mut request = SignedRequest::new("POST", "route53domains", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn get_domain_detail(&self, input: &GetDomainDetailRequest)  -> Result<GetDomainDetailResponse, GetDomainDetailError> {
                    let mut request = SignedRequest::new("POST", "route53domains", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn get_domain_suggestions(&self, input: &GetDomainSuggestionsRequest)  -> Result<GetDomainSuggestionsResponse, GetDomainSuggestionsError> {
                    let mut request = SignedRequest::new("POST", "route53domains", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn get_operation_detail(&self, input: &GetOperationDetailRequest)  -> Result<GetOperationDetailResponse, GetOperationDetailError> {
                    let mut request = SignedRequest::new("POST", "route53domains", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn list_domains(&self, input: &ListDomainsRequest)  -> Result<ListDomainsResponse, ListDomainsError> {
                    let mut request = SignedRequest::new("POST", "route53domains", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn list_operations(&self, input: &ListOperationsRequest)  -> Result<ListOperationsResponse, ListOperationsError> {
                    let mut request = SignedRequest::new("POST", "route53domains", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn list_tags_for_domain(&self, input: &ListTagsForDomainRequest)  -> Result<ListTagsForDomainResponse, ListTagsForDomainError> {
                    let mut request = SignedRequest::new("POST", "route53domains", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn register_domain(&self, input: &RegisterDomainRequest)  -> Result<RegisterDomainResponse, RegisterDomainError> {
                    let mut request = SignedRequest::new("POST", "route53domains", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn renew_domain(&self, input: &RenewDomainRequest)  -> Result<RenewDomainResponse, RenewDomainError> {
                    let mut request = SignedRequest::new("POST", "route53domains", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn resend_contact_reachability_email(&self, input: &ResendContactReachabilityEmailRequest)  -> Result<ResendContactReachabilityEmailResponse, ResendContactReachabilityEmailError> {
                    let mut request = SignedRequest::new("POST", "route53domains", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn retrieve_domain_auth_code(&self, input: &RetrieveDomainAuthCodeRequest)  -> Result<RetrieveDomainAuthCodeResponse, RetrieveDomainAuthCodeError> {
                    let mut request = SignedRequest::new("POST", "route53domains", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn transfer_domain(&self, input: &TransferDomainRequest)  -> Result<TransferDomainResponse, TransferDomainError> {
                    let mut request = SignedRequest::new("POST", "route53domains", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn update_domain_contact(&self, input: &UpdateDomainContactRequest)  -> Result<UpdateDomainContactResponse, UpdateDomainContactError> {
                    let mut request = SignedRequest::new("POST", "route53domains", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn update_domain_contact_privacy(&self, input: &UpdateDomainContactPrivacyRequest)  -> Result<UpdateDomainContactPrivacyResponse, UpdateDomainContactPrivacyError> {
                    let mut request = SignedRequest::new("POST", "route53domains", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn update_domain_nameservers(&self, input: &UpdateDomainNameserversRequest)  -> Result<UpdateDomainNameserversResponse, UpdateDomainNameserversError> {
                    let mut request = SignedRequest::new("POST", "route53domains", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn update_tags_for_domain(&self, input: &UpdateTagsForDomainRequest)  -> Result<UpdateTagsForDomainResponse, UpdateTagsForDomainError> {
                    let mut request = SignedRequest::new("POST", "route53domains", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn view_billing(&self, input: &ViewBillingRequest)  -> Result<ViewBillingResponse, ViewBillingError> {
                    let mut request = SignedRequest::new("POST", "route53domains", self.region, "/");
