...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> AddInstanceFleetError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InternalServerException" => AddInstanceFleetError::InternalServer(String::from(error_message)),"InvalidRequestException" => AddInstanceFleetError::InvalidRequest(String::from(error_message)),"ValidationException" => AddInstanceFleetError::Validation(error_message.to_string()),_ => AddInstanceFleetError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for AddInstanceFleetError {
                    fn description(&self) -> &str {
                        match *self {
                            AddInstanceFleetError::InternalServer(ref cause) => cause,AddInstanceFleetError::InvalidRequest(ref cause) => cause,AddInstanceFleetError::Validation(ref cause) => cause,AddInstanceFleetError::Credentials(ref err) => err.description(),AddInstanceFleetError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),AddInstanceFleetError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> DeleteSecurityConfigurationError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InternalServerException" => DeleteSecurityConfigurationError::InternalServer(String::from(error_message)),"InvalidRequestException" => DeleteSecurityConfigurationError::InvalidRequest(String::from(error_message)),"ValidationException" => DeleteSecurityConfigurationError::Validation(error_message.to_string()),_ => DeleteSecurityConfigurationError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for DeleteSecurityConfigurationError {
                    fn description(&self) -> &str {
                        match *self {
                            DeleteSecurityConfigurationError::InternalServer(ref cause) => cause,DeleteSecurityConfigurationError::InvalidRequest(ref cause) => cause,DeleteSecurityConfigurationError::Validation(ref cause) => cause,DeleteSecurityConfigurationError::Credentials(ref err) => err.description(),DeleteSecurityConfigurationError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),DeleteSecurityConfigurationError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> DescribeClusterError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InternalServerException" => DescribeClusterError::InternalServer(String::from(error_message)),"InvalidRequestException" => DescribeClusterError::InvalidRequest(String::from(error_message)),"ValidationException" => DescribeClusterError::Validation(error_message.to_string()),_ => DescribeClusterError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for DescribeClusterError {
                    fn description(&self) -> &str {
                        match *self {
                            DescribeClusterError::InternalServer(ref cause) => cause,DescribeClusterError::InvalidRequest(ref cause) => cause,DescribeClusterError::Validation(ref cause) => cause,DescribeClusterError::Credentials(ref err) => err.description(),DescribeClusterError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),DescribeClusterError::Unknown(ref cause) => cause
                        }
                    }
                 }
                    ...
                    pub fn from_body(body: &str) -> DescribeStepError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InternalServerException" => DescribeStepError::InternalServer(String::from(error_message)),"InvalidRequestException" => DescribeStepError::InvalidRequest(String::from(error_message)),"ValidationException" => DescribeStepError::Validation(error_message.to_string()),_ => DescribeStepError::Unknown(String::from(body))
                                }
                            },
                    ...
                    pub fn from_body(body: &str) -> ListClustersError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InternalServerException" => ListClustersError::InternalServer(String::from(error_message)),"InvalidRequestException" => ListClustersError::InvalidRequest(String::from(error_message)),"ValidationException" => ListClustersError::Validation(error_message.to_string()),_ => ListClustersError::Unknown(String::from(body))
                                }
                            },
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> ListInstanceFleetsError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InternalServerException" => ListInstanceFleetsError::InternalServer(String::from(error_message)),"InvalidRequestException" => ListInstanceFleetsError::InvalidRequest(String::from(error_message)),"ValidationException" => ListInstanceFleetsError::Validation(error_message.to_string()),_ => ListInstanceFleetsError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for ListInstanceFleetsError {
                    fn description(&self) -> &str {
                        match *self {
                            ListInstanceFleetsError::InternalServer(ref cause) => cause,ListInstanceFleetsError::InvalidRequest(ref cause) => cause,ListInstanceFleetsError::Validation(ref cause) => cause,ListInstanceFleetsError::Credentials(ref err) => err.description(),ListInstanceFleetsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),ListInstanceFleetsError::Unknown(ref cause) => cause
                        }
                    }
                 }
                    ...
                    pub fn from_body(body: &str) -> ListInstanceGroupsError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InternalServerException" => ListInstanceGroupsError::InternalServer(String::from(error_message)),"InvalidRequestException" => ListInstanceGroupsError::InvalidRequest(String::from(error_message)),"ValidationException" => ListInstanceGroupsError::Validation(error_message.to_string()),_ => ListInstanceGroupsError::Unknown(String::from(body))
                                }
                            },
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> ListInstancesError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InternalServerException" => ListInstancesError::InternalServer(String::from(error_message)),"InvalidRequestException" => ListInstancesError::InvalidRequest(String::from(error_message)),"ValidationException" => ListInstancesError::Validation(error_message.to_string()),_ => ListInstancesError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for ListInstancesError {
                    fn description(&self) -> &str {
                        match *self {
                            ListInstancesError::InternalServer(ref cause) => cause,ListInstancesError::InvalidRequest(ref cause) => cause,ListInstancesError::Validation(ref cause) => cause,ListInstancesError::Credentials(ref err) => err.description(),ListInstancesError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),ListInstancesError::Unknown(ref cause) => cause
                        }
                    }
                 }
                    ...
                    pub fn from_body(body: &str) -> ListSecurityConfigurationsError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InternalServerException" => ListSecurityConfigurationsError::InternalServer(String::from(error_message)),"InvalidRequestException" => ListSecurityConfigurationsError::InvalidRequest(String::from(error_message)),"ValidationException" => ListSecurityConfigurationsError::Validation(error_message.to_string()),_ => ListSecurityConfigurationsError::Unknown(String::from(body))
                                }
                            },
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> ModifyInstanceFleetError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InternalServerException" => ModifyInstanceFleetError::InternalServer(String::from(error_message)),"InvalidRequestException" => ModifyInstanceFleetError::InvalidRequest(String::from(error_message)),"ValidationException" => ModifyInstanceFleetError::Validation(error_message.to_string()),_ => ModifyInstanceFleetError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for ModifyInstanceFleetError {
                    fn description(&self) -> &str {
                        match *self {
                            ModifyInstanceFleetError::InternalServer(ref cause) => cause,ModifyInstanceFleetError::InvalidRequest(ref cause) => cause,ModifyInstanceFleetError::Validation(ref cause) => cause,ModifyInstanceFleetError::Credentials(ref err) => err.description(),ModifyInstanceFleetError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),ModifyInstanceFleetError::Unknown(ref cause) => cause
                        }
                    }
                 }
                    ...
                    pub fn from_body(body: &str) -> RemoveTagsError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InternalServerException" => RemoveTagsError::InternalServer(String::from(error_message)),"InvalidRequestException" => RemoveTagsError::InvalidRequest(String::from(error_message)),"ValidationException" => RemoveTagsError::Validation(error_message.to_string()),_ => RemoveTagsError::Unknown(String::from(body))
                                }
                            },
...
/// A client for the Amazon EMR API.
        ...
        impl<P, D> EmrClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
            pub fn new(request_dispatcher: D, credentials_provider: P, region: region::Region) -> Self {
                ...
                pub fn add_instance_fleet(&self, input: &AddInstanceFleetInput)  -> Result<AddInstanceFleetOutput, AddInstanceFleetError> {
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    match response.status {
                        ...
                        _ => Err(AddInstanceFleetError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                    }
                }
                

                #[doc="<p>Adds one or more instance groups to a running cluster.</p>"]
                pub fn add_instance_groups(&self, input: &AddInstanceGroupsInput)  -> Result<AddInstanceGroupsOutput, AddInstanceGroupsError> {
                    let mut request = SignedRequest::new("POST", "elasticmapreduce", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn add_job_flow_steps(&self, input: &AddJobFlowStepsInput)  -> Result<AddJobFlowStepsOutput, AddJobFlowStepsError> {
                    let mut request = SignedRequest::new("POST", "elasticmapreduce", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn cancel_steps(&self, input: &CancelStepsInput)  -> Result<CancelStepsOutput, CancelStepsError> {
                    let mut request = SignedRequest::new("POST", "elasticmapreduce", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn create_security_configuration(&self, input: &CreateSecurityConfigurationInput)  -> Result<CreateSecurityConfigurationOutput, CreateSecurityConfigurationError> {
                    let mut request = SignedRequest::new("POST", "elasticmapreduce", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn delete_security_configuration(&self, input: &DeleteSecurityConfigurationInput)  -> Result<DeleteSecurityConfigurationOutput, DeleteSecurityConfigurationError> {
                    let mut request = SignedRequest::new("POST", "elasticmapreduce", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn describe_cluster(&self, input: &DescribeClusterInput)  -> Result<DescribeClusterOutput, DescribeClusterError> {
                    let mut request = SignedRequest::new("POST", "elasticmapreduce", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn describe_job_flows(&self, input: &DescribeJobFlowsInput)  -> Result<DescribeJobFlowsOutput, DescribeJobFlowsError> {
                    let mut request = SignedRequest::new("POST", "elasticmapreduce", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn describe_security_configuration(&self, input: &DescribeSecurityConfigurationInput)  -> Result<DescribeSecurityConfigurationOutput, DescribeSecurityConfigurationError> {
                    let mut request = SignedRequest::new("POST", "elasticmapreduce", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn describe_step(&self, input: &DescribeStepInput)  -> Result<DescribeStepOutput, DescribeStepError> {
                    let mut request = SignedRequest::new("POST", "elasticmapreduce", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn list_bootstrap_actions(&self, input: &ListBootstrapActionsInput)  -> Result<ListBootstrapActionsOutput, ListBootstrapActionsError> {
                    let mut request = SignedRequest::new("POST", "elasticmapreduce", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn list_clusters(&self, input: &ListClustersInput)  -> Result<ListClustersOutput, ListClustersError> {
                    let mut request = SignedRequest::new("POST", "elasticmapreduce", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn list_instance_fleets(&self, input: &ListInstanceFleetsInput)  -> Result<ListInstanceFleetsOutput, ListInstanceFleetsError> {
                    let mut request = SignedRequest::new("POST", "elasticmapreduce", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    match response.status {
                        ...
                        _ => Err(ListInstanceFleetsError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                    }
                }
                

                #[doc="<p>Provides all available details about the instance groups in a cluster.</p>"]
                pub fn list_instance_groups(&self, input: &ListInstanceGroupsInput)  -> Result<ListInstanceGroupsOutput, ListInstanceGroupsError> {
                    let mut request = SignedRequest::new("POST", "elasticmapreduce", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn list_instances(&self, input: &ListInstancesInput)  -> Result<ListInstancesOutput, ListInstancesError> {
                    let mut request = SignedRequest::new("POST", "elasticmapreduce", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn list_security_configurations(&self, input: &ListSecurityConfigurationsInput)  -> Result<ListSecurityConfigurationsOutput, ListSecurityConfigurationsError> {
                    let mut request = SignedRequest::new("POST", "elasticmapreduce", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn list_steps(&self, input: &ListStepsInput)  -> Result<ListStepsOutput, ListStepsError> {
                    let mut request = SignedRequest::new("POST", "elasticmapreduce", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn modify_instance_fleet(&self, input: &ModifyInstanceFleetInput)  -> Result<(), ModifyInstanceFleetError> {
                    let mut request = SignedRequest::new("POST", "elasticmapreduce", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    match response.status {
                        ...
                        _ => Err(ModifyInstanceFleetError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                    }
                }
                ...
                pub fn modify_instance_groups(&self, input: &ModifyInstanceGroupsInput)  -> Result<(), ModifyInstanceGroupsError> {
                    let mut request = SignedRequest::new("POST", "elasticmapreduce", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn put_auto_scaling_policy(&self, input: &PutAutoScalingPolicyInput)  -> Result<PutAutoScalingPolicyOutput, PutAutoScalingPolicyError> {
                    let mut request = SignedRequest::new("POST", "elasticmapreduce", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn remove_auto_scaling_policy(&self, input: &RemoveAutoScalingPolicyInput)  -> Result<RemoveAutoScalingPolicyOutput, RemoveAutoScalingPolicyError> {
                    let mut request = SignedRequest::new("POST", "elasticmapreduce", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn run_job_flow(&self, input: &RunJobFlowInput)  -> Result<RunJobFlowOutput, RunJobFlowError> {
                    let mut request = SignedRequest::new("POST", "elasticmapreduce", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn set_termination_protection(&self, input: &SetTerminationProtectionInput)  -> Result<(), SetTerminationProtectionError> {
                    let mut request = SignedRequest::new("POST", "elasticmapreduce", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn set_visible_to_all_users(&self, input: &SetVisibleToAllUsersInput)  -> Result<(), SetVisibleToAllUsersError> {
                    let mut request = SignedRequest::new("POST", "elasticmapreduce", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn terminate_job_flows(&self, input: &TerminateJobFlowsInput)  -> Result<(), TerminateJobFlowsError> {
                    let mut request = SignedRequest::new("POST", "elasticmapreduce", self.region, "/");
