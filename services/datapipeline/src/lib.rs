...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> PollForTaskError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InternalServiceError" => PollForTaskError::InternalServiceError(String::from(error_message)),"InvalidRequestException" => PollForTaskError::InvalidRequest(String::from(error_message)),"TaskNotFoundException" => PollForTaskError::TaskNotFound(String::from(error_message)),"ValidationException" => PollForTaskError::Validation(error_message.to_string()),_ => PollForTaskError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for PollForTaskError {
                    fn description(&self) -> &str {
                        match *self {
                            PollForTaskError::InternalServiceError(ref cause) => cause,PollForTaskError::InvalidRequest(ref cause) => cause,PollForTaskError::TaskNotFound(ref cause) => cause,PollForTaskError::Validation(ref cause) => cause,PollForTaskError::Credentials(ref err) => err.description(),PollForTaskError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),PollForTaskError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
/// A client for the AWS Data Pipeline API.
        ...
        impl<P, D> DataPipelineClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
            pub fn new(request_dispatcher: D, credentials_provider: P, region: region::Region) -> Self {
                ...
                pub fn activate_pipeline(&self, input: &ActivatePipelineInput)  -> Result<ActivatePipelineOutput, ActivatePipelineError> {
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn deactivate_pipeline(&self, input: &DeactivatePipelineInput)  -> Result<DeactivatePipelineOutput, DeactivatePipelineError> {
                    let mut request = SignedRequest::new("POST", "datapipeline", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn describe_objects(&self, input: &DescribeObjectsInput)  -> Result<DescribeObjectsOutput, DescribeObjectsError> {
                    let mut request = SignedRequest::new("POST", "datapipeline", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn describe_pipelines(&self, input: &DescribePipelinesInput)  -> Result<DescribePipelinesOutput, DescribePipelinesError> {
                    let mut request = SignedRequest::new("POST", "datapipeline", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn evaluate_expression(&self, input: &EvaluateExpressionInput)  -> Result<EvaluateExpressionOutput, EvaluateExpressionError> {
                    let mut request = SignedRequest::new("POST", "datapipeline", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn get_pipeline_definition(&self, input: &GetPipelineDefinitionInput)  -> Result<GetPipelineDefinitionOutput, GetPipelineDefinitionError> {
                    let mut request = SignedRequest::new("POST", "datapipeline", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn poll_for_task(&self, input: &PollForTaskInput)  -> Result<PollForTaskOutput, PollForTaskError> {
                    let mut request = SignedRequest::new("POST", "datapipeline", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn put_pipeline_definition(&self, input: &PutPipelineDefinitionInput)  -> Result<PutPipelineDefinitionOutput, PutPipelineDefinitionError> {
                    let mut request = SignedRequest::new("POST", "datapipeline", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn query_objects(&self, input: &QueryObjectsInput)  -> Result<QueryObjectsOutput, QueryObjectsError> {
                    let mut request = SignedRequest::new("POST", "datapipeline", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn report_task_progress(&self, input: &ReportTaskProgressInput)  -> Result<ReportTaskProgressOutput, ReportTaskProgressError> {
                    let mut request = SignedRequest::new("POST", "datapipeline", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn report_task_runner_heartbeat(&self, input: &ReportTaskRunnerHeartbeatInput)  -> Result<ReportTaskRunnerHeartbeatOutput, ReportTaskRunnerHeartbeatError> {
                    let mut request = SignedRequest::new("POST", "datapipeline", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn set_status(&self, input: &SetStatusInput)  -> Result<(), SetStatusError> {
                    let mut request = SignedRequest::new("POST", "datapipeline", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn set_task_status(&self, input: &SetTaskStatusInput)  -> Result<SetTaskStatusOutput, SetTaskStatusError> {
                    let mut request = SignedRequest::new("POST", "datapipeline", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn validate_pipeline_definition(&self, input: &ValidatePipelineDefinitionInput)  -> Result<ValidatePipelineDefinitionOutput, ValidatePipelineDefinitionError> {
                    let mut request = SignedRequest::new("POST", "datapipeline", self.region, "/");
