...
Unknown(String)
                ...
                impl Error for DescribeFindingsError {
                    fn description(&self) -> &str {
                        match *self {
                            DescribeFindingsError::Internal(ref cause) => cause,DescribeFindingsError::InvalidInput(ref cause) => cause,DescribeFindingsError::Validation(ref cause) => cause,DescribeFindingsError::Credentials(ref err) => err.description(),DescribeFindingsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),DescribeFindingsError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
/// A client for the Amazon Inspector API.
        ...
        impl<P, D> InspectorClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
            pub fn new(request_dispatcher: D, credentials_provider: P, region: region::Region) -> Self {
                ...
                pub fn add_attributes_to_findings(&self, input: &AddAttributesToFindingsRequest)  -> Result<AddAttributesToFindingsResponse, AddAttributesToFindingsError> {
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn create_assessment_target(&self, input: &CreateAssessmentTargetRequest)  -> Result<CreateAssessmentTargetResponse, CreateAssessmentTargetError> {
                    let mut request = SignedRequest::new("POST", "inspector", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn create_assessment_template(&self, input: &CreateAssessmentTemplateRequest)  -> Result<CreateAssessmentTemplateResponse, CreateAssessmentTemplateError> {
                    let mut request = SignedRequest::new("POST", "inspector", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn create_resource_group(&self, input: &CreateResourceGroupRequest)  -> Result<CreateResourceGroupResponse, CreateResourceGroupError> {
                    let mut request = SignedRequest::new("POST", "inspector", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn delete_assessment_run(&self, input: &DeleteAssessmentRunRequest)  -> Result<(), DeleteAssessmentRunError> {
                    let mut request = SignedRequest::new("POST", "inspector", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn delete_assessment_target(&self, input: &DeleteAssessmentTargetRequest)  -> Result<(), DeleteAssessmentTargetError> {
                    let mut request = SignedRequest::new("POST", "inspector", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn delete_assessment_template(&self, input: &DeleteAssessmentTemplateRequest)  -> Result<(), DeleteAssessmentTemplateError> {
                    let mut request = SignedRequest::new("POST", "inspector", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn describe_assessment_runs(&self, input: &DescribeAssessmentRunsRequest)  -> Result<DescribeAssessmentRunsResponse, DescribeAssessmentRunsError> {
                    let mut request = SignedRequest::new("POST", "inspector", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn describe_assessment_targets(&self, input: &DescribeAssessmentTargetsRequest)  -> Result<DescribeAssessmentTargetsResponse, DescribeAssessmentTargetsError> {
                    let mut request = SignedRequest::new("POST", "inspector", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn describe_assessment_templates(&self, input: &DescribeAssessmentTemplatesRequest)  -> Result<DescribeAssessmentTemplatesResponse, DescribeAssessmentTemplatesError> {
                    let mut request = SignedRequest::new("POST", "inspector", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn describe_cross_account_access_role(&self)  -> Result<DescribeCrossAccountAccessRoleResponse, DescribeCrossAccountAccessRoleError> {
                    let mut request = SignedRequest::new("POST", "inspector", self.region, "/");
                ...
                pub fn describe_findings(&self, input: &DescribeFindingsRequest)  -> Result<DescribeFindingsResponse, DescribeFindingsError> {
                    let mut request = SignedRequest::new("POST", "inspector", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn describe_resource_groups(&self, input: &DescribeResourceGroupsRequest)  -> Result<DescribeResourceGroupsResponse, DescribeResourceGroupsError> {
                    let mut request = SignedRequest::new("POST", "inspector", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn describe_rules_packages(&self, input: &DescribeRulesPackagesRequest)  -> Result<DescribeRulesPackagesResponse, DescribeRulesPackagesError> {
                    let mut request = SignedRequest::new("POST", "inspector", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn get_telemetry_metadata(&self, input: &GetTelemetryMetadataRequest)  -> Result<GetTelemetryMetadataResponse, GetTelemetryMetadataError> {
                    let mut request = SignedRequest::new("POST", "inspector", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn list_assessment_run_agents(&self, input: &ListAssessmentRunAgentsRequest)  -> Result<ListAssessmentRunAgentsResponse, ListAssessmentRunAgentsError> {
                    let mut request = SignedRequest::new("POST", "inspector", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn list_assessment_runs(&self, input: &ListAssessmentRunsRequest)  -> Result<ListAssessmentRunsResponse, ListAssessmentRunsError> {
                    let mut request = SignedRequest::new("POST", "inspector", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn list_assessment_targets(&self, input: &ListAssessmentTargetsRequest)  -> Result<ListAssessmentTargetsResponse, ListAssessmentTargetsError> {
                    let mut request = SignedRequest::new("POST", "inspector", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn list_assessment_templates(&self, input: &ListAssessmentTemplatesRequest)  -> Result<ListAssessmentTemplatesResponse, ListAssessmentTemplatesError> {
                    let mut request = SignedRequest::new("POST", "inspector", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn list_event_subscriptions(&self, input: &ListEventSubscriptionsRequest)  -> Result<ListEventSubscriptionsResponse, ListEventSubscriptionsError> {
                    let mut request = SignedRequest::new("POST", "inspector", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn list_findings(&self, input: &ListFindingsRequest)  -> Result<ListFindingsResponse, ListFindingsError> {
                    let mut request = SignedRequest::new("POST", "inspector", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn list_rules_packages(&self, input: &ListRulesPackagesRequest)  -> Result<ListRulesPackagesResponse, ListRulesPackagesError> {
                    let mut request = SignedRequest::new("POST", "inspector", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn preview_agents(&self, input: &PreviewAgentsRequest)  -> Result<PreviewAgentsResponse, PreviewAgentsError> {
                    let mut request = SignedRequest::new("POST", "inspector", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn register_cross_account_access_role(&self, input: &RegisterCrossAccountAccessRoleRequest)  -> Result<(), RegisterCrossAccountAccessRoleError> {
                    let mut request = SignedRequest::new("POST", "inspector", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn remove_attributes_from_findings(&self, input: &RemoveAttributesFromFindingsRequest)  -> Result<RemoveAttributesFromFindingsResponse, RemoveAttributesFromFindingsError> {
                    let mut request = SignedRequest::new("POST", "inspector", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn set_tags_for_resource(&self, input: &SetTagsForResourceRequest)  -> Result<(), SetTagsForResourceError> {
                    let mut request = SignedRequest::new("POST", "inspector", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn start_assessment_run(&self, input: &StartAssessmentRunRequest)  -> Result<StartAssessmentRunResponse, StartAssessmentRunError> {
                    let mut request = SignedRequest::new("POST", "inspector", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn stop_assessment_run(&self, input: &StopAssessmentRunRequest)  -> Result<(), StopAssessmentRunError> {
                    let mut request = SignedRequest::new("POST", "inspector", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn subscribe_to_event(&self, input: &SubscribeToEventRequest)  -> Result<(), SubscribeToEventError> {
                    let mut request = SignedRequest::new("POST", "inspector", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn unsubscribe_from_event(&self, input: &UnsubscribeFromEventRequest)  -> Result<(), UnsubscribeFromEventError> {
                    let mut request = SignedRequest::new("POST", "inspector", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn update_assessment_target(&self, input: &UpdateAssessmentTargetRequest)  -> Result<(), UpdateAssessmentTargetError> {
                    let mut request = SignedRequest::new("POST", "inspector", self.region, "/");
