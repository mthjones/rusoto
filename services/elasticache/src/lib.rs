...
if let Some(ref field_value) = obj.show_cache_clusters_not_in_replication_groups {
                params.put(&format!("{}{}", prefix, "ShowCacheClustersNotInReplicationGroups"), &field_value.to_string());
            }
...
"ClusterEnabled" => {
                obj.cluster_enabled = Some(try!(BooleanOptionalDeserializer::deserialize("ClusterEnabled", stack)));
            }
"ConfigurationEndpoint" => {
                obj.configuration_endpoint = Some(try!(EndpointDeserializer::deserialize("ConfigurationEndpoint", stack)));
            }
...
Unknown(String)
                ...
                impl TestFailoverError {
                    pub fn from_body(body: &str) -> TestFailoverError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "APICallRateForCustomerExceededFault" => TestFailoverError::APICallRateForCustomerExceededFault(String::from(parsed_error.message)),"InvalidCacheClusterStateFault" => TestFailoverError::InvalidCacheClusterStateFault(String::from(parsed_error.message)),"InvalidReplicationGroupStateFault" => TestFailoverError::InvalidReplicationGroupStateFault(String::from(parsed_error.message)),"NodeGroupNotFoundFault" => TestFailoverError::NodeGroupNotFoundFault(String::from(parsed_error.message)),"ReplicationGroupNotFoundFault" => TestFailoverError::ReplicationGroupNotFoundFault(String::from(parsed_error.message)),"TestFailoverNotAvailableFault" => TestFailoverError::TestFailoverNotAvailableFault(String::from(parsed_error.message)),"InvalidParameterValueException" => TestFailoverError::InvalidParameterValue(String::from(parsed_error.message)),"InvalidParameterCombinationException" => TestFailoverError::InvalidParameterCombination(String::from(parsed_error.message)),_ => TestFailoverError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for TestFailoverError {
                    fn description(&self) -> &str {
                        match *self {
                            TestFailoverError::APICallRateForCustomerExceededFault(ref cause) => cause,TestFailoverError::InvalidCacheClusterStateFault(ref cause) => cause,TestFailoverError::InvalidReplicationGroupStateFault(ref cause) => cause,TestFailoverError::NodeGroupNotFoundFault(ref cause) => cause,TestFailoverError::ReplicationGroupNotFoundFault(ref cause) => cause,TestFailoverError::TestFailoverNotAvailableFault(ref cause) => cause,TestFailoverError::InvalidParameterValue(ref cause) => cause,TestFailoverError::InvalidParameterCombination(ref cause) => cause,TestFailoverError::Validation(ref cause) => cause,TestFailoverError::Credentials(ref err) => err.description(),TestFailoverError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),TestFailoverError::Unknown(ref cause) => cause
                        }
                    }
                 }
/// A client for the Amazon ElastiCache API.
        ...
        impl<P, D> ElastiCacheClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
            pub fn new(request_dispatcher: D, credentials_provider: P, region: region::Region) -> Self {
                ...
                pub fn add_tags_to_resource(&self, input: &AddTagsToResourceMessage) -> Result<TagListMessage, AddTagsToResourceError> {
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn authorize_cache_security_group_ingress(&self, input: &AuthorizeCacheSecurityGroupIngressMessage) -> Result<AuthorizeCacheSecurityGroupIngressResult, AuthorizeCacheSecurityGroupIngressError> {
                    let mut request = SignedRequest::new("POST", "elasticache", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn copy_snapshot(&self, input: &CopySnapshotMessage) -> Result<CopySnapshotResult, CopySnapshotError> {
                    let mut request = SignedRequest::new("POST", "elasticache", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn create_cache_cluster(&self, input: &CreateCacheClusterMessage) -> Result<CreateCacheClusterResult, CreateCacheClusterError> {
                    let mut request = SignedRequest::new("POST", "elasticache", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn create_cache_parameter_group(&self, input: &CreateCacheParameterGroupMessage) -> Result<CreateCacheParameterGroupResult, CreateCacheParameterGroupError> {
                    let mut request = SignedRequest::new("POST", "elasticache", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn create_cache_security_group(&self, input: &CreateCacheSecurityGroupMessage) -> Result<CreateCacheSecurityGroupResult, CreateCacheSecurityGroupError> {
                    let mut request = SignedRequest::new("POST", "elasticache", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn create_cache_subnet_group(&self, input: &CreateCacheSubnetGroupMessage) -> Result<CreateCacheSubnetGroupResult, CreateCacheSubnetGroupError> {
                    let mut request = SignedRequest::new("POST", "elasticache", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn create_replication_group(&self, input: &CreateReplicationGroupMessage) -> Result<CreateReplicationGroupResult, CreateReplicationGroupError> {
                    let mut request = SignedRequest::new("POST", "elasticache", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn create_snapshot(&self, input: &CreateSnapshotMessage) -> Result<CreateSnapshotResult, CreateSnapshotError> {
                    let mut request = SignedRequest::new("POST", "elasticache", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn delete_cache_cluster(&self, input: &DeleteCacheClusterMessage) -> Result<DeleteCacheClusterResult, DeleteCacheClusterError> {
                    let mut request = SignedRequest::new("POST", "elasticache", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn delete_cache_parameter_group(&self, input: &DeleteCacheParameterGroupMessage) -> Result<(), DeleteCacheParameterGroupError> {
                    let mut request = SignedRequest::new("POST", "elasticache", self.region, "/");
                    let mut params = Params::new();
                ...
                pub fn delete_cache_security_group(&self, input: &DeleteCacheSecurityGroupMessage) -> Result<(), DeleteCacheSecurityGroupError> {
                    let mut request = SignedRequest::new("POST", "elasticache", self.region, "/");
                    let mut params = Params::new();
                ...
                pub fn delete_cache_subnet_group(&self, input: &DeleteCacheSubnetGroupMessage) -> Result<(), DeleteCacheSubnetGroupError> {
                    let mut request = SignedRequest::new("POST", "elasticache", self.region, "/");
                    let mut params = Params::new();
                ...
                pub fn delete_replication_group(&self, input: &DeleteReplicationGroupMessage) -> Result<DeleteReplicationGroupResult, DeleteReplicationGroupError> {
                    let mut request = SignedRequest::new("POST", "elasticache", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn delete_snapshot(&self, input: &DeleteSnapshotMessage) -> Result<DeleteSnapshotResult, DeleteSnapshotError> {
                    let mut request = SignedRequest::new("POST", "elasticache", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn describe_cache_clusters(&self, input: &DescribeCacheClustersMessage) -> Result<CacheClusterMessage, DescribeCacheClustersError> {
                    let mut request = SignedRequest::new("POST", "elasticache", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn describe_cache_engine_versions(&self, input: &DescribeCacheEngineVersionsMessage) -> Result<CacheEngineVersionMessage, DescribeCacheEngineVersionsError> {
                    let mut request = SignedRequest::new("POST", "elasticache", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn describe_cache_parameter_groups(&self, input: &DescribeCacheParameterGroupsMessage) -> Result<CacheParameterGroupsMessage, DescribeCacheParameterGroupsError> {
                    let mut request = SignedRequest::new("POST", "elasticache", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn describe_cache_parameters(&self, input: &DescribeCacheParametersMessage) -> Result<CacheParameterGroupDetails, DescribeCacheParametersError> {
                    let mut request = SignedRequest::new("POST", "elasticache", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn describe_cache_security_groups(&self, input: &DescribeCacheSecurityGroupsMessage) -> Result<CacheSecurityGroupMessage, DescribeCacheSecurityGroupsError> {
                    let mut request = SignedRequest::new("POST", "elasticache", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn describe_cache_subnet_groups(&self, input: &DescribeCacheSubnetGroupsMessage) -> Result<CacheSubnetGroupMessage, DescribeCacheSubnetGroupsError> {
                    let mut request = SignedRequest::new("POST", "elasticache", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn describe_engine_default_parameters(&self, input: &DescribeEngineDefaultParametersMessage) -> Result<DescribeEngineDefaultParametersResult, DescribeEngineDefaultParametersError> {
                    let mut request = SignedRequest::new("POST", "elasticache", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn describe_replication_groups(&self, input: &DescribeReplicationGroupsMessage) -> Result<ReplicationGroupMessage, DescribeReplicationGroupsError> {
                    let mut request = SignedRequest::new("POST", "elasticache", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn describe_reserved_cache_nodes(&self, input: &DescribeReservedCacheNodesMessage) -> Result<ReservedCacheNodeMessage, DescribeReservedCacheNodesError> {
                    let mut request = SignedRequest::new("POST", "elasticache", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn describe_reserved_cache_nodes_offerings(&self, input: &DescribeReservedCacheNodesOfferingsMessage) -> Result<ReservedCacheNodesOfferingMessage, DescribeReservedCacheNodesOfferingsError> {
                    let mut request = SignedRequest::new("POST", "elasticache", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn describe_snapshots(&self, input: &DescribeSnapshotsMessage) -> Result<DescribeSnapshotsListMessage, DescribeSnapshotsError> {
                    let mut request = SignedRequest::new("POST", "elasticache", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn list_allowed_node_type_modifications(&self, input: &ListAllowedNodeTypeModificationsMessage) -> Result<AllowedNodeTypeModificationsMessage, ListAllowedNodeTypeModificationsError> {
                    let mut request = SignedRequest::new("POST", "elasticache", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn list_tags_for_resource(&self, input: &ListTagsForResourceMessage) -> Result<TagListMessage, ListTagsForResourceError> {
                    let mut request = SignedRequest::new("POST", "elasticache", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn modify_cache_cluster(&self, input: &ModifyCacheClusterMessage) -> Result<ModifyCacheClusterResult, ModifyCacheClusterError> {
                    let mut request = SignedRequest::new("POST", "elasticache", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn modify_cache_parameter_group(&self, input: &ModifyCacheParameterGroupMessage) -> Result<CacheParameterGroupNameMessage, ModifyCacheParameterGroupError> {
                    let mut request = SignedRequest::new("POST", "elasticache", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn modify_cache_subnet_group(&self, input: &ModifyCacheSubnetGroupMessage) -> Result<ModifyCacheSubnetGroupResult, ModifyCacheSubnetGroupError> {
                    let mut request = SignedRequest::new("POST", "elasticache", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn modify_replication_group(&self, input: &ModifyReplicationGroupMessage) -> Result<ModifyReplicationGroupResult, ModifyReplicationGroupError> {
                    let mut request = SignedRequest::new("POST", "elasticache", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn purchase_reserved_cache_nodes_offering(&self, input: &PurchaseReservedCacheNodesOfferingMessage) -> Result<PurchaseReservedCacheNodesOfferingResult, PurchaseReservedCacheNodesOfferingError> {
                    let mut request = SignedRequest::new("POST", "elasticache", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn reboot_cache_cluster(&self, input: &RebootCacheClusterMessage) -> Result<RebootCacheClusterResult, RebootCacheClusterError> {
                    let mut request = SignedRequest::new("POST", "elasticache", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn remove_tags_from_resource(&self, input: &RemoveTagsFromResourceMessage) -> Result<TagListMessage, RemoveTagsFromResourceError> {
                    let mut request = SignedRequest::new("POST", "elasticache", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn reset_cache_parameter_group(&self, input: &ResetCacheParameterGroupMessage) -> Result<CacheParameterGroupNameMessage, ResetCacheParameterGroupError> {
                    let mut request = SignedRequest::new("POST", "elasticache", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn revoke_cache_security_group_ingress(&self, input: &RevokeCacheSecurityGroupIngressMessage) -> Result<RevokeCacheSecurityGroupIngressResult, RevokeCacheSecurityGroupIngressError> {
                    let mut request = SignedRequest::new("POST", "elasticache", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn test_failover(&self, input: &TestFailoverMessage) -> Result<TestFailoverResult, TestFailoverError> {
                    let mut request = SignedRequest::new("POST", "elasticache", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            let actual_tag_name = try!(peek_at_name(&mut stack));
            try!(start_element(&actual_tag_name, &mut stack));
                     result = try!(TestFailoverResultDeserializer::deserialize("TestFailoverResult", &mut stack));
                     skip_tree(&mut stack);
                     try!(end_element(&actual_tag_name, &mut stack));
        }
                            Ok(result)
