...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> AddTagsToCertificateError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InvalidArnException" => AddTagsToCertificateError::InvalidArn(String::from(error_message)),"InvalidTagException" => AddTagsToCertificateError::InvalidTag(String::from(error_message)),"ResourceNotFoundException" => AddTagsToCertificateError::ResourceNotFound(String::from(error_message)),"TooManyTagsException" => AddTagsToCertificateError::TooManyTags(String::from(error_message)),"ValidationException" => AddTagsToCertificateError::Validation(error_message.to_string()),_ => AddTagsToCertificateError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for AddTagsToCertificateError {
                    fn description(&self) -> &str {
                        match *self {
                            AddTagsToCertificateError::InvalidArn(ref cause) => cause,AddTagsToCertificateError::InvalidTag(ref cause) => cause,AddTagsToCertificateError::ResourceNotFound(ref cause) => cause,AddTagsToCertificateError::TooManyTags(ref cause) => cause,AddTagsToCertificateError::Validation(ref cause) => cause,AddTagsToCertificateError::Credentials(ref err) => err.description(),AddTagsToCertificateError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),AddTagsToCertificateError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> GetCertificateError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InvalidArnException" => GetCertificateError::InvalidArn(String::from(error_message)),"RequestInProgressException" => GetCertificateError::RequestInProgress(String::from(error_message)),"ResourceNotFoundException" => GetCertificateError::ResourceNotFound(String::from(error_message)),"ValidationException" => GetCertificateError::Validation(error_message.to_string()),_ => GetCertificateError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for GetCertificateError {
                    fn description(&self) -> &str {
                        match *self {
                            GetCertificateError::InvalidArn(ref cause) => cause,GetCertificateError::RequestInProgress(ref cause) => cause,GetCertificateError::ResourceNotFound(ref cause) => cause,GetCertificateError::Validation(ref cause) => cause,GetCertificateError::Credentials(ref err) => err.description(),GetCertificateError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),GetCertificateError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> RemoveTagsFromCertificateError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InvalidArnException" => RemoveTagsFromCertificateError::InvalidArn(String::from(error_message)),"InvalidTagException" => RemoveTagsFromCertificateError::InvalidTag(String::from(error_message)),"ResourceNotFoundException" => RemoveTagsFromCertificateError::ResourceNotFound(String::from(error_message)),"ValidationException" => RemoveTagsFromCertificateError::Validation(error_message.to_string()),_ => RemoveTagsFromCertificateError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for RemoveTagsFromCertificateError {
                    fn description(&self) -> &str {
                        match *self {
                            RemoveTagsFromCertificateError::InvalidArn(ref cause) => cause,RemoveTagsFromCertificateError::InvalidTag(ref cause) => cause,RemoveTagsFromCertificateError::ResourceNotFound(ref cause) => cause,RemoveTagsFromCertificateError::Validation(ref cause) => cause,RemoveTagsFromCertificateError::Credentials(ref err) => err.description(),RemoveTagsFromCertificateError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),RemoveTagsFromCertificateError::Unknown(ref cause) => cause
                        }
                    }
                 }
                    ...
                    pub fn from_body(body: &str) -> ResendValidationEmailError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InvalidArnException" => ResendValidationEmailError::InvalidArn(String::from(error_message)),"InvalidDomainValidationOptionsException" => ResendValidationEmailError::InvalidDomainValidationOptions(String::from(error_message)),"InvalidStateException" => ResendValidationEmailError::InvalidState(String::from(error_message)),"ResourceNotFoundException" => ResendValidationEmailError::ResourceNotFound(String::from(error_message)),"ValidationException" => ResendValidationEmailError::Validation(error_message.to_string()),_ => ResendValidationEmailError::Unknown(String::from(body))
                                }
                            },
