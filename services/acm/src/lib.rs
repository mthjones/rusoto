...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> AddTagsToCertificateError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InvalidTagException" => AddTagsToCertificateError::InvalidTag(String::from(error_message)),"ResourceNotFoundException" => AddTagsToCertificateError::ResourceNotFound(String::from(error_message)),"TooManyTagsException" => AddTagsToCertificateError::TooManyTags(String::from(error_message)),"InvalidArnException" => AddTagsToCertificateError::InvalidArn(String::from(error_message)),"ValidationException" => AddTagsToCertificateError::Validation(error_message.to_string()),_ => AddTagsToCertificateError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for AddTagsToCertificateError {
                    fn description(&self) -> &str {
                        match *self {
                            AddTagsToCertificateError::InvalidTag(ref cause) => cause,AddTagsToCertificateError::ResourceNotFound(ref cause) => cause,AddTagsToCertificateError::InvalidArn(ref cause) => cause,AddTagsToCertificateError::TooManyTags(ref cause) => cause,AddTagsToCertificateError::Validation(ref cause) => cause,AddTagsToCertificateError::Credentials(ref err) => err.description(),AddTagsToCertificateError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),AddTagsToCertificateError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> DeleteCertificateError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InvalidArnException" => DeleteCertificateError::InvalidArn(String::from(error_message)),"ResourceNotFoundException" => DeleteCertificateError::ResourceNotFound(String::from(error_message)),"ResourceInUseException" => DeleteCertificateError::ResourceInUse(String::from(error_message)),"ValidationException" => DeleteCertificateError::Validation(error_message.to_string()),_ => DeleteCertificateError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for DeleteCertificateError {
                    fn description(&self) -> &str {
                        match *self {
                            DeleteCertificateError::ResourceNotFound(ref cause) => cause,DeleteCertificateError::ResourceInUse(ref cause) => cause,DeleteCertificateError::InvalidArn(ref cause) => cause,DeleteCertificateError::Validation(ref cause) => cause,DeleteCertificateError::Credentials(ref err) => err.description(),DeleteCertificateError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),DeleteCertificateError::Unknown(ref cause) => cause
                        }
                    }
                 }
                    ...
                    pub fn from_body(body: &str) -> DescribeCertificateError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InvalidArnException" => DescribeCertificateError::InvalidArn(String::from(error_message)),"ResourceNotFoundException" => DescribeCertificateError::ResourceNotFound(String::from(error_message)),"ValidationException" => DescribeCertificateError::Validation(error_message.to_string()),_ => DescribeCertificateError::Unknown(String::from(body))
                                }
                            },
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> GetCertificateError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "RequestInProgressException" => GetCertificateError::RequestInProgress(String::from(error_message)),"InvalidArnException" => GetCertificateError::InvalidArn(String::from(error_message)),"ResourceNotFoundException" => GetCertificateError::ResourceNotFound(String::from(error_message)),"ValidationException" => GetCertificateError::Validation(error_message.to_string()),_ => GetCertificateError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for GetCertificateError {
                    fn description(&self) -> &str {
                        match *self {
                            GetCertificateError::ResourceNotFound(ref cause) => cause,GetCertificateError::InvalidArn(ref cause) => cause,GetCertificateError::RequestInProgress(ref cause) => cause,GetCertificateError::Validation(ref cause) => cause,GetCertificateError::Credentials(ref err) => err.description(),GetCertificateError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),GetCertificateError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl Error for ListTagsForCertificateError {
                    fn description(&self) -> &str {
                        match *self {
                            ListTagsForCertificateError::InvalidArn(ref cause) => cause,ListTagsForCertificateError::ResourceNotFound(ref cause) => cause,ListTagsForCertificateError::Validation(ref cause) => cause,ListTagsForCertificateError::Credentials(ref err) => err.description(),ListTagsForCertificateError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),ListTagsForCertificateError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl Error for RemoveTagsFromCertificateError {
                    fn description(&self) -> &str {
                        match *self {
                            RemoveTagsFromCertificateError::InvalidTag(ref cause) => cause,RemoveTagsFromCertificateError::ResourceNotFound(ref cause) => cause,RemoveTagsFromCertificateError::InvalidArn(ref cause) => cause,RemoveTagsFromCertificateError::Validation(ref cause) => cause,RemoveTagsFromCertificateError::Credentials(ref err) => err.description(),RemoveTagsFromCertificateError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),RemoveTagsFromCertificateError::Unknown(ref cause) => cause
                        }
                    }
                 }
                    ...
                    pub fn from_body(body: &str) -> ResendValidationEmailError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InvalidDomainValidationOptionsException" => ResendValidationEmailError::InvalidDomainValidationOptions(String::from(error_message)),"InvalidArnException" => ResendValidationEmailError::InvalidArn(String::from(error_message)),"ResourceNotFoundException" => ResendValidationEmailError::ResourceNotFound(String::from(error_message)),"InvalidStateException" => ResendValidationEmailError::InvalidState(String::from(error_message)),"ValidationException" => ResendValidationEmailError::Validation(error_message.to_string()),_ => ResendValidationEmailError::Unknown(String::from(body))
                                }
                            },
