...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> AddTagsError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "ResourceNotFoundException" => AddTagsError::ResourceNotFound(String::from(error_message)),"CloudTrailARNInvalidException" => AddTagsError::CloudTrailARNInvalid(String::from(error_message)),"ResourceTypeNotSupportedException" => AddTagsError::ResourceTypeNotSupported(String::from(error_message)),"TagsLimitExceededException" => AddTagsError::TagsLimitExceeded(String::from(error_message)),"InvalidTrailNameException" => AddTagsError::InvalidTrailName(String::from(error_message)),"InvalidTagParameterException" => AddTagsError::InvalidTagParameter(String::from(error_message)),"UnsupportedOperationException" => AddTagsError::UnsupportedOperation(String::from(error_message)),"OperationNotPermittedException" => AddTagsError::OperationNotPermitted(String::from(error_message)),"ValidationException" => AddTagsError::Validation(error_message.to_string()),_ => AddTagsError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for AddTagsError {
                    fn description(&self) -> &str {
                        match *self {
                            AddTagsError::ResourceNotFound(ref cause) => cause,AddTagsError::CloudTrailARNInvalid(ref cause) => cause,AddTagsError::ResourceTypeNotSupported(ref cause) => cause,AddTagsError::TagsLimitExceeded(ref cause) => cause,AddTagsError::InvalidTrailName(ref cause) => cause,AddTagsError::InvalidTagParameter(ref cause) => cause,AddTagsError::UnsupportedOperation(ref cause) => cause,AddTagsError::OperationNotPermitted(ref cause) => cause,AddTagsError::Validation(ref cause) => cause,AddTagsError::Credentials(ref err) => err.description(),AddTagsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),AddTagsError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> CreateTrailError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "MaximumNumberOfTrailsExceededException" => CreateTrailError::MaximumNumberOfTrailsExceeded(String::from(error_message)),"TrailAlreadyExistsException" => CreateTrailError::TrailAlreadyExists(String::from(error_message)),"S3BucketDoesNotExistException" => CreateTrailError::S3BucketDoesNotExist(String::from(error_message)),"InsufficientS3BucketPolicyException" => CreateTrailError::InsufficientS3BucketPolicy(String::from(error_message)),"InsufficientSnsTopicPolicyException" => CreateTrailError::InsufficientSnsTopicPolicy(String::from(error_message)),"InsufficientEncryptionPolicyException" => CreateTrailError::InsufficientEncryptionPolicy(String::from(error_message)),"InvalidS3BucketNameException" => CreateTrailError::InvalidS3BucketName(String::from(error_message)),"InvalidS3PrefixException" => CreateTrailError::InvalidS3Prefix(String::from(error_message)),"InvalidSnsTopicNameException" => CreateTrailError::InvalidSnsTopicName(String::from(error_message)),"InvalidKmsKeyIdException" => CreateTrailError::InvalidKmsKeyId(String::from(error_message)),"InvalidTrailNameException" => CreateTrailError::InvalidTrailName(String::from(error_message)),"TrailNotProvidedException" => CreateTrailError::TrailNotProvided(String::from(error_message)),"InvalidParameterCombinationException" => CreateTrailError::InvalidParameterCombination(String::from(error_message)),"KmsKeyNotFoundException" => CreateTrailError::KmsKeyNotFound(String::from(error_message)),"KmsKeyDisabledException" => CreateTrailError::KmsKeyDisabled(String::from(error_message)),"KmsException" => CreateTrailError::Kms(String::from(error_message)),"InvalidCloudWatchLogsLogGroupArnException" => CreateTrailError::InvalidCloudWatchLogsLogGroupArn(String::from(error_message)),"InvalidCloudWatchLogsRoleArnException" => CreateTrailError::InvalidCloudWatchLogsRoleArn(String::from(error_message)),"CloudWatchLogsDeliveryUnavailableException" => CreateTrailError::CloudWatchLogsDeliveryUnavailable(String::from(error_message)),"UnsupportedOperationException" => CreateTrailError::UnsupportedOperation(String::from(error_message)),"OperationNotPermittedException" => CreateTrailError::OperationNotPermitted(String::from(error_message)),"ValidationException" => CreateTrailError::Validation(error_message.to_string()),_ => CreateTrailError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for CreateTrailError {
                    fn description(&self) -> &str {
                        match *self {
                            CreateTrailError::MaximumNumberOfTrailsExceeded(ref cause) => cause,CreateTrailError::TrailAlreadyExists(ref cause) => cause,CreateTrailError::S3BucketDoesNotExist(ref cause) => cause,CreateTrailError::InsufficientS3BucketPolicy(ref cause) => cause,CreateTrailError::InsufficientSnsTopicPolicy(ref cause) => cause,CreateTrailError::InsufficientEncryptionPolicy(ref cause) => cause,CreateTrailError::InvalidS3BucketName(ref cause) => cause,CreateTrailError::InvalidS3Prefix(ref cause) => cause,CreateTrailError::InvalidSnsTopicName(ref cause) => cause,CreateTrailError::InvalidKmsKeyId(ref cause) => cause,CreateTrailError::InvalidTrailName(ref cause) => cause,CreateTrailError::TrailNotProvided(ref cause) => cause,CreateTrailError::InvalidParameterCombination(ref cause) => cause,CreateTrailError::KmsKeyNotFound(ref cause) => cause,CreateTrailError::KmsKeyDisabled(ref cause) => cause,CreateTrailError::Kms(ref cause) => cause,CreateTrailError::InvalidCloudWatchLogsLogGroupArn(ref cause) => cause,CreateTrailError::InvalidCloudWatchLogsRoleArn(ref cause) => cause,CreateTrailError::CloudWatchLogsDeliveryUnavailable(ref cause) => cause,CreateTrailError::UnsupportedOperation(ref cause) => cause,CreateTrailError::OperationNotPermitted(ref cause) => cause,CreateTrailError::Validation(ref cause) => cause,CreateTrailError::Credentials(ref err) => err.description(),CreateTrailError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),CreateTrailError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
InvalidHomeRegion(String),/// An error occurred dispatching the HTTP request
HttpDispatch(HttpDispatchError),/// An error was encountered with AWS credentials.
Credentials(CredentialsError),/// A validation error occurred.  Details from AWS are provided.
Validation(String),/// An unknown error occurred.  The raw HTTP response is provided.
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> DeleteTrailError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "TrailNotFoundException" => DeleteTrailError::TrailNotFound(String::from(error_message)),"InvalidTrailNameException" => DeleteTrailError::InvalidTrailName(String::from(error_message)),"InvalidHomeRegionException" => DeleteTrailError::InvalidHomeRegion(String::from(error_message)),"ValidationException" => DeleteTrailError::Validation(error_message.to_string()),_ => DeleteTrailError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for DeleteTrailError {
                    fn description(&self) -> &str {
                        match *self {
                            DeleteTrailError::TrailNotFound(ref cause) => cause,DeleteTrailError::InvalidTrailName(ref cause) => cause,DeleteTrailError::InvalidHomeRegion(ref cause) => cause,DeleteTrailError::Validation(ref cause) => cause,DeleteTrailError::Credentials(ref err) => err.description(),DeleteTrailError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),DeleteTrailError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> GetEventSelectorsError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "TrailNotFoundException" => GetEventSelectorsError::TrailNotFound(String::from(error_message)),"InvalidTrailNameException" => GetEventSelectorsError::InvalidTrailName(String::from(error_message)),"UnsupportedOperationException" => GetEventSelectorsError::UnsupportedOperation(String::from(error_message)),"OperationNotPermittedException" => GetEventSelectorsError::OperationNotPermitted(String::from(error_message)),"ValidationException" => GetEventSelectorsError::Validation(error_message.to_string()),_ => GetEventSelectorsError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for GetEventSelectorsError {
                    fn description(&self) -> &str {
                        match *self {
                            GetEventSelectorsError::TrailNotFound(ref cause) => cause,GetEventSelectorsError::InvalidTrailName(ref cause) => cause,GetEventSelectorsError::UnsupportedOperation(ref cause) => cause,GetEventSelectorsError::OperationNotPermitted(ref cause) => cause,GetEventSelectorsError::Validation(ref cause) => cause,GetEventSelectorsError::Credentials(ref err) => err.description(),GetEventSelectorsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),GetEventSelectorsError::Unknown(ref cause) => cause
                        }
                    }
                 }
                    ...
                    pub fn from_body(body: &str) -> GetTrailStatusError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "TrailNotFoundException" => GetTrailStatusError::TrailNotFound(String::from(error_message)),"InvalidTrailNameException" => GetTrailStatusError::InvalidTrailName(String::from(error_message)),"ValidationException" => GetTrailStatusError::Validation(error_message.to_string()),_ => GetTrailStatusError::Unknown(String::from(body))
                                }
                            },
...
InvalidToken(String),/// An error occurred dispatching the HTTP request
HttpDispatch(HttpDispatchError),/// An error was encountered with AWS credentials.
Credentials(CredentialsError),/// A validation error occurred.  Details from AWS are provided.
Validation(String),/// An unknown error occurred.  The raw HTTP response is provided.
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> ListPublicKeysError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InvalidTimeRangeException" => ListPublicKeysError::InvalidTimeRange(String::from(error_message)),"UnsupportedOperationException" => ListPublicKeysError::UnsupportedOperation(String::from(error_message)),"OperationNotPermittedException" => ListPublicKeysError::OperationNotPermitted(String::from(error_message)),"InvalidTokenException" => ListPublicKeysError::InvalidToken(String::from(error_message)),"ValidationException" => ListPublicKeysError::Validation(error_message.to_string()),_ => ListPublicKeysError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for ListPublicKeysError {
                    fn description(&self) -> &str {
                        match *self {
                            ListPublicKeysError::InvalidTimeRange(ref cause) => cause,ListPublicKeysError::UnsupportedOperation(ref cause) => cause,ListPublicKeysError::OperationNotPermitted(ref cause) => cause,ListPublicKeysError::InvalidToken(ref cause) => cause,ListPublicKeysError::Validation(ref cause) => cause,ListPublicKeysError::Credentials(ref err) => err.description(),ListPublicKeysError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),ListPublicKeysError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> ListTagsError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "ResourceNotFoundException" => ListTagsError::ResourceNotFound(String::from(error_message)),"CloudTrailARNInvalidException" => ListTagsError::CloudTrailARNInvalid(String::from(error_message)),"ResourceTypeNotSupportedException" => ListTagsError::ResourceTypeNotSupported(String::from(error_message)),"InvalidTrailNameException" => ListTagsError::InvalidTrailName(String::from(error_message)),"UnsupportedOperationException" => ListTagsError::UnsupportedOperation(String::from(error_message)),"OperationNotPermittedException" => ListTagsError::OperationNotPermitted(String::from(error_message)),"InvalidTokenException" => ListTagsError::InvalidToken(String::from(error_message)),"ValidationException" => ListTagsError::Validation(error_message.to_string()),_ => ListTagsError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for ListTagsError {
                    fn description(&self) -> &str {
                        match *self {
                            ListTagsError::ResourceNotFound(ref cause) => cause,ListTagsError::CloudTrailARNInvalid(ref cause) => cause,ListTagsError::ResourceTypeNotSupported(ref cause) => cause,ListTagsError::InvalidTrailName(ref cause) => cause,ListTagsError::UnsupportedOperation(ref cause) => cause,ListTagsError::OperationNotPermitted(ref cause) => cause,ListTagsError::InvalidToken(ref cause) => cause,ListTagsError::Validation(ref cause) => cause,ListTagsError::Credentials(ref err) => err.description(),ListTagsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),ListTagsError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> LookupEventsError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InvalidLookupAttributesException" => LookupEventsError::InvalidLookupAttributes(String::from(error_message)),"InvalidTimeRangeException" => LookupEventsError::InvalidTimeRange(String::from(error_message)),"InvalidMaxResultsException" => LookupEventsError::InvalidMaxResults(String::from(error_message)),"InvalidNextTokenException" => LookupEventsError::InvalidNextToken(String::from(error_message)),"ValidationException" => LookupEventsError::Validation(error_message.to_string()),_ => LookupEventsError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for LookupEventsError {
                    fn description(&self) -> &str {
                        match *self {
                            LookupEventsError::InvalidLookupAttributes(ref cause) => cause,LookupEventsError::InvalidTimeRange(ref cause) => cause,LookupEventsError::InvalidMaxResults(ref cause) => cause,LookupEventsError::InvalidNextToken(ref cause) => cause,LookupEventsError::Validation(ref cause) => cause,LookupEventsError::Credentials(ref err) => err.description(),LookupEventsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),LookupEventsError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl Error for PutEventSelectorsError {
                    fn description(&self) -> &str {
                        match *self {
                            PutEventSelectorsError::TrailNotFound(ref cause) => cause,PutEventSelectorsError::InvalidTrailName(ref cause) => cause,PutEventSelectorsError::InvalidHomeRegion(ref cause) => cause,PutEventSelectorsError::InvalidEventSelectors(ref cause) => cause,PutEventSelectorsError::UnsupportedOperation(ref cause) => cause,PutEventSelectorsError::OperationNotPermitted(ref cause) => cause,PutEventSelectorsError::Validation(ref cause) => cause,PutEventSelectorsError::Credentials(ref err) => err.description(),PutEventSelectorsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),PutEventSelectorsError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> RemoveTagsError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "ResourceNotFoundException" => RemoveTagsError::ResourceNotFound(String::from(error_message)),"CloudTrailARNInvalidException" => RemoveTagsError::CloudTrailARNInvalid(String::from(error_message)),"ResourceTypeNotSupportedException" => RemoveTagsError::ResourceTypeNotSupported(String::from(error_message)),"InvalidTrailNameException" => RemoveTagsError::InvalidTrailName(String::from(error_message)),"InvalidTagParameterException" => RemoveTagsError::InvalidTagParameter(String::from(error_message)),"UnsupportedOperationException" => RemoveTagsError::UnsupportedOperation(String::from(error_message)),"OperationNotPermittedException" => RemoveTagsError::OperationNotPermitted(String::from(error_message)),"ValidationException" => RemoveTagsError::Validation(error_message.to_string()),_ => RemoveTagsError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for RemoveTagsError {
                    fn description(&self) -> &str {
                        match *self {
                            RemoveTagsError::ResourceNotFound(ref cause) => cause,RemoveTagsError::CloudTrailARNInvalid(ref cause) => cause,RemoveTagsError::ResourceTypeNotSupported(ref cause) => cause,RemoveTagsError::InvalidTrailName(ref cause) => cause,RemoveTagsError::InvalidTagParameter(ref cause) => cause,RemoveTagsError::UnsupportedOperation(ref cause) => cause,RemoveTagsError::OperationNotPermitted(ref cause) => cause,RemoveTagsError::Validation(ref cause) => cause,RemoveTagsError::Credentials(ref err) => err.description(),RemoveTagsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),RemoveTagsError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> StartLoggingError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "TrailNotFoundException" => StartLoggingError::TrailNotFound(String::from(error_message)),"InvalidTrailNameException" => StartLoggingError::InvalidTrailName(String::from(error_message)),"InvalidHomeRegionException" => StartLoggingError::InvalidHomeRegion(String::from(error_message)),"ValidationException" => StartLoggingError::Validation(error_message.to_string()),_ => StartLoggingError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for StartLoggingError {
                    fn description(&self) -> &str {
                        match *self {
                            StartLoggingError::TrailNotFound(ref cause) => cause,StartLoggingError::InvalidTrailName(ref cause) => cause,StartLoggingError::InvalidHomeRegion(ref cause) => cause,StartLoggingError::Validation(ref cause) => cause,StartLoggingError::Credentials(ref err) => err.description(),StartLoggingError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),StartLoggingError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> StopLoggingError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "TrailNotFoundException" => StopLoggingError::TrailNotFound(String::from(error_message)),"InvalidTrailNameException" => StopLoggingError::InvalidTrailName(String::from(error_message)),"InvalidHomeRegionException" => StopLoggingError::InvalidHomeRegion(String::from(error_message)),"ValidationException" => StopLoggingError::Validation(error_message.to_string()),_ => StopLoggingError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for StopLoggingError {
                    fn description(&self) -> &str {
                        match *self {
                            StopLoggingError::TrailNotFound(ref cause) => cause,StopLoggingError::InvalidTrailName(ref cause) => cause,StopLoggingError::InvalidHomeRegion(ref cause) => cause,StopLoggingError::Validation(ref cause) => cause,StopLoggingError::Credentials(ref err) => err.description(),StopLoggingError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),StopLoggingError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> UpdateTrailError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "S3BucketDoesNotExistException" => UpdateTrailError::S3BucketDoesNotExist(String::from(error_message)),"InsufficientS3BucketPolicyException" => UpdateTrailError::InsufficientS3BucketPolicy(String::from(error_message)),"InsufficientSnsTopicPolicyException" => UpdateTrailError::InsufficientSnsTopicPolicy(String::from(error_message)),"InsufficientEncryptionPolicyException" => UpdateTrailError::InsufficientEncryptionPolicy(String::from(error_message)),"TrailNotFoundException" => UpdateTrailError::TrailNotFound(String::from(error_message)),"InvalidS3BucketNameException" => UpdateTrailError::InvalidS3BucketName(String::from(error_message)),"InvalidS3PrefixException" => UpdateTrailError::InvalidS3Prefix(String::from(error_message)),"InvalidSnsTopicNameException" => UpdateTrailError::InvalidSnsTopicName(String::from(error_message)),"InvalidKmsKeyIdException" => UpdateTrailError::InvalidKmsKeyId(String::from(error_message)),"InvalidTrailNameException" => UpdateTrailError::InvalidTrailName(String::from(error_message)),"TrailNotProvidedException" => UpdateTrailError::TrailNotProvided(String::from(error_message)),"InvalidParameterCombinationException" => UpdateTrailError::InvalidParameterCombination(String::from(error_message)),"InvalidHomeRegionException" => UpdateTrailError::InvalidHomeRegion(String::from(error_message)),"KmsKeyNotFoundException" => UpdateTrailError::KmsKeyNotFound(String::from(error_message)),"KmsKeyDisabledException" => UpdateTrailError::KmsKeyDisabled(String::from(error_message)),"KmsException" => UpdateTrailError::Kms(String::from(error_message)),"InvalidCloudWatchLogsLogGroupArnException" => UpdateTrailError::InvalidCloudWatchLogsLogGroupArn(String::from(error_message)),"InvalidCloudWatchLogsRoleArnException" => UpdateTrailError::InvalidCloudWatchLogsRoleArn(String::from(error_message)),"CloudWatchLogsDeliveryUnavailableException" => UpdateTrailError::CloudWatchLogsDeliveryUnavailable(String::from(error_message)),"UnsupportedOperationException" => UpdateTrailError::UnsupportedOperation(String::from(error_message)),"OperationNotPermittedException" => UpdateTrailError::OperationNotPermitted(String::from(error_message)),"ValidationException" => UpdateTrailError::Validation(error_message.to_string()),_ => UpdateTrailError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for UpdateTrailError {
                    fn description(&self) -> &str {
                        match *self {
                            UpdateTrailError::S3BucketDoesNotExist(ref cause) => cause,UpdateTrailError::InsufficientS3BucketPolicy(ref cause) => cause,UpdateTrailError::InsufficientSnsTopicPolicy(ref cause) => cause,UpdateTrailError::InsufficientEncryptionPolicy(ref cause) => cause,UpdateTrailError::TrailNotFound(ref cause) => cause,UpdateTrailError::InvalidS3BucketName(ref cause) => cause,UpdateTrailError::InvalidS3Prefix(ref cause) => cause,UpdateTrailError::InvalidSnsTopicName(ref cause) => cause,UpdateTrailError::InvalidKmsKeyId(ref cause) => cause,UpdateTrailError::InvalidTrailName(ref cause) => cause,UpdateTrailError::TrailNotProvided(ref cause) => cause,UpdateTrailError::InvalidParameterCombination(ref cause) => cause,UpdateTrailError::InvalidHomeRegion(ref cause) => cause,UpdateTrailError::KmsKeyNotFound(ref cause) => cause,UpdateTrailError::KmsKeyDisabled(ref cause) => cause,UpdateTrailError::Kms(ref cause) => cause,UpdateTrailError::InvalidCloudWatchLogsLogGroupArn(ref cause) => cause,UpdateTrailError::InvalidCloudWatchLogsRoleArn(ref cause) => cause,UpdateTrailError::CloudWatchLogsDeliveryUnavailable(ref cause) => cause,UpdateTrailError::UnsupportedOperation(ref cause) => cause,UpdateTrailError::OperationNotPermitted(ref cause) => cause,UpdateTrailError::Validation(ref cause) => cause,UpdateTrailError::Credentials(ref err) => err.description(),UpdateTrailError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),UpdateTrailError::Unknown(ref cause) => cause
                        }
                    }
                 }
