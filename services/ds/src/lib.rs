...
/// A client for the Directory Service API.
        ...
        impl<P, D> DirectoryServiceClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
            pub fn new(request_dispatcher: D, credentials_provider: P, region: region::Region) -> Self {
                ...
                pub fn add_ip_routes(&self, input: &AddIpRoutesRequest)  -> Result<AddIpRoutesResult, AddIpRoutesError> {
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn cancel_schema_extension(&self, input: &CancelSchemaExtensionRequest)  -> Result<CancelSchemaExtensionResult, CancelSchemaExtensionError> {
                    let mut request = SignedRequest::new("POST", "ds", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn connect_directory(&self, input: &ConnectDirectoryRequest)  -> Result<ConnectDirectoryResult, ConnectDirectoryError> {
                    let mut request = SignedRequest::new("POST", "ds", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn create_alias(&self, input: &CreateAliasRequest)  -> Result<CreateAliasResult, CreateAliasError> {
                    let mut request = SignedRequest::new("POST", "ds", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn create_computer(&self, input: &CreateComputerRequest)  -> Result<CreateComputerResult, CreateComputerError> {
                    let mut request = SignedRequest::new("POST", "ds", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn create_conditional_forwarder(&self, input: &CreateConditionalForwarderRequest)  -> Result<CreateConditionalForwarderResult, CreateConditionalForwarderError> {
                    let mut request = SignedRequest::new("POST", "ds", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn create_directory(&self, input: &CreateDirectoryRequest)  -> Result<CreateDirectoryResult, CreateDirectoryError> {
                    let mut request = SignedRequest::new("POST", "ds", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn create_microsoft_ad(&self, input: &CreateMicrosoftADRequest)  -> Result<CreateMicrosoftADResult, CreateMicrosoftADError> {
                    let mut request = SignedRequest::new("POST", "ds", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn create_snapshot(&self, input: &CreateSnapshotRequest)  -> Result<CreateSnapshotResult, CreateSnapshotError> {
                    let mut request = SignedRequest::new("POST", "ds", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                #[doc="<p>AWS Directory Service for Microsoft Active Directory allows you to configure trust relationships. For example, you can establish a trust between your Microsoft AD in the AWS cloud, and your existing on-premises Microsoft Active Directory. This would allow you to provide users and groups access to resources in either domain, with a single set of credentials.</p> <p>This action initiates the creation of the AWS side of a trust relationship between a Microsoft AD in the AWS cloud and an external domain.</p>"]
                pub fn create_trust(&self, input: &CreateTrustRequest)  -> Result<CreateTrustResult, CreateTrustError> {
                    let mut request = SignedRequest::new("POST", "ds", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn delete_conditional_forwarder(&self, input: &DeleteConditionalForwarderRequest)  -> Result<DeleteConditionalForwarderResult, DeleteConditionalForwarderError> {
                    let mut request = SignedRequest::new("POST", "ds", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn delete_directory(&self, input: &DeleteDirectoryRequest)  -> Result<DeleteDirectoryResult, DeleteDirectoryError> {
                    let mut request = SignedRequest::new("POST", "ds", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn delete_snapshot(&self, input: &DeleteSnapshotRequest)  -> Result<DeleteSnapshotResult, DeleteSnapshotError> {
                    let mut request = SignedRequest::new("POST", "ds", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn delete_trust(&self, input: &DeleteTrustRequest)  -> Result<DeleteTrustResult, DeleteTrustError> {
                    let mut request = SignedRequest::new("POST", "ds", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                #[doc="<p>Removes the specified directory as a publisher to the specified SNS topic.</p>"]
                pub fn deregister_event_topic(&self, input: &DeregisterEventTopicRequest)  -> Result<DeregisterEventTopicResult, DeregisterEventTopicError> {
                    let mut request = SignedRequest::new("POST", "ds", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn describe_conditional_forwarders(&self, input: &DescribeConditionalForwardersRequest)  -> Result<DescribeConditionalForwardersResult, DescribeConditionalForwardersError> {
                    let mut request = SignedRequest::new("POST", "ds", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn describe_directories(&self, input: &DescribeDirectoriesRequest)  -> Result<DescribeDirectoriesResult, DescribeDirectoriesError> {
                    let mut request = SignedRequest::new("POST", "ds", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn describe_event_topics(&self, input: &DescribeEventTopicsRequest)  -> Result<DescribeEventTopicsResult, DescribeEventTopicsError> {
                    let mut request = SignedRequest::new("POST", "ds", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn describe_snapshots(&self, input: &DescribeSnapshotsRequest)  -> Result<DescribeSnapshotsResult, DescribeSnapshotsError> {
                    let mut request = SignedRequest::new("POST", "ds", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn describe_trusts(&self, input: &DescribeTrustsRequest)  -> Result<DescribeTrustsResult, DescribeTrustsError> {
                    let mut request = SignedRequest::new("POST", "ds", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn disable_radius(&self, input: &DisableRadiusRequest)  -> Result<DisableRadiusResult, DisableRadiusError> {
                    let mut request = SignedRequest::new("POST", "ds", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn disable_sso(&self, input: &DisableSsoRequest)  -> Result<DisableSsoResult, DisableSsoError> {
                    let mut request = SignedRequest::new("POST", "ds", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn enable_radius(&self, input: &EnableRadiusRequest)  -> Result<EnableRadiusResult, EnableRadiusError> {
                    let mut request = SignedRequest::new("POST", "ds", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn enable_sso(&self, input: &EnableSsoRequest)  -> Result<EnableSsoResult, EnableSsoError> {
                    let mut request = SignedRequest::new("POST", "ds", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn get_directory_limits(&self, input: &GetDirectoryLimitsRequest)  -> Result<GetDirectoryLimitsResult, GetDirectoryLimitsError> {
                    let mut request = SignedRequest::new("POST", "ds", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn get_snapshot_limits(&self, input: &GetSnapshotLimitsRequest)  -> Result<GetSnapshotLimitsResult, GetSnapshotLimitsError> {
                    let mut request = SignedRequest::new("POST", "ds", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn list_ip_routes(&self, input: &ListIpRoutesRequest)  -> Result<ListIpRoutesResult, ListIpRoutesError> {
                    let mut request = SignedRequest::new("POST", "ds", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn list_schema_extensions(&self, input: &ListSchemaExtensionsRequest)  -> Result<ListSchemaExtensionsResult, ListSchemaExtensionsError> {
                    let mut request = SignedRequest::new("POST", "ds", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn register_event_topic(&self, input: &RegisterEventTopicRequest)  -> Result<RegisterEventTopicResult, RegisterEventTopicError> {
                    let mut request = SignedRequest::new("POST", "ds", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn remove_ip_routes(&self, input: &RemoveIpRoutesRequest)  -> Result<RemoveIpRoutesResult, RemoveIpRoutesError> {
                    let mut request = SignedRequest::new("POST", "ds", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn restore_from_snapshot(&self, input: &RestoreFromSnapshotRequest)  -> Result<RestoreFromSnapshotResult, RestoreFromSnapshotError> {
                    let mut request = SignedRequest::new("POST", "ds", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn start_schema_extension(&self, input: &StartSchemaExtensionRequest)  -> Result<StartSchemaExtensionResult, StartSchemaExtensionError> {
                    let mut request = SignedRequest::new("POST", "ds", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn update_conditional_forwarder(&self, input: &UpdateConditionalForwarderRequest)  -> Result<UpdateConditionalForwarderResult, UpdateConditionalForwarderError> {
                    let mut request = SignedRequest::new("POST", "ds", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn update_radius(&self, input: &UpdateRadiusRequest)  -> Result<UpdateRadiusResult, UpdateRadiusError> {
                    let mut request = SignedRequest::new("POST", "ds", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn verify_trust(&self, input: &VerifyTrustRequest)  -> Result<VerifyTrustResult, VerifyTrustError> {
                    let mut request = SignedRequest::new("POST", "ds", self.region, "/");
