...
Unknown(String)
                ...
                impl Error for DescribeAutoScalingInstancesError {
                    fn description(&self) -> &str {
                        match *self {
                            DescribeAutoScalingInstancesError::InvalidNextToken(ref cause) => cause,DescribeAutoScalingInstancesError::ResourceContentionFault(ref cause) => cause,DescribeAutoScalingInstancesError::Validation(ref cause) => cause,DescribeAutoScalingInstancesError::Credentials(ref err) => err.description(),DescribeAutoScalingInstancesError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),DescribeAutoScalingInstancesError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl Error for DescribePoliciesError {
                    fn description(&self) -> &str {
                        match *self {
                            DescribePoliciesError::InvalidNextToken(ref cause) => cause,DescribePoliciesError::ResourceContentionFault(ref cause) => cause,DescribePoliciesError::Validation(ref cause) => cause,DescribePoliciesError::Credentials(ref err) => err.description(),DescribePoliciesError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),DescribePoliciesError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl Error for DescribeScalingActivitiesError {
                    fn description(&self) -> &str {
                        match *self {
                            DescribeScalingActivitiesError::InvalidNextToken(ref cause) => cause,DescribeScalingActivitiesError::ResourceContentionFault(ref cause) => cause,DescribeScalingActivitiesError::Validation(ref cause) => cause,DescribeScalingActivitiesError::Credentials(ref err) => err.description(),DescribeScalingActivitiesError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),DescribeScalingActivitiesError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl Error for DescribeTagsError {
                    fn description(&self) -> &str {
                        match *self {
                            DescribeTagsError::InvalidNextToken(ref cause) => cause,DescribeTagsError::ResourceContentionFault(ref cause) => cause,DescribeTagsError::Validation(ref cause) => cause,DescribeTagsError::Credentials(ref err) => err.description(),DescribeTagsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),DescribeTagsError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl Error for PutNotificationConfigurationError {
                    fn description(&self) -> &str {
                        match *self {
                            PutNotificationConfigurationError::LimitExceededFault(ref cause) => cause,PutNotificationConfigurationError::ResourceContentionFault(ref cause) => cause,PutNotificationConfigurationError::Validation(ref cause) => cause,PutNotificationConfigurationError::Credentials(ref err) => err.description(),PutNotificationConfigurationError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),PutNotificationConfigurationError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl Error for PutScalingPolicyError {
                    fn description(&self) -> &str {
                        match *self {
                            PutScalingPolicyError::LimitExceededFault(ref cause) => cause,PutScalingPolicyError::ResourceContentionFault(ref cause) => cause,PutScalingPolicyError::Validation(ref cause) => cause,PutScalingPolicyError::Credentials(ref err) => err.description(),PutScalingPolicyError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),PutScalingPolicyError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl Error for SetInstanceProtectionError {
                    fn description(&self) -> &str {
                        match *self {
                            SetInstanceProtectionError::LimitExceededFault(ref cause) => cause,SetInstanceProtectionError::ResourceContentionFault(ref cause) => cause,SetInstanceProtectionError::Validation(ref cause) => cause,SetInstanceProtectionError::Credentials(ref err) => err.description(),SetInstanceProtectionError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),SetInstanceProtectionError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
/// A client for the Auto Scaling API.
        ...
        impl<P, D> AutoscalingClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
            pub fn new(request_dispatcher: D, credentials_provider: P, region: region::Region) -> Self {
                ...
                pub fn attach_instances(&self, input: &AttachInstancesQuery) -> Result<(), AttachInstancesError> {
                ...
                pub fn attach_load_balancer_target_groups(&self, input: &AttachLoadBalancerTargetGroupsType) -> Result<AttachLoadBalancerTargetGroupsResultType, AttachLoadBalancerTargetGroupsError> {
                    let mut request = SignedRequest::new("POST", "autoscaling", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn attach_load_balancers(&self, input: &AttachLoadBalancersType) -> Result<AttachLoadBalancersResultType, AttachLoadBalancersError> {
                    let mut request = SignedRequest::new("POST", "autoscaling", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn complete_lifecycle_action(&self, input: &CompleteLifecycleActionType) -> Result<CompleteLifecycleActionAnswer, CompleteLifecycleActionError> {
                    let mut request = SignedRequest::new("POST", "autoscaling", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn create_auto_scaling_group(&self, input: &CreateAutoScalingGroupType) -> Result<(), CreateAutoScalingGroupError> {
                    let mut request = SignedRequest::new("POST", "autoscaling", self.region, "/");
                    let mut params = Params::new();
                ...
                pub fn create_launch_configuration(&self, input: &CreateLaunchConfigurationType) -> Result<(), CreateLaunchConfigurationError> {
                    let mut request = SignedRequest::new("POST", "autoscaling", self.region, "/");
                    let mut params = Params::new();
                ...
                pub fn create_or_update_tags(&self, input: &CreateOrUpdateTagsType) -> Result<(), CreateOrUpdateTagsError> {
                    let mut request = SignedRequest::new("POST", "autoscaling", self.region, "/");
                    let mut params = Params::new();
                ...
                pub fn delete_auto_scaling_group(&self, input: &DeleteAutoScalingGroupType) -> Result<(), DeleteAutoScalingGroupError> {
                    let mut request = SignedRequest::new("POST", "autoscaling", self.region, "/");
                    let mut params = Params::new();
                ...
                pub fn delete_launch_configuration(&self, input: &LaunchConfigurationNameType) -> Result<(), DeleteLaunchConfigurationError> {
                    let mut request = SignedRequest::new("POST", "autoscaling", self.region, "/");
                    let mut params = Params::new();
                ...
                pub fn delete_lifecycle_hook(&self, input: &DeleteLifecycleHookType) -> Result<DeleteLifecycleHookAnswer, DeleteLifecycleHookError> {
                    let mut request = SignedRequest::new("POST", "autoscaling", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn delete_notification_configuration(&self, input: &DeleteNotificationConfigurationType) -> Result<(), DeleteNotificationConfigurationError> {
                    let mut request = SignedRequest::new("POST", "autoscaling", self.region, "/");
                    let mut params = Params::new();
                ...
                pub fn delete_policy(&self, input: &DeletePolicyType) -> Result<(), DeletePolicyError> {
                    let mut request = SignedRequest::new("POST", "autoscaling", self.region, "/");
                    let mut params = Params::new();
                ...
                pub fn delete_scheduled_action(&self, input: &DeleteScheduledActionType) -> Result<(), DeleteScheduledActionError> {
                    let mut request = SignedRequest::new("POST", "autoscaling", self.region, "/");
                    let mut params = Params::new();
                ...
                pub fn delete_tags(&self, input: &DeleteTagsType) -> Result<(), DeleteTagsError> {
                    let mut request = SignedRequest::new("POST", "autoscaling", self.region, "/");
                    let mut params = Params::new();
                ...
                pub fn describe_account_limits(&self) -> Result<DescribeAccountLimitsAnswer, DescribeAccountLimitsError> {
                    let mut request = SignedRequest::new("POST", "autoscaling", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn describe_adjustment_types(&self) -> Result<DescribeAdjustmentTypesAnswer, DescribeAdjustmentTypesError> {
                    let mut request = SignedRequest::new("POST", "autoscaling", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn describe_auto_scaling_groups(&self, input: &AutoScalingGroupNamesType) -> Result<AutoScalingGroupsType, DescribeAutoScalingGroupsError> {
                    let mut request = SignedRequest::new("POST", "autoscaling", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn describe_auto_scaling_instances(&self, input: &DescribeAutoScalingInstancesType) -> Result<AutoScalingInstancesType, DescribeAutoScalingInstancesError> {
                    let mut request = SignedRequest::new("POST", "autoscaling", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn describe_auto_scaling_notification_types(&self) -> Result<DescribeAutoScalingNotificationTypesAnswer, DescribeAutoScalingNotificationTypesError> {
                    let mut request = SignedRequest::new("POST", "autoscaling", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn describe_launch_configurations(&self, input: &LaunchConfigurationNamesType) -> Result<LaunchConfigurationsType, DescribeLaunchConfigurationsError> {
                    let mut request = SignedRequest::new("POST", "autoscaling", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn describe_lifecycle_hook_types(&self) -> Result<DescribeLifecycleHookTypesAnswer, DescribeLifecycleHookTypesError> {
                    let mut request = SignedRequest::new("POST", "autoscaling", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn describe_lifecycle_hooks(&self, input: &DescribeLifecycleHooksType) -> Result<DescribeLifecycleHooksAnswer, DescribeLifecycleHooksError> {
                    let mut request = SignedRequest::new("POST", "autoscaling", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn describe_load_balancer_target_groups(&self, input: &DescribeLoadBalancerTargetGroupsRequest) -> Result<DescribeLoadBalancerTargetGroupsResponse, DescribeLoadBalancerTargetGroupsError> {
                    let mut request = SignedRequest::new("POST", "autoscaling", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn describe_load_balancers(&self, input: &DescribeLoadBalancersRequest) -> Result<DescribeLoadBalancersResponse, DescribeLoadBalancersError> {
                    let mut request = SignedRequest::new("POST", "autoscaling", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn describe_metric_collection_types(&self) -> Result<DescribeMetricCollectionTypesAnswer, DescribeMetricCollectionTypesError> {
                    let mut request = SignedRequest::new("POST", "autoscaling", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn describe_notification_configurations(&self, input: &DescribeNotificationConfigurationsType) -> Result<DescribeNotificationConfigurationsAnswer, DescribeNotificationConfigurationsError> {
                    let mut request = SignedRequest::new("POST", "autoscaling", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn describe_policies(&self, input: &DescribePoliciesType) -> Result<PoliciesType, DescribePoliciesError> {
                    let mut request = SignedRequest::new("POST", "autoscaling", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn describe_scaling_activities(&self, input: &DescribeScalingActivitiesType) -> Result<ActivitiesType, DescribeScalingActivitiesError> {
                    let mut request = SignedRequest::new("POST", "autoscaling", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn describe_scaling_process_types(&self) -> Result<ProcessesType, DescribeScalingProcessTypesError> {
                    let mut request = SignedRequest::new("POST", "autoscaling", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn describe_scheduled_actions(&self, input: &DescribeScheduledActionsType) -> Result<ScheduledActionsType, DescribeScheduledActionsError> {
                    let mut request = SignedRequest::new("POST", "autoscaling", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn describe_tags(&self, input: &DescribeTagsType) -> Result<TagsType, DescribeTagsError> {
                    let mut request = SignedRequest::new("POST", "autoscaling", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn describe_termination_policy_types(&self) -> Result<DescribeTerminationPolicyTypesAnswer, DescribeTerminationPolicyTypesError> {
                    let mut request = SignedRequest::new("POST", "autoscaling", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn detach_instances(&self, input: &DetachInstancesQuery) -> Result<DetachInstancesAnswer, DetachInstancesError> {
                    let mut request = SignedRequest::new("POST", "autoscaling", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn detach_load_balancer_target_groups(&self, input: &DetachLoadBalancerTargetGroupsType) -> Result<DetachLoadBalancerTargetGroupsResultType, DetachLoadBalancerTargetGroupsError> {
                    let mut request = SignedRequest::new("POST", "autoscaling", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn detach_load_balancers(&self, input: &DetachLoadBalancersType) -> Result<DetachLoadBalancersResultType, DetachLoadBalancersError> {
                    let mut request = SignedRequest::new("POST", "autoscaling", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn disable_metrics_collection(&self, input: &DisableMetricsCollectionQuery) -> Result<(), DisableMetricsCollectionError> {
                    let mut request = SignedRequest::new("POST", "autoscaling", self.region, "/");
                    let mut params = Params::new();
                ...
                pub fn enable_metrics_collection(&self, input: &EnableMetricsCollectionQuery) -> Result<(), EnableMetricsCollectionError> {
                    let mut request = SignedRequest::new("POST", "autoscaling", self.region, "/");
                    let mut params = Params::new();
                ...
                pub fn enter_standby(&self, input: &EnterStandbyQuery) -> Result<EnterStandbyAnswer, EnterStandbyError> {
                    let mut request = SignedRequest::new("POST", "autoscaling", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn execute_policy(&self, input: &ExecutePolicyType) -> Result<(), ExecutePolicyError> {
                    let mut request = SignedRequest::new("POST", "autoscaling", self.region, "/");
                    let mut params = Params::new();
                ...
                pub fn exit_standby(&self, input: &ExitStandbyQuery) -> Result<ExitStandbyAnswer, ExitStandbyError> {
                    let mut request = SignedRequest::new("POST", "autoscaling", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn put_lifecycle_hook(&self, input: &PutLifecycleHookType) -> Result<PutLifecycleHookAnswer, PutLifecycleHookError> {
                    let mut request = SignedRequest::new("POST", "autoscaling", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn put_notification_configuration(&self, input: &PutNotificationConfigurationType) -> Result<(), PutNotificationConfigurationError> {
                    let mut request = SignedRequest::new("POST", "autoscaling", self.region, "/");
                    let mut params = Params::new();
                ...
                pub fn put_scaling_policy(&self, input: &PutScalingPolicyType) -> Result<PolicyARNType, PutScalingPolicyError> {
                    let mut request = SignedRequest::new("POST", "autoscaling", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn put_scheduled_update_group_action(&self, input: &PutScheduledUpdateGroupActionType) -> Result<(), PutScheduledUpdateGroupActionError> {
                    let mut request = SignedRequest::new("POST", "autoscaling", self.region, "/");
                    let mut params = Params::new();
                ...
                pub fn record_lifecycle_action_heartbeat(&self, input: &RecordLifecycleActionHeartbeatType) -> Result<RecordLifecycleActionHeartbeatAnswer, RecordLifecycleActionHeartbeatError> {
                    let mut request = SignedRequest::new("POST", "autoscaling", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn resume_processes(&self, input: &ScalingProcessQuery) -> Result<(), ResumeProcessesError> {
                    let mut request = SignedRequest::new("POST", "autoscaling", self.region, "/");
                    let mut params = Params::new();
                ...
                pub fn set_desired_capacity(&self, input: &SetDesiredCapacityType) -> Result<(), SetDesiredCapacityError> {
                    let mut request = SignedRequest::new("POST", "autoscaling", self.region, "/");
                    let mut params = Params::new();
                ...
                pub fn set_instance_health(&self, input: &SetInstanceHealthQuery) -> Result<(), SetInstanceHealthError> {
                    let mut request = SignedRequest::new("POST", "autoscaling", self.region, "/");
                    let mut params = Params::new();
                ...
                pub fn set_instance_protection(&self, input: &SetInstanceProtectionQuery) -> Result<SetInstanceProtectionAnswer, SetInstanceProtectionError> {
                    let mut request = SignedRequest::new("POST", "autoscaling", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn suspend_processes(&self, input: &ScalingProcessQuery) -> Result<(), SuspendProcessesError> {
                    let mut request = SignedRequest::new("POST", "autoscaling", self.region, "/");
                    let mut params = Params::new();
                ...
                pub fn terminate_instance_in_auto_scaling_group(&self, input: &TerminateInstanceInAutoScalingGroupType) -> Result<ActivityType, TerminateInstanceInAutoScalingGroupError> {
                    let mut request = SignedRequest::new("POST", "autoscaling", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn update_auto_scaling_group(&self, input: &UpdateAutoScalingGroupType) -> Result<(), UpdateAutoScalingGroupError> {
                    let mut request = SignedRequest::new("POST", "autoscaling", self.region, "/");
                    let mut params = Params::new();
        ...
        fn test_parse_autoscaling_describe_adjustment_types() {
            let mock_response =  MockResponseReader::read_response("test_resources", "autoscaling-describe-adjustment-types.xml");
        ...
        fn test_parse_autoscaling_describe_auto_scaling_groups() {
            let mock_response =  MockResponseReader::read_response("test_resources", "autoscaling-describe-auto-scaling-groups.xml");
            let mock = MockRequestDispatcher::with_status(200).with_body(&mock_response);
            let client = AutoscalingClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
        ...
        fn test_parse_autoscaling_describe_auto_scaling_instances() {
            let mock_response =  MockResponseReader::read_response("test_resources", "autoscaling-describe-auto-scaling-instances.xml");
            let mock = MockRequestDispatcher::with_status(200).with_body(&mock_response);
            let client = AutoscalingClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
        ...
        fn test_parse_autoscaling_describe_auto_scaling_notification_types() {
            let mock_response =  MockResponseReader::read_response("test_resources", "autoscaling-describe-auto-scaling-notification-types.xml");
            let mock = MockRequestDispatcher::with_status(200).with_body(&mock_response);
            let client = AutoscalingClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
        ...
        fn test_parse_autoscaling_describe_launch_configurations() {
            let mock_response =  MockResponseReader::read_response("test_resources", "autoscaling-describe-launch-configurations.xml");
            let mock = MockRequestDispatcher::with_status(200).with_body(&mock_response);
            let client = AutoscalingClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
        ...
        fn test_parse_autoscaling_describe_metric_collection_types() {
            let mock_response =  MockResponseReader::read_response("test_resources", "autoscaling-describe-metric-collection-types.xml");
            let mock = MockRequestDispatcher::with_status(200).with_body(&mock_response);
            let client = AutoscalingClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
        ...
        fn test_parse_autoscaling_describe_notification_configurations() {
            let mock_response =  MockResponseReader::read_response("test_resources", "autoscaling-describe-notification-configurations.xml");
            let mock = MockRequestDispatcher::with_status(200).with_body(&mock_response);
            let client = AutoscalingClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
        ...
        fn test_parse_autoscaling_describe_policies() {
            let mock_response =  MockResponseReader::read_response("test_resources", "autoscaling-describe-policies.xml");
            let mock = MockRequestDispatcher::with_status(200).with_body(&mock_response);
            let client = AutoscalingClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
        ...
        fn test_parse_autoscaling_describe_scaling_activities() {
            let mock_response =  MockResponseReader::read_response("test_resources", "autoscaling-describe-scaling-activities.xml");
            let mock = MockRequestDispatcher::with_status(200).with_body(&mock_response);
            let client = AutoscalingClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
        ...
        fn test_parse_autoscaling_describe_scaling_process_types() {
            let mock_response =  MockResponseReader::read_response("test_resources", "autoscaling-describe-scaling-process-types.xml");
            let mock = MockRequestDispatcher::with_status(200).with_body(&mock_response);
            let client = AutoscalingClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
        ...
        fn test_parse_autoscaling_describe_scheduled_actions() {
            let mock_response =  MockResponseReader::read_response("test_resources", "autoscaling-describe-scheduled-actions.xml");
            let mock = MockRequestDispatcher::with_status(200).with_body(&mock_response);
            let client = AutoscalingClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
        ...
        fn test_parse_autoscaling_describe_tags() {
            let mock_response =  MockResponseReader::read_response("test_resources", "autoscaling-describe-tags.xml");
            let mock = MockRequestDispatcher::with_status(200).with_body(&mock_response);
            let client = AutoscalingClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
        ...
        fn test_parse_autoscaling_describe_termination_policy_types() {
            let mock_response =  MockResponseReader::read_response("test_resources", "autoscaling-describe-termination-policy-types.xml");
            let mock = MockRequestDispatcher::with_status(200).with_body(&mock_response);
            let client = AutoscalingClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
