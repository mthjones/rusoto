...
Unknown(String)
                ...
                impl Error for CreateBucketError {
                    fn description(&self) -> &str {
                        match *self {
                            CreateBucketError::BucketAlreadyExists(ref cause) => cause,CreateBucketError::BucketAlreadyOwnedByYou(ref cause) => cause,CreateBucketError::Validation(ref cause) => cause,CreateBucketError::Credentials(ref err) => err.description(),CreateBucketError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),CreateBucketError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
#[doc="<p>Aborts a multipart upload.</p><p>To verify that all parts have been removed, so you don't get charged for the part storage, you should call the List Parts operation and ensure the parts list is empty.</p>"]
                #[allow(unused_variables, warnings)]
                pub fn abort_multipart_upload(&self, input: &AbortMultipartUploadRequest) -> Result<AbortMultipartUploadOutput, AbortMultipartUploadError> {
...
#[doc="Completes a multipart upload by assembling previously uploaded parts."]
                #[allow(unused_variables, warnings)]
                pub fn complete_multipart_upload(&self, input: &CompleteMultipartUploadRequest) -> Result<CompleteMultipartUploadOutput, CompleteMultipartUploadError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}/{Key}".to_string();
...
#[doc="Creates a copy of an object that is already stored in Amazon S3."]
                #[allow(unused_variables, warnings)]
                pub fn copy_object(&self, input: &CopyObjectRequest) -> Result<CopyObjectOutput, CopyObjectError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}/{Key}".to_string();
...
#[doc="Creates a new bucket."]
                #[allow(unused_variables, warnings)]
                pub fn create_bucket(&self, input: &CreateBucketRequest) -> Result<CreateBucketOutput, CreateBucketError> {
                    let mut params = Params::new();
...
#[doc="<p>Initiates a multipart upload and returns an upload ID.</p><p><b>Note:</b> After you initiate multipart upload and upload one or more parts, you must either complete or abort multipart upload in order to stop getting charged for storage of the uploaded parts. Only after you either complete or abort multipart upload, Amazon S3 frees up the parts storage and stops charging you for the parts storage.</p>"]
                #[allow(unused_variables, warnings)]
                pub fn create_multipart_upload(&self, input: &CreateMultipartUploadRequest) -> Result<CreateMultipartUploadOutput, CreateMultipartUploadError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}/{Key}".to_string();
...
#[doc="Deletes the bucket. All objects (including all object versions and Delete Markers) in the bucket must be deleted before the bucket itself can be deleted."]
                #[allow(unused_variables, warnings)]
                pub fn delete_bucket(&self, input: &DeleteBucketRequest) -> Result<(), DeleteBucketError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="Deletes an analytics configuration for the bucket (specified by the analytics configuration ID)."]
                #[allow(unused_variables, warnings)]
                pub fn delete_bucket_analytics_configuration(&self, input: &DeleteBucketAnalyticsConfigurationRequest) -> Result<(), DeleteBucketAnalyticsConfigurationError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="Deletes the cors configuration information set for the bucket."]
                #[allow(unused_variables, warnings)]
                pub fn delete_bucket_cors(&self, input: &DeleteBucketCorsRequest) -> Result<(), DeleteBucketCorsError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="Deletes an inventory configuration (identified by the inventory ID) from the bucket."]
                #[allow(unused_variables, warnings)]
                pub fn delete_bucket_inventory_configuration(&self, input: &DeleteBucketInventoryConfigurationRequest) -> Result<(), DeleteBucketInventoryConfigurationError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="Deletes the lifecycle configuration from the bucket."]
                #[allow(unused_variables, warnings)]
                pub fn delete_bucket_lifecycle(&self, input: &DeleteBucketLifecycleRequest) -> Result<(), DeleteBucketLifecycleError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="Deletes a metrics configuration (specified by the metrics configuration ID) from the bucket."]
                #[allow(unused_variables, warnings)]
                pub fn delete_bucket_metrics_configuration(&self, input: &DeleteBucketMetricsConfigurationRequest) -> Result<(), DeleteBucketMetricsConfigurationError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="Deletes the policy from the bucket."]
                #[allow(unused_variables, warnings)]
                pub fn delete_bucket_policy(&self, input: &DeleteBucketPolicyRequest) -> Result<(), DeleteBucketPolicyError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="Deletes the replication configuration from the bucket."]
                #[allow(unused_variables, warnings)]
                pub fn delete_bucket_replication(&self, input: &DeleteBucketReplicationRequest) -> Result<(), DeleteBucketReplicationError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="Deletes the tags from the bucket."]
                #[allow(unused_variables, warnings)]
                pub fn delete_bucket_tagging(&self, input: &DeleteBucketTaggingRequest) -> Result<(), DeleteBucketTaggingError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="This operation removes the website configuration from the bucket."]
                #[allow(unused_variables, warnings)]
                pub fn delete_bucket_website(&self, input: &DeleteBucketWebsiteRequest) -> Result<(), DeleteBucketWebsiteError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="Removes the null version (if there is one) of an object and inserts a delete marker, which becomes the latest version of the object. If there isn't a null version, Amazon S3 does not remove any objects."]
                #[allow(unused_variables, warnings)]
                pub fn delete_object(&self, input: &DeleteObjectRequest) -> Result<DeleteObjectOutput, DeleteObjectError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}/{Key}".to_string();
...
#[doc="Removes the tag-set from an existing object."]
                #[allow(unused_variables, warnings)]
                pub fn delete_object_tagging(&self, input: &DeleteObjectTaggingRequest) -> Result<DeleteObjectTaggingOutput, DeleteObjectTaggingError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}/{Key}".to_string();
...
#[doc="This operation enables you to delete multiple objects from a bucket using a single HTTP request. You may specify up to 1000 keys."]
                #[allow(unused_variables, warnings)]
                pub fn delete_objects(&self, input: &DeleteObjectsRequest) -> Result<DeleteObjectsOutput, DeleteObjectsError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="Returns the accelerate configuration of a bucket."]
                #[allow(unused_variables, warnings)]
                pub fn get_bucket_accelerate_configuration(&self, input: &GetBucketAccelerateConfigurationRequest) -> Result<GetBucketAccelerateConfigurationOutput, GetBucketAccelerateConfigurationError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="Gets the access control policy for the bucket."]
                #[allow(unused_variables, warnings)]
                pub fn get_bucket_acl(&self, input: &GetBucketAclRequest) -> Result<GetBucketAclOutput, GetBucketAclError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="Gets an analytics configuration for the bucket (specified by the analytics configuration ID)."]
                #[allow(unused_variables, warnings)]
                pub fn get_bucket_analytics_configuration(&self, input: &GetBucketAnalyticsConfigurationRequest) -> Result<GetBucketAnalyticsConfigurationOutput, GetBucketAnalyticsConfigurationError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="Returns the cors configuration for the bucket."]
                #[allow(unused_variables, warnings)]
                pub fn get_bucket_cors(&self, input: &GetBucketCorsRequest) -> Result<GetBucketCorsOutput, GetBucketCorsError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="Returns an inventory configuration (identified by the inventory ID) from the bucket."]
                #[allow(unused_variables, warnings)]
                pub fn get_bucket_inventory_configuration(&self, input: &GetBucketInventoryConfigurationRequest) -> Result<GetBucketInventoryConfigurationOutput, GetBucketInventoryConfigurationError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="Deprecated, see the GetBucketLifecycleConfiguration operation."]
                #[allow(unused_variables, warnings)]
                pub fn get_bucket_lifecycle(&self, input: &GetBucketLifecycleRequest) -> Result<GetBucketLifecycleOutput, GetBucketLifecycleError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="Returns the lifecycle configuration information set on the bucket."]
                #[allow(unused_variables, warnings)]
                pub fn get_bucket_lifecycle_configuration(&self, input: &GetBucketLifecycleConfigurationRequest) -> Result<GetBucketLifecycleConfigurationOutput, GetBucketLifecycleConfigurationError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="Returns the region the bucket resides in."]
                #[allow(unused_variables, warnings)]
                pub fn get_bucket_location(&self, input: &GetBucketLocationRequest) -> Result<GetBucketLocationOutput, GetBucketLocationError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="Returns the logging status of a bucket and the permissions users have to view and modify that status. To use GET, you must be the bucket owner."]
                #[allow(unused_variables, warnings)]
                pub fn get_bucket_logging(&self, input: &GetBucketLoggingRequest) -> Result<GetBucketLoggingOutput, GetBucketLoggingError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="Gets a metrics configuration (specified by the metrics configuration ID) from the bucket."]
                #[allow(unused_variables, warnings)]
                pub fn get_bucket_metrics_configuration(&self, input: &GetBucketMetricsConfigurationRequest) -> Result<GetBucketMetricsConfigurationOutput, GetBucketMetricsConfigurationError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="Deprecated, see the GetBucketNotificationConfiguration operation."]
                #[allow(unused_variables, warnings)]
                pub fn get_bucket_notification(&self, input: &GetBucketNotificationConfigurationRequest) -> Result<NotificationConfigurationDeprecated, GetBucketNotificationError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="Returns the notification configuration of a bucket."]
                #[allow(unused_variables, warnings)]
                pub fn get_bucket_notification_configuration(&self, input: &GetBucketNotificationConfigurationRequest) -> Result<NotificationConfiguration, GetBucketNotificationConfigurationError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="Returns the policy of a specified bucket."]
                #[allow(unused_variables, warnings)]
                pub fn get_bucket_policy(&self, input: &GetBucketPolicyRequest) -> Result<GetBucketPolicyOutput, GetBucketPolicyError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="Returns the replication configuration of a bucket."]
                #[allow(unused_variables, warnings)]
                pub fn get_bucket_replication(&self, input: &GetBucketReplicationRequest) -> Result<GetBucketReplicationOutput, GetBucketReplicationError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="Returns the request payment configuration of a bucket."]
                #[allow(unused_variables, warnings)]
                pub fn get_bucket_request_payment(&self, input: &GetBucketRequestPaymentRequest) -> Result<GetBucketRequestPaymentOutput, GetBucketRequestPaymentError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="Returns the tag set associated with the bucket."]
                #[allow(unused_variables, warnings)]
                pub fn get_bucket_tagging(&self, input: &GetBucketTaggingRequest) -> Result<GetBucketTaggingOutput, GetBucketTaggingError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="Returns the versioning state of a bucket."]
                #[allow(unused_variables, warnings)]
                pub fn get_bucket_versioning(&self, input: &GetBucketVersioningRequest) -> Result<GetBucketVersioningOutput, GetBucketVersioningError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="Returns the website configuration for a bucket."]
                #[allow(unused_variables, warnings)]
                pub fn get_bucket_website(&self, input: &GetBucketWebsiteRequest) -> Result<GetBucketWebsiteOutput, GetBucketWebsiteError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="Retrieves objects from Amazon S3."]
                #[allow(unused_variables, warnings)]
                pub fn get_object(&self, input: &GetObjectRequest) -> Result<GetObjectOutput, GetObjectError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}/{Key}".to_string();
...
#[doc="Returns the access control list (ACL) of an object."]
                #[allow(unused_variables, warnings)]
                pub fn get_object_acl(&self, input: &GetObjectAclRequest) -> Result<GetObjectAclOutput, GetObjectAclError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}/{Key}".to_string();
...
#[doc="Returns the tag-set of an object."]
                #[allow(unused_variables, warnings)]
                pub fn get_object_tagging(&self, input: &GetObjectTaggingRequest) -> Result<GetObjectTaggingOutput, GetObjectTaggingError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}/{Key}".to_string();
...
#[doc="Return torrent files from a bucket."]
                #[allow(unused_variables, warnings)]
                pub fn get_object_torrent(&self, input: &GetObjectTorrentRequest) -> Result<GetObjectTorrentOutput, GetObjectTorrentError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}/{Key}".to_string();
...
#[doc="This operation is useful to determine if a bucket exists and you have permission to access it."]
                #[allow(unused_variables, warnings)]
                pub fn head_bucket(&self, input: &HeadBucketRequest) -> Result<(), HeadBucketError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="The HEAD operation retrieves metadata from an object without returning the object itself. This operation is useful if you're only interested in an object's metadata. To use HEAD, you must have READ access to the object."]
                #[allow(unused_variables, warnings)]
                pub fn head_object(&self, input: &HeadObjectRequest) -> Result<HeadObjectOutput, HeadObjectError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}/{Key}".to_string();
...
#[doc="Lists the analytics configurations for the bucket."]
                #[allow(unused_variables, warnings)]
                pub fn list_bucket_analytics_configurations(&self, input: &ListBucketAnalyticsConfigurationsRequest) -> Result<ListBucketAnalyticsConfigurationsOutput, ListBucketAnalyticsConfigurationsError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="Returns a list of inventory configurations for the bucket."]
                #[allow(unused_variables, warnings)]
                pub fn list_bucket_inventory_configurations(&self, input: &ListBucketInventoryConfigurationsRequest) -> Result<ListBucketInventoryConfigurationsOutput, ListBucketInventoryConfigurationsError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="Lists the metrics configurations for the bucket."]
                #[allow(unused_variables, warnings)]
                pub fn list_bucket_metrics_configurations(&self, input: &ListBucketMetricsConfigurationsRequest) -> Result<ListBucketMetricsConfigurationsOutput, ListBucketMetricsConfigurationsError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="Returns a list of all buckets owned by the authenticated sender of the request."]
                #[allow(unused_variables, warnings)]
                pub fn list_buckets(&self) -> Result<ListBucketsOutput, ListBucketsError> {
                    let mut params = Params::new();
...
#[doc="This operation lists in-progress multipart uploads."]
                #[allow(unused_variables, warnings)]
                pub fn list_multipart_uploads(&self, input: &ListMultipartUploadsRequest) -> Result<ListMultipartUploadsOutput, ListMultipartUploadsError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="Returns metadata about all of the versions of objects in a bucket."]
                #[allow(unused_variables, warnings)]
                pub fn list_object_versions(&self, input: &ListObjectVersionsRequest) -> Result<ListObjectVersionsOutput, ListObjectVersionsError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="Returns some or all (up to 1000) of the objects in a bucket. You can use the request parameters as selection criteria to return a subset of the objects in a bucket."]
                #[allow(unused_variables, warnings)]
                pub fn list_objects(&self, input: &ListObjectsRequest) -> Result<ListObjectsOutput, ListObjectsError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="Returns some or all (up to 1000) of the objects in a bucket. You can use the request parameters as selection criteria to return a subset of the objects in a bucket. Note: ListObjectsV2 is the revised List Objects API and we recommend you use this revised API for new application development."]
                #[allow(unused_variables, warnings)]
                pub fn list_objects_v2(&self, input: &ListObjectsV2Request) -> Result<ListObjectsV2Output, ListObjectsV2Error> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="Lists the parts that have been uploaded for a specific multipart upload."]
                #[allow(unused_variables, warnings)]
                pub fn list_parts(&self, input: &ListPartsRequest) -> Result<ListPartsOutput, ListPartsError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}/{Key}".to_string();
...
#[doc="Sets the accelerate configuration of an existing bucket."]
                #[allow(unused_variables, warnings)]
                pub fn put_bucket_accelerate_configuration(&self, input: &PutBucketAccelerateConfigurationRequest) -> Result<(), PutBucketAccelerateConfigurationError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="Sets the permissions on a bucket using access control lists (ACL)."]
                #[allow(unused_variables, warnings)]
                pub fn put_bucket_acl(&self, input: &PutBucketAclRequest) -> Result<(), PutBucketAclError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="Sets an analytics configuration for the bucket (specified by the analytics configuration ID)."]
                #[allow(unused_variables, warnings)]
                pub fn put_bucket_analytics_configuration(&self, input: &PutBucketAnalyticsConfigurationRequest) -> Result<(), PutBucketAnalyticsConfigurationError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="Sets the cors configuration for a bucket."]
                #[allow(unused_variables, warnings)]
                pub fn put_bucket_cors(&self, input: &PutBucketCorsRequest) -> Result<(), PutBucketCorsError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="Adds an inventory configuration (identified by the inventory ID) from the bucket."]
                #[allow(unused_variables, warnings)]
                pub fn put_bucket_inventory_configuration(&self, input: &PutBucketInventoryConfigurationRequest) -> Result<(), PutBucketInventoryConfigurationError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="Deprecated, see the PutBucketLifecycleConfiguration operation."]
                #[allow(unused_variables, warnings)]
                pub fn put_bucket_lifecycle(&self, input: &PutBucketLifecycleRequest) -> Result<(), PutBucketLifecycleError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="Sets lifecycle configuration for your bucket. If a lifecycle configuration exists, it replaces it."]
                #[allow(unused_variables, warnings)]
                pub fn put_bucket_lifecycle_configuration(&self, input: &PutBucketLifecycleConfigurationRequest) -> Result<(), PutBucketLifecycleConfigurationError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="Set the logging parameters for a bucket and to specify permissions for who can view and modify the logging parameters. To set the logging status of a bucket, you must be the bucket owner."]
                #[allow(unused_variables, warnings)]
                pub fn put_bucket_logging(&self, input: &PutBucketLoggingRequest) -> Result<(), PutBucketLoggingError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="Sets a metrics configuration (specified by the metrics configuration ID) for the bucket."]
                #[allow(unused_variables, warnings)]
                pub fn put_bucket_metrics_configuration(&self, input: &PutBucketMetricsConfigurationRequest) -> Result<(), PutBucketMetricsConfigurationError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="Deprecated, see the PutBucketNotificationConfiguraiton operation."]
                #[allow(unused_variables, warnings)]
                pub fn put_bucket_notification(&self, input: &PutBucketNotificationRequest) -> Result<(), PutBucketNotificationError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="Enables notifications of specified events for a bucket."]
                #[allow(unused_variables, warnings)]
                pub fn put_bucket_notification_configuration(&self, input: &PutBucketNotificationConfigurationRequest) -> Result<(), PutBucketNotificationConfigurationError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="Replaces a policy on a bucket. If the bucket already has a policy, the one in this request completely replaces it."]
                #[allow(unused_variables, warnings)]
                pub fn put_bucket_policy(&self, input: &PutBucketPolicyRequest) -> Result<(), PutBucketPolicyError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="Creates a new replication configuration (or replaces an existing one, if present)."]
                #[allow(unused_variables, warnings)]
                pub fn put_bucket_replication(&self, input: &PutBucketReplicationRequest) -> Result<(), PutBucketReplicationError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="Sets the request payment configuration for a bucket. By default, the bucket owner pays for downloads from the bucket. This configuration parameter enables the bucket owner (only) to specify that the person requesting the download will be charged for the download. Documentation on requester pays buckets can be found at http://docs.aws.amazon.com/AmazonS3/latest/dev/RequesterPaysBuckets.html"]
                #[allow(unused_variables, warnings)]
                pub fn put_bucket_request_payment(&self, input: &PutBucketRequestPaymentRequest) -> Result<(), PutBucketRequestPaymentError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="Sets the tags for a bucket."]
                #[allow(unused_variables, warnings)]
                pub fn put_bucket_tagging(&self, input: &PutBucketTaggingRequest) -> Result<(), PutBucketTaggingError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="Sets the versioning state of an existing bucket. To set the versioning state, you must be the bucket owner."]
                #[allow(unused_variables, warnings)]
                pub fn put_bucket_versioning(&self, input: &PutBucketVersioningRequest) -> Result<(), PutBucketVersioningError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="Set the website configuration for a bucket."]
                #[allow(unused_variables, warnings)]
                pub fn put_bucket_website(&self, input: &PutBucketWebsiteRequest) -> Result<(), PutBucketWebsiteError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}".to_string();
...
#[doc="Adds an object to a bucket."]
                #[allow(unused_variables, warnings)]
                pub fn put_object(&self, input: &PutObjectRequest) -> Result<PutObjectOutput, PutObjectError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}/{Key}".to_string();
...
#[doc="uses the acl subresource to set the access control list (ACL) permissions for an object that already exists in a bucket"]
                #[allow(unused_variables, warnings)]
                pub fn put_object_acl(&self, input: &PutObjectAclRequest) -> Result<PutObjectAclOutput, PutObjectAclError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}/{Key}".to_string();
...
#[doc="Sets the supplied tag-set to an object that already exists in a bucket"]
                #[allow(unused_variables, warnings)]
                pub fn put_object_tagging(&self, input: &PutObjectTaggingRequest) -> Result<PutObjectTaggingOutput, PutObjectTaggingError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}/{Key}".to_string();
...
#[doc="Restores an archived copy of an object back into Amazon S3"]
                #[allow(unused_variables, warnings)]
                pub fn restore_object(&self, input: &RestoreObjectRequest) -> Result<RestoreObjectOutput, RestoreObjectError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}/{Key}".to_string();
...
#[doc="<p>Uploads a part in a multipart upload.</p><p><b>Note:</b> After you initiate multipart upload and upload one or more parts, you must either complete or abort multipart upload in order to stop getting charged for storage of the uploaded parts. Only after you either complete or abort multipart upload, Amazon S3 frees up the parts storage and stops charging you for the parts storage.</p>"]
                #[allow(unused_variables, warnings)]
                pub fn upload_part(&self, input: &UploadPartRequest) -> Result<UploadPartOutput, UploadPartError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}/{Key}".to_string();
...
#[doc="Uploads a part by copying data from an existing object as data source."]
                #[allow(unused_variables, warnings)]
                pub fn upload_part_copy(&self, input: &UploadPartCopyRequest) -> Result<UploadPartCopyOutput, UploadPartCopyError> {
                    let mut params = Params::new();
                    let mut request_uri = "/{Bucket}/{Key}".to_string();
...
if let Some(server_side_encryption) = response.headers.get("x-amz-server-side-encryption") {
        ...
        fn test_parse_s3_get_bucket_acl() {
            let mock_response =  MockResponseReader::read_response("test_resources", "s3-get-bucket-acl.xml");
        ...
        fn test_parse_s3_get_bucket_location() {
            let mock_response =  MockResponseReader::read_response("test_resources", "s3-get-bucket-location.xml");
            let mock = MockRequestDispatcher::with_status(200).with_body(&mock_response);
            let client = S3Client::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
        ...
        fn test_parse_s3_get_bucket_logging() {
            let mock_response =  MockResponseReader::read_response("test_resources", "s3-get-bucket-logging.xml");
            let mock = MockRequestDispatcher::with_status(200).with_body(&mock_response);
            let client = S3Client::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
        ...
        fn test_parse_s3_get_bucket_policy() {
            let mock_response =  MockResponseReader::read_response("test_resources", "s3-get-bucket-policy.xml");
            let mock = MockRequestDispatcher::with_status(200).with_body(&mock_response);
            let client = S3Client::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
        ...
        fn test_parse_s3_list_buckets() {
            let mock_response =  MockResponseReader::read_response("test_resources", "s3-list-buckets.xml");
            let mock = MockRequestDispatcher::with_status(200).with_body(&mock_response);
            let client = S3Client::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
        ...
        fn test_parse_s3_list_multipart_uploads() {
            let mock_response =  MockResponseReader::read_response("test_resources", "s3-list-multipart-uploads.xml");
            let mock = MockRequestDispatcher::with_status(200).with_body(&mock_response);
            let client = S3Client::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
        ...
        fn test_parse_s3_list_object_versions() {
            let mock_response =  MockResponseReader::read_response("test_resources", "s3-list-object-versions.xml");
            let mock = MockRequestDispatcher::with_status(200).with_body(&mock_response);
            let client = S3Client::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
        ...
        fn test_parse_s3_list_objects() {
            let mock_response =  MockResponseReader::read_response("test_resources", "s3-list-objects.xml");
            let mock = MockRequestDispatcher::with_status(200).with_body(&mock_response);
            let client = S3Client::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
