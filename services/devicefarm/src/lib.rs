                    ...
                    pub fn from_body(body: &str) -> CreateNetworkProfileError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "ArgumentException" => CreateNetworkProfileError::Argument(String::from(error_message)),"NotFoundException" => CreateNetworkProfileError::NotFound(String::from(error_message)),"LimitExceededException" => CreateNetworkProfileError::LimitExceeded(String::from(error_message)),"ServiceAccountException" => CreateNetworkProfileError::ServiceAccount(String::from(error_message)),"ValidationException" => CreateNetworkProfileError::Validation(error_message.to_string()),_ => CreateNetworkProfileError::Unknown(String::from(body))
                                }
                            },
                    ...
                    pub fn from_body(body: &str) -> DeleteNetworkProfileError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "ArgumentException" => DeleteNetworkProfileError::Argument(String::from(error_message)),"NotFoundException" => DeleteNetworkProfileError::NotFound(String::from(error_message)),"LimitExceededException" => DeleteNetworkProfileError::LimitExceeded(String::from(error_message)),"ServiceAccountException" => DeleteNetworkProfileError::ServiceAccount(String::from(error_message)),"ValidationException" => DeleteNetworkProfileError::Validation(error_message.to_string()),_ => DeleteNetworkProfileError::Unknown(String::from(body))
                                }
                            },
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> GetNetworkProfileError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "ArgumentException" => GetNetworkProfileError::Argument(String::from(error_message)),"NotFoundException" => GetNetworkProfileError::NotFound(String::from(error_message)),"LimitExceededException" => GetNetworkProfileError::LimitExceeded(String::from(error_message)),"ServiceAccountException" => GetNetworkProfileError::ServiceAccount(String::from(error_message)),"ValidationException" => GetNetworkProfileError::Validation(error_message.to_string()),_ => GetNetworkProfileError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for GetNetworkProfileError {
                    fn description(&self) -> &str {
                        match *self {
                            GetNetworkProfileError::Argument(ref cause) => cause,GetNetworkProfileError::NotFound(ref cause) => cause,GetNetworkProfileError::LimitExceeded(ref cause) => cause,GetNetworkProfileError::ServiceAccount(ref cause) => cause,GetNetworkProfileError::Validation(ref cause) => cause,GetNetworkProfileError::Credentials(ref err) => err.description(),GetNetworkProfileError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),GetNetworkProfileError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> ListNetworkProfilesError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "ArgumentException" => ListNetworkProfilesError::Argument(String::from(error_message)),"NotFoundException" => ListNetworkProfilesError::NotFound(String::from(error_message)),"LimitExceededException" => ListNetworkProfilesError::LimitExceeded(String::from(error_message)),"ServiceAccountException" => ListNetworkProfilesError::ServiceAccount(String::from(error_message)),"ValidationException" => ListNetworkProfilesError::Validation(error_message.to_string()),_ => ListNetworkProfilesError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for ListNetworkProfilesError {
                    fn description(&self) -> &str {
                        match *self {
                            ListNetworkProfilesError::Argument(ref cause) => cause,ListNetworkProfilesError::NotFound(ref cause) => cause,ListNetworkProfilesError::LimitExceeded(ref cause) => cause,ListNetworkProfilesError::ServiceAccount(ref cause) => cause,ListNetworkProfilesError::Validation(ref cause) => cause,ListNetworkProfilesError::Credentials(ref err) => err.description(),ListNetworkProfilesError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),ListNetworkProfilesError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> ListOfferingPromotionsError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "ArgumentException" => ListOfferingPromotionsError::Argument(String::from(error_message)),"NotFoundException" => ListOfferingPromotionsError::NotFound(String::from(error_message)),"NotEligibleException" => ListOfferingPromotionsError::NotEligible(String::from(error_message)),"LimitExceededException" => ListOfferingPromotionsError::LimitExceeded(String::from(error_message)),"ServiceAccountException" => ListOfferingPromotionsError::ServiceAccount(String::from(error_message)),"ValidationException" => ListOfferingPromotionsError::Validation(error_message.to_string()),_ => ListOfferingPromotionsError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for ListOfferingPromotionsError {
                    fn description(&self) -> &str {
                        match *self {
                            ListOfferingPromotionsError::Argument(ref cause) => cause,ListOfferingPromotionsError::NotFound(ref cause) => cause,ListOfferingPromotionsError::NotEligible(ref cause) => cause,ListOfferingPromotionsError::LimitExceeded(ref cause) => cause,ListOfferingPromotionsError::ServiceAccount(ref cause) => cause,ListOfferingPromotionsError::Validation(ref cause) => cause,ListOfferingPromotionsError::Credentials(ref err) => err.description(),ListOfferingPromotionsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),ListOfferingPromotionsError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> UpdateNetworkProfileError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "ArgumentException" => UpdateNetworkProfileError::Argument(String::from(error_message)),"NotFoundException" => UpdateNetworkProfileError::NotFound(String::from(error_message)),"LimitExceededException" => UpdateNetworkProfileError::LimitExceeded(String::from(error_message)),"ServiceAccountException" => UpdateNetworkProfileError::ServiceAccount(String::from(error_message)),"ValidationException" => UpdateNetworkProfileError::Validation(error_message.to_string()),_ => UpdateNetworkProfileError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for UpdateNetworkProfileError {
                    fn description(&self) -> &str {
                        match *self {
                            UpdateNetworkProfileError::Argument(ref cause) => cause,UpdateNetworkProfileError::NotFound(ref cause) => cause,UpdateNetworkProfileError::LimitExceeded(ref cause) => cause,UpdateNetworkProfileError::ServiceAccount(ref cause) => cause,UpdateNetworkProfileError::Validation(ref cause) => cause,UpdateNetworkProfileError::Credentials(ref err) => err.description(),UpdateNetworkProfileError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),UpdateNetworkProfileError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
/// A client for the AWS Device Farm API.
        ...
        impl<P, D> DeviceFarmClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
            pub fn new(request_dispatcher: D, credentials_provider: P, region: region::Region) -> Self {
                ...
                pub fn create_device_pool(&self, input: &CreateDevicePoolRequest)  -> Result<CreateDevicePoolResult, CreateDevicePoolError> {
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn create_network_profile(&self, input: &CreateNetworkProfileRequest)  -> Result<CreateNetworkProfileResult, CreateNetworkProfileError> {
                    let mut request = SignedRequest::new("POST", "devicefarm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    match response.status {
                        ...
                        _ => Err(CreateNetworkProfileError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                    }
                }
                

                #[doc="<p>Creates a new project.</p>"]
                pub fn create_project(&self, input: &CreateProjectRequest)  -> Result<CreateProjectResult, CreateProjectError> {
                    let mut request = SignedRequest::new("POST", "devicefarm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn create_remote_access_session(&self, input: &CreateRemoteAccessSessionRequest)  -> Result<CreateRemoteAccessSessionResult, CreateRemoteAccessSessionError> {
                    let mut request = SignedRequest::new("POST", "devicefarm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn create_upload(&self, input: &CreateUploadRequest)  -> Result<CreateUploadResult, CreateUploadError> {
                    let mut request = SignedRequest::new("POST", "devicefarm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn delete_device_pool(&self, input: &DeleteDevicePoolRequest)  -> Result<DeleteDevicePoolResult, DeleteDevicePoolError> {
                    let mut request = SignedRequest::new("POST", "devicefarm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn delete_network_profile(&self, input: &DeleteNetworkProfileRequest)  -> Result<DeleteNetworkProfileResult, DeleteNetworkProfileError> {
                    let mut request = SignedRequest::new("POST", "devicefarm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    match response.status {
                        ...
                        _ => Err(DeleteNetworkProfileError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                    }
                }
                ...
                pub fn delete_project(&self, input: &DeleteProjectRequest)  -> Result<DeleteProjectResult, DeleteProjectError> {
                    let mut request = SignedRequest::new("POST", "devicefarm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn delete_remote_access_session(&self, input: &DeleteRemoteAccessSessionRequest)  -> Result<DeleteRemoteAccessSessionResult, DeleteRemoteAccessSessionError> {
                    let mut request = SignedRequest::new("POST", "devicefarm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn delete_run(&self, input: &DeleteRunRequest)  -> Result<DeleteRunResult, DeleteRunError> {
                    let mut request = SignedRequest::new("POST", "devicefarm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn delete_upload(&self, input: &DeleteUploadRequest)  -> Result<DeleteUploadResult, DeleteUploadError> {
                    let mut request = SignedRequest::new("POST", "devicefarm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn get_account_settings(&self, input: &GetAccountSettingsRequest)  -> Result<GetAccountSettingsResult, GetAccountSettingsError> {
                    let mut request = SignedRequest::new("POST", "devicefarm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn get_device(&self, input: &GetDeviceRequest)  -> Result<GetDeviceResult, GetDeviceError> {
                    let mut request = SignedRequest::new("POST", "devicefarm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn get_device_pool(&self, input: &GetDevicePoolRequest)  -> Result<GetDevicePoolResult, GetDevicePoolError> {
                    let mut request = SignedRequest::new("POST", "devicefarm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn get_device_pool_compatibility(&self, input: &GetDevicePoolCompatibilityRequest)  -> Result<GetDevicePoolCompatibilityResult, GetDevicePoolCompatibilityError> {
                    let mut request = SignedRequest::new("POST", "devicefarm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn get_job(&self, input: &GetJobRequest)  -> Result<GetJobResult, GetJobError> {
                    let mut request = SignedRequest::new("POST", "devicefarm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn get_network_profile(&self, input: &GetNetworkProfileRequest)  -> Result<GetNetworkProfileResult, GetNetworkProfileError> {
                    let mut request = SignedRequest::new("POST", "devicefarm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    match response.status {
                        ...
                        _ => Err(GetNetworkProfileError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                    }
                }
                ...
                pub fn get_offering_status(&self, input: &GetOfferingStatusRequest)  -> Result<GetOfferingStatusResult, GetOfferingStatusError> {
                    let mut request = SignedRequest::new("POST", "devicefarm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn get_project(&self, input: &GetProjectRequest)  -> Result<GetProjectResult, GetProjectError> {
                    let mut request = SignedRequest::new("POST", "devicefarm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn get_remote_access_session(&self, input: &GetRemoteAccessSessionRequest)  -> Result<GetRemoteAccessSessionResult, GetRemoteAccessSessionError> {
                    let mut request = SignedRequest::new("POST", "devicefarm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn get_run(&self, input: &GetRunRequest)  -> Result<GetRunResult, GetRunError> {
                    let mut request = SignedRequest::new("POST", "devicefarm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn get_suite(&self, input: &GetSuiteRequest)  -> Result<GetSuiteResult, GetSuiteError> {
                    let mut request = SignedRequest::new("POST", "devicefarm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn get_test(&self, input: &GetTestRequest)  -> Result<GetTestResult, GetTestError> {
                    let mut request = SignedRequest::new("POST", "devicefarm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn get_upload(&self, input: &GetUploadRequest)  -> Result<GetUploadResult, GetUploadError> {
                    let mut request = SignedRequest::new("POST", "devicefarm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn install_to_remote_access_session(&self, input: &InstallToRemoteAccessSessionRequest)  -> Result<InstallToRemoteAccessSessionResult, InstallToRemoteAccessSessionError> {
                    let mut request = SignedRequest::new("POST", "devicefarm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn list_artifacts(&self, input: &ListArtifactsRequest)  -> Result<ListArtifactsResult, ListArtifactsError> {
                    let mut request = SignedRequest::new("POST", "devicefarm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn list_device_pools(&self, input: &ListDevicePoolsRequest)  -> Result<ListDevicePoolsResult, ListDevicePoolsError> {
                    let mut request = SignedRequest::new("POST", "devicefarm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn list_devices(&self, input: &ListDevicesRequest)  -> Result<ListDevicesResult, ListDevicesError> {
                    let mut request = SignedRequest::new("POST", "devicefarm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn list_jobs(&self, input: &ListJobsRequest)  -> Result<ListJobsResult, ListJobsError> {
                    let mut request = SignedRequest::new("POST", "devicefarm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn list_network_profiles(&self, input: &ListNetworkProfilesRequest)  -> Result<ListNetworkProfilesResult, ListNetworkProfilesError> {
                    let mut request = SignedRequest::new("POST", "devicefarm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    match response.status {
                        ...
                        _ => Err(ListNetworkProfilesError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                    }
                }
                ...
                pub fn list_offering_promotions(&self, input: &ListOfferingPromotionsRequest)  -> Result<ListOfferingPromotionsResult, ListOfferingPromotionsError> {
                    let mut request = SignedRequest::new("POST", "devicefarm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    match response.status {
                        ...
                        _ => Err(ListOfferingPromotionsError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                    }
                }
                

                #[doc="<p>Returns a list of all historical purchases, renewals, and system renewal transactions for an AWS account. The list is paginated and ordered by a descending timestamp (most recent transactions are first). The API returns a <code>NotEligible</code> error if the user is not permitted to invoke the operation. Please contact <a href=\"mailto:aws-devicefarm-support@amazon.com\">aws-devicefarm-support@amazon.com</a> if you believe that you should be able to invoke this operation.</p>"]
                pub fn list_offering_transactions(&self, input: &ListOfferingTransactionsRequest)  -> Result<ListOfferingTransactionsResult, ListOfferingTransactionsError> {
                    let mut request = SignedRequest::new("POST", "devicefarm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn list_offerings(&self, input: &ListOfferingsRequest)  -> Result<ListOfferingsResult, ListOfferingsError> {
                    let mut request = SignedRequest::new("POST", "devicefarm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn list_projects(&self, input: &ListProjectsRequest)  -> Result<ListProjectsResult, ListProjectsError> {
                    let mut request = SignedRequest::new("POST", "devicefarm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn list_remote_access_sessions(&self, input: &ListRemoteAccessSessionsRequest)  -> Result<ListRemoteAccessSessionsResult, ListRemoteAccessSessionsError> {
                    let mut request = SignedRequest::new("POST", "devicefarm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn list_runs(&self, input: &ListRunsRequest)  -> Result<ListRunsResult, ListRunsError> {
                    let mut request = SignedRequest::new("POST", "devicefarm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn list_samples(&self, input: &ListSamplesRequest)  -> Result<ListSamplesResult, ListSamplesError> {
                    let mut request = SignedRequest::new("POST", "devicefarm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn list_suites(&self, input: &ListSuitesRequest)  -> Result<ListSuitesResult, ListSuitesError> {
                    let mut request = SignedRequest::new("POST", "devicefarm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn list_tests(&self, input: &ListTestsRequest)  -> Result<ListTestsResult, ListTestsError> {
                    let mut request = SignedRequest::new("POST", "devicefarm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn list_unique_problems(&self, input: &ListUniqueProblemsRequest)  -> Result<ListUniqueProblemsResult, ListUniqueProblemsError> {
                    let mut request = SignedRequest::new("POST", "devicefarm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn list_uploads(&self, input: &ListUploadsRequest)  -> Result<ListUploadsResult, ListUploadsError> {
                    let mut request = SignedRequest::new("POST", "devicefarm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn purchase_offering(&self, input: &PurchaseOfferingRequest)  -> Result<PurchaseOfferingResult, PurchaseOfferingError> {
                    let mut request = SignedRequest::new("POST", "devicefarm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn renew_offering(&self, input: &RenewOfferingRequest)  -> Result<RenewOfferingResult, RenewOfferingError> {
                    let mut request = SignedRequest::new("POST", "devicefarm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn schedule_run(&self, input: &ScheduleRunRequest)  -> Result<ScheduleRunResult, ScheduleRunError> {
                    let mut request = SignedRequest::new("POST", "devicefarm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn stop_remote_access_session(&self, input: &StopRemoteAccessSessionRequest)  -> Result<StopRemoteAccessSessionResult, StopRemoteAccessSessionError> {
                    let mut request = SignedRequest::new("POST", "devicefarm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn stop_run(&self, input: &StopRunRequest)  -> Result<StopRunResult, StopRunError> {
                    let mut request = SignedRequest::new("POST", "devicefarm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn update_device_pool(&self, input: &UpdateDevicePoolRequest)  -> Result<UpdateDevicePoolResult, UpdateDevicePoolError> {
                    let mut request = SignedRequest::new("POST", "devicefarm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn update_network_profile(&self, input: &UpdateNetworkProfileRequest)  -> Result<UpdateNetworkProfileResult, UpdateNetworkProfileError> {
                    let mut request = SignedRequest::new("POST", "devicefarm", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    match response.status {
                        ...
                        _ => Err(UpdateNetworkProfileError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                    }
                }
                

                #[doc="<p>Modifies the specified project name, given the project ARN and a new name.</p>"]
                pub fn update_project(&self, input: &UpdateProjectRequest)  -> Result<UpdateProjectResult, UpdateProjectError> {
                    let mut request = SignedRequest::new("POST", "devicefarm", self.region, "/");
