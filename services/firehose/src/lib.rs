...
Unknown(String)
                ...
                impl Error for CreateDeliveryStreamError {
                    fn description(&self) -> &str {
                        match *self {
                            CreateDeliveryStreamError::InvalidArgument(ref cause) => cause,CreateDeliveryStreamError::LimitExceeded(ref cause) => cause,CreateDeliveryStreamError::ResourceInUse(ref cause) => cause,CreateDeliveryStreamError::Validation(ref cause) => cause,CreateDeliveryStreamError::Credentials(ref err) => err.description(),CreateDeliveryStreamError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),CreateDeliveryStreamError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
/// A client for the Firehose API.
        ...
        impl<P, D> KinesisFirehoseClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
            pub fn new(request_dispatcher: D, credentials_provider: P, region: region::Region) -> Self {
                ...
                pub fn create_delivery_stream(&self, input: &CreateDeliveryStreamInput)  -> Result<CreateDeliveryStreamOutput, CreateDeliveryStreamError> {
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn delete_delivery_stream(&self, input: &DeleteDeliveryStreamInput)  -> Result<DeleteDeliveryStreamOutput, DeleteDeliveryStreamError> {
                    let mut request = SignedRequest::new("POST", "firehose", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn describe_delivery_stream(&self, input: &DescribeDeliveryStreamInput)  -> Result<DescribeDeliveryStreamOutput, DescribeDeliveryStreamError> {
                    let mut request = SignedRequest::new("POST", "firehose", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn list_delivery_streams(&self, input: &ListDeliveryStreamsInput)  -> Result<ListDeliveryStreamsOutput, ListDeliveryStreamsError> {
                    let mut request = SignedRequest::new("POST", "firehose", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn put_record_batch(&self, input: &PutRecordBatchInput)  -> Result<PutRecordBatchOutput, PutRecordBatchError> {
                    let mut request = SignedRequest::new("POST", "firehose", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn update_destination(&self, input: &UpdateDestinationInput)  -> Result<UpdateDestinationOutput, UpdateDestinationError> {
                    let mut request = SignedRequest::new("POST", "firehose", self.region, "/");
