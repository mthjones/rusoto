...
/// A client for the Amazon WorkSpaces API.
        ...
        impl<P, D> WorkspacesClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
            pub fn new(request_dispatcher: D, credentials_provider: P, region: region::Region) -> Self {
                ...
                pub fn create_tags(&self, input: &CreateTagsRequest)  -> Result<CreateTagsResult, CreateTagsError> {
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn create_workspaces(&self, input: &CreateWorkspacesRequest)  -> Result<CreateWorkspacesResult, CreateWorkspacesError> {
                    let mut request = SignedRequest::new("POST", "workspaces", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn delete_tags(&self, input: &DeleteTagsRequest)  -> Result<DeleteTagsResult, DeleteTagsError> {
                    let mut request = SignedRequest::new("POST", "workspaces", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn describe_tags(&self, input: &DescribeTagsRequest)  -> Result<DescribeTagsResult, DescribeTagsError> {
                    let mut request = SignedRequest::new("POST", "workspaces", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn describe_workspace_bundles(&self, input: &DescribeWorkspaceBundlesRequest)  -> Result<DescribeWorkspaceBundlesResult, DescribeWorkspaceBundlesError> {
                    let mut request = SignedRequest::new("POST", "workspaces", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn describe_workspace_directories(&self, input: &DescribeWorkspaceDirectoriesRequest)  -> Result<DescribeWorkspaceDirectoriesResult, DescribeWorkspaceDirectoriesError> {
                    let mut request = SignedRequest::new("POST", "workspaces", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn describe_workspaces(&self, input: &DescribeWorkspacesRequest)  -> Result<DescribeWorkspacesResult, DescribeWorkspacesError> {
                    let mut request = SignedRequest::new("POST", "workspaces", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn describe_workspaces_connection_status(&self, input: &DescribeWorkspacesConnectionStatusRequest)  -> Result<DescribeWorkspacesConnectionStatusResult, DescribeWorkspacesConnectionStatusError> {
                    let mut request = SignedRequest::new("POST", "workspaces", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn modify_workspace_properties(&self, input: &ModifyWorkspacePropertiesRequest)  -> Result<ModifyWorkspacePropertiesResult, ModifyWorkspacePropertiesError> {
                    let mut request = SignedRequest::new("POST", "workspaces", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn reboot_workspaces(&self, input: &RebootWorkspacesRequest)  -> Result<RebootWorkspacesResult, RebootWorkspacesError> {
                    let mut request = SignedRequest::new("POST", "workspaces", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn rebuild_workspaces(&self, input: &RebuildWorkspacesRequest)  -> Result<RebuildWorkspacesResult, RebuildWorkspacesError> {
                    let mut request = SignedRequest::new("POST", "workspaces", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn start_workspaces(&self, input: &StartWorkspacesRequest)  -> Result<StartWorkspacesResult, StartWorkspacesError> {
                    let mut request = SignedRequest::new("POST", "workspaces", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn stop_workspaces(&self, input: &StopWorkspacesRequest)  -> Result<StopWorkspacesResult, StopWorkspacesError> {
                    let mut request = SignedRequest::new("POST", "workspaces", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn terminate_workspaces(&self, input: &TerminateWorkspacesRequest)  -> Result<TerminateWorkspacesResult, TerminateWorkspacesError> {
                    let mut request = SignedRequest::new("POST", "workspaces", self.region, "/");
