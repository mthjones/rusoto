...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> AllocateHostedConnectionError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "DirectConnectServerException" => AllocateHostedConnectionError::DirectConnectServer(String::from(error_message)),"DirectConnectClientException" => AllocateHostedConnectionError::DirectConnectClient(String::from(error_message)),"ValidationException" => AllocateHostedConnectionError::Validation(error_message.to_string()),_ => AllocateHostedConnectionError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for AllocateHostedConnectionError {
                    fn description(&self) -> &str {
                        match *self {
                            AllocateHostedConnectionError::DirectConnectServer(ref cause) => cause,AllocateHostedConnectionError::DirectConnectClient(ref cause) => cause,AllocateHostedConnectionError::Validation(ref cause) => cause,AllocateHostedConnectionError::Credentials(ref err) => err.description(),AllocateHostedConnectionError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),AllocateHostedConnectionError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> AllocatePrivateVirtualInterfaceError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "DirectConnectServerException" => AllocatePrivateVirtualInterfaceError::DirectConnectServer(String::from(error_message)),"DirectConnectClientException" => AllocatePrivateVirtualInterfaceError::DirectConnectClient(String::from(error_message)),"ValidationException" => AllocatePrivateVirtualInterfaceError::Validation(error_message.to_string()),_ => AllocatePrivateVirtualInterfaceError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for AllocatePrivateVirtualInterfaceError {
                    fn description(&self) -> &str {
                        match *self {
                            AllocatePrivateVirtualInterfaceError::DirectConnectServer(ref cause) => cause,AllocatePrivateVirtualInterfaceError::DirectConnectClient(ref cause) => cause,AllocatePrivateVirtualInterfaceError::Validation(ref cause) => cause,AllocatePrivateVirtualInterfaceError::Credentials(ref err) => err.description(),AllocatePrivateVirtualInterfaceError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),AllocatePrivateVirtualInterfaceError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> AssociateConnectionWithLagError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "DirectConnectServerException" => AssociateConnectionWithLagError::DirectConnectServer(String::from(error_message)),"DirectConnectClientException" => AssociateConnectionWithLagError::DirectConnectClient(String::from(error_message)),"ValidationException" => AssociateConnectionWithLagError::Validation(error_message.to_string()),_ => AssociateConnectionWithLagError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for AssociateConnectionWithLagError {
                    fn description(&self) -> &str {
                        match *self {
                            AssociateConnectionWithLagError::DirectConnectServer(ref cause) => cause,AssociateConnectionWithLagError::DirectConnectClient(ref cause) => cause,AssociateConnectionWithLagError::Validation(ref cause) => cause,AssociateConnectionWithLagError::Credentials(ref err) => err.description(),AssociateConnectionWithLagError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),AssociateConnectionWithLagError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> AssociateHostedConnectionError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "DirectConnectServerException" => AssociateHostedConnectionError::DirectConnectServer(String::from(error_message)),"DirectConnectClientException" => AssociateHostedConnectionError::DirectConnectClient(String::from(error_message)),"ValidationException" => AssociateHostedConnectionError::Validation(error_message.to_string()),_ => AssociateHostedConnectionError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for AssociateHostedConnectionError {
                    fn description(&self) -> &str {
                        match *self {
                            AssociateHostedConnectionError::DirectConnectServer(ref cause) => cause,AssociateHostedConnectionError::DirectConnectClient(ref cause) => cause,AssociateHostedConnectionError::Validation(ref cause) => cause,AssociateHostedConnectionError::Credentials(ref err) => err.description(),AssociateHostedConnectionError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),AssociateHostedConnectionError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> AssociateVirtualInterfaceError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "DirectConnectServerException" => AssociateVirtualInterfaceError::DirectConnectServer(String::from(error_message)),"DirectConnectClientException" => AssociateVirtualInterfaceError::DirectConnectClient(String::from(error_message)),"ValidationException" => AssociateVirtualInterfaceError::Validation(error_message.to_string()),_ => AssociateVirtualInterfaceError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for AssociateVirtualInterfaceError {
                    fn description(&self) -> &str {
                        match *self {
                            AssociateVirtualInterfaceError::DirectConnectServer(ref cause) => cause,AssociateVirtualInterfaceError::DirectConnectClient(ref cause) => cause,AssociateVirtualInterfaceError::Validation(ref cause) => cause,AssociateVirtualInterfaceError::Credentials(ref err) => err.description(),AssociateVirtualInterfaceError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),AssociateVirtualInterfaceError::Unknown(ref cause) => cause
                        }
                    }
                 }
                    ...
                    pub fn from_body(body: &str) -> ConfirmConnectionError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "DirectConnectServerException" => ConfirmConnectionError::DirectConnectServer(String::from(error_message)),"DirectConnectClientException" => ConfirmConnectionError::DirectConnectClient(String::from(error_message)),"ValidationException" => ConfirmConnectionError::Validation(error_message.to_string()),_ => ConfirmConnectionError::Unknown(String::from(body))
                                }
                            },
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> ConfirmPublicVirtualInterfaceError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "DirectConnectServerException" => ConfirmPublicVirtualInterfaceError::DirectConnectServer(String::from(error_message)),"DirectConnectClientException" => ConfirmPublicVirtualInterfaceError::DirectConnectClient(String::from(error_message)),"ValidationException" => ConfirmPublicVirtualInterfaceError::Validation(error_message.to_string()),_ => ConfirmPublicVirtualInterfaceError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for ConfirmPublicVirtualInterfaceError {
                    fn description(&self) -> &str {
                        match *self {
                            ConfirmPublicVirtualInterfaceError::DirectConnectServer(ref cause) => cause,ConfirmPublicVirtualInterfaceError::DirectConnectClient(ref cause) => cause,ConfirmPublicVirtualInterfaceError::Validation(ref cause) => cause,ConfirmPublicVirtualInterfaceError::Credentials(ref err) => err.description(),ConfirmPublicVirtualInterfaceError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),ConfirmPublicVirtualInterfaceError::Unknown(ref cause) => cause
                        }
                    }
                 }
                    ...
                    pub fn from_body(body: &str) -> CreateBGPPeerError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "DirectConnectServerException" => CreateBGPPeerError::DirectConnectServer(String::from(error_message)),"DirectConnectClientException" => CreateBGPPeerError::DirectConnectClient(String::from(error_message)),"ValidationException" => CreateBGPPeerError::Validation(error_message.to_string()),_ => CreateBGPPeerError::Unknown(String::from(body))
                                }
                            },
...
Unknown(String)
                ...
                impl Error for CreateInterconnectError {
                    fn description(&self) -> &str {
                        match *self {
                            CreateInterconnectError::DirectConnectServer(ref cause) => cause,CreateInterconnectError::DirectConnectClient(ref cause) => cause,CreateInterconnectError::Validation(ref cause) => cause,CreateInterconnectError::Credentials(ref err) => err.description(),CreateInterconnectError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),CreateInterconnectError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> CreateLagError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "DirectConnectServerException" => CreateLagError::DirectConnectServer(String::from(error_message)),"DirectConnectClientException" => CreateLagError::DirectConnectClient(String::from(error_message)),"ValidationException" => CreateLagError::Validation(error_message.to_string()),_ => CreateLagError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for CreateLagError {
                    fn description(&self) -> &str {
                        match *self {
                            CreateLagError::DirectConnectServer(ref cause) => cause,CreateLagError::DirectConnectClient(ref cause) => cause,CreateLagError::Validation(ref cause) => cause,CreateLagError::Credentials(ref err) => err.description(),CreateLagError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),CreateLagError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl Error for DeleteBGPPeerError {
                    fn description(&self) -> &str {
                        match *self {
                            DeleteBGPPeerError::DirectConnectServer(ref cause) => cause,DeleteBGPPeerError::DirectConnectClient(ref cause) => cause,DeleteBGPPeerError::Validation(ref cause) => cause,DeleteBGPPeerError::Credentials(ref err) => err.description(),DeleteBGPPeerError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),DeleteBGPPeerError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl Error for DeleteConnectionError {
                    fn description(&self) -> &str {
                        match *self {
                            DeleteConnectionError::DirectConnectServer(ref cause) => cause,DeleteConnectionError::DirectConnectClient(ref cause) => cause,DeleteConnectionError::Validation(ref cause) => cause,DeleteConnectionError::Credentials(ref err) => err.description(),DeleteConnectionError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),DeleteConnectionError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> DeleteLagError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "DirectConnectServerException" => DeleteLagError::DirectConnectServer(String::from(error_message)),"DirectConnectClientException" => DeleteLagError::DirectConnectClient(String::from(error_message)),"ValidationException" => DeleteLagError::Validation(error_message.to_string()),_ => DeleteLagError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for DeleteLagError {
                    fn description(&self) -> &str {
                        match *self {
                            DeleteLagError::DirectConnectServer(ref cause) => cause,DeleteLagError::DirectConnectClient(ref cause) => cause,DeleteLagError::Validation(ref cause) => cause,DeleteLagError::Credentials(ref err) => err.description(),DeleteLagError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),DeleteLagError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> DeleteVirtualInterfaceError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "DirectConnectServerException" => DeleteVirtualInterfaceError::DirectConnectServer(String::from(error_message)),"DirectConnectClientException" => DeleteVirtualInterfaceError::DirectConnectClient(String::from(error_message)),"ValidationException" => DeleteVirtualInterfaceError::Validation(error_message.to_string()),_ => DeleteVirtualInterfaceError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for DeleteVirtualInterfaceError {
                    fn description(&self) -> &str {
                        match *self {
                            DeleteVirtualInterfaceError::DirectConnectServer(ref cause) => cause,DeleteVirtualInterfaceError::DirectConnectClient(ref cause) => cause,DeleteVirtualInterfaceError::Validation(ref cause) => cause,DeleteVirtualInterfaceError::Credentials(ref err) => err.description(),DeleteVirtualInterfaceError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),DeleteVirtualInterfaceError::Unknown(ref cause) => cause
                        }
                    }
                 }
                    ...
                    pub fn from_body(body: &str) -> DescribeConnectionLoaError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "DirectConnectServerException" => DescribeConnectionLoaError::DirectConnectServer(String::from(error_message)),"DirectConnectClientException" => DescribeConnectionLoaError::DirectConnectClient(String::from(error_message)),"ValidationException" => DescribeConnectionLoaError::Validation(error_message.to_string()),_ => DescribeConnectionLoaError::Unknown(String::from(body))
                                }
                            },
                    ...
                    pub fn from_body(body: &str) -> DescribeConnectionsError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "DirectConnectServerException" => DescribeConnectionsError::DirectConnectServer(String::from(error_message)),"DirectConnectClientException" => DescribeConnectionsError::DirectConnectClient(String::from(error_message)),"ValidationException" => DescribeConnectionsError::Validation(error_message.to_string()),_ => DescribeConnectionsError::Unknown(String::from(body))
                                }
                            },
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> DescribeHostedConnectionsError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "DirectConnectServerException" => DescribeHostedConnectionsError::DirectConnectServer(String::from(error_message)),"DirectConnectClientException" => DescribeHostedConnectionsError::DirectConnectClient(String::from(error_message)),"ValidationException" => DescribeHostedConnectionsError::Validation(error_message.to_string()),_ => DescribeHostedConnectionsError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for DescribeHostedConnectionsError {
                    fn description(&self) -> &str {
                        match *self {
                            DescribeHostedConnectionsError::DirectConnectServer(ref cause) => cause,DescribeHostedConnectionsError::DirectConnectClient(ref cause) => cause,DescribeHostedConnectionsError::Validation(ref cause) => cause,DescribeHostedConnectionsError::Credentials(ref err) => err.description(),DescribeHostedConnectionsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),DescribeHostedConnectionsError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl Error for DescribeInterconnectLoaError {
                    fn description(&self) -> &str {
                        match *self {
                            DescribeInterconnectLoaError::DirectConnectServer(ref cause) => cause,DescribeInterconnectLoaError::DirectConnectClient(ref cause) => cause,DescribeInterconnectLoaError::Validation(ref cause) => cause,DescribeInterconnectLoaError::Credentials(ref err) => err.description(),DescribeInterconnectLoaError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),DescribeInterconnectLoaError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> DescribeLagsError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "DirectConnectServerException" => DescribeLagsError::DirectConnectServer(String::from(error_message)),"DirectConnectClientException" => DescribeLagsError::DirectConnectClient(String::from(error_message)),"ValidationException" => DescribeLagsError::Validation(error_message.to_string()),_ => DescribeLagsError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for DescribeLagsError {
                    fn description(&self) -> &str {
                        match *self {
                            DescribeLagsError::DirectConnectServer(ref cause) => cause,DescribeLagsError::DirectConnectClient(ref cause) => cause,DescribeLagsError::Validation(ref cause) => cause,DescribeLagsError::Credentials(ref err) => err.description(),DescribeLagsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),DescribeLagsError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> DescribeLoaError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "DirectConnectServerException" => DescribeLoaError::DirectConnectServer(String::from(error_message)),"DirectConnectClientException" => DescribeLoaError::DirectConnectClient(String::from(error_message)),"ValidationException" => DescribeLoaError::Validation(error_message.to_string()),_ => DescribeLoaError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for DescribeLoaError {
                    fn description(&self) -> &str {
                        match *self {
                            DescribeLoaError::DirectConnectServer(ref cause) => cause,DescribeLoaError::DirectConnectClient(ref cause) => cause,DescribeLoaError::Validation(ref cause) => cause,DescribeLoaError::Credentials(ref err) => err.description(),DescribeLoaError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),DescribeLoaError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl Error for DescribeLocationsError {
                    fn description(&self) -> &str {
                        match *self {
                            DescribeLocationsError::DirectConnectServer(ref cause) => cause,DescribeLocationsError::DirectConnectClient(ref cause) => cause,DescribeLocationsError::Validation(ref cause) => cause,DescribeLocationsError::Credentials(ref err) => err.description(),DescribeLocationsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),DescribeLocationsError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> DescribeTagsError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "DirectConnectServerException" => DescribeTagsError::DirectConnectServer(String::from(error_message)),"DirectConnectClientException" => DescribeTagsError::DirectConnectClient(String::from(error_message)),"ValidationException" => DescribeTagsError::Validation(error_message.to_string()),_ => DescribeTagsError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for DescribeTagsError {
                    fn description(&self) -> &str {
                        match *self {
                            DescribeTagsError::DirectConnectServer(ref cause) => cause,DescribeTagsError::DirectConnectClient(ref cause) => cause,DescribeTagsError::Validation(ref cause) => cause,DescribeTagsError::Credentials(ref err) => err.description(),DescribeTagsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),DescribeTagsError::Unknown(ref cause) => cause
                        }
                    }
                 }
                    ...
                    pub fn from_body(body: &str) -> DescribeVirtualGatewaysError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "DirectConnectServerException" => DescribeVirtualGatewaysError::DirectConnectServer(String::from(error_message)),"DirectConnectClientException" => DescribeVirtualGatewaysError::DirectConnectClient(String::from(error_message)),"ValidationException" => DescribeVirtualGatewaysError::Validation(error_message.to_string()),_ => DescribeVirtualGatewaysError::Unknown(String::from(body))
                                }
                            },
                    ...
                    pub fn from_body(body: &str) -> DescribeVirtualInterfacesError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "DirectConnectServerException" => DescribeVirtualInterfacesError::DirectConnectServer(String::from(error_message)),"DirectConnectClientException" => DescribeVirtualInterfacesError::DirectConnectClient(String::from(error_message)),"ValidationException" => DescribeVirtualInterfacesError::Validation(error_message.to_string()),_ => DescribeVirtualInterfacesError::Unknown(String::from(body))
                                }
                            },
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> DisassociateConnectionFromLagError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "DirectConnectServerException" => DisassociateConnectionFromLagError::DirectConnectServer(String::from(error_message)),"DirectConnectClientException" => DisassociateConnectionFromLagError::DirectConnectClient(String::from(error_message)),"ValidationException" => DisassociateConnectionFromLagError::Validation(error_message.to_string()),_ => DisassociateConnectionFromLagError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for DisassociateConnectionFromLagError {
                    fn description(&self) -> &str {
                        match *self {
                            DisassociateConnectionFromLagError::DirectConnectServer(ref cause) => cause,DisassociateConnectionFromLagError::DirectConnectClient(ref cause) => cause,DisassociateConnectionFromLagError::Validation(ref cause) => cause,DisassociateConnectionFromLagError::Credentials(ref err) => err.description(),DisassociateConnectionFromLagError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),DisassociateConnectionFromLagError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> TagResourceError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "DuplicateTagKeysException" => TagResourceError::DuplicateTagKeys(String::from(error_message)),"TooManyTagsException" => TagResourceError::TooManyTags(String::from(error_message)),"DirectConnectServerException" => TagResourceError::DirectConnectServer(String::from(error_message)),"DirectConnectClientException" => TagResourceError::DirectConnectClient(String::from(error_message)),"ValidationException" => TagResourceError::Validation(error_message.to_string()),_ => TagResourceError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for TagResourceError {
                    fn description(&self) -> &str {
                        match *self {
                            TagResourceError::DuplicateTagKeys(ref cause) => cause,TagResourceError::TooManyTags(ref cause) => cause,TagResourceError::DirectConnectServer(ref cause) => cause,TagResourceError::DirectConnectClient(ref cause) => cause,TagResourceError::Validation(ref cause) => cause,TagResourceError::Credentials(ref err) => err.description(),TagResourceError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),TagResourceError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> UpdateLagError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "DirectConnectServerException" => UpdateLagError::DirectConnectServer(String::from(error_message)),"DirectConnectClientException" => UpdateLagError::DirectConnectClient(String::from(error_message)),"ValidationException" => UpdateLagError::Validation(error_message.to_string()),_ => UpdateLagError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for UpdateLagError {
                    fn description(&self) -> &str {
                        match *self {
                            UpdateLagError::DirectConnectServer(ref cause) => cause,UpdateLagError::DirectConnectClient(ref cause) => cause,UpdateLagError::Validation(ref cause) => cause,UpdateLagError::Credentials(ref err) => err.description(),UpdateLagError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),UpdateLagError::Unknown(ref cause) => cause
                        }
                    }
                 }
/// A client for the AWS Direct Connect API.
        ...
        impl<P, D> DirectConnectClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
            pub fn new(request_dispatcher: D, credentials_provider: P, region: region::Region) -> Self {
                ...
                pub fn allocate_connection_on_interconnect(&self, input: &AllocateConnectionOnInterconnectRequest)  -> Result<Connection, AllocateConnectionOnInterconnectError> {
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn allocate_hosted_connection(&self, input: &AllocateHostedConnectionRequest)  -> Result<Connection, AllocateHostedConnectionError> {
                    let mut request = SignedRequest::new("POST", "directconnect", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn allocate_private_virtual_interface(&self, input: &AllocatePrivateVirtualInterfaceRequest)  -> Result<VirtualInterface, AllocatePrivateVirtualInterfaceError> {
                    let mut request = SignedRequest::new("POST", "directconnect", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn allocate_public_virtual_interface(&self, input: &AllocatePublicVirtualInterfaceRequest)  -> Result<VirtualInterface, AllocatePublicVirtualInterfaceError> {
                    let mut request = SignedRequest::new("POST", "directconnect", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn associate_connection_with_lag(&self, input: &AssociateConnectionWithLagRequest)  -> Result<Connection, AssociateConnectionWithLagError> {
                    let mut request = SignedRequest::new("POST", "directconnect", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn associate_hosted_connection(&self, input: &AssociateHostedConnectionRequest)  -> Result<Connection, AssociateHostedConnectionError> {
                    let mut request = SignedRequest::new("POST", "directconnect", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn associate_virtual_interface(&self, input: &AssociateVirtualInterfaceRequest)  -> Result<VirtualInterface, AssociateVirtualInterfaceError> {
                    let mut request = SignedRequest::new("POST", "directconnect", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn confirm_connection(&self, input: &ConfirmConnectionRequest)  -> Result<ConfirmConnectionResponse, ConfirmConnectionError> {
                    let mut request = SignedRequest::new("POST", "directconnect", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn confirm_private_virtual_interface(&self, input: &ConfirmPrivateVirtualInterfaceRequest)  -> Result<ConfirmPrivateVirtualInterfaceResponse, ConfirmPrivateVirtualInterfaceError> {
                    let mut request = SignedRequest::new("POST", "directconnect", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn confirm_public_virtual_interface(&self, input: &ConfirmPublicVirtualInterfaceRequest)  -> Result<ConfirmPublicVirtualInterfaceResponse, ConfirmPublicVirtualInterfaceError> {
                    let mut request = SignedRequest::new("POST", "directconnect", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn create_bgp_peer(&self, input: &CreateBGPPeerRequest)  -> Result<CreateBGPPeerResponse, CreateBGPPeerError> {
                    let mut request = SignedRequest::new("POST", "directconnect", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn create_connection(&self, input: &CreateConnectionRequest)  -> Result<Connection, CreateConnectionError> {
                    let mut request = SignedRequest::new("POST", "directconnect", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn create_interconnect(&self, input: &CreateInterconnectRequest)  -> Result<Interconnect, CreateInterconnectError> {
                    let mut request = SignedRequest::new("POST", "directconnect", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn create_lag(&self, input: &CreateLagRequest)  -> Result<Lag, CreateLagError> {
                    let mut request = SignedRequest::new("POST", "directconnect", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    match response.status {
                        StatusCode::Ok => {
                            Ok(serde_json::from_str::<Lag>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                        }
                ...
                pub fn create_private_virtual_interface(&self, input: &CreatePrivateVirtualInterfaceRequest)  -> Result<VirtualInterface, CreatePrivateVirtualInterfaceError> {
                    let mut request = SignedRequest::new("POST", "directconnect", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn create_public_virtual_interface(&self, input: &CreatePublicVirtualInterfaceRequest)  -> Result<VirtualInterface, CreatePublicVirtualInterfaceError> {
                    let mut request = SignedRequest::new("POST", "directconnect", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn delete_bgp_peer(&self, input: &DeleteBGPPeerRequest)  -> Result<DeleteBGPPeerResponse, DeleteBGPPeerError> {
                    let mut request = SignedRequest::new("POST", "directconnect", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn delete_connection(&self, input: &DeleteConnectionRequest)  -> Result<Connection, DeleteConnectionError> {
                    let mut request = SignedRequest::new("POST", "directconnect", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn delete_interconnect(&self, input: &DeleteInterconnectRequest)  -> Result<DeleteInterconnectResponse, DeleteInterconnectError> {
                    let mut request = SignedRequest::new("POST", "directconnect", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn delete_lag(&self, input: &DeleteLagRequest)  -> Result<Lag, DeleteLagError> {
                    let mut request = SignedRequest::new("POST", "directconnect", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn delete_virtual_interface(&self, input: &DeleteVirtualInterfaceRequest)  -> Result<DeleteVirtualInterfaceResponse, DeleteVirtualInterfaceError> {
                    let mut request = SignedRequest::new("POST", "directconnect", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn describe_connection_loa(&self, input: &DescribeConnectionLoaRequest)  -> Result<DescribeConnectionLoaResponse, DescribeConnectionLoaError> {
                    let mut request = SignedRequest::new("POST", "directconnect", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn describe_connections(&self, input: &DescribeConnectionsRequest)  -> Result<Connections, DescribeConnectionsError> {
                    let mut request = SignedRequest::new("POST", "directconnect", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn describe_connections_on_interconnect(&self, input: &DescribeConnectionsOnInterconnectRequest)  -> Result<Connections, DescribeConnectionsOnInterconnectError> {
                    let mut request = SignedRequest::new("POST", "directconnect", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn describe_hosted_connections(&self, input: &DescribeHostedConnectionsRequest)  -> Result<Connections, DescribeHostedConnectionsError> {
                    let mut request = SignedRequest::new("POST", "directconnect", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn describe_interconnect_loa(&self, input: &DescribeInterconnectLoaRequest)  -> Result<DescribeInterconnectLoaResponse, DescribeInterconnectLoaError> {
                    let mut request = SignedRequest::new("POST", "directconnect", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn describe_interconnects(&self, input: &DescribeInterconnectsRequest)  -> Result<Interconnects, DescribeInterconnectsError> {
                    let mut request = SignedRequest::new("POST", "directconnect", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn describe_lags(&self, input: &DescribeLagsRequest)  -> Result<Lags, DescribeLagsError> {
                    let mut request = SignedRequest::new("POST", "directconnect", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    match response.status {
                        StatusCode::Ok => {
                            Ok(serde_json::from_str::<Lags>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                        }
                        _ => Err(DescribeLagsError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                    }
                }
                ...
                pub fn describe_loa(&self, input: &DescribeLoaRequest)  -> Result<Loa, DescribeLoaError> {
                    let mut request = SignedRequest::new("POST", "directconnect", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    match response.status {
                        StatusCode::Ok => {
                            Ok(serde_json::from_str::<Loa>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                        }
                ...
                pub fn describe_locations(&self)  -> Result<Locations, DescribeLocationsError> {
                    let mut request = SignedRequest::new("POST", "directconnect", self.region, "/");
                ...
                pub fn describe_tags(&self, input: &DescribeTagsRequest)  -> Result<DescribeTagsResponse, DescribeTagsError> {
                    let mut request = SignedRequest::new("POST", "directconnect", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn describe_virtual_gateways(&self)  -> Result<VirtualGateways, DescribeVirtualGatewaysError> {
                    let mut request = SignedRequest::new("POST", "directconnect", self.region, "/");
                ...
                pub fn describe_virtual_interfaces(&self, input: &DescribeVirtualInterfacesRequest)  -> Result<VirtualInterfaces, DescribeVirtualInterfacesError> {
                    let mut request = SignedRequest::new("POST", "directconnect", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn disassociate_connection_from_lag(&self, input: &DisassociateConnectionFromLagRequest)  -> Result<Connection, DisassociateConnectionFromLagError> {
                    let mut request = SignedRequest::new("POST", "directconnect", self.region, "/");
                    
                    request.set_content_type("application/x-amz-json-1.1".to_owned());
                    request.add_header("x-amz-target", "OvertureService.DisassociateConnectionFromLag");
                    let encoded = serde_json::to_string(input).unwrap();
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn tag_resource(&self, input: &TagResourceRequest)  -> Result<TagResourceResponse, TagResourceError> {
                    let mut request = SignedRequest::new("POST", "directconnect", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn untag_resource(&self, input: &UntagResourceRequest)  -> Result<UntagResourceResponse, UntagResourceError> {
                    let mut request = SignedRequest::new("POST", "directconnect", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn update_lag(&self, input: &UpdateLagRequest)  -> Result<Lag, UpdateLagError> {
                    let mut request = SignedRequest::new("POST", "directconnect", self.region, "/");
