...
Unknown(String)
                ...
                impl Error for AssumeRoleError {
                    fn description(&self) -> &str {
                        match *self {
                            AssumeRoleError::MalformedPolicyDocument(ref cause) => cause,AssumeRoleError::PackedPolicyTooLarge(ref cause) => cause,AssumeRoleError::RegionDisabled(ref cause) => cause,AssumeRoleError::Validation(ref cause) => cause,AssumeRoleError::Credentials(ref err) => err.description(),AssumeRoleError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),AssumeRoleError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl Error for GetFederationTokenError {
                    fn description(&self) -> &str {
                        match *self {
                            GetFederationTokenError::MalformedPolicyDocument(ref cause) => cause,GetFederationTokenError::PackedPolicyTooLarge(ref cause) => cause,GetFederationTokenError::RegionDisabled(ref cause) => cause,GetFederationTokenError::Validation(ref cause) => cause,GetFederationTokenError::Credentials(ref err) => err.description(),GetFederationTokenError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),GetFederationTokenError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
/// A client for the AWS STS API.
        ...
        impl<P, D> StsClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
            pub fn new(request_dispatcher: D, credentials_provider: P, region: region::Region) -> Self {
                ...
                pub fn assume_role(&self, input: &AssumeRoleRequest) -> Result<AssumeRoleResponse, AssumeRoleError> {
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn assume_role_with_saml(&self, input: &AssumeRoleWithSAMLRequest) -> Result<AssumeRoleWithSAMLResponse, AssumeRoleWithSAMLError> {
                    let mut request = SignedRequest::new("POST", "sts", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn assume_role_with_web_identity(&self, input: &AssumeRoleWithWebIdentityRequest) -> Result<AssumeRoleWithWebIdentityResponse, AssumeRoleWithWebIdentityError> {
                    let mut request = SignedRequest::new("POST", "sts", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn decode_authorization_message(&self, input: &DecodeAuthorizationMessageRequest) -> Result<DecodeAuthorizationMessageResponse, DecodeAuthorizationMessageError> {
                    let mut request = SignedRequest::new("POST", "sts", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn get_caller_identity(&self, input: &GetCallerIdentityRequest) -> Result<GetCallerIdentityResponse, GetCallerIdentityError> {
                    let mut request = SignedRequest::new("POST", "sts", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn get_federation_token(&self, input: &GetFederationTokenRequest) -> Result<GetFederationTokenResponse, GetFederationTokenError> {
                    let mut request = SignedRequest::new("POST", "sts", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn get_session_token(&self, input: &GetSessionTokenRequest) -> Result<GetSessionTokenResponse, GetSessionTokenError> {
                    let mut request = SignedRequest::new("POST", "sts", self.region, "/");
                    let mut params = Params::new();
