...
Unknown(String)
                ...
                impl Error for CreateChangeSetError {
                    fn description(&self) -> &str {
                        match *self {
                            CreateChangeSetError::AlreadyExists(ref cause) => cause,CreateChangeSetError::InsufficientCapabilities(ref cause) => cause,CreateChangeSetError::LimitExceeded(ref cause) => cause,CreateChangeSetError::Validation(ref cause) => cause,CreateChangeSetError::Credentials(ref err) => err.description(),CreateChangeSetError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),CreateChangeSetError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
/// A client for the AWS CloudFormation API.
        ...
        impl<P, D> CloudFormationClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
            pub fn new(request_dispatcher: D, credentials_provider: P, region: region::Region) -> Self {
                ...
                pub fn cancel_update_stack(&self, input: &CancelUpdateStackInput) -> Result<(), CancelUpdateStackError> {
                ...
                pub fn continue_update_rollback(&self, input: &ContinueUpdateRollbackInput) -> Result<ContinueUpdateRollbackOutput, ContinueUpdateRollbackError> {
                    let mut request = SignedRequest::new("POST", "cloudformation", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn create_change_set(&self, input: &CreateChangeSetInput) -> Result<CreateChangeSetOutput, CreateChangeSetError> {
                    let mut request = SignedRequest::new("POST", "cloudformation", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn create_stack(&self, input: &CreateStackInput) -> Result<CreateStackOutput, CreateStackError> {
                    let mut request = SignedRequest::new("POST", "cloudformation", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn delete_change_set(&self, input: &DeleteChangeSetInput) -> Result<DeleteChangeSetOutput, DeleteChangeSetError> {
                    let mut request = SignedRequest::new("POST", "cloudformation", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn delete_stack(&self, input: &DeleteStackInput) -> Result<(), DeleteStackError> {
                    let mut request = SignedRequest::new("POST", "cloudformation", self.region, "/");
                    let mut params = Params::new();
                ...
                pub fn describe_account_limits(&self, input: &DescribeAccountLimitsInput) -> Result<DescribeAccountLimitsOutput, DescribeAccountLimitsError> {
                    let mut request = SignedRequest::new("POST", "cloudformation", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn describe_change_set(&self, input: &DescribeChangeSetInput) -> Result<DescribeChangeSetOutput, DescribeChangeSetError> {
                    let mut request = SignedRequest::new("POST", "cloudformation", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn describe_stack_events(&self, input: &DescribeStackEventsInput) -> Result<DescribeStackEventsOutput, DescribeStackEventsError> {
                    let mut request = SignedRequest::new("POST", "cloudformation", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn describe_stack_resource(&self, input: &DescribeStackResourceInput) -> Result<DescribeStackResourceOutput, DescribeStackResourceError> {
                    let mut request = SignedRequest::new("POST", "cloudformation", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn describe_stack_resources(&self, input: &DescribeStackResourcesInput) -> Result<DescribeStackResourcesOutput, DescribeStackResourcesError> {
                    let mut request = SignedRequest::new("POST", "cloudformation", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn describe_stacks(&self, input: &DescribeStacksInput) -> Result<DescribeStacksOutput, DescribeStacksError> {
                    let mut request = SignedRequest::new("POST", "cloudformation", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn estimate_template_cost(&self, input: &EstimateTemplateCostInput) -> Result<EstimateTemplateCostOutput, EstimateTemplateCostError> {
                    let mut request = SignedRequest::new("POST", "cloudformation", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn execute_change_set(&self, input: &ExecuteChangeSetInput) -> Result<ExecuteChangeSetOutput, ExecuteChangeSetError> {
                    let mut request = SignedRequest::new("POST", "cloudformation", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn get_stack_policy(&self, input: &GetStackPolicyInput) -> Result<GetStackPolicyOutput, GetStackPolicyError> {
                    let mut request = SignedRequest::new("POST", "cloudformation", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn get_template(&self, input: &GetTemplateInput) -> Result<GetTemplateOutput, GetTemplateError> {
                    let mut request = SignedRequest::new("POST", "cloudformation", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn get_template_summary(&self, input: &GetTemplateSummaryInput) -> Result<GetTemplateSummaryOutput, GetTemplateSummaryError> {
                    let mut request = SignedRequest::new("POST", "cloudformation", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn list_change_sets(&self, input: &ListChangeSetsInput) -> Result<ListChangeSetsOutput, ListChangeSetsError> {
                    let mut request = SignedRequest::new("POST", "cloudformation", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn list_exports(&self, input: &ListExportsInput) -> Result<ListExportsOutput, ListExportsError> {
                    let mut request = SignedRequest::new("POST", "cloudformation", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn list_imports(&self, input: &ListImportsInput) -> Result<ListImportsOutput, ListImportsError> {
                    let mut request = SignedRequest::new("POST", "cloudformation", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn list_stack_resources(&self, input: &ListStackResourcesInput) -> Result<ListStackResourcesOutput, ListStackResourcesError> {
                    let mut request = SignedRequest::new("POST", "cloudformation", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn list_stacks(&self, input: &ListStacksInput) -> Result<ListStacksOutput, ListStacksError> {
                    let mut request = SignedRequest::new("POST", "cloudformation", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn set_stack_policy(&self, input: &SetStackPolicyInput) -> Result<(), SetStackPolicyError> {
                    let mut request = SignedRequest::new("POST", "cloudformation", self.region, "/");
                    let mut params = Params::new();
                ...
                pub fn signal_resource(&self, input: &SignalResourceInput) -> Result<(), SignalResourceError> {
                    let mut request = SignedRequest::new("POST", "cloudformation", self.region, "/");
                    let mut params = Params::new();
                ...
                pub fn update_stack(&self, input: &UpdateStackInput) -> Result<UpdateStackOutput, UpdateStackError> {
                    let mut request = SignedRequest::new("POST", "cloudformation", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn validate_template(&self, input: &ValidateTemplateInput) -> Result<ValidateTemplateOutput, ValidateTemplateError> {
                    let mut request = SignedRequest::new("POST", "cloudformation", self.region, "/");
                    let mut params = Params::new();
