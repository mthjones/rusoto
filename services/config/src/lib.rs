                    ...
                    pub fn from_body(body: &str) -> DeleteConfigRuleError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "NoSuchConfigRuleException" => DeleteConfigRuleError::NoSuchConfigRule(String::from(error_message)),"ResourceInUseException" => DeleteConfigRuleError::ResourceInUse(String::from(error_message)),"ValidationException" => DeleteConfigRuleError::Validation(error_message.to_string()),_ => DeleteConfigRuleError::Unknown(String::from(body))
                                }
                            },
...
Unknown(String)
                ...
                impl Error for DeleteEvaluationResultsError {
                    fn description(&self) -> &str {
                        match *self {
                            DeleteEvaluationResultsError::NoSuchConfigRule(ref cause) => cause,DeleteEvaluationResultsError::ResourceInUse(ref cause) => cause,DeleteEvaluationResultsError::Validation(ref cause) => cause,DeleteEvaluationResultsError::Credentials(ref err) => err.description(),DeleteEvaluationResultsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),DeleteEvaluationResultsError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> DescribeComplianceByConfigRuleError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InvalidParameterValueException" => DescribeComplianceByConfigRuleError::InvalidParameterValue(String::from(error_message)),"NoSuchConfigRuleException" => DescribeComplianceByConfigRuleError::NoSuchConfigRule(String::from(error_message)),"InvalidNextTokenException" => DescribeComplianceByConfigRuleError::InvalidNextToken(String::from(error_message)),"ValidationException" => DescribeComplianceByConfigRuleError::Validation(error_message.to_string()),_ => DescribeComplianceByConfigRuleError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for DescribeComplianceByConfigRuleError {
                    fn description(&self) -> &str {
                        match *self {
                            DescribeComplianceByConfigRuleError::InvalidParameterValue(ref cause) => cause,DescribeComplianceByConfigRuleError::NoSuchConfigRule(ref cause) => cause,DescribeComplianceByConfigRuleError::InvalidNextToken(ref cause) => cause,DescribeComplianceByConfigRuleError::Validation(ref cause) => cause,DescribeComplianceByConfigRuleError::Credentials(ref err) => err.description(),DescribeComplianceByConfigRuleError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),DescribeComplianceByConfigRuleError::Unknown(ref cause) => cause
                        }
                    }
                 }
                    ...
                    pub fn from_body(body: &str) -> DescribeConfigRulesError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "NoSuchConfigRuleException" => DescribeConfigRulesError::NoSuchConfigRule(String::from(error_message)),"InvalidNextTokenException" => DescribeConfigRulesError::InvalidNextToken(String::from(error_message)),"ValidationException" => DescribeConfigRulesError::Validation(error_message.to_string()),_ => DescribeConfigRulesError::Unknown(String::from(body))
                                }
                            },
...
Unknown(String)
                ...
                impl Error for ListDiscoveredResourcesError {
                    fn description(&self) -> &str {
                        match *self {
                            ListDiscoveredResourcesError::InvalidLimit(ref cause) => cause,ListDiscoveredResourcesError::InvalidNextToken(ref cause) => cause,ListDiscoveredResourcesError::NoAvailableConfigurationRecorder(ref cause) => cause,ListDiscoveredResourcesError::Validation(ref cause) => cause,ListDiscoveredResourcesError::Credentials(ref err) => err.description(),ListDiscoveredResourcesError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),ListDiscoveredResourcesError::Unknown(ref cause) => cause
                        }
                    }
                 }
                    ...
                    pub fn from_body(body: &str) -> PutEvaluationsError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InvalidParameterValueException" => PutEvaluationsError::InvalidParameterValue(String::from(error_message)),"InvalidResultTokenException" => PutEvaluationsError::InvalidResultToken(String::from(error_message)),"NoSuchConfigRuleException" => PutEvaluationsError::NoSuchConfigRule(String::from(error_message)),"ValidationException" => PutEvaluationsError::Validation(error_message.to_string()),_ => PutEvaluationsError::Unknown(String::from(body))
                                }
                            },
...
/// A client for the Config Service API.
        ...
        impl<P, D> ConfigServiceClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
            pub fn new(request_dispatcher: D, credentials_provider: P, region: region::Region) -> Self {
                ...
                pub fn delete_config_rule(&self, input: &DeleteConfigRuleRequest)  -> Result<(), DeleteConfigRuleError> {
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn delete_configuration_recorder(&self, input: &DeleteConfigurationRecorderRequest)  -> Result<(), DeleteConfigurationRecorderError> {
                    let mut request = SignedRequest::new("POST", "config", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn delete_delivery_channel(&self, input: &DeleteDeliveryChannelRequest)  -> Result<(), DeleteDeliveryChannelError> {
                    let mut request = SignedRequest::new("POST", "config", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn delete_evaluation_results(&self, input: &DeleteEvaluationResultsRequest)  -> Result<DeleteEvaluationResultsResponse, DeleteEvaluationResultsError> {
                    let mut request = SignedRequest::new("POST", "config", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn deliver_config_snapshot(&self, input: &DeliverConfigSnapshotRequest)  -> Result<DeliverConfigSnapshotResponse, DeliverConfigSnapshotError> {
                    let mut request = SignedRequest::new("POST", "config", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn describe_compliance_by_config_rule(&self, input: &DescribeComplianceByConfigRuleRequest)  -> Result<DescribeComplianceByConfigRuleResponse, DescribeComplianceByConfigRuleError> {
                    let mut request = SignedRequest::new("POST", "config", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn describe_compliance_by_resource(&self, input: &DescribeComplianceByResourceRequest)  -> Result<DescribeComplianceByResourceResponse, DescribeComplianceByResourceError> {
                    let mut request = SignedRequest::new("POST", "config", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn describe_config_rule_evaluation_status(&self, input: &DescribeConfigRuleEvaluationStatusRequest)  -> Result<DescribeConfigRuleEvaluationStatusResponse, DescribeConfigRuleEvaluationStatusError> {
                    let mut request = SignedRequest::new("POST", "config", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn describe_config_rules(&self, input: &DescribeConfigRulesRequest)  -> Result<DescribeConfigRulesResponse, DescribeConfigRulesError> {
                    let mut request = SignedRequest::new("POST", "config", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn describe_configuration_recorder_status(&self, input: &DescribeConfigurationRecorderStatusRequest)  -> Result<DescribeConfigurationRecorderStatusResponse, DescribeConfigurationRecorderStatusError> {
                    let mut request = SignedRequest::new("POST", "config", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn describe_configuration_recorders(&self, input: &DescribeConfigurationRecordersRequest)  -> Result<DescribeConfigurationRecordersResponse, DescribeConfigurationRecordersError> {
                    let mut request = SignedRequest::new("POST", "config", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn describe_delivery_channel_status(&self, input: &DescribeDeliveryChannelStatusRequest)  -> Result<DescribeDeliveryChannelStatusResponse, DescribeDeliveryChannelStatusError> {
                    let mut request = SignedRequest::new("POST", "config", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn describe_delivery_channels(&self, input: &DescribeDeliveryChannelsRequest)  -> Result<DescribeDeliveryChannelsResponse, DescribeDeliveryChannelsError> {
                    let mut request = SignedRequest::new("POST", "config", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn get_compliance_details_by_config_rule(&self, input: &GetComplianceDetailsByConfigRuleRequest)  -> Result<GetComplianceDetailsByConfigRuleResponse, GetComplianceDetailsByConfigRuleError> {
                    let mut request = SignedRequest::new("POST", "config", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn get_compliance_details_by_resource(&self, input: &GetComplianceDetailsByResourceRequest)  -> Result<GetComplianceDetailsByResourceResponse, GetComplianceDetailsByResourceError> {
                    let mut request = SignedRequest::new("POST", "config", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn get_compliance_summary_by_config_rule(&self)  -> Result<GetComplianceSummaryByConfigRuleResponse, GetComplianceSummaryByConfigRuleError> {
                    let mut request = SignedRequest::new("POST", "config", self.region, "/");
                ...
                pub fn get_compliance_summary_by_resource_type(&self, input: &GetComplianceSummaryByResourceTypeRequest)  -> Result<GetComplianceSummaryByResourceTypeResponse, GetComplianceSummaryByResourceTypeError> {
                    let mut request = SignedRequest::new("POST", "config", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn get_resource_config_history(&self, input: &GetResourceConfigHistoryRequest)  -> Result<GetResourceConfigHistoryResponse, GetResourceConfigHistoryError> {
                    let mut request = SignedRequest::new("POST", "config", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn list_discovered_resources(&self, input: &ListDiscoveredResourcesRequest)  -> Result<ListDiscoveredResourcesResponse, ListDiscoveredResourcesError> {
                    let mut request = SignedRequest::new("POST", "config", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn put_config_rule(&self, input: &PutConfigRuleRequest)  -> Result<(), PutConfigRuleError> {
                    let mut request = SignedRequest::new("POST", "config", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn put_configuration_recorder(&self, input: &PutConfigurationRecorderRequest)  -> Result<(), PutConfigurationRecorderError> {
                    let mut request = SignedRequest::new("POST", "config", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn put_delivery_channel(&self, input: &PutDeliveryChannelRequest)  -> Result<(), PutDeliveryChannelError> {
                    let mut request = SignedRequest::new("POST", "config", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn put_evaluations(&self, input: &PutEvaluationsRequest)  -> Result<PutEvaluationsResponse, PutEvaluationsError> {
                    let mut request = SignedRequest::new("POST", "config", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn start_config_rules_evaluation(&self, input: &StartConfigRulesEvaluationRequest)  -> Result<StartConfigRulesEvaluationResponse, StartConfigRulesEvaluationError> {
                    let mut request = SignedRequest::new("POST", "config", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn start_configuration_recorder(&self, input: &StartConfigurationRecorderRequest)  -> Result<(), StartConfigurationRecorderError> {
                    let mut request = SignedRequest::new("POST", "config", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn stop_configuration_recorder(&self, input: &StopConfigurationRecorderRequest)  -> Result<(), StopConfigurationRecorderError> {
                    let mut request = SignedRequest::new("POST", "config", self.region, "/");
