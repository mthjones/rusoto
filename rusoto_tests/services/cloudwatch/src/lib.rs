...
/// A client for the CloudWatch API.
        ...
        impl<P, D> CloudWatchClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
            pub fn new(request_dispatcher: D, credentials_provider: P, region: region::Region) -> Self {
                ...
                pub fn delete_alarms(&self, input: &DeleteAlarmsInput) -> Result<(), DeleteAlarmsError> {
                ...
                pub fn describe_alarm_history(&self, input: &DescribeAlarmHistoryInput) -> Result<DescribeAlarmHistoryOutput, DescribeAlarmHistoryError> {
                    let mut request = SignedRequest::new("POST", "monitoring", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn describe_alarms(&self, input: &DescribeAlarmsInput) -> Result<DescribeAlarmsOutput, DescribeAlarmsError> {
                    let mut request = SignedRequest::new("POST", "monitoring", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn describe_alarms_for_metric(&self, input: &DescribeAlarmsForMetricInput) -> Result<DescribeAlarmsForMetricOutput, DescribeAlarmsForMetricError> {
                    let mut request = SignedRequest::new("POST", "monitoring", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn disable_alarm_actions(&self, input: &DisableAlarmActionsInput) -> Result<(), DisableAlarmActionsError> {
                    let mut request = SignedRequest::new("POST", "monitoring", self.region, "/");
                    let mut params = Params::new();
                ...
                pub fn enable_alarm_actions(&self, input: &EnableAlarmActionsInput) -> Result<(), EnableAlarmActionsError> {
                    let mut request = SignedRequest::new("POST", "monitoring", self.region, "/");
                    let mut params = Params::new();
                ...
                pub fn get_metric_statistics(&self, input: &GetMetricStatisticsInput) -> Result<GetMetricStatisticsOutput, GetMetricStatisticsError> {
                    let mut request = SignedRequest::new("POST", "monitoring", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn list_metrics(&self, input: &ListMetricsInput) -> Result<ListMetricsOutput, ListMetricsError> {
                    let mut request = SignedRequest::new("POST", "monitoring", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn put_metric_alarm(&self, input: &PutMetricAlarmInput) -> Result<(), PutMetricAlarmError> {
                    let mut request = SignedRequest::new("POST", "monitoring", self.region, "/");
                    let mut params = Params::new();
                ...
                pub fn put_metric_data(&self, input: &PutMetricDataInput) -> Result<(), PutMetricDataError> {
                    let mut request = SignedRequest::new("POST", "monitoring", self.region, "/");
                    let mut params = Params::new();
                ...
                pub fn set_alarm_state(&self, input: &SetAlarmStateInput) -> Result<(), SetAlarmStateError> {
                    let mut request = SignedRequest::new("POST", "monitoring", self.region, "/");
                    let mut params = Params::new();
        ...
        fn test_parse_cloudwatch_describe_alarm_history() {
            let mock_response =  MockResponseReader::read_response("test_resources", "cloudwatch-describe-alarm-history.xml");
        ...
        fn test_parse_cloudwatch_describe_alarms() {
            let mock_response =  MockResponseReader::read_response("test_resources", "cloudwatch-describe-alarms.xml");
            let mock = MockRequestDispatcher::with_status(200).with_body(&mock_response);
            let client = CloudWatchClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
        ...
        fn test_parse_cloudwatch_list_metrics() {
            let mock_response =  MockResponseReader::read_response("test_resources", "cloudwatch-list-metrics.xml");
            let mock = MockRequestDispatcher::with_status(200).with_body(&mock_response);
            let client = CloudWatchClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
