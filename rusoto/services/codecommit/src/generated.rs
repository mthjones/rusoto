...
MaximumRepositoryNamesExceeded(String),/// An error occurred dispatching the HTTP request
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> BatchGetRepositoriesError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "EncryptionKeyDisabledException" => BatchGetRepositoriesError::EncryptionKeyDisabled(String::from(error_message)),"EncryptionKeyUnavailableException" => BatchGetRepositoriesError::EncryptionKeyUnavailable(String::from(error_message)),"EncryptionKeyNotFoundException" => BatchGetRepositoriesError::EncryptionKeyNotFound(String::from(error_message)),"EncryptionIntegrityChecksFailedException" => BatchGetRepositoriesError::EncryptionIntegrityChecksFailed(String::from(error_message)),"RepositoryNamesRequiredException" => BatchGetRepositoriesError::RepositoryNamesRequired(String::from(error_message)),"EncryptionKeyAccessDeniedException" => BatchGetRepositoriesError::EncryptionKeyAccessDenied(String::from(error_message)),"InvalidRepositoryNameException" => BatchGetRepositoriesError::InvalidRepositoryName(String::from(error_message)),"MaximumRepositoryNamesExceededException" => BatchGetRepositoriesError::MaximumRepositoryNamesExceeded(String::from(error_message)),"ValidationException" => BatchGetRepositoriesError::Validation(error_message.to_string()),_ => BatchGetRepositoriesError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for BatchGetRepositoriesError {
                    fn description(&self) -> &str {
                        match *self {
                            BatchGetRepositoriesError::InvalidRepositoryName(ref cause) => cause,BatchGetRepositoriesError::EncryptionKeyAccessDenied(ref cause) => cause,BatchGetRepositoriesError::MaximumRepositoryNamesExceeded(ref cause) => cause,BatchGetRepositoriesError::EncryptionKeyUnavailable(ref cause) => cause,BatchGetRepositoriesError::EncryptionKeyNotFound(ref cause) => cause,BatchGetRepositoriesError::RepositoryNamesRequired(ref cause) => cause,BatchGetRepositoriesError::EncryptionKeyDisabled(ref cause) => cause,BatchGetRepositoriesError::EncryptionIntegrityChecksFailed(ref cause) => cause,BatchGetRepositoriesError::Validation(ref cause) => cause,BatchGetRepositoriesError::Credentials(ref err) => err.description(),BatchGetRepositoriesError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),BatchGetRepositoriesError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
BranchNameRequired(String),/// An error occurred dispatching the HTTP request
HttpDispatch(HttpDispatchError),/// An error was encountered with AWS credentials.
Credentials(CredentialsError),/// A validation error occurred.  Details from AWS are provided.
Validation(String),/// An unknown error occurred.  The raw HTTP response is provided.
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> CreateBranchError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "EncryptionKeyDisabledException" => CreateBranchError::EncryptionKeyDisabled(String::from(error_message)),"EncryptionKeyAccessDeniedException" => CreateBranchError::EncryptionKeyAccessDenied(String::from(error_message)),"BranchNameRequiredException" => CreateBranchError::BranchNameRequired(String::from(error_message)),"EncryptionKeyUnavailableException" => CreateBranchError::EncryptionKeyUnavailable(String::from(error_message)),"RepositoryDoesNotExistException" => CreateBranchError::RepositoryDoesNotExist(String::from(error_message)),"InvalidRepositoryNameException" => CreateBranchError::InvalidRepositoryName(String::from(error_message)),"CommitIdRequiredException" => CreateBranchError::CommitIdRequired(String::from(error_message)),"EncryptionKeyNotFoundException" => CreateBranchError::EncryptionKeyNotFound(String::from(error_message)),"InvalidBranchNameException" => CreateBranchError::InvalidBranchName(String::from(error_message)),"EncryptionIntegrityChecksFailedException" => CreateBranchError::EncryptionIntegrityChecksFailed(String::from(error_message)),"InvalidCommitIdException" => CreateBranchError::InvalidCommitId(String::from(error_message)),"BranchNameExistsException" => CreateBranchError::BranchNameExists(String::from(error_message)),"CommitDoesNotExistException" => CreateBranchError::CommitDoesNotExist(String::from(error_message)),"RepositoryNameRequiredException" => CreateBranchError::RepositoryNameRequired(String::from(error_message)),"ValidationException" => CreateBranchError::Validation(error_message.to_string()),_ => CreateBranchError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for CreateBranchError {
                    fn description(&self) -> &str {
                        match *self {
                            CreateBranchError::EncryptionIntegrityChecksFailed(ref cause) => cause,CreateBranchError::RepositoryNameRequired(ref cause) => cause,CreateBranchError::CommitIdRequired(ref cause) => cause,CreateBranchError::EncryptionKeyNotFound(ref cause) => cause,CreateBranchError::InvalidRepositoryName(ref cause) => cause,CreateBranchError::EncryptionKeyAccessDenied(ref cause) => cause,CreateBranchError::InvalidCommitId(ref cause) => cause,CreateBranchError::BranchNameExists(ref cause) => cause,CreateBranchError::EncryptionKeyUnavailable(ref cause) => cause,CreateBranchError::RepositoryDoesNotExist(ref cause) => cause,CreateBranchError::EncryptionKeyDisabled(ref cause) => cause,CreateBranchError::CommitDoesNotExist(ref cause) => cause,CreateBranchError::BranchNameRequired(ref cause) => cause,CreateBranchError::InvalidBranchName(ref cause) => cause,CreateBranchError::Validation(ref cause) => cause,CreateBranchError::Credentials(ref err) => err.description(),CreateBranchError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),CreateBranchError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> CreateRepositoryError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "EncryptionKeyNotFoundException" => CreateRepositoryError::EncryptionKeyNotFound(String::from(error_message)),"EncryptionKeyDisabledException" => CreateRepositoryError::EncryptionKeyDisabled(String::from(error_message)),"RepositoryNameRequiredException" => CreateRepositoryError::RepositoryNameRequired(String::from(error_message)),"RepositoryNameExistsException" => CreateRepositoryError::RepositoryNameExists(String::from(error_message)),"EncryptionIntegrityChecksFailedException" => CreateRepositoryError::EncryptionIntegrityChecksFailed(String::from(error_message)),"InvalidRepositoryDescriptionException" => CreateRepositoryError::InvalidRepositoryDescription(String::from(error_message)),"InvalidRepositoryNameException" => CreateRepositoryError::InvalidRepositoryName(String::from(error_message)),"EncryptionKeyUnavailableException" => CreateRepositoryError::EncryptionKeyUnavailable(String::from(error_message)),"RepositoryLimitExceededException" => CreateRepositoryError::RepositoryLimitExceeded(String::from(error_message)),"EncryptionKeyAccessDeniedException" => CreateRepositoryError::EncryptionKeyAccessDenied(String::from(error_message)),"ValidationException" => CreateRepositoryError::Validation(error_message.to_string()),_ => CreateRepositoryError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for CreateRepositoryError {
                    fn description(&self) -> &str {
                        match *self {
                            CreateRepositoryError::RepositoryNameRequired(ref cause) => cause,CreateRepositoryError::RepositoryLimitExceeded(ref cause) => cause,CreateRepositoryError::EncryptionKeyUnavailable(ref cause) => cause,CreateRepositoryError::InvalidRepositoryDescription(ref cause) => cause,CreateRepositoryError::EncryptionKeyDisabled(ref cause) => cause,CreateRepositoryError::EncryptionIntegrityChecksFailed(ref cause) => cause,CreateRepositoryError::EncryptionKeyNotFound(ref cause) => cause,CreateRepositoryError::RepositoryNameExists(ref cause) => cause,CreateRepositoryError::InvalidRepositoryName(ref cause) => cause,CreateRepositoryError::EncryptionKeyAccessDenied(ref cause) => cause,CreateRepositoryError::Validation(ref cause) => cause,CreateRepositoryError::Credentials(ref err) => err.description(),CreateRepositoryError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),CreateRepositoryError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> DeleteRepositoryError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "EncryptionKeyUnavailableException" => DeleteRepositoryError::EncryptionKeyUnavailable(String::from(error_message)),"EncryptionKeyDisabledException" => DeleteRepositoryError::EncryptionKeyDisabled(String::from(error_message)),"EncryptionIntegrityChecksFailedException" => DeleteRepositoryError::EncryptionIntegrityChecksFailed(String::from(error_message)),"EncryptionKeyNotFoundException" => DeleteRepositoryError::EncryptionKeyNotFound(String::from(error_message)),"EncryptionKeyAccessDeniedException" => DeleteRepositoryError::EncryptionKeyAccessDenied(String::from(error_message)),"InvalidRepositoryNameException" => DeleteRepositoryError::InvalidRepositoryName(String::from(error_message)),"RepositoryNameRequiredException" => DeleteRepositoryError::RepositoryNameRequired(String::from(error_message)),"ValidationException" => DeleteRepositoryError::Validation(error_message.to_string()),_ => DeleteRepositoryError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for DeleteRepositoryError {
                    fn description(&self) -> &str {
                        match *self {
                            DeleteRepositoryError::EncryptionKeyUnavailable(ref cause) => cause,DeleteRepositoryError::EncryptionKeyDisabled(ref cause) => cause,DeleteRepositoryError::EncryptionKeyNotFound(ref cause) => cause,DeleteRepositoryError::RepositoryNameRequired(ref cause) => cause,DeleteRepositoryError::EncryptionIntegrityChecksFailed(ref cause) => cause,DeleteRepositoryError::EncryptionKeyAccessDenied(ref cause) => cause,DeleteRepositoryError::InvalidRepositoryName(ref cause) => cause,DeleteRepositoryError::Validation(ref cause) => cause,DeleteRepositoryError::Credentials(ref err) => err.description(),DeleteRepositoryError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),DeleteRepositoryError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> GetBranchError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "BranchDoesNotExistException" => GetBranchError::BranchDoesNotExist(String::from(error_message)),"InvalidBranchNameException" => GetBranchError::InvalidBranchName(String::from(error_message)),"InvalidRepositoryNameException" => GetBranchError::InvalidRepositoryName(String::from(error_message)),"BranchNameRequiredException" => GetBranchError::BranchNameRequired(String::from(error_message)),"EncryptionKeyDisabledException" => GetBranchError::EncryptionKeyDisabled(String::from(error_message)),"RepositoryNameRequiredException" => GetBranchError::RepositoryNameRequired(String::from(error_message)),"EncryptionKeyAccessDeniedException" => GetBranchError::EncryptionKeyAccessDenied(String::from(error_message)),"EncryptionKeyNotFoundException" => GetBranchError::EncryptionKeyNotFound(String::from(error_message)),"EncryptionIntegrityChecksFailedException" => GetBranchError::EncryptionIntegrityChecksFailed(String::from(error_message)),"RepositoryDoesNotExistException" => GetBranchError::RepositoryDoesNotExist(String::from(error_message)),"EncryptionKeyUnavailableException" => GetBranchError::EncryptionKeyUnavailable(String::from(error_message)),"ValidationException" => GetBranchError::Validation(error_message.to_string()),_ => GetBranchError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for GetBranchError {
                    fn description(&self) -> &str {
                        match *self {
                            GetBranchError::RepositoryDoesNotExist(ref cause) => cause,GetBranchError::EncryptionKeyAccessDenied(ref cause) => cause,GetBranchError::EncryptionKeyNotFound(ref cause) => cause,GetBranchError::BranchNameRequired(ref cause) => cause,GetBranchError::InvalidBranchName(ref cause) => cause,GetBranchError::EncryptionIntegrityChecksFailed(ref cause) => cause,GetBranchError::EncryptionKeyUnavailable(ref cause) => cause,GetBranchError::BranchDoesNotExist(ref cause) => cause,GetBranchError::RepositoryNameRequired(ref cause) => cause,GetBranchError::InvalidRepositoryName(ref cause) => cause,GetBranchError::EncryptionKeyDisabled(ref cause) => cause,GetBranchError::Validation(ref cause) => cause,GetBranchError::Credentials(ref err) => err.description(),GetBranchError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),GetBranchError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> GetCommitError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "EncryptionKeyAccessDeniedException" => GetCommitError::EncryptionKeyAccessDenied(String::from(error_message)),"InvalidRepositoryNameException" => GetCommitError::InvalidRepositoryName(String::from(error_message)),"CommitIdRequiredException" => GetCommitError::CommitIdRequired(String::from(error_message)),"EncryptionKeyUnavailableException" => GetCommitError::EncryptionKeyUnavailable(String::from(error_message)),"EncryptionKeyNotFoundException" => GetCommitError::EncryptionKeyNotFound(String::from(error_message)),"RepositoryDoesNotExistException" => GetCommitError::RepositoryDoesNotExist(String::from(error_message)),"InvalidCommitIdException" => GetCommitError::InvalidCommitId(String::from(error_message)),"EncryptionKeyDisabledException" => GetCommitError::EncryptionKeyDisabled(String::from(error_message)),"EncryptionIntegrityChecksFailedException" => GetCommitError::EncryptionIntegrityChecksFailed(String::from(error_message)),"RepositoryNameRequiredException" => GetCommitError::RepositoryNameRequired(String::from(error_message)),"CommitIdDoesNotExistException" => GetCommitError::CommitIdDoesNotExist(String::from(error_message)),"ValidationException" => GetCommitError::Validation(error_message.to_string()),_ => GetCommitError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for GetCommitError {
                    fn description(&self) -> &str {
                        match *self {
                            GetCommitError::EncryptionIntegrityChecksFailed(ref cause) => cause,GetCommitError::RepositoryDoesNotExist(ref cause) => cause,GetCommitError::RepositoryNameRequired(ref cause) => cause,GetCommitError::EncryptionKeyUnavailable(ref cause) => cause,GetCommitError::EncryptionKeyDisabled(ref cause) => cause,GetCommitError::EncryptionKeyNotFound(ref cause) => cause,GetCommitError::CommitIdDoesNotExist(ref cause) => cause,GetCommitError::InvalidRepositoryName(ref cause) => cause,GetCommitError::EncryptionKeyAccessDenied(ref cause) => cause,GetCommitError::CommitIdRequired(ref cause) => cause,GetCommitError::InvalidCommitId(ref cause) => cause,GetCommitError::Validation(ref cause) => cause,GetCommitError::Credentials(ref err) => err.description(),GetCommitError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),GetCommitError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> GetRepositoryError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "RepositoryDoesNotExistException" => GetRepositoryError::RepositoryDoesNotExist(String::from(error_message)),"EncryptionIntegrityChecksFailedException" => GetRepositoryError::EncryptionIntegrityChecksFailed(String::from(error_message)),"EncryptionKeyUnavailableException" => GetRepositoryError::EncryptionKeyUnavailable(String::from(error_message)),"RepositoryNameRequiredException" => GetRepositoryError::RepositoryNameRequired(String::from(error_message)),"InvalidRepositoryNameException" => GetRepositoryError::InvalidRepositoryName(String::from(error_message)),"EncryptionKeyAccessDeniedException" => GetRepositoryError::EncryptionKeyAccessDenied(String::from(error_message)),"EncryptionKeyNotFoundException" => GetRepositoryError::EncryptionKeyNotFound(String::from(error_message)),"EncryptionKeyDisabledException" => GetRepositoryError::EncryptionKeyDisabled(String::from(error_message)),"ValidationException" => GetRepositoryError::Validation(error_message.to_string()),_ => GetRepositoryError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for GetRepositoryError {
                    fn description(&self) -> &str {
                        match *self {
                            GetRepositoryError::RepositoryNameRequired(ref cause) => cause,GetRepositoryError::RepositoryDoesNotExist(ref cause) => cause,GetRepositoryError::EncryptionKeyAccessDenied(ref cause) => cause,GetRepositoryError::EncryptionKeyNotFound(ref cause) => cause,GetRepositoryError::EncryptionIntegrityChecksFailed(ref cause) => cause,GetRepositoryError::EncryptionKeyDisabled(ref cause) => cause,GetRepositoryError::InvalidRepositoryName(ref cause) => cause,GetRepositoryError::EncryptionKeyUnavailable(ref cause) => cause,GetRepositoryError::Validation(ref cause) => cause,GetRepositoryError::Credentials(ref err) => err.description(),GetRepositoryError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),GetRepositoryError::Unknown(ref cause) => cause
                        }
                    }
                 }
                    ...
                    pub fn from_body(body: &str) -> GetRepositoryTriggersError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "EncryptionKeyAccessDeniedException" => GetRepositoryTriggersError::EncryptionKeyAccessDenied(String::from(error_message)),"EncryptionKeyDisabledException" => GetRepositoryTriggersError::EncryptionKeyDisabled(String::from(error_message)),"EncryptionKeyNotFoundException" => GetRepositoryTriggersError::EncryptionKeyNotFound(String::from(error_message)),"InvalidRepositoryNameException" => GetRepositoryTriggersError::InvalidRepositoryName(String::from(error_message)),"EncryptionIntegrityChecksFailedException" => GetRepositoryTriggersError::EncryptionIntegrityChecksFailed(String::from(error_message)),"RepositoryNameRequiredException" => GetRepositoryTriggersError::RepositoryNameRequired(String::from(error_message)),"RepositoryDoesNotExistException" => GetRepositoryTriggersError::RepositoryDoesNotExist(String::from(error_message)),"EncryptionKeyUnavailableException" => GetRepositoryTriggersError::EncryptionKeyUnavailable(String::from(error_message)),"ValidationException" => GetRepositoryTriggersError::Validation(error_message.to_string()),_ => GetRepositoryTriggersError::Unknown(String::from(body))
                                }
                            },
...
EncryptionKeyAccessDenied(String),
///<p>An encryption integrity check failed.</p>
EncryptionIntegrityChecksFailed(String),/// An error occurred dispatching the HTTP request
HttpDispatch(HttpDispatchError),/// An error was encountered with AWS credentials.
Credentials(CredentialsError),/// A validation error occurred.  Details from AWS are provided.
Validation(String),/// An unknown error occurred.  The raw HTTP response is provided.
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> ListBranchesError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "EncryptionKeyDisabledException" => ListBranchesError::EncryptionKeyDisabled(String::from(error_message)),"EncryptionKeyAccessDeniedException" => ListBranchesError::EncryptionKeyAccessDenied(String::from(error_message)),"EncryptionKeyNotFoundException" => ListBranchesError::EncryptionKeyNotFound(String::from(error_message)),"EncryptionKeyUnavailableException" => ListBranchesError::EncryptionKeyUnavailable(String::from(error_message)),"InvalidRepositoryNameException" => ListBranchesError::InvalidRepositoryName(String::from(error_message)),"InvalidContinuationTokenException" => ListBranchesError::InvalidContinuationToken(String::from(error_message)),"EncryptionIntegrityChecksFailedException" => ListBranchesError::EncryptionIntegrityChecksFailed(String::from(error_message)),"RepositoryNameRequiredException" => ListBranchesError::RepositoryNameRequired(String::from(error_message)),"RepositoryDoesNotExistException" => ListBranchesError::RepositoryDoesNotExist(String::from(error_message)),"ValidationException" => ListBranchesError::Validation(error_message.to_string()),_ => ListBranchesError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for ListBranchesError {
                    fn description(&self) -> &str {
                        match *self {
                            ListBranchesError::EncryptionIntegrityChecksFailed(ref cause) => cause,ListBranchesError::EncryptionKeyNotFound(ref cause) => cause,ListBranchesError::InvalidContinuationToken(ref cause) => cause,ListBranchesError::RepositoryDoesNotExist(ref cause) => cause,ListBranchesError::InvalidRepositoryName(ref cause) => cause,ListBranchesError::EncryptionKeyUnavailable(ref cause) => cause,ListBranchesError::EncryptionKeyDisabled(ref cause) => cause,ListBranchesError::RepositoryNameRequired(ref cause) => cause,ListBranchesError::EncryptionKeyAccessDenied(ref cause) => cause,ListBranchesError::Validation(ref cause) => cause,ListBranchesError::Credentials(ref err) => err.description(),ListBranchesError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),ListBranchesError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> PutRepositoryTriggersError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "RepositoryNameRequiredException" => PutRepositoryTriggersError::RepositoryNameRequired(String::from(error_message)),"InvalidRepositoryTriggerCustomDataException" => PutRepositoryTriggersError::InvalidRepositoryTriggerCustomData(String::from(error_message)),"InvalidRepositoryTriggerBranchNameException" => PutRepositoryTriggersError::InvalidRepositoryTriggerBranchName(String::from(error_message)),"MaximumBranchesExceededException" => PutRepositoryTriggersError::MaximumBranchesExceeded(String::from(error_message)),"RepositoryTriggerEventsListRequiredException" => PutRepositoryTriggersError::RepositoryTriggerEventsListRequired(String::from(error_message)),"EncryptionKeyNotFoundException" => PutRepositoryTriggersError::EncryptionKeyNotFound(String::from(error_message)),"InvalidRepositoryTriggerEventsException" => PutRepositoryTriggersError::InvalidRepositoryTriggerEvents(String::from(error_message)),"InvalidRepositoryNameException" => PutRepositoryTriggersError::InvalidRepositoryName(String::from(error_message)),"InvalidRepositoryTriggerDestinationArnException" => PutRepositoryTriggersError::InvalidRepositoryTriggerDestinationArn(String::from(error_message)),"RepositoryTriggerNameRequiredException" => PutRepositoryTriggersError::RepositoryTriggerNameRequired(String::from(error_message)),"RepositoryDoesNotExistException" => PutRepositoryTriggersError::RepositoryDoesNotExist(String::from(error_message)),"InvalidRepositoryTriggerNameException" => PutRepositoryTriggersError::InvalidRepositoryTriggerName(String::from(error_message)),"EncryptionKeyAccessDeniedException" => PutRepositoryTriggersError::EncryptionKeyAccessDenied(String::from(error_message)),"InvalidRepositoryTriggerRegionException" => PutRepositoryTriggersError::InvalidRepositoryTriggerRegion(String::from(error_message)),"EncryptionKeyDisabledException" => PutRepositoryTriggersError::EncryptionKeyDisabled(String::from(error_message)),"RepositoryTriggersListRequiredException" => PutRepositoryTriggersError::RepositoryTriggersListRequired(String::from(error_message)),"EncryptionKeyUnavailableException" => PutRepositoryTriggersError::EncryptionKeyUnavailable(String::from(error_message)),"RepositoryTriggerBranchNameListRequiredException" => PutRepositoryTriggersError::RepositoryTriggerBranchNameListRequired(String::from(error_message)),"RepositoryTriggerDestinationArnRequiredException" => PutRepositoryTriggersError::RepositoryTriggerDestinationArnRequired(String::from(error_message)),"MaximumRepositoryTriggersExceededException" => PutRepositoryTriggersError::MaximumRepositoryTriggersExceeded(String::from(error_message)),"EncryptionIntegrityChecksFailedException" => PutRepositoryTriggersError::EncryptionIntegrityChecksFailed(String::from(error_message)),"ValidationException" => PutRepositoryTriggersError::Validation(error_message.to_string()),_ => PutRepositoryTriggersError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for PutRepositoryTriggersError {
                    fn description(&self) -> &str {
                        match *self {
                            PutRepositoryTriggersError::RepositoryTriggerBranchNameListRequired(ref cause) => cause,PutRepositoryTriggersError::EncryptionKeyUnavailable(ref cause) => cause,PutRepositoryTriggersError::EncryptionKeyAccessDenied(ref cause) => cause,PutRepositoryTriggersError::InvalidRepositoryTriggerEvents(ref cause) => cause,PutRepositoryTriggersError::InvalidRepositoryTriggerRegion(ref cause) => cause,PutRepositoryTriggersError::RepositoryTriggersListRequired(ref cause) => cause,PutRepositoryTriggersError::RepositoryDoesNotExist(ref cause) => cause,PutRepositoryTriggersError::RepositoryNameRequired(ref cause) => cause,PutRepositoryTriggersError::MaximumRepositoryTriggersExceeded(ref cause) => cause,PutRepositoryTriggersError::EncryptionKeyDisabled(ref cause) => cause,PutRepositoryTriggersError::MaximumBranchesExceeded(ref cause) => cause,PutRepositoryTriggersError::RepositoryTriggerEventsListRequired(ref cause) => cause,PutRepositoryTriggersError::RepositoryTriggerNameRequired(ref cause) => cause,PutRepositoryTriggersError::EncryptionIntegrityChecksFailed(ref cause) => cause,PutRepositoryTriggersError::InvalidRepositoryTriggerName(ref cause) => cause,PutRepositoryTriggersError::InvalidRepositoryTriggerBranchName(ref cause) => cause,PutRepositoryTriggersError::InvalidRepositoryName(ref cause) => cause,PutRepositoryTriggersError::EncryptionKeyNotFound(ref cause) => cause,PutRepositoryTriggersError::RepositoryTriggerDestinationArnRequired(ref cause) => cause,PutRepositoryTriggersError::InvalidRepositoryTriggerDestinationArn(ref cause) => cause,PutRepositoryTriggersError::InvalidRepositoryTriggerCustomData(ref cause) => cause,PutRepositoryTriggersError::Validation(ref cause) => cause,PutRepositoryTriggersError::Credentials(ref err) => err.description(),PutRepositoryTriggersError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),PutRepositoryTriggersError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> TestRepositoryTriggersError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "MaximumBranchesExceededException" => TestRepositoryTriggersError::MaximumBranchesExceeded(String::from(error_message)),"RepositoryNameRequiredException" => TestRepositoryTriggersError::RepositoryNameRequired(String::from(error_message)),"InvalidRepositoryTriggerBranchNameException" => TestRepositoryTriggersError::InvalidRepositoryTriggerBranchName(String::from(error_message)),"RepositoryTriggerBranchNameListRequiredException" => TestRepositoryTriggersError::RepositoryTriggerBranchNameListRequired(String::from(error_message)),"MaximumRepositoryTriggersExceededException" => TestRepositoryTriggersError::MaximumRepositoryTriggersExceeded(String::from(error_message)),"InvalidRepositoryNameException" => TestRepositoryTriggersError::InvalidRepositoryName(String::from(error_message)),"RepositoryTriggerNameRequiredException" => TestRepositoryTriggersError::RepositoryTriggerNameRequired(String::from(error_message)),"InvalidRepositoryTriggerCustomDataException" => TestRepositoryTriggersError::InvalidRepositoryTriggerCustomData(String::from(error_message)),"InvalidRepositoryTriggerEventsException" => TestRepositoryTriggersError::InvalidRepositoryTriggerEvents(String::from(error_message)),"RepositoryTriggersListRequiredException" => TestRepositoryTriggersError::RepositoryTriggersListRequired(String::from(error_message)),"InvalidRepositoryTriggerRegionException" => TestRepositoryTriggersError::InvalidRepositoryTriggerRegion(String::from(error_message)),"EncryptionKeyNotFoundException" => TestRepositoryTriggersError::EncryptionKeyNotFound(String::from(error_message)),"EncryptionIntegrityChecksFailedException" => TestRepositoryTriggersError::EncryptionIntegrityChecksFailed(String::from(error_message)),"InvalidRepositoryTriggerDestinationArnException" => TestRepositoryTriggersError::InvalidRepositoryTriggerDestinationArn(String::from(error_message)),"EncryptionKeyUnavailableException" => TestRepositoryTriggersError::EncryptionKeyUnavailable(String::from(error_message)),"InvalidRepositoryTriggerNameException" => TestRepositoryTriggersError::InvalidRepositoryTriggerName(String::from(error_message)),"RepositoryTriggerEventsListRequiredException" => TestRepositoryTriggersError::RepositoryTriggerEventsListRequired(String::from(error_message)),"RepositoryDoesNotExistException" => TestRepositoryTriggersError::RepositoryDoesNotExist(String::from(error_message)),"RepositoryTriggerDestinationArnRequiredException" => TestRepositoryTriggersError::RepositoryTriggerDestinationArnRequired(String::from(error_message)),"EncryptionKeyAccessDeniedException" => TestRepositoryTriggersError::EncryptionKeyAccessDenied(String::from(error_message)),"EncryptionKeyDisabledException" => TestRepositoryTriggersError::EncryptionKeyDisabled(String::from(error_message)),"ValidationException" => TestRepositoryTriggersError::Validation(error_message.to_string()),_ => TestRepositoryTriggersError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for TestRepositoryTriggersError {
                    fn description(&self) -> &str {
                        match *self {
                            TestRepositoryTriggersError::InvalidRepositoryTriggerDestinationArn(ref cause) => cause,TestRepositoryTriggersError::InvalidRepositoryTriggerCustomData(ref cause) => cause,TestRepositoryTriggersError::InvalidRepositoryTriggerEvents(ref cause) => cause,TestRepositoryTriggersError::RepositoryDoesNotExist(ref cause) => cause,TestRepositoryTriggersError::EncryptionKeyAccessDenied(ref cause) => cause,TestRepositoryTriggersError::RepositoryTriggerNameRequired(ref cause) => cause,TestRepositoryTriggersError::InvalidRepositoryTriggerRegion(ref cause) => cause,TestRepositoryTriggersError::RepositoryTriggerBranchNameListRequired(ref cause) => cause,TestRepositoryTriggersError::MaximumRepositoryTriggersExceeded(ref cause) => cause,TestRepositoryTriggersError::RepositoryTriggerEventsListRequired(ref cause) => cause,TestRepositoryTriggersError::EncryptionKeyDisabled(ref cause) => cause,TestRepositoryTriggersError::EncryptionKeyUnavailable(ref cause) => cause,TestRepositoryTriggersError::InvalidRepositoryName(ref cause) => cause,TestRepositoryTriggersError::RepositoryTriggersListRequired(ref cause) => cause,TestRepositoryTriggersError::MaximumBranchesExceeded(ref cause) => cause,TestRepositoryTriggersError::RepositoryTriggerDestinationArnRequired(ref cause) => cause,TestRepositoryTriggersError::InvalidRepositoryTriggerName(ref cause) => cause,TestRepositoryTriggersError::EncryptionKeyNotFound(ref cause) => cause,TestRepositoryTriggersError::EncryptionIntegrityChecksFailed(ref cause) => cause,TestRepositoryTriggersError::RepositoryNameRequired(ref cause) => cause,TestRepositoryTriggersError::InvalidRepositoryTriggerBranchName(ref cause) => cause,TestRepositoryTriggersError::Validation(ref cause) => cause,TestRepositoryTriggersError::Credentials(ref err) => err.description(),TestRepositoryTriggersError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),TestRepositoryTriggersError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> UpdateDefaultBranchError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "BranchDoesNotExistException" => UpdateDefaultBranchError::BranchDoesNotExist(String::from(error_message)),"EncryptionKeyUnavailableException" => UpdateDefaultBranchError::EncryptionKeyUnavailable(String::from(error_message)),"EncryptionKeyAccessDeniedException" => UpdateDefaultBranchError::EncryptionKeyAccessDenied(String::from(error_message)),"EncryptionKeyDisabledException" => UpdateDefaultBranchError::EncryptionKeyDisabled(String::from(error_message)),"EncryptionIntegrityChecksFailedException" => UpdateDefaultBranchError::EncryptionIntegrityChecksFailed(String::from(error_message)),"EncryptionKeyNotFoundException" => UpdateDefaultBranchError::EncryptionKeyNotFound(String::from(error_message)),"InvalidBranchNameException" => UpdateDefaultBranchError::InvalidBranchName(String::from(error_message)),"RepositoryNameRequiredException" => UpdateDefaultBranchError::RepositoryNameRequired(String::from(error_message)),"BranchNameRequiredException" => UpdateDefaultBranchError::BranchNameRequired(String::from(error_message)),"InvalidRepositoryNameException" => UpdateDefaultBranchError::InvalidRepositoryName(String::from(error_message)),"RepositoryDoesNotExistException" => UpdateDefaultBranchError::RepositoryDoesNotExist(String::from(error_message)),"ValidationException" => UpdateDefaultBranchError::Validation(error_message.to_string()),_ => UpdateDefaultBranchError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for UpdateDefaultBranchError {
                    fn description(&self) -> &str {
                        match *self {
                            UpdateDefaultBranchError::EncryptionKeyAccessDenied(ref cause) => cause,UpdateDefaultBranchError::EncryptionKeyDisabled(ref cause) => cause,UpdateDefaultBranchError::RepositoryNameRequired(ref cause) => cause,UpdateDefaultBranchError::BranchDoesNotExist(ref cause) => cause,UpdateDefaultBranchError::EncryptionIntegrityChecksFailed(ref cause) => cause,UpdateDefaultBranchError::InvalidBranchName(ref cause) => cause,UpdateDefaultBranchError::InvalidRepositoryName(ref cause) => cause,UpdateDefaultBranchError::EncryptionKeyUnavailable(ref cause) => cause,UpdateDefaultBranchError::EncryptionKeyNotFound(ref cause) => cause,UpdateDefaultBranchError::RepositoryDoesNotExist(ref cause) => cause,UpdateDefaultBranchError::BranchNameRequired(ref cause) => cause,UpdateDefaultBranchError::Validation(ref cause) => cause,UpdateDefaultBranchError::Credentials(ref err) => err.description(),UpdateDefaultBranchError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),UpdateDefaultBranchError::Unknown(ref cause) => cause
                        }
                    }
                 }
