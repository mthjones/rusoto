...
Unknown(String)
                ...
                impl Error for CancelStepsError {
                    fn description(&self) -> &str {
                        match *self {
                            CancelStepsError::InvalidRequest(ref cause) => cause,CancelStepsError::InternalServerError(ref cause) => cause,CancelStepsError::Validation(ref cause) => cause,CancelStepsError::Credentials(ref err) => err.description(),CancelStepsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),CancelStepsError::Unknown(ref cause) => cause
                        }
                    }
                 }
                    ...
                    pub fn from_body(body: &str) -> CreateSecurityConfigurationError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InvalidRequestException" => CreateSecurityConfigurationError::InvalidRequest(String::from(error_message)),"InternalServerException" => CreateSecurityConfigurationError::InternalServer(String::from(error_message)),"ValidationException" => CreateSecurityConfigurationError::Validation(error_message.to_string()),_ => CreateSecurityConfigurationError::Unknown(String::from(body))
                                }
                            },
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> DescribeSecurityConfigurationError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InvalidRequestException" => DescribeSecurityConfigurationError::InvalidRequest(String::from(error_message)),"InternalServerException" => DescribeSecurityConfigurationError::InternalServer(String::from(error_message)),"ValidationException" => DescribeSecurityConfigurationError::Validation(error_message.to_string()),_ => DescribeSecurityConfigurationError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for DescribeSecurityConfigurationError {
                    fn description(&self) -> &str {
                        match *self {
                            DescribeSecurityConfigurationError::InvalidRequest(ref cause) => cause,DescribeSecurityConfigurationError::InternalServer(ref cause) => cause,DescribeSecurityConfigurationError::Validation(ref cause) => cause,DescribeSecurityConfigurationError::Credentials(ref err) => err.description(),DescribeSecurityConfigurationError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),DescribeSecurityConfigurationError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl Error for ListStepsError {
                    fn description(&self) -> &str {
                        match *self {
                            ListStepsError::InvalidRequest(ref cause) => cause,ListStepsError::InternalServer(ref cause) => cause,ListStepsError::Validation(ref cause) => cause,ListStepsError::Credentials(ref err) => err.description(),ListStepsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),ListStepsError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl Error for RemoveTagsError {
                    fn description(&self) -> &str {
                        match *self {
                            RemoveTagsError::InvalidRequest(ref cause) => cause,RemoveTagsError::InternalServer(ref cause) => cause,RemoveTagsError::Validation(ref cause) => cause,RemoveTagsError::Credentials(ref err) => err.description(),RemoveTagsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),RemoveTagsError::Unknown(ref cause) => cause
                        }
                    }
                 }
