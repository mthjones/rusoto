                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "CloudFrontOriginAccessIdentityAlreadyExists" => CreateCloudFrontOriginAccessIdentityError::CloudFrontOriginAccessIdentityAlreadyExists(String::from(parsed_error.message)),"InconsistentQuantities" => CreateCloudFrontOriginAccessIdentityError::InconsistentQuantities(String::from(parsed_error.message)),"InvalidArgument" => CreateCloudFrontOriginAccessIdentityError::InvalidArgument(String::from(parsed_error.message)),"TooManyCloudFrontOriginAccessIdentities" => CreateCloudFrontOriginAccessIdentityError::TooManyCloudFrontOriginAccessIdentities(String::from(parsed_error.message)),"MissingBody" => CreateCloudFrontOriginAccessIdentityError::MissingBody(String::from(parsed_error.message)),_ => CreateCloudFrontOriginAccessIdentityError::Unknown(String::from(body))
                                }
                           },
...
AccessDenied(String),
///
InvalidMinimumProtocolVersion(String),/// An error occurred dispatching the HTTP request
HttpDispatch(HttpDispatchError),/// An error was encountered with AWS credentials.
Credentials(CredentialsError),/// A validation error occurred.  Details from AWS are provided.
Validation(String),/// An unknown error occurred.  The raw HTTP response is provided.
Unknown(String)
                ...
                impl CreateDistributionError {
                    pub fn from_body(body: &str) -> CreateDistributionError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "TooManyQueryStringParameters" => CreateDistributionError::TooManyQueryStringParameters(String::from(parsed_error.message)),"InvalidViewerCertificate" => CreateDistributionError::InvalidViewerCertificate(String::from(parsed_error.message)),"TooManyDistributions" => CreateDistributionError::TooManyDistributions(String::from(parsed_error.message)),"TooManyLambdaFunctionAssociations" => CreateDistributionError::TooManyLambdaFunctionAssociations(String::from(parsed_error.message)),"InvalidProtocolSettings" => CreateDistributionError::InvalidProtocolSettings(String::from(parsed_error.message)),"TooManyDistributionCNAMEs" => CreateDistributionError::TooManyDistributionCNAMEs(String::from(parsed_error.message)),"InvalidOrigin" => CreateDistributionError::InvalidOrigin(String::from(parsed_error.message)),"InvalidTTLOrder" => CreateDistributionError::InvalidTTLOrder(String::from(parsed_error.message)),"TooManyOriginCustomHeaders" => CreateDistributionError::TooManyOriginCustomHeaders(String::from(parsed_error.message)),"InvalidOriginAccessIdentity" => CreateDistributionError::InvalidOriginAccessIdentity(String::from(parsed_error.message)),"TooManyCookieNamesInWhiteList" => CreateDistributionError::TooManyCookieNamesInWhiteList(String::from(parsed_error.message)),"InvalidLocationCode" => CreateDistributionError::InvalidLocationCode(String::from(parsed_error.message)),"InvalidLambdaFunctionAssociation" => CreateDistributionError::InvalidLambdaFunctionAssociation(String::from(parsed_error.message)),"TrustedSignerDoesNotExist" => CreateDistributionError::TrustedSignerDoesNotExist(String::from(parsed_error.message)),"InvalidQueryStringParameters" => CreateDistributionError::InvalidQueryStringParameters(String::from(parsed_error.message)),"CNAMEAlreadyExists" => CreateDistributionError::CNAMEAlreadyExists(String::from(parsed_error.message)),"InvalidErrorCode" => CreateDistributionError::InvalidErrorCode(String::from(parsed_error.message)),"InvalidGeoRestrictionParameter" => CreateDistributionError::InvalidGeoRestrictionParameter(String::from(parsed_error.message)),"TooManyDistributionsWithLambdaAssociations" => CreateDistributionError::TooManyDistributionsWithLambdaAssociations(String::from(parsed_error.message)),"TooManyCacheBehaviors" => CreateDistributionError::TooManyCacheBehaviors(String::from(parsed_error.message)),"MissingBody" => CreateDistributionError::MissingBody(String::from(parsed_error.message)),"InconsistentQuantities" => CreateDistributionError::InconsistentQuantities(String::from(parsed_error.message)),"InvalidForwardCookies" => CreateDistributionError::InvalidForwardCookies(String::from(parsed_error.message)),"AccessDenied" => CreateDistributionError::AccessDenied(String::from(parsed_error.message)),"NoSuchOrigin" => CreateDistributionError::NoSuchOrigin(String::from(parsed_error.message)),"TooManyHeadersInForwardedValues" => CreateDistributionError::TooManyHeadersInForwardedValues(String::from(parsed_error.message)),"InvalidDefaultRootObject" => CreateDistributionError::InvalidDefaultRootObject(String::from(parsed_error.message)),"InvalidArgument" => CreateDistributionError::InvalidArgument(String::from(parsed_error.message)),"InvalidWebACLId" => CreateDistributionError::InvalidWebACLId(String::from(parsed_error.message)),"InvalidHeadersForS3Origin" => CreateDistributionError::InvalidHeadersForS3Origin(String::from(parsed_error.message)),"InvalidMinimumProtocolVersion" => CreateDistributionError::InvalidMinimumProtocolVersion(String::from(parsed_error.message)),"TooManyCertificates" => CreateDistributionError::TooManyCertificates(String::from(parsed_error.message)),"TooManyOrigins" => CreateDistributionError::TooManyOrigins(String::from(parsed_error.message)),"InvalidRequiredProtocol" => CreateDistributionError::InvalidRequiredProtocol(String::from(parsed_error.message)),"InvalidResponseCode" => CreateDistributionError::InvalidResponseCode(String::from(parsed_error.message)),"InvalidRelativePath" => CreateDistributionError::InvalidRelativePath(String::from(parsed_error.message)),"DistributionAlreadyExists" => CreateDistributionError::DistributionAlreadyExists(String::from(parsed_error.message)),"TooManyTrustedSigners" => CreateDistributionError::TooManyTrustedSigners(String::from(parsed_error.message)),_ => CreateDistributionError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for CreateDistributionError {
                    fn description(&self) -> &str {
                        match *self {
                            CreateDistributionError::TooManyCacheBehaviors(ref cause) => cause,CreateDistributionError::TooManyHeadersInForwardedValues(ref cause) => cause,CreateDistributionError::TooManyQueryStringParameters(ref cause) => cause,CreateDistributionError::InvalidLocationCode(ref cause) => cause,CreateDistributionError::InvalidHeadersForS3Origin(ref cause) => cause,CreateDistributionError::InvalidErrorCode(ref cause) => cause,CreateDistributionError::NoSuchOrigin(ref cause) => cause,CreateDistributionError::CNAMEAlreadyExists(ref cause) => cause,CreateDistributionError::InvalidDefaultRootObject(ref cause) => cause,CreateDistributionError::TooManyDistributions(ref cause) => cause,CreateDistributionError::TooManyOrigins(ref cause) => cause,CreateDistributionError::DistributionAlreadyExists(ref cause) => cause,CreateDistributionError::TooManyTrustedSigners(ref cause) => cause,CreateDistributionError::InvalidTTLOrder(ref cause) => cause,CreateDistributionError::InvalidLambdaFunctionAssociation(ref cause) => cause,CreateDistributionError::InvalidOrigin(ref cause) => cause,CreateDistributionError::InvalidOriginAccessIdentity(ref cause) => cause,CreateDistributionError::InvalidGeoRestrictionParameter(ref cause) => cause,CreateDistributionError::InvalidForwardCookies(ref cause) => cause,CreateDistributionError::InvalidMinimumProtocolVersion(ref cause) => cause,CreateDistributionError::InvalidProtocolSettings(ref cause) => cause,CreateDistributionError::InvalidQueryStringParameters(ref cause) => cause,CreateDistributionError::InvalidRequiredProtocol(ref cause) => cause,CreateDistributionError::TrustedSignerDoesNotExist(ref cause) => cause,CreateDistributionError::TooManyCookieNamesInWhiteList(ref cause) => cause,CreateDistributionError::InvalidRelativePath(ref cause) => cause,CreateDistributionError::TooManyCertificates(ref cause) => cause,CreateDistributionError::InconsistentQuantities(ref cause) => cause,CreateDistributionError::AccessDenied(ref cause) => cause,CreateDistributionError::TooManyLambdaFunctionAssociations(ref cause) => cause,CreateDistributionError::InvalidResponseCode(ref cause) => cause,CreateDistributionError::TooManyDistributionsWithLambdaAssociations(ref cause) => cause,CreateDistributionError::InvalidWebACLId(ref cause) => cause,CreateDistributionError::InvalidViewerCertificate(ref cause) => cause,CreateDistributionError::InvalidArgument(ref cause) => cause,CreateDistributionError::MissingBody(ref cause) => cause,CreateDistributionError::TooManyOriginCustomHeaders(ref cause) => cause,CreateDistributionError::TooManyDistributionCNAMEs(ref cause) => cause,CreateDistributionError::Validation(ref cause) => cause,CreateDistributionError::Credentials(ref err) => err.description(),CreateDistributionError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),CreateDistributionError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
InvalidOriginAccessIdentity(String),
///<p>The relative path is too big, is not URL-encoded, or does not begin with a slash (/).</p>
InvalidRelativePath(String),/// An error occurred dispatching the HTTP request
HttpDispatch(HttpDispatchError),/// An error was encountered with AWS credentials.
Credentials(CredentialsError),/// A validation error occurred.  Details from AWS are provided.
Validation(String),/// An unknown error occurred.  The raw HTTP response is provided.
Unknown(String)
                ...
                impl CreateDistributionWithTagsError {
                    pub fn from_body(body: &str) -> CreateDistributionWithTagsError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "InvalidQueryStringParameters" => CreateDistributionWithTagsError::InvalidQueryStringParameters(String::from(parsed_error.message)),"TooManyDistributionsWithLambdaAssociations" => CreateDistributionWithTagsError::TooManyDistributionsWithLambdaAssociations(String::from(parsed_error.message)),"InvalidProtocolSettings" => CreateDistributionWithTagsError::InvalidProtocolSettings(String::from(parsed_error.message)),"TooManyOrigins" => CreateDistributionWithTagsError::TooManyOrigins(String::from(parsed_error.message)),"InvalidLambdaFunctionAssociation" => CreateDistributionWithTagsError::InvalidLambdaFunctionAssociation(String::from(parsed_error.message)),"InvalidOrigin" => CreateDistributionWithTagsError::InvalidOrigin(String::from(parsed_error.message)),"InvalidTTLOrder" => CreateDistributionWithTagsError::InvalidTTLOrder(String::from(parsed_error.message)),"TooManyLambdaFunctionAssociations" => CreateDistributionWithTagsError::TooManyLambdaFunctionAssociations(String::from(parsed_error.message)),"TooManyDistributionCNAMEs" => CreateDistributionWithTagsError::TooManyDistributionCNAMEs(String::from(parsed_error.message)),"TooManyCacheBehaviors" => CreateDistributionWithTagsError::TooManyCacheBehaviors(String::from(parsed_error.message)),"TooManyCookieNamesInWhiteList" => CreateDistributionWithTagsError::TooManyCookieNamesInWhiteList(String::from(parsed_error.message)),"InvalidViewerCertificate" => CreateDistributionWithTagsError::InvalidViewerCertificate(String::from(parsed_error.message)),"NoSuchOrigin" => CreateDistributionWithTagsError::NoSuchOrigin(String::from(parsed_error.message)),"InvalidRequiredProtocol" => CreateDistributionWithTagsError::InvalidRequiredProtocol(String::from(parsed_error.message)),"InvalidOriginAccessIdentity" => CreateDistributionWithTagsError::InvalidOriginAccessIdentity(String::from(parsed_error.message)),"InvalidGeoRestrictionParameter" => CreateDistributionWithTagsError::InvalidGeoRestrictionParameter(String::from(parsed_error.message)),"TooManyDistributions" => CreateDistributionWithTagsError::TooManyDistributions(String::from(parsed_error.message)),"InvalidTagging" => CreateDistributionWithTagsError::InvalidTagging(String::from(parsed_error.message)),"InvalidRelativePath" => CreateDistributionWithTagsError::InvalidRelativePath(String::from(parsed_error.message)),"DistributionAlreadyExists" => CreateDistributionWithTagsError::DistributionAlreadyExists(String::from(parsed_error.message)),"TooManyTrustedSigners" => CreateDistributionWithTagsError::TooManyTrustedSigners(String::from(parsed_error.message)),"TooManyHeadersInForwardedValues" => CreateDistributionWithTagsError::TooManyHeadersInForwardedValues(String::from(parsed_error.message)),"InvalidArgument" => CreateDistributionWithTagsError::InvalidArgument(String::from(parsed_error.message)),"MissingBody" => CreateDistributionWithTagsError::MissingBody(String::from(parsed_error.message)),"InvalidResponseCode" => CreateDistributionWithTagsError::InvalidResponseCode(String::from(parsed_error.message)),"TooManyQueryStringParameters" => CreateDistributionWithTagsError::TooManyQueryStringParameters(String::from(parsed_error.message)),"InvalidDefaultRootObject" => CreateDistributionWithTagsError::InvalidDefaultRootObject(String::from(parsed_error.message)),"CNAMEAlreadyExists" => CreateDistributionWithTagsError::CNAMEAlreadyExists(String::from(parsed_error.message)),"TooManyCertificates" => CreateDistributionWithTagsError::TooManyCertificates(String::from(parsed_error.message)),"InvalidForwardCookies" => CreateDistributionWithTagsError::InvalidForwardCookies(String::from(parsed_error.message)),"InvalidHeadersForS3Origin" => CreateDistributionWithTagsError::InvalidHeadersForS3Origin(String::from(parsed_error.message)),"InconsistentQuantities" => CreateDistributionWithTagsError::InconsistentQuantities(String::from(parsed_error.message)),"TrustedSignerDoesNotExist" => CreateDistributionWithTagsError::TrustedSignerDoesNotExist(String::from(parsed_error.message)),"InvalidErrorCode" => CreateDistributionWithTagsError::InvalidErrorCode(String::from(parsed_error.message)),"InvalidWebACLId" => CreateDistributionWithTagsError::InvalidWebACLId(String::from(parsed_error.message)),"InvalidMinimumProtocolVersion" => CreateDistributionWithTagsError::InvalidMinimumProtocolVersion(String::from(parsed_error.message)),"InvalidLocationCode" => CreateDistributionWithTagsError::InvalidLocationCode(String::from(parsed_error.message)),"TooManyOriginCustomHeaders" => CreateDistributionWithTagsError::TooManyOriginCustomHeaders(String::from(parsed_error.message)),"AccessDenied" => CreateDistributionWithTagsError::AccessDenied(String::from(parsed_error.message)),_ => CreateDistributionWithTagsError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for CreateDistributionWithTagsError {
                    fn description(&self) -> &str {
                        match *self {
                            CreateDistributionWithTagsError::InvalidDefaultRootObject(ref cause) => cause,CreateDistributionWithTagsError::InvalidResponseCode(ref cause) => cause,CreateDistributionWithTagsError::AccessDenied(ref cause) => cause,CreateDistributionWithTagsError::TooManyOriginCustomHeaders(ref cause) => cause,CreateDistributionWithTagsError::InvalidLambdaFunctionAssociation(ref cause) => cause,CreateDistributionWithTagsError::InvalidOrigin(ref cause) => cause,CreateDistributionWithTagsError::InvalidQueryStringParameters(ref cause) => cause,CreateDistributionWithTagsError::MissingBody(ref cause) => cause,CreateDistributionWithTagsError::InvalidForwardCookies(ref cause) => cause,CreateDistributionWithTagsError::InvalidTagging(ref cause) => cause,CreateDistributionWithTagsError::NoSuchOrigin(ref cause) => cause,CreateDistributionWithTagsError::InvalidOriginAccessIdentity(ref cause) => cause,CreateDistributionWithTagsError::InvalidGeoRestrictionParameter(ref cause) => cause,CreateDistributionWithTagsError::TooManyDistributionsWithLambdaAssociations(ref cause) => cause,CreateDistributionWithTagsError::InvalidWebACLId(ref cause) => cause,CreateDistributionWithTagsError::TooManyQueryStringParameters(ref cause) => cause,CreateDistributionWithTagsError::InvalidRequiredProtocol(ref cause) => cause,CreateDistributionWithTagsError::InconsistentQuantities(ref cause) => cause,CreateDistributionWithTagsError::InvalidRelativePath(ref cause) => cause,CreateDistributionWithTagsError::TooManyLambdaFunctionAssociations(ref cause) => cause,CreateDistributionWithTagsError::TooManyCookieNamesInWhiteList(ref cause) => cause,CreateDistributionWithTagsError::InvalidProtocolSettings(ref cause) => cause,CreateDistributionWithTagsError::InvalidMinimumProtocolVersion(ref cause) => cause,CreateDistributionWithTagsError::CNAMEAlreadyExists(ref cause) => cause,CreateDistributionWithTagsError::TooManyTrustedSigners(ref cause) => cause,CreateDistributionWithTagsError::TrustedSignerDoesNotExist(ref cause) => cause,CreateDistributionWithTagsError::TooManyCertificates(ref cause) => cause,CreateDistributionWithTagsError::InvalidTTLOrder(ref cause) => cause,CreateDistributionWithTagsError::InvalidViewerCertificate(ref cause) => cause,CreateDistributionWithTagsError::InvalidErrorCode(ref cause) => cause,CreateDistributionWithTagsError::InvalidHeadersForS3Origin(ref cause) => cause,CreateDistributionWithTagsError::DistributionAlreadyExists(ref cause) => cause,CreateDistributionWithTagsError::TooManyDistributions(ref cause) => cause,CreateDistributionWithTagsError::TooManyHeadersInForwardedValues(ref cause) => cause,CreateDistributionWithTagsError::InvalidLocationCode(ref cause) => cause,CreateDistributionWithTagsError::TooManyOrigins(ref cause) => cause,CreateDistributionWithTagsError::TooManyCacheBehaviors(ref cause) => cause,CreateDistributionWithTagsError::TooManyDistributionCNAMEs(ref cause) => cause,CreateDistributionWithTagsError::InvalidArgument(ref cause) => cause,CreateDistributionWithTagsError::Validation(ref cause) => cause,CreateDistributionWithTagsError::Credentials(ref err) => err.description(),CreateDistributionWithTagsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),CreateDistributionWithTagsError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl CreateInvalidationError {
                    pub fn from_body(body: &str) -> CreateInvalidationError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "AccessDenied" => CreateInvalidationError::AccessDenied(String::from(parsed_error.message)),"MissingBody" => CreateInvalidationError::MissingBody(String::from(parsed_error.message)),"InconsistentQuantities" => CreateInvalidationError::InconsistentQuantities(String::from(parsed_error.message)),"TooManyInvalidationsInProgress" => CreateInvalidationError::TooManyInvalidationsInProgress(String::from(parsed_error.message)),"NoSuchDistribution" => CreateInvalidationError::NoSuchDistribution(String::from(parsed_error.message)),"InvalidArgument" => CreateInvalidationError::InvalidArgument(String::from(parsed_error.message)),"BatchTooLarge" => CreateInvalidationError::BatchTooLarge(String::from(parsed_error.message)),_ => CreateInvalidationError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for CreateInvalidationError {
                    fn description(&self) -> &str {
                        match *self {
                            CreateInvalidationError::MissingBody(ref cause) => cause,CreateInvalidationError::AccessDenied(ref cause) => cause,CreateInvalidationError::InvalidArgument(ref cause) => cause,CreateInvalidationError::BatchTooLarge(ref cause) => cause,CreateInvalidationError::TooManyInvalidationsInProgress(ref cause) => cause,CreateInvalidationError::NoSuchDistribution(ref cause) => cause,CreateInvalidationError::InconsistentQuantities(ref cause) => cause,CreateInvalidationError::Validation(ref cause) => cause,CreateInvalidationError::Credentials(ref err) => err.description(),CreateInvalidationError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),CreateInvalidationError::Unknown(ref cause) => cause
                        }
                    }
                 }
                ...
                impl CreateStreamingDistributionError {
                    pub fn from_body(body: &str) -> CreateStreamingDistributionError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "TrustedSignerDoesNotExist" => CreateStreamingDistributionError::TrustedSignerDoesNotExist(String::from(parsed_error.message)),"TooManyStreamingDistributionCNAMEs" => CreateStreamingDistributionError::TooManyStreamingDistributionCNAMEs(String::from(parsed_error.message)),"TooManyStreamingDistributions" => CreateStreamingDistributionError::TooManyStreamingDistributions(String::from(parsed_error.message)),"TooManyTrustedSigners" => CreateStreamingDistributionError::TooManyTrustedSigners(String::from(parsed_error.message)),"InvalidOrigin" => CreateStreamingDistributionError::InvalidOrigin(String::from(parsed_error.message)),"MissingBody" => CreateStreamingDistributionError::MissingBody(String::from(parsed_error.message)),"InconsistentQuantities" => CreateStreamingDistributionError::InconsistentQuantities(String::from(parsed_error.message)),"AccessDenied" => CreateStreamingDistributionError::AccessDenied(String::from(parsed_error.message)),"InvalidArgument" => CreateStreamingDistributionError::InvalidArgument(String::from(parsed_error.message)),"CNAMEAlreadyExists" => CreateStreamingDistributionError::CNAMEAlreadyExists(String::from(parsed_error.message)),"StreamingDistributionAlreadyExists" => CreateStreamingDistributionError::StreamingDistributionAlreadyExists(String::from(parsed_error.message)),"InvalidOriginAccessIdentity" => CreateStreamingDistributionError::InvalidOriginAccessIdentity(String::from(parsed_error.message)),_ => CreateStreamingDistributionError::Unknown(String::from(body))
                                }
                           },
...
Unknown(String)
                ...
                impl CreateStreamingDistributionWithTagsError {
                    pub fn from_body(body: &str) -> CreateStreamingDistributionWithTagsError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "InvalidOriginAccessIdentity" => CreateStreamingDistributionWithTagsError::InvalidOriginAccessIdentity(String::from(parsed_error.message)),"StreamingDistributionAlreadyExists" => CreateStreamingDistributionWithTagsError::StreamingDistributionAlreadyExists(String::from(parsed_error.message)),"TrustedSignerDoesNotExist" => CreateStreamingDistributionWithTagsError::TrustedSignerDoesNotExist(String::from(parsed_error.message)),"InvalidOrigin" => CreateStreamingDistributionWithTagsError::InvalidOrigin(String::from(parsed_error.message)),"TooManyStreamingDistributionCNAMEs" => CreateStreamingDistributionWithTagsError::TooManyStreamingDistributionCNAMEs(String::from(parsed_error.message)),"CNAMEAlreadyExists" => CreateStreamingDistributionWithTagsError::CNAMEAlreadyExists(String::from(parsed_error.message)),"TooManyTrustedSigners" => CreateStreamingDistributionWithTagsError::TooManyTrustedSigners(String::from(parsed_error.message)),"InconsistentQuantities" => CreateStreamingDistributionWithTagsError::InconsistentQuantities(String::from(parsed_error.message)),"InvalidArgument" => CreateStreamingDistributionWithTagsError::InvalidArgument(String::from(parsed_error.message)),"MissingBody" => CreateStreamingDistributionWithTagsError::MissingBody(String::from(parsed_error.message)),"TooManyStreamingDistributions" => CreateStreamingDistributionWithTagsError::TooManyStreamingDistributions(String::from(parsed_error.message)),"AccessDenied" => CreateStreamingDistributionWithTagsError::AccessDenied(String::from(parsed_error.message)),"InvalidTagging" => CreateStreamingDistributionWithTagsError::InvalidTagging(String::from(parsed_error.message)),_ => CreateStreamingDistributionWithTagsError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for CreateStreamingDistributionWithTagsError {
                    fn description(&self) -> &str {
                        match *self {
                            CreateStreamingDistributionWithTagsError::TooManyStreamingDistributionCNAMEs(ref cause) => cause,CreateStreamingDistributionWithTagsError::TooManyStreamingDistributions(ref cause) => cause,CreateStreamingDistributionWithTagsError::TooManyTrustedSigners(ref cause) => cause,CreateStreamingDistributionWithTagsError::InvalidTagging(ref cause) => cause,CreateStreamingDistributionWithTagsError::TrustedSignerDoesNotExist(ref cause) => cause,CreateStreamingDistributionWithTagsError::InconsistentQuantities(ref cause) => cause,CreateStreamingDistributionWithTagsError::AccessDenied(ref cause) => cause,CreateStreamingDistributionWithTagsError::MissingBody(ref cause) => cause,CreateStreamingDistributionWithTagsError::CNAMEAlreadyExists(ref cause) => cause,CreateStreamingDistributionWithTagsError::InvalidOriginAccessIdentity(ref cause) => cause,CreateStreamingDistributionWithTagsError::InvalidOrigin(ref cause) => cause,CreateStreamingDistributionWithTagsError::InvalidArgument(ref cause) => cause,CreateStreamingDistributionWithTagsError::StreamingDistributionAlreadyExists(ref cause) => cause,CreateStreamingDistributionWithTagsError::Validation(ref cause) => cause,CreateStreamingDistributionWithTagsError::Credentials(ref err) => err.description(),CreateStreamingDistributionWithTagsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),CreateStreamingDistributionWithTagsError::Unknown(ref cause) => cause
                        }
                    }
                 }
                ...
                impl DeleteCloudFrontOriginAccessIdentityError {
                    pub fn from_body(body: &str) -> DeleteCloudFrontOriginAccessIdentityError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "AccessDenied" => DeleteCloudFrontOriginAccessIdentityError::AccessDenied(String::from(parsed_error.message)),"NoSuchCloudFrontOriginAccessIdentity" => DeleteCloudFrontOriginAccessIdentityError::NoSuchCloudFrontOriginAccessIdentity(String::from(parsed_error.message)),"PreconditionFailed" => DeleteCloudFrontOriginAccessIdentityError::PreconditionFailed(String::from(parsed_error.message)),"CloudFrontOriginAccessIdentityInUse" => DeleteCloudFrontOriginAccessIdentityError::CloudFrontOriginAccessIdentityInUse(String::from(parsed_error.message)),"InvalidIfMatchVersion" => DeleteCloudFrontOriginAccessIdentityError::InvalidIfMatchVersion(String::from(parsed_error.message)),_ => DeleteCloudFrontOriginAccessIdentityError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DeleteDistributionError {
                    pub fn from_body(body: &str) -> DeleteDistributionError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "DistributionNotDisabled" => DeleteDistributionError::DistributionNotDisabled(String::from(parsed_error.message)),"AccessDenied" => DeleteDistributionError::AccessDenied(String::from(parsed_error.message)),"NoSuchDistribution" => DeleteDistributionError::NoSuchDistribution(String::from(parsed_error.message)),"PreconditionFailed" => DeleteDistributionError::PreconditionFailed(String::from(parsed_error.message)),"InvalidIfMatchVersion" => DeleteDistributionError::InvalidIfMatchVersion(String::from(parsed_error.message)),_ => DeleteDistributionError::Unknown(String::from(body))
                                }
                           },
...
Unknown(String)
                ...
                impl DeleteStreamingDistributionError {
                    pub fn from_body(body: &str) -> DeleteStreamingDistributionError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "NoSuchStreamingDistribution" => DeleteStreamingDistributionError::NoSuchStreamingDistribution(String::from(parsed_error.message)),"InvalidIfMatchVersion" => DeleteStreamingDistributionError::InvalidIfMatchVersion(String::from(parsed_error.message)),"StreamingDistributionNotDisabled" => DeleteStreamingDistributionError::StreamingDistributionNotDisabled(String::from(parsed_error.message)),"PreconditionFailed" => DeleteStreamingDistributionError::PreconditionFailed(String::from(parsed_error.message)),"AccessDenied" => DeleteStreamingDistributionError::AccessDenied(String::from(parsed_error.message)),_ => DeleteStreamingDistributionError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for DeleteStreamingDistributionError {
                    fn description(&self) -> &str {
                        match *self {
                            DeleteStreamingDistributionError::StreamingDistributionNotDisabled(ref cause) => cause,DeleteStreamingDistributionError::InvalidIfMatchVersion(ref cause) => cause,DeleteStreamingDistributionError::PreconditionFailed(ref cause) => cause,DeleteStreamingDistributionError::NoSuchStreamingDistribution(ref cause) => cause,DeleteStreamingDistributionError::AccessDenied(ref cause) => cause,DeleteStreamingDistributionError::Validation(ref cause) => cause,DeleteStreamingDistributionError::Credentials(ref err) => err.description(),DeleteStreamingDistributionError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),DeleteStreamingDistributionError::Unknown(ref cause) => cause
                        }
                    }
                 }
                ...
                impl GetDistributionConfigError {
                    pub fn from_body(body: &str) -> GetDistributionConfigError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "NoSuchDistribution" => GetDistributionConfigError::NoSuchDistribution(String::from(parsed_error.message)),"AccessDenied" => GetDistributionConfigError::AccessDenied(String::from(parsed_error.message)),_ => GetDistributionConfigError::Unknown(String::from(body))
                                }
                           },
...
Unknown(String)
                ...
                impl GetInvalidationError {
                    pub fn from_body(body: &str) -> GetInvalidationError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "NoSuchInvalidation" => GetInvalidationError::NoSuchInvalidation(String::from(parsed_error.message)),"AccessDenied" => GetInvalidationError::AccessDenied(String::from(parsed_error.message)),"NoSuchDistribution" => GetInvalidationError::NoSuchDistribution(String::from(parsed_error.message)),_ => GetInvalidationError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for GetInvalidationError {
                    fn description(&self) -> &str {
                        match *self {
                            GetInvalidationError::NoSuchDistribution(ref cause) => cause,GetInvalidationError::NoSuchInvalidation(ref cause) => cause,GetInvalidationError::AccessDenied(ref cause) => cause,GetInvalidationError::Validation(ref cause) => cause,GetInvalidationError::Credentials(ref err) => err.description(),GetInvalidationError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),GetInvalidationError::Unknown(ref cause) => cause
                        }
                    }
                 }
                ...
                impl GetStreamingDistributionError {
                    pub fn from_body(body: &str) -> GetStreamingDistributionError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "NoSuchStreamingDistribution" => GetStreamingDistributionError::NoSuchStreamingDistribution(String::from(parsed_error.message)),"AccessDenied" => GetStreamingDistributionError::AccessDenied(String::from(parsed_error.message)),_ => GetStreamingDistributionError::Unknown(String::from(body))
                                }
                           },
...
Unknown(String)
                ...
                impl ListInvalidationsError {
                    pub fn from_body(body: &str) -> ListInvalidationsError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "AccessDenied" => ListInvalidationsError::AccessDenied(String::from(parsed_error.message)),"NoSuchDistribution" => ListInvalidationsError::NoSuchDistribution(String::from(parsed_error.message)),"InvalidArgument" => ListInvalidationsError::InvalidArgument(String::from(parsed_error.message)),_ => ListInvalidationsError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for ListInvalidationsError {
                    fn description(&self) -> &str {
                        match *self {
                            ListInvalidationsError::InvalidArgument(ref cause) => cause,ListInvalidationsError::NoSuchDistribution(ref cause) => cause,ListInvalidationsError::AccessDenied(ref cause) => cause,ListInvalidationsError::Validation(ref cause) => cause,ListInvalidationsError::Credentials(ref err) => err.description(),ListInvalidationsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),ListInvalidationsError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl ListTagsForResourceError {
                    pub fn from_body(body: &str) -> ListTagsForResourceError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "NoSuchResource" => ListTagsForResourceError::NoSuchResource(String::from(parsed_error.message)),"InvalidArgument" => ListTagsForResourceError::InvalidArgument(String::from(parsed_error.message)),"InvalidTagging" => ListTagsForResourceError::InvalidTagging(String::from(parsed_error.message)),"AccessDenied" => ListTagsForResourceError::AccessDenied(String::from(parsed_error.message)),_ => ListTagsForResourceError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for ListTagsForResourceError {
                    fn description(&self) -> &str {
                        match *self {
                            ListTagsForResourceError::AccessDenied(ref cause) => cause,ListTagsForResourceError::InvalidTagging(ref cause) => cause,ListTagsForResourceError::InvalidArgument(ref cause) => cause,ListTagsForResourceError::NoSuchResource(ref cause) => cause,ListTagsForResourceError::Validation(ref cause) => cause,ListTagsForResourceError::Credentials(ref err) => err.description(),ListTagsForResourceError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),ListTagsForResourceError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
AccessDenied(String),
///
InvalidTagging(String),/// An error occurred dispatching the HTTP request
HttpDispatch(HttpDispatchError),/// An error was encountered with AWS credentials.
Credentials(CredentialsError),/// A validation error occurred.  Details from AWS are provided.
Validation(String),/// An unknown error occurred.  The raw HTTP response is provided.
Unknown(String)
                ...
                impl TagResourceError {
                    pub fn from_body(body: &str) -> TagResourceError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "NoSuchResource" => TagResourceError::NoSuchResource(String::from(parsed_error.message)),"InvalidArgument" => TagResourceError::InvalidArgument(String::from(parsed_error.message)),"InvalidTagging" => TagResourceError::InvalidTagging(String::from(parsed_error.message)),"AccessDenied" => TagResourceError::AccessDenied(String::from(parsed_error.message)),_ => TagResourceError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for TagResourceError {
                    fn description(&self) -> &str {
                        match *self {
                            TagResourceError::InvalidTagging(ref cause) => cause,TagResourceError::InvalidArgument(ref cause) => cause,TagResourceError::AccessDenied(ref cause) => cause,TagResourceError::NoSuchResource(ref cause) => cause,TagResourceError::Validation(ref cause) => cause,TagResourceError::Credentials(ref err) => err.description(),TagResourceError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),TagResourceError::Unknown(ref cause) => cause
                        }
                    }
                 }
                ...
                impl UntagResourceError {
                    pub fn from_body(body: &str) -> UntagResourceError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "InvalidTagging" => UntagResourceError::InvalidTagging(String::from(parsed_error.message)),"NoSuchResource" => UntagResourceError::NoSuchResource(String::from(parsed_error.message)),"AccessDenied" => UntagResourceError::AccessDenied(String::from(parsed_error.message)),"InvalidArgument" => UntagResourceError::InvalidArgument(String::from(parsed_error.message)),_ => UntagResourceError::Unknown(String::from(body))
                                }
                           },
                ...
                impl UpdateCloudFrontOriginAccessIdentityError {
                    pub fn from_body(body: &str) -> UpdateCloudFrontOriginAccessIdentityError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "AccessDenied" => UpdateCloudFrontOriginAccessIdentityError::AccessDenied(String::from(parsed_error.message)),"NoSuchCloudFrontOriginAccessIdentity" => UpdateCloudFrontOriginAccessIdentityError::NoSuchCloudFrontOriginAccessIdentity(String::from(parsed_error.message)),"PreconditionFailed" => UpdateCloudFrontOriginAccessIdentityError::PreconditionFailed(String::from(parsed_error.message)),"InvalidArgument" => UpdateCloudFrontOriginAccessIdentityError::InvalidArgument(String::from(parsed_error.message)),"InvalidIfMatchVersion" => UpdateCloudFrontOriginAccessIdentityError::InvalidIfMatchVersion(String::from(parsed_error.message)),"MissingBody" => UpdateCloudFrontOriginAccessIdentityError::MissingBody(String::from(parsed_error.message)),"IllegalUpdate" => UpdateCloudFrontOriginAccessIdentityError::IllegalUpdate(String::from(parsed_error.message)),"InconsistentQuantities" => UpdateCloudFrontOriginAccessIdentityError::InconsistentQuantities(String::from(parsed_error.message)),_ => UpdateCloudFrontOriginAccessIdentityError::Unknown(String::from(body))
                                }
                           },
...
PreconditionFailed(String),
///<p>Processing your request would cause the maximum number of distributions with Lambda function associations per owner to be exceeded.</p>
TooManyDistributionsWithLambdaAssociations(String),/// An error occurred dispatching the HTTP request
HttpDispatch(HttpDispatchError),/// An error was encountered with AWS credentials.
Credentials(CredentialsError),/// A validation error occurred.  Details from AWS are provided.
Validation(String),/// An unknown error occurred.  The raw HTTP response is provided.
Unknown(String)
                ...
                impl UpdateDistributionError {
                    pub fn from_body(body: &str) -> UpdateDistributionError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "InvalidRelativePath" => UpdateDistributionError::InvalidRelativePath(String::from(parsed_error.message)),"InvalidIfMatchVersion" => UpdateDistributionError::InvalidIfMatchVersion(String::from(parsed_error.message)),"TooManyHeadersInForwardedValues" => UpdateDistributionError::TooManyHeadersInForwardedValues(String::from(parsed_error.message)),"TooManyTrustedSigners" => UpdateDistributionError::TooManyTrustedSigners(String::from(parsed_error.message)),"IllegalUpdate" => UpdateDistributionError::IllegalUpdate(String::from(parsed_error.message)),"NoSuchOrigin" => UpdateDistributionError::NoSuchOrigin(String::from(parsed_error.message)),"InvalidForwardCookies" => UpdateDistributionError::InvalidForwardCookies(String::from(parsed_error.message)),"InvalidOriginAccessIdentity" => UpdateDistributionError::InvalidOriginAccessIdentity(String::from(parsed_error.message)),"AccessDenied" => UpdateDistributionError::AccessDenied(String::from(parsed_error.message)),"InvalidDefaultRootObject" => UpdateDistributionError::InvalidDefaultRootObject(String::from(parsed_error.message)),"InvalidLocationCode" => UpdateDistributionError::InvalidLocationCode(String::from(parsed_error.message)),"TooManyCookieNamesInWhiteList" => UpdateDistributionError::TooManyCookieNamesInWhiteList(String::from(parsed_error.message)),"InvalidErrorCode" => UpdateDistributionError::InvalidErrorCode(String::from(parsed_error.message)),"CNAMEAlreadyExists" => UpdateDistributionError::CNAMEAlreadyExists(String::from(parsed_error.message)),"InvalidWebACLId" => UpdateDistributionError::InvalidWebACLId(String::from(parsed_error.message)),"TooManyDistributionCNAMEs" => UpdateDistributionError::TooManyDistributionCNAMEs(String::from(parsed_error.message)),"TooManyOrigins" => UpdateDistributionError::TooManyOrigins(String::from(parsed_error.message)),"InvalidGeoRestrictionParameter" => UpdateDistributionError::InvalidGeoRestrictionParameter(String::from(parsed_error.message)),"InvalidViewerCertificate" => UpdateDistributionError::InvalidViewerCertificate(String::from(parsed_error.message)),"InvalidMinimumProtocolVersion" => UpdateDistributionError::InvalidMinimumProtocolVersion(String::from(parsed_error.message)),"InvalidLambdaFunctionAssociation" => UpdateDistributionError::InvalidLambdaFunctionAssociation(String::from(parsed_error.message)),"TooManyOriginCustomHeaders" => UpdateDistributionError::TooManyOriginCustomHeaders(String::from(parsed_error.message)),"MissingBody" => UpdateDistributionError::MissingBody(String::from(parsed_error.message)),"InvalidHeadersForS3Origin" => UpdateDistributionError::InvalidHeadersForS3Origin(String::from(parsed_error.message)),"TooManyQueryStringParameters" => UpdateDistributionError::TooManyQueryStringParameters(String::from(parsed_error.message)),"InvalidQueryStringParameters" => UpdateDistributionError::InvalidQueryStringParameters(String::from(parsed_error.message)),"InconsistentQuantities" => UpdateDistributionError::InconsistentQuantities(String::from(parsed_error.message)),"TooManyDistributionsWithLambdaAssociations" => UpdateDistributionError::TooManyDistributionsWithLambdaAssociations(String::from(parsed_error.message)),"PreconditionFailed" => UpdateDistributionError::PreconditionFailed(String::from(parsed_error.message)),"TrustedSignerDoesNotExist" => UpdateDistributionError::TrustedSignerDoesNotExist(String::from(parsed_error.message)),"NoSuchDistribution" => UpdateDistributionError::NoSuchDistribution(String::from(parsed_error.message)),"InvalidArgument" => UpdateDistributionError::InvalidArgument(String::from(parsed_error.message)),"InvalidRequiredProtocol" => UpdateDistributionError::InvalidRequiredProtocol(String::from(parsed_error.message)),"InvalidResponseCode" => UpdateDistributionError::InvalidResponseCode(String::from(parsed_error.message)),"TooManyCertificates" => UpdateDistributionError::TooManyCertificates(String::from(parsed_error.message)),"TooManyLambdaFunctionAssociations" => UpdateDistributionError::TooManyLambdaFunctionAssociations(String::from(parsed_error.message)),"InvalidTTLOrder" => UpdateDistributionError::InvalidTTLOrder(String::from(parsed_error.message)),"TooManyCacheBehaviors" => UpdateDistributionError::TooManyCacheBehaviors(String::from(parsed_error.message)),_ => UpdateDistributionError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for UpdateDistributionError {
                    fn description(&self) -> &str {
                        match *self {
                            UpdateDistributionError::CNAMEAlreadyExists(ref cause) => cause,UpdateDistributionError::InvalidRequiredProtocol(ref cause) => cause,UpdateDistributionError::InvalidViewerCertificate(ref cause) => cause,UpdateDistributionError::TooManyCookieNamesInWhiteList(ref cause) => cause,UpdateDistributionError::AccessDenied(ref cause) => cause,UpdateDistributionError::TooManyDistributionCNAMEs(ref cause) => cause,UpdateDistributionError::TooManyLambdaFunctionAssociations(ref cause) => cause,UpdateDistributionError::InvalidRelativePath(ref cause) => cause,UpdateDistributionError::InvalidDefaultRootObject(ref cause) => cause,UpdateDistributionError::InvalidForwardCookies(ref cause) => cause,UpdateDistributionError::InvalidErrorCode(ref cause) => cause,UpdateDistributionError::TooManyTrustedSigners(ref cause) => cause,UpdateDistributionError::TrustedSignerDoesNotExist(ref cause) => cause,UpdateDistributionError::NoSuchOrigin(ref cause) => cause,UpdateDistributionError::InvalidArgument(ref cause) => cause,UpdateDistributionError::TooManyOrigins(ref cause) => cause,UpdateDistributionError::InvalidLambdaFunctionAssociation(ref cause) => cause,UpdateDistributionError::TooManyCertificates(ref cause) => cause,UpdateDistributionError::TooManyHeadersInForwardedValues(ref cause) => cause,UpdateDistributionError::InconsistentQuantities(ref cause) => cause,UpdateDistributionError::InvalidResponseCode(ref cause) => cause,UpdateDistributionError::InvalidWebACLId(ref cause) => cause,UpdateDistributionError::NoSuchDistribution(ref cause) => cause,UpdateDistributionError::PreconditionFailed(ref cause) => cause,UpdateDistributionError::IllegalUpdate(ref cause) => cause,UpdateDistributionError::InvalidIfMatchVersion(ref cause) => cause,UpdateDistributionError::MissingBody(ref cause) => cause,UpdateDistributionError::TooManyOriginCustomHeaders(ref cause) => cause,UpdateDistributionError::InvalidOriginAccessIdentity(ref cause) => cause,UpdateDistributionError::InvalidHeadersForS3Origin(ref cause) => cause,UpdateDistributionError::InvalidLocationCode(ref cause) => cause,UpdateDistributionError::TooManyQueryStringParameters(ref cause) => cause,UpdateDistributionError::TooManyCacheBehaviors(ref cause) => cause,UpdateDistributionError::TooManyDistributionsWithLambdaAssociations(ref cause) => cause,UpdateDistributionError::InvalidTTLOrder(ref cause) => cause,UpdateDistributionError::InvalidMinimumProtocolVersion(ref cause) => cause,UpdateDistributionError::InvalidQueryStringParameters(ref cause) => cause,UpdateDistributionError::InvalidGeoRestrictionParameter(ref cause) => cause,UpdateDistributionError::Validation(ref cause) => cause,UpdateDistributionError::Credentials(ref err) => err.description(),UpdateDistributionError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),UpdateDistributionError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl UpdateStreamingDistributionError {
                    pub fn from_body(body: &str) -> UpdateStreamingDistributionError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "InvalidIfMatchVersion" => UpdateStreamingDistributionError::InvalidIfMatchVersion(String::from(parsed_error.message)),"MissingBody" => UpdateStreamingDistributionError::MissingBody(String::from(parsed_error.message)),"InvalidOriginAccessIdentity" => UpdateStreamingDistributionError::InvalidOriginAccessIdentity(String::from(parsed_error.message)),"TooManyStreamingDistributionCNAMEs" => UpdateStreamingDistributionError::TooManyStreamingDistributionCNAMEs(String::from(parsed_error.message)),"InvalidArgument" => UpdateStreamingDistributionError::InvalidArgument(String::from(parsed_error.message)),"AccessDenied" => UpdateStreamingDistributionError::AccessDenied(String::from(parsed_error.message)),"TooManyTrustedSigners" => UpdateStreamingDistributionError::TooManyTrustedSigners(String::from(parsed_error.message)),"IllegalUpdate" => UpdateStreamingDistributionError::IllegalUpdate(String::from(parsed_error.message)),"InconsistentQuantities" => UpdateStreamingDistributionError::InconsistentQuantities(String::from(parsed_error.message)),"NoSuchStreamingDistribution" => UpdateStreamingDistributionError::NoSuchStreamingDistribution(String::from(parsed_error.message)),"TrustedSignerDoesNotExist" => UpdateStreamingDistributionError::TrustedSignerDoesNotExist(String::from(parsed_error.message)),"PreconditionFailed" => UpdateStreamingDistributionError::PreconditionFailed(String::from(parsed_error.message)),"CNAMEAlreadyExists" => UpdateStreamingDistributionError::CNAMEAlreadyExists(String::from(parsed_error.message)),_ => UpdateStreamingDistributionError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for UpdateStreamingDistributionError {
                    fn description(&self) -> &str {
                        match *self {
                            UpdateStreamingDistributionError::AccessDenied(ref cause) => cause,UpdateStreamingDistributionError::TrustedSignerDoesNotExist(ref cause) => cause,UpdateStreamingDistributionError::InvalidOriginAccessIdentity(ref cause) => cause,UpdateStreamingDistributionError::TooManyTrustedSigners(ref cause) => cause,UpdateStreamingDistributionError::IllegalUpdate(ref cause) => cause,UpdateStreamingDistributionError::InconsistentQuantities(ref cause) => cause,UpdateStreamingDistributionError::NoSuchStreamingDistribution(ref cause) => cause,UpdateStreamingDistributionError::CNAMEAlreadyExists(ref cause) => cause,UpdateStreamingDistributionError::MissingBody(ref cause) => cause,UpdateStreamingDistributionError::InvalidArgument(ref cause) => cause,UpdateStreamingDistributionError::InvalidIfMatchVersion(ref cause) => cause,UpdateStreamingDistributionError::TooManyStreamingDistributionCNAMEs(ref cause) => cause,UpdateStreamingDistributionError::PreconditionFailed(ref cause) => cause,UpdateStreamingDistributionError::Validation(ref cause) => cause,UpdateStreamingDistributionError::Credentials(ref err) => err.description(),UpdateStreamingDistributionError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),UpdateStreamingDistributionError::Unknown(ref cause) => cause
                        }
                    }
                 }
