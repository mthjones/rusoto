...
Unknown(String)
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "LoadBalancerNotFoundException" => AddTagsError::LoadBalancerNotFound(String::from(parsed_error.message)),"TargetGroupNotFoundException" => AddTagsError::TargetGroupNotFound(String::from(parsed_error.message)),"DuplicateTagKeysException" => AddTagsError::DuplicateTagKeys(String::from(parsed_error.message)),"TooManyTagsException" => AddTagsError::TooManyTags(String::from(parsed_error.message)),_ => AddTagsError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for AddTagsError {
                    fn description(&self) -> &str {
                        match *self {
                            AddTagsError::TooManyTags(ref cause) => cause,AddTagsError::TargetGroupNotFound(ref cause) => cause,AddTagsError::DuplicateTagKeys(ref cause) => cause,AddTagsError::LoadBalancerNotFound(ref cause) => cause,AddTagsError::Validation(ref cause) => cause,AddTagsError::Credentials(ref err) => err.description(),AddTagsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),AddTagsError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl CreateListenerError {
                    pub fn from_body(body: &str) -> CreateListenerError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "TargetGroupAssociationLimitException" => CreateListenerError::TargetGroupAssociationLimit(String::from(parsed_error.message)),"SSLPolicyNotFoundException" => CreateListenerError::SSLPolicyNotFound(String::from(parsed_error.message)),"TooManyRegistrationsForTargetIdException" => CreateListenerError::TooManyRegistrationsForTargetId(String::from(parsed_error.message)),"DuplicateListenerException" => CreateListenerError::DuplicateListener(String::from(parsed_error.message)),"CertificateNotFoundException" => CreateListenerError::CertificateNotFound(String::from(parsed_error.message)),"TooManyListenersException" => CreateListenerError::TooManyListeners(String::from(parsed_error.message)),"LoadBalancerNotFoundException" => CreateListenerError::LoadBalancerNotFound(String::from(parsed_error.message)),"IncompatibleProtocolsException" => CreateListenerError::IncompatibleProtocols(String::from(parsed_error.message)),"TooManyCertificatesException" => CreateListenerError::TooManyCertificates(String::from(parsed_error.message)),"TargetGroupNotFoundException" => CreateListenerError::TargetGroupNotFound(String::from(parsed_error.message)),"InvalidConfigurationRequestException" => CreateListenerError::InvalidConfigurationRequest(String::from(parsed_error.message)),"UnsupportedProtocolException" => CreateListenerError::UnsupportedProtocol(String::from(parsed_error.message)),_ => CreateListenerError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for CreateListenerError {
                    fn description(&self) -> &str {
                        match *self {
                            CreateListenerError::IncompatibleProtocols(ref cause) => cause,CreateListenerError::LoadBalancerNotFound(ref cause) => cause,CreateListenerError::TargetGroupAssociationLimit(ref cause) => cause,CreateListenerError::InvalidConfigurationRequest(ref cause) => cause,CreateListenerError::SSLPolicyNotFound(ref cause) => cause,CreateListenerError::DuplicateListener(ref cause) => cause,CreateListenerError::TooManyCertificates(ref cause) => cause,CreateListenerError::UnsupportedProtocol(ref cause) => cause,CreateListenerError::CertificateNotFound(ref cause) => cause,CreateListenerError::TooManyRegistrationsForTargetId(ref cause) => cause,CreateListenerError::TooManyListeners(ref cause) => cause,CreateListenerError::TargetGroupNotFound(ref cause) => cause,CreateListenerError::Validation(ref cause) => cause,CreateListenerError::Credentials(ref err) => err.description(),CreateListenerError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),CreateListenerError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
TooManyLoadBalancers(String),/// An error occurred dispatching the HTTP request
HttpDispatch(HttpDispatchError),/// An error was encountered with AWS credentials.
Credentials(CredentialsError),/// A validation error occurred.  Details from AWS are provided.
Validation(String),/// An unknown error occurred.  The raw HTTP response is provided.
Unknown(String)
                ...
                impl CreateLoadBalancerError {
                    pub fn from_body(body: &str) -> CreateLoadBalancerError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "DuplicateLoadBalancerNameException" => CreateLoadBalancerError::DuplicateLoadBalancerName(String::from(parsed_error.message)),"DuplicateTagKeysException" => CreateLoadBalancerError::DuplicateTagKeys(String::from(parsed_error.message)),"InvalidSubnetException" => CreateLoadBalancerError::InvalidSubnet(String::from(parsed_error.message)),"InvalidSecurityGroupException" => CreateLoadBalancerError::InvalidSecurityGroup(String::from(parsed_error.message)),"InvalidSchemeException" => CreateLoadBalancerError::InvalidScheme(String::from(parsed_error.message)),"TooManyTagsException" => CreateLoadBalancerError::TooManyTags(String::from(parsed_error.message)),"TooManyLoadBalancersException" => CreateLoadBalancerError::TooManyLoadBalancers(String::from(parsed_error.message)),"InvalidConfigurationRequestException" => CreateLoadBalancerError::InvalidConfigurationRequest(String::from(parsed_error.message)),"SubnetNotFoundException" => CreateLoadBalancerError::SubnetNotFound(String::from(parsed_error.message)),_ => CreateLoadBalancerError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for CreateLoadBalancerError {
                    fn description(&self) -> &str {
                        match *self {
                            CreateLoadBalancerError::InvalidScheme(ref cause) => cause,CreateLoadBalancerError::DuplicateTagKeys(ref cause) => cause,CreateLoadBalancerError::InvalidSubnet(ref cause) => cause,CreateLoadBalancerError::TooManyLoadBalancers(ref cause) => cause,CreateLoadBalancerError::InvalidSecurityGroup(ref cause) => cause,CreateLoadBalancerError::TooManyTags(ref cause) => cause,CreateLoadBalancerError::InvalidConfigurationRequest(ref cause) => cause,CreateLoadBalancerError::SubnetNotFound(ref cause) => cause,CreateLoadBalancerError::DuplicateLoadBalancerName(ref cause) => cause,CreateLoadBalancerError::Validation(ref cause) => cause,CreateLoadBalancerError::Credentials(ref err) => err.description(),CreateLoadBalancerError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),CreateLoadBalancerError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl CreateRuleError {
                    pub fn from_body(body: &str) -> CreateRuleError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "InvalidConfigurationRequestException" => CreateRuleError::InvalidConfigurationRequest(String::from(parsed_error.message)),"PriorityInUseException" => CreateRuleError::PriorityInUse(String::from(parsed_error.message)),"TargetGroupAssociationLimitException" => CreateRuleError::TargetGroupAssociationLimit(String::from(parsed_error.message)),"TooManyRegistrationsForTargetIdException" => CreateRuleError::TooManyRegistrationsForTargetId(String::from(parsed_error.message)),"ListenerNotFoundException" => CreateRuleError::ListenerNotFound(String::from(parsed_error.message)),"TooManyRulesException" => CreateRuleError::TooManyRules(String::from(parsed_error.message)),"TargetGroupNotFoundException" => CreateRuleError::TargetGroupNotFound(String::from(parsed_error.message)),"TooManyTargetGroupsException" => CreateRuleError::TooManyTargetGroups(String::from(parsed_error.message)),_ => CreateRuleError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for CreateRuleError {
                    fn description(&self) -> &str {
                        match *self {
                            CreateRuleError::TargetGroupNotFound(ref cause) => cause,CreateRuleError::TargetGroupAssociationLimit(ref cause) => cause,CreateRuleError::TooManyTargetGroups(ref cause) => cause,CreateRuleError::TooManyRegistrationsForTargetId(ref cause) => cause,CreateRuleError::InvalidConfigurationRequest(ref cause) => cause,CreateRuleError::ListenerNotFound(ref cause) => cause,CreateRuleError::TooManyRules(ref cause) => cause,CreateRuleError::PriorityInUse(ref cause) => cause,CreateRuleError::Validation(ref cause) => cause,CreateRuleError::Credentials(ref err) => err.description(),CreateRuleError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),CreateRuleError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl CreateTargetGroupError {
                    pub fn from_body(body: &str) -> CreateTargetGroupError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "TooManyTargetGroupsException" => CreateTargetGroupError::TooManyTargetGroups(String::from(parsed_error.message)),"DuplicateTargetGroupNameException" => CreateTargetGroupError::DuplicateTargetGroupName(String::from(parsed_error.message)),_ => CreateTargetGroupError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for CreateTargetGroupError {
                    fn description(&self) -> &str {
                        match *self {
                            CreateTargetGroupError::TooManyTargetGroups(ref cause) => cause,CreateTargetGroupError::DuplicateTargetGroupName(ref cause) => cause,CreateTargetGroupError::Validation(ref cause) => cause,CreateTargetGroupError::Credentials(ref err) => err.description(),CreateTargetGroupError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),CreateTargetGroupError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl Error for DeleteLoadBalancerError {
                    fn description(&self) -> &str {
                        match *self {
                            DeleteLoadBalancerError::OperationNotPermitted(ref cause) => cause,DeleteLoadBalancerError::LoadBalancerNotFound(ref cause) => cause,DeleteLoadBalancerError::Validation(ref cause) => cause,DeleteLoadBalancerError::Credentials(ref err) => err.description(),DeleteLoadBalancerError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),DeleteLoadBalancerError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl DescribeRulesError {
                    pub fn from_body(body: &str) -> DescribeRulesError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "RuleNotFoundException" => DescribeRulesError::RuleNotFound(String::from(parsed_error.message)),"ListenerNotFoundException" => DescribeRulesError::ListenerNotFound(String::from(parsed_error.message)),_ => DescribeRulesError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for DescribeRulesError {
                    fn description(&self) -> &str {
                        match *self {
                            DescribeRulesError::RuleNotFound(ref cause) => cause,DescribeRulesError::ListenerNotFound(ref cause) => cause,DescribeRulesError::Validation(ref cause) => cause,DescribeRulesError::Credentials(ref err) => err.description(),DescribeRulesError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),DescribeRulesError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl DescribeTagsError {
                    pub fn from_body(body: &str) -> DescribeTagsError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "LoadBalancerNotFoundException" => DescribeTagsError::LoadBalancerNotFound(String::from(parsed_error.message)),"ListenerNotFoundException" => DescribeTagsError::ListenerNotFound(String::from(parsed_error.message)),"RuleNotFoundException" => DescribeTagsError::RuleNotFound(String::from(parsed_error.message)),"TargetGroupNotFoundException" => DescribeTagsError::TargetGroupNotFound(String::from(parsed_error.message)),_ => DescribeTagsError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for DescribeTagsError {
                    fn description(&self) -> &str {
                        match *self {
                            DescribeTagsError::ListenerNotFound(ref cause) => cause,DescribeTagsError::RuleNotFound(ref cause) => cause,DescribeTagsError::LoadBalancerNotFound(ref cause) => cause,DescribeTagsError::TargetGroupNotFound(ref cause) => cause,DescribeTagsError::Validation(ref cause) => cause,DescribeTagsError::Credentials(ref err) => err.description(),DescribeTagsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),DescribeTagsError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl Error for DescribeTargetHealthError {
                    fn description(&self) -> &str {
                        match *self {
                            DescribeTargetHealthError::InvalidTarget(ref cause) => cause,DescribeTargetHealthError::HealthUnavailable(ref cause) => cause,DescribeTargetHealthError::TargetGroupNotFound(ref cause) => cause,DescribeTargetHealthError::Validation(ref cause) => cause,DescribeTargetHealthError::Credentials(ref err) => err.description(),DescribeTargetHealthError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),DescribeTargetHealthError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl ModifyListenerError {
                    pub fn from_body(body: &str) -> ModifyListenerError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "TargetGroupAssociationLimitException" => ModifyListenerError::TargetGroupAssociationLimit(String::from(parsed_error.message)),"CertificateNotFoundException" => ModifyListenerError::CertificateNotFound(String::from(parsed_error.message)),"TooManyRegistrationsForTargetIdException" => ModifyListenerError::TooManyRegistrationsForTargetId(String::from(parsed_error.message)),"InvalidConfigurationRequestException" => ModifyListenerError::InvalidConfigurationRequest(String::from(parsed_error.message)),"SSLPolicyNotFoundException" => ModifyListenerError::SSLPolicyNotFound(String::from(parsed_error.message)),"TargetGroupNotFoundException" => ModifyListenerError::TargetGroupNotFound(String::from(parsed_error.message)),"ListenerNotFoundException" => ModifyListenerError::ListenerNotFound(String::from(parsed_error.message)),"DuplicateListenerException" => ModifyListenerError::DuplicateListener(String::from(parsed_error.message)),"TooManyListenersException" => ModifyListenerError::TooManyListeners(String::from(parsed_error.message)),"TooManyCertificatesException" => ModifyListenerError::TooManyCertificates(String::from(parsed_error.message)),"IncompatibleProtocolsException" => ModifyListenerError::IncompatibleProtocols(String::from(parsed_error.message)),"UnsupportedProtocolException" => ModifyListenerError::UnsupportedProtocol(String::from(parsed_error.message)),_ => ModifyListenerError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for ModifyListenerError {
                    fn description(&self) -> &str {
                        match *self {
                            ModifyListenerError::TargetGroupAssociationLimit(ref cause) => cause,ModifyListenerError::InvalidConfigurationRequest(ref cause) => cause,ModifyListenerError::TooManyListeners(ref cause) => cause,ModifyListenerError::TooManyRegistrationsForTargetId(ref cause) => cause,ModifyListenerError::SSLPolicyNotFound(ref cause) => cause,ModifyListenerError::CertificateNotFound(ref cause) => cause,ModifyListenerError::TooManyCertificates(ref cause) => cause,ModifyListenerError::IncompatibleProtocols(ref cause) => cause,ModifyListenerError::DuplicateListener(ref cause) => cause,ModifyListenerError::TargetGroupNotFound(ref cause) => cause,ModifyListenerError::UnsupportedProtocol(ref cause) => cause,ModifyListenerError::ListenerNotFound(ref cause) => cause,ModifyListenerError::Validation(ref cause) => cause,ModifyListenerError::Credentials(ref err) => err.description(),ModifyListenerError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),ModifyListenerError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl ModifyRuleError {
                    pub fn from_body(body: &str) -> ModifyRuleError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "TargetGroupAssociationLimitException" => ModifyRuleError::TargetGroupAssociationLimit(String::from(parsed_error.message)),"OperationNotPermittedException" => ModifyRuleError::OperationNotPermitted(String::from(parsed_error.message)),"RuleNotFoundException" => ModifyRuleError::RuleNotFound(String::from(parsed_error.message)),"TooManyRegistrationsForTargetIdException" => ModifyRuleError::TooManyRegistrationsForTargetId(String::from(parsed_error.message)),_ => ModifyRuleError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for ModifyRuleError {
                    fn description(&self) -> &str {
                        match *self {
                            ModifyRuleError::OperationNotPermitted(ref cause) => cause,ModifyRuleError::TooManyRegistrationsForTargetId(ref cause) => cause,ModifyRuleError::TargetGroupAssociationLimit(ref cause) => cause,ModifyRuleError::RuleNotFound(ref cause) => cause,ModifyRuleError::Validation(ref cause) => cause,ModifyRuleError::Credentials(ref err) => err.description(),ModifyRuleError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),ModifyRuleError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl RegisterTargetsError {
                    pub fn from_body(body: &str) -> RegisterTargetsError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "TargetGroupNotFoundException" => RegisterTargetsError::TargetGroupNotFound(String::from(parsed_error.message)),"TooManyTargetsException" => RegisterTargetsError::TooManyTargets(String::from(parsed_error.message)),"TooManyRegistrationsForTargetIdException" => RegisterTargetsError::TooManyRegistrationsForTargetId(String::from(parsed_error.message)),"InvalidTargetException" => RegisterTargetsError::InvalidTarget(String::from(parsed_error.message)),_ => RegisterTargetsError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for RegisterTargetsError {
                    fn description(&self) -> &str {
                        match *self {
                            RegisterTargetsError::TooManyRegistrationsForTargetId(ref cause) => cause,RegisterTargetsError::TargetGroupNotFound(ref cause) => cause,RegisterTargetsError::TooManyTargets(ref cause) => cause,RegisterTargetsError::InvalidTarget(ref cause) => cause,RegisterTargetsError::Validation(ref cause) => cause,RegisterTargetsError::Credentials(ref err) => err.description(),RegisterTargetsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),RegisterTargetsError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl RemoveTagsError {
                    pub fn from_body(body: &str) -> RemoveTagsError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ListenerNotFoundException" => RemoveTagsError::ListenerNotFound(String::from(parsed_error.message)),"TooManyTagsException" => RemoveTagsError::TooManyTags(String::from(parsed_error.message)),"LoadBalancerNotFoundException" => RemoveTagsError::LoadBalancerNotFound(String::from(parsed_error.message)),"RuleNotFoundException" => RemoveTagsError::RuleNotFound(String::from(parsed_error.message)),"TargetGroupNotFoundException" => RemoveTagsError::TargetGroupNotFound(String::from(parsed_error.message)),_ => RemoveTagsError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for RemoveTagsError {
                    fn description(&self) -> &str {
                        match *self {
                            RemoveTagsError::TargetGroupNotFound(ref cause) => cause,RemoveTagsError::TooManyTags(ref cause) => cause,RemoveTagsError::RuleNotFound(ref cause) => cause,RemoveTagsError::LoadBalancerNotFound(ref cause) => cause,RemoveTagsError::ListenerNotFound(ref cause) => cause,RemoveTagsError::Validation(ref cause) => cause,RemoveTagsError::Credentials(ref err) => err.description(),RemoveTagsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),RemoveTagsError::Unknown(ref cause) => cause
                        }
                    }
                 }
                ...
                impl SetRulePrioritiesError {
                    pub fn from_body(body: &str) -> SetRulePrioritiesError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "RuleNotFoundException" => SetRulePrioritiesError::RuleNotFound(String::from(parsed_error.message)),"OperationNotPermittedException" => SetRulePrioritiesError::OperationNotPermitted(String::from(parsed_error.message)),"PriorityInUseException" => SetRulePrioritiesError::PriorityInUse(String::from(parsed_error.message)),_ => SetRulePrioritiesError::Unknown(String::from(body))
                                }
                           },
                ...
                impl SetSecurityGroupsError {
                    pub fn from_body(body: &str) -> SetSecurityGroupsError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "InvalidSecurityGroupException" => SetSecurityGroupsError::InvalidSecurityGroup(String::from(parsed_error.message)),"InvalidConfigurationRequestException" => SetSecurityGroupsError::InvalidConfigurationRequest(String::from(parsed_error.message)),"LoadBalancerNotFoundException" => SetSecurityGroupsError::LoadBalancerNotFound(String::from(parsed_error.message)),_ => SetSecurityGroupsError::Unknown(String::from(body))
                                }
                           },
                ...
                impl SetSubnetsError {
                    pub fn from_body(body: &str) -> SetSubnetsError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "SubnetNotFoundException" => SetSubnetsError::SubnetNotFound(String::from(parsed_error.message)),"InvalidSubnetException" => SetSubnetsError::InvalidSubnet(String::from(parsed_error.message)),"LoadBalancerNotFoundException" => SetSubnetsError::LoadBalancerNotFound(String::from(parsed_error.message)),"InvalidConfigurationRequestException" => SetSubnetsError::InvalidConfigurationRequest(String::from(parsed_error.message)),_ => SetSubnetsError::Unknown(String::from(body))
                                }
                           },
