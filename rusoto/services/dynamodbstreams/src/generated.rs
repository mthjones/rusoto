                    ...
                    pub fn from_body(body: &str) -> GetRecordsError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InternalServerError" => GetRecordsError::InternalServerError(String::from(error_message)),"ResourceNotFoundException" => GetRecordsError::ResourceNotFound(String::from(error_message)),"ExpiredIteratorException" => GetRecordsError::ExpiredIterator(String::from(error_message)),"TrimmedDataAccessException" => GetRecordsError::TrimmedDataAccess(String::from(error_message)),"LimitExceededException" => GetRecordsError::LimitExceeded(String::from(error_message)),"ValidationException" => GetRecordsError::Validation(error_message.to_string()),_ => GetRecordsError::Unknown(String::from(body))
                                }
                            },
...
Unknown(String)
                ...
                impl Error for GetShardIteratorError {
                    fn description(&self) -> &str {
                        match *self {
                            GetShardIteratorError::TrimmedDataAccess(ref cause) => cause,GetShardIteratorError::ResourceNotFound(ref cause) => cause,GetShardIteratorError::InternalServerError(ref cause) => cause,GetShardIteratorError::Validation(ref cause) => cause,GetShardIteratorError::Credentials(ref err) => err.description(),GetShardIteratorError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),GetShardIteratorError::Unknown(ref cause) => cause
                        }
                    }
                 }
