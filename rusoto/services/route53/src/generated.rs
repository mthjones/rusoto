...
Unknown(String)
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "NoSuchHostedZone" => AssociateVPCWithHostedZoneError::NoSuchHostedZone(String::from(parsed_error.message)),"InvalidVPCId" => AssociateVPCWithHostedZoneError::InvalidVPCId(String::from(parsed_error.message)),"LimitsExceeded" => AssociateVPCWithHostedZoneError::LimitsExceeded(String::from(parsed_error.message)),"NotAuthorizedException" => AssociateVPCWithHostedZoneError::NotAuthorized(String::from(parsed_error.message)),"PublicZoneVPCAssociation" => AssociateVPCWithHostedZoneError::PublicZoneVPCAssociation(String::from(parsed_error.message)),"ConflictingDomainExists" => AssociateVPCWithHostedZoneError::ConflictingDomainExists(String::from(parsed_error.message)),"InvalidInput" => AssociateVPCWithHostedZoneError::InvalidInput(String::from(parsed_error.message)),_ => AssociateVPCWithHostedZoneError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for AssociateVPCWithHostedZoneError {
                    fn description(&self) -> &str {
                        match *self {
                            AssociateVPCWithHostedZoneError::LimitsExceeded(ref cause) => cause,AssociateVPCWithHostedZoneError::NotAuthorized(ref cause) => cause,AssociateVPCWithHostedZoneError::ConflictingDomainExists(ref cause) => cause,AssociateVPCWithHostedZoneError::PublicZoneVPCAssociation(ref cause) => cause,AssociateVPCWithHostedZoneError::InvalidInput(ref cause) => cause,AssociateVPCWithHostedZoneError::NoSuchHostedZone(ref cause) => cause,AssociateVPCWithHostedZoneError::InvalidVPCId(ref cause) => cause,AssociateVPCWithHostedZoneError::Validation(ref cause) => cause,AssociateVPCWithHostedZoneError::Credentials(ref err) => err.description(),AssociateVPCWithHostedZoneError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),AssociateVPCWithHostedZoneError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl ChangeTagsForResourceError {
                    pub fn from_body(body: &str) -> ChangeTagsForResourceError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ThrottlingException" => ChangeTagsForResourceError::Throttling(String::from(parsed_error.message)),"NoSuchHealthCheck" => ChangeTagsForResourceError::NoSuchHealthCheck(String::from(parsed_error.message)),"PriorRequestNotComplete" => ChangeTagsForResourceError::PriorRequestNotComplete(String::from(parsed_error.message)),"InvalidInput" => ChangeTagsForResourceError::InvalidInput(String::from(parsed_error.message)),"NoSuchHostedZone" => ChangeTagsForResourceError::NoSuchHostedZone(String::from(parsed_error.message)),_ => ChangeTagsForResourceError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for ChangeTagsForResourceError {
                    fn description(&self) -> &str {
                        match *self {
                            ChangeTagsForResourceError::PriorRequestNotComplete(ref cause) => cause,ChangeTagsForResourceError::Throttling(ref cause) => cause,ChangeTagsForResourceError::InvalidInput(ref cause) => cause,ChangeTagsForResourceError::NoSuchHostedZone(ref cause) => cause,ChangeTagsForResourceError::NoSuchHealthCheck(ref cause) => cause,ChangeTagsForResourceError::Validation(ref cause) => cause,ChangeTagsForResourceError::Credentials(ref err) => err.description(),ChangeTagsForResourceError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),ChangeTagsForResourceError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl CreateHealthCheckError {
                    pub fn from_body(body: &str) -> CreateHealthCheckError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "InvalidInput" => CreateHealthCheckError::InvalidInput(String::from(parsed_error.message)),"TooManyHealthChecks" => CreateHealthCheckError::TooManyHealthChecks(String::from(parsed_error.message)),"HealthCheckAlreadyExists" => CreateHealthCheckError::HealthCheckAlreadyExists(String::from(parsed_error.message)),_ => CreateHealthCheckError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for CreateHealthCheckError {
                    fn description(&self) -> &str {
                        match *self {
                            CreateHealthCheckError::TooManyHealthChecks(ref cause) => cause,CreateHealthCheckError::HealthCheckAlreadyExists(ref cause) => cause,CreateHealthCheckError::InvalidInput(ref cause) => cause,CreateHealthCheckError::Validation(ref cause) => cause,CreateHealthCheckError::Credentials(ref err) => err.description(),CreateHealthCheckError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),CreateHealthCheckError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
HostedZoneAlreadyExists(String),/// An error occurred dispatching the HTTP request
HttpDispatch(HttpDispatchError),/// An error was encountered with AWS credentials.
Credentials(CredentialsError),/// A validation error occurred.  Details from AWS are provided.
Validation(String),/// An unknown error occurred.  The raw HTTP response is provided.
Unknown(String)
                ...
                impl CreateHostedZoneError {
                    pub fn from_body(body: &str) -> CreateHostedZoneError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "InvalidInput" => CreateHostedZoneError::InvalidInput(String::from(parsed_error.message)),"DelegationSetNotAvailable" => CreateHostedZoneError::DelegationSetNotAvailable(String::from(parsed_error.message)),"DelegationSetNotReusable" => CreateHostedZoneError::DelegationSetNotReusable(String::from(parsed_error.message)),"TooManyHostedZones" => CreateHostedZoneError::TooManyHostedZones(String::from(parsed_error.message)),"HostedZoneAlreadyExists" => CreateHostedZoneError::HostedZoneAlreadyExists(String::from(parsed_error.message)),"ConflictingDomainExists" => CreateHostedZoneError::ConflictingDomainExists(String::from(parsed_error.message)),"NoSuchDelegationSet" => CreateHostedZoneError::NoSuchDelegationSet(String::from(parsed_error.message)),"InvalidVPCId" => CreateHostedZoneError::InvalidVPCId(String::from(parsed_error.message)),"InvalidDomainName" => CreateHostedZoneError::InvalidDomainName(String::from(parsed_error.message)),_ => CreateHostedZoneError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for CreateHostedZoneError {
                    fn description(&self) -> &str {
                        match *self {
                            CreateHostedZoneError::DelegationSetNotReusable(ref cause) => cause,CreateHostedZoneError::DelegationSetNotAvailable(ref cause) => cause,CreateHostedZoneError::InvalidInput(ref cause) => cause,CreateHostedZoneError::NoSuchDelegationSet(ref cause) => cause,CreateHostedZoneError::InvalidVPCId(ref cause) => cause,CreateHostedZoneError::ConflictingDomainExists(ref cause) => cause,CreateHostedZoneError::HostedZoneAlreadyExists(ref cause) => cause,CreateHostedZoneError::TooManyHostedZones(ref cause) => cause,CreateHostedZoneError::InvalidDomainName(ref cause) => cause,CreateHostedZoneError::Validation(ref cause) => cause,CreateHostedZoneError::Credentials(ref err) => err.description(),CreateHostedZoneError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),CreateHostedZoneError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
HostedZoneNotFound(String),/// An error occurred dispatching the HTTP request
HttpDispatch(HttpDispatchError),/// An error was encountered with AWS credentials.
Credentials(CredentialsError),/// A validation error occurred.  Details from AWS are provided.
Validation(String),/// An unknown error occurred.  The raw HTTP response is provided.
Unknown(String)
                ...
                impl CreateReusableDelegationSetError {
                    pub fn from_body(body: &str) -> CreateReusableDelegationSetError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "DelegationSetAlreadyCreated" => CreateReusableDelegationSetError::DelegationSetAlreadyCreated(String::from(parsed_error.message)),"DelegationSetAlreadyReusable" => CreateReusableDelegationSetError::DelegationSetAlreadyReusable(String::from(parsed_error.message)),"InvalidArgument" => CreateReusableDelegationSetError::InvalidArgument(String::from(parsed_error.message)),"InvalidInput" => CreateReusableDelegationSetError::InvalidInput(String::from(parsed_error.message)),"HostedZoneNotFound" => CreateReusableDelegationSetError::HostedZoneNotFound(String::from(parsed_error.message)),"DelegationSetNotAvailable" => CreateReusableDelegationSetError::DelegationSetNotAvailable(String::from(parsed_error.message)),"LimitsExceeded" => CreateReusableDelegationSetError::LimitsExceeded(String::from(parsed_error.message)),_ => CreateReusableDelegationSetError::Unknown(String::from(body))
                                }
                           },
...
Unknown(String)
                ...
                impl Error for CreateTrafficPolicyError {
                    fn description(&self) -> &str {
                        match *self {
                            CreateTrafficPolicyError::TooManyTrafficPolicies(ref cause) => cause,CreateTrafficPolicyError::InvalidTrafficPolicyDocument(ref cause) => cause,CreateTrafficPolicyError::TrafficPolicyAlreadyExists(ref cause) => cause,CreateTrafficPolicyError::InvalidInput(ref cause) => cause,CreateTrafficPolicyError::Validation(ref cause) => cause,CreateTrafficPolicyError::Credentials(ref err) => err.description(),CreateTrafficPolicyError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),CreateTrafficPolicyError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
TooManyTrafficPolicyInstances(String),/// An error occurred dispatching the HTTP request
HttpDispatch(HttpDispatchError),/// An error was encountered with AWS credentials.
Credentials(CredentialsError),/// A validation error occurred.  Details from AWS are provided.
Validation(String),/// An unknown error occurred.  The raw HTTP response is provided.
Unknown(String)
...
Unknown(String)
                ...
                impl CreateTrafficPolicyVersionError {
                    pub fn from_body(body: &str) -> CreateTrafficPolicyVersionError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "NoSuchTrafficPolicy" => CreateTrafficPolicyVersionError::NoSuchTrafficPolicy(String::from(parsed_error.message)),"ConcurrentModification" => CreateTrafficPolicyVersionError::ConcurrentModification(String::from(parsed_error.message)),"InvalidTrafficPolicyDocument" => CreateTrafficPolicyVersionError::InvalidTrafficPolicyDocument(String::from(parsed_error.message)),"InvalidInput" => CreateTrafficPolicyVersionError::InvalidInput(String::from(parsed_error.message)),_ => CreateTrafficPolicyVersionError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for CreateTrafficPolicyVersionError {
                    fn description(&self) -> &str {
                        match *self {
                            CreateTrafficPolicyVersionError::ConcurrentModification(ref cause) => cause,CreateTrafficPolicyVersionError::NoSuchTrafficPolicy(ref cause) => cause,CreateTrafficPolicyVersionError::InvalidInput(ref cause) => cause,CreateTrafficPolicyVersionError::InvalidTrafficPolicyDocument(ref cause) => cause,CreateTrafficPolicyVersionError::Validation(ref cause) => cause,CreateTrafficPolicyVersionError::Credentials(ref err) => err.description(),CreateTrafficPolicyVersionError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),CreateTrafficPolicyVersionError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl CreateVPCAssociationAuthorizationError {
                    pub fn from_body(body: &str) -> CreateVPCAssociationAuthorizationError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "NoSuchHostedZone" => CreateVPCAssociationAuthorizationError::NoSuchHostedZone(String::from(parsed_error.message)),"TooManyVPCAssociationAuthorizations" => CreateVPCAssociationAuthorizationError::TooManyVPCAssociationAuthorizations(String::from(parsed_error.message)),"InvalidInput" => CreateVPCAssociationAuthorizationError::InvalidInput(String::from(parsed_error.message)),"InvalidVPCId" => CreateVPCAssociationAuthorizationError::InvalidVPCId(String::from(parsed_error.message)),_ => CreateVPCAssociationAuthorizationError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for CreateVPCAssociationAuthorizationError {
                    fn description(&self) -> &str {
                        match *self {
                            CreateVPCAssociationAuthorizationError::InvalidInput(ref cause) => cause,CreateVPCAssociationAuthorizationError::NoSuchHostedZone(ref cause) => cause,CreateVPCAssociationAuthorizationError::TooManyVPCAssociationAuthorizations(ref cause) => cause,CreateVPCAssociationAuthorizationError::InvalidVPCId(ref cause) => cause,CreateVPCAssociationAuthorizationError::Validation(ref cause) => cause,CreateVPCAssociationAuthorizationError::Credentials(ref err) => err.description(),CreateVPCAssociationAuthorizationError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),CreateVPCAssociationAuthorizationError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl DeleteHealthCheckError {
                    pub fn from_body(body: &str) -> DeleteHealthCheckError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "NoSuchHealthCheck" => DeleteHealthCheckError::NoSuchHealthCheck(String::from(parsed_error.message)),"HealthCheckInUse" => DeleteHealthCheckError::HealthCheckInUse(String::from(parsed_error.message)),"InvalidInput" => DeleteHealthCheckError::InvalidInput(String::from(parsed_error.message)),_ => DeleteHealthCheckError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for DeleteHealthCheckError {
                    fn description(&self) -> &str {
                        match *self {
                            DeleteHealthCheckError::InvalidInput(ref cause) => cause,DeleteHealthCheckError::HealthCheckInUse(ref cause) => cause,DeleteHealthCheckError::NoSuchHealthCheck(ref cause) => cause,DeleteHealthCheckError::Validation(ref cause) => cause,DeleteHealthCheckError::Credentials(ref err) => err.description(),DeleteHealthCheckError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),DeleteHealthCheckError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl DeleteHostedZoneError {
                    pub fn from_body(body: &str) -> DeleteHostedZoneError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "InvalidInput" => DeleteHostedZoneError::InvalidInput(String::from(parsed_error.message)),"HostedZoneNotEmpty" => DeleteHostedZoneError::HostedZoneNotEmpty(String::from(parsed_error.message)),"PriorRequestNotComplete" => DeleteHostedZoneError::PriorRequestNotComplete(String::from(parsed_error.message)),"InvalidDomainName" => DeleteHostedZoneError::InvalidDomainName(String::from(parsed_error.message)),"NoSuchHostedZone" => DeleteHostedZoneError::NoSuchHostedZone(String::from(parsed_error.message)),_ => DeleteHostedZoneError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for DeleteHostedZoneError {
                    fn description(&self) -> &str {
                        match *self {
                            DeleteHostedZoneError::HostedZoneNotEmpty(ref cause) => cause,DeleteHostedZoneError::InvalidInput(ref cause) => cause,DeleteHostedZoneError::InvalidDomainName(ref cause) => cause,DeleteHostedZoneError::NoSuchHostedZone(ref cause) => cause,DeleteHostedZoneError::PriorRequestNotComplete(ref cause) => cause,DeleteHostedZoneError::Validation(ref cause) => cause,DeleteHostedZoneError::Credentials(ref err) => err.description(),DeleteHostedZoneError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),DeleteHostedZoneError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
DelegationSetInUse(String),/// An error occurred dispatching the HTTP request
HttpDispatch(HttpDispatchError),/// An error was encountered with AWS credentials.
Credentials(CredentialsError),/// A validation error occurred.  Details from AWS are provided.
Validation(String),/// An unknown error occurred.  The raw HTTP response is provided.
Unknown(String)
                ...
                impl DeleteReusableDelegationSetError {
                    pub fn from_body(body: &str) -> DeleteReusableDelegationSetError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "NoSuchDelegationSet" => DeleteReusableDelegationSetError::NoSuchDelegationSet(String::from(parsed_error.message)),"DelegationSetNotReusable" => DeleteReusableDelegationSetError::DelegationSetNotReusable(String::from(parsed_error.message)),"DelegationSetInUse" => DeleteReusableDelegationSetError::DelegationSetInUse(String::from(parsed_error.message)),"InvalidInput" => DeleteReusableDelegationSetError::InvalidInput(String::from(parsed_error.message)),_ => DeleteReusableDelegationSetError::Unknown(String::from(body))
                                }
                           },
...
Unknown(String)
                ...
                impl DeleteTrafficPolicyInstanceError {
                    pub fn from_body(body: &str) -> DeleteTrafficPolicyInstanceError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "InvalidInput" => DeleteTrafficPolicyInstanceError::InvalidInput(String::from(parsed_error.message)),"PriorRequestNotComplete" => DeleteTrafficPolicyInstanceError::PriorRequestNotComplete(String::from(parsed_error.message)),"NoSuchTrafficPolicyInstance" => DeleteTrafficPolicyInstanceError::NoSuchTrafficPolicyInstance(String::from(parsed_error.message)),_ => DeleteTrafficPolicyInstanceError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for DeleteTrafficPolicyInstanceError {
                    fn description(&self) -> &str {
                        match *self {
                            DeleteTrafficPolicyInstanceError::InvalidInput(ref cause) => cause,DeleteTrafficPolicyInstanceError::PriorRequestNotComplete(ref cause) => cause,DeleteTrafficPolicyInstanceError::NoSuchTrafficPolicyInstance(ref cause) => cause,DeleteTrafficPolicyInstanceError::Validation(ref cause) => cause,DeleteTrafficPolicyInstanceError::Credentials(ref err) => err.description(),DeleteTrafficPolicyInstanceError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),DeleteTrafficPolicyInstanceError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl DeleteVPCAssociationAuthorizationError {
                    pub fn from_body(body: &str) -> DeleteVPCAssociationAuthorizationError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "InvalidInput" => DeleteVPCAssociationAuthorizationError::InvalidInput(String::from(parsed_error.message)),"NoSuchHostedZone" => DeleteVPCAssociationAuthorizationError::NoSuchHostedZone(String::from(parsed_error.message)),"VPCAssociationAuthorizationNotFound" => DeleteVPCAssociationAuthorizationError::VPCAssociationAuthorizationNotFound(String::from(parsed_error.message)),"InvalidVPCId" => DeleteVPCAssociationAuthorizationError::InvalidVPCId(String::from(parsed_error.message)),_ => DeleteVPCAssociationAuthorizationError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for DeleteVPCAssociationAuthorizationError {
                    fn description(&self) -> &str {
                        match *self {
                            DeleteVPCAssociationAuthorizationError::VPCAssociationAuthorizationNotFound(ref cause) => cause,DeleteVPCAssociationAuthorizationError::NoSuchHostedZone(ref cause) => cause,DeleteVPCAssociationAuthorizationError::InvalidVPCId(ref cause) => cause,DeleteVPCAssociationAuthorizationError::InvalidInput(ref cause) => cause,DeleteVPCAssociationAuthorizationError::Validation(ref cause) => cause,DeleteVPCAssociationAuthorizationError::Credentials(ref err) => err.description(),DeleteVPCAssociationAuthorizationError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),DeleteVPCAssociationAuthorizationError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
///<p>The VPC ID that you specified either isn't a valid ID or the current account is not authorized to access this VPC.</p>
InvalidVPCId(String),/// An error occurred dispatching the HTTP request
HttpDispatch(HttpDispatchError),/// An error was encountered with AWS credentials.
Credentials(CredentialsError),/// A validation error occurred.  Details from AWS are provided.
Validation(String),/// An unknown error occurred.  The raw HTTP response is provided.
Unknown(String)
                ...
                impl DisassociateVPCFromHostedZoneError {
                    pub fn from_body(body: &str) -> DisassociateVPCFromHostedZoneError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "NoSuchHostedZone" => DisassociateVPCFromHostedZoneError::NoSuchHostedZone(String::from(parsed_error.message)),"InvalidVPCId" => DisassociateVPCFromHostedZoneError::InvalidVPCId(String::from(parsed_error.message)),"InvalidInput" => DisassociateVPCFromHostedZoneError::InvalidInput(String::from(parsed_error.message)),"VPCAssociationNotFound" => DisassociateVPCFromHostedZoneError::VPCAssociationNotFound(String::from(parsed_error.message)),"LastVPCAssociation" => DisassociateVPCFromHostedZoneError::LastVPCAssociation(String::from(parsed_error.message)),_ => DisassociateVPCFromHostedZoneError::Unknown(String::from(body))
                                }
                           },
                ...
                impl GetGeoLocationError {
                    pub fn from_body(body: &str) -> GetGeoLocationError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "NoSuchGeoLocation" => GetGeoLocationError::NoSuchGeoLocation(String::from(parsed_error.message)),"InvalidInput" => GetGeoLocationError::InvalidInput(String::from(parsed_error.message)),_ => GetGeoLocationError::Unknown(String::from(body))
                                }
                           },
                ...
                impl GetHealthCheckError {
                    pub fn from_body(body: &str) -> GetHealthCheckError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "NoSuchHealthCheck" => GetHealthCheckError::NoSuchHealthCheck(String::from(parsed_error.message)),"InvalidInput" => GetHealthCheckError::InvalidInput(String::from(parsed_error.message)),"IncompatibleVersion" => GetHealthCheckError::IncompatibleVersion(String::from(parsed_error.message)),_ => GetHealthCheckError::Unknown(String::from(body))
                                }
                           },
                ...
                impl GetHealthCheckLastFailureReasonError {
                    pub fn from_body(body: &str) -> GetHealthCheckLastFailureReasonError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "NoSuchHealthCheck" => GetHealthCheckLastFailureReasonError::NoSuchHealthCheck(String::from(parsed_error.message)),"InvalidInput" => GetHealthCheckLastFailureReasonError::InvalidInput(String::from(parsed_error.message)),_ => GetHealthCheckLastFailureReasonError::Unknown(String::from(body))
                                }
                           },
                ...
                impl GetHealthCheckStatusError {
                    pub fn from_body(body: &str) -> GetHealthCheckStatusError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "NoSuchHealthCheck" => GetHealthCheckStatusError::NoSuchHealthCheck(String::from(parsed_error.message)),"InvalidInput" => GetHealthCheckStatusError::InvalidInput(String::from(parsed_error.message)),_ => GetHealthCheckStatusError::Unknown(String::from(body))
                                }
                           },
...
Unknown(String)
                ...
                impl GetReusableDelegationSetError {
                    pub fn from_body(body: &str) -> GetReusableDelegationSetError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "InvalidInput" => GetReusableDelegationSetError::InvalidInput(String::from(parsed_error.message)),"DelegationSetNotReusable" => GetReusableDelegationSetError::DelegationSetNotReusable(String::from(parsed_error.message)),"NoSuchDelegationSet" => GetReusableDelegationSetError::NoSuchDelegationSet(String::from(parsed_error.message)),_ => GetReusableDelegationSetError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for GetReusableDelegationSetError {
                    fn description(&self) -> &str {
                        match *self {
                            GetReusableDelegationSetError::InvalidInput(ref cause) => cause,GetReusableDelegationSetError::DelegationSetNotReusable(ref cause) => cause,GetReusableDelegationSetError::NoSuchDelegationSet(ref cause) => cause,GetReusableDelegationSetError::Validation(ref cause) => cause,GetReusableDelegationSetError::Credentials(ref err) => err.description(),GetReusableDelegationSetError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),GetReusableDelegationSetError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl Error for ListResourceRecordSetsError {
                    fn description(&self) -> &str {
                        match *self {
                            ListResourceRecordSetsError::NoSuchHostedZone(ref cause) => cause,ListResourceRecordSetsError::InvalidInput(ref cause) => cause,ListResourceRecordSetsError::Validation(ref cause) => cause,ListResourceRecordSetsError::Credentials(ref err) => err.description(),ListResourceRecordSetsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),ListResourceRecordSetsError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl ListTagsForResourceError {
                    pub fn from_body(body: &str) -> ListTagsForResourceError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "NoSuchHealthCheck" => ListTagsForResourceError::NoSuchHealthCheck(String::from(parsed_error.message)),"ThrottlingException" => ListTagsForResourceError::Throttling(String::from(parsed_error.message)),"InvalidInput" => ListTagsForResourceError::InvalidInput(String::from(parsed_error.message)),"PriorRequestNotComplete" => ListTagsForResourceError::PriorRequestNotComplete(String::from(parsed_error.message)),"NoSuchHostedZone" => ListTagsForResourceError::NoSuchHostedZone(String::from(parsed_error.message)),_ => ListTagsForResourceError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for ListTagsForResourceError {
                    fn description(&self) -> &str {
                        match *self {
                            ListTagsForResourceError::NoSuchHealthCheck(ref cause) => cause,ListTagsForResourceError::PriorRequestNotComplete(ref cause) => cause,ListTagsForResourceError::NoSuchHostedZone(ref cause) => cause,ListTagsForResourceError::InvalidInput(ref cause) => cause,ListTagsForResourceError::Throttling(ref cause) => cause,ListTagsForResourceError::Validation(ref cause) => cause,ListTagsForResourceError::Credentials(ref err) => err.description(),ListTagsForResourceError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),ListTagsForResourceError::Unknown(ref cause) => cause
                        }
                    }
                 }
                ...
                impl ListTagsForResourcesError {
                    pub fn from_body(body: &str) -> ListTagsForResourcesError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "InvalidInput" => ListTagsForResourcesError::InvalidInput(String::from(parsed_error.message)),"NoSuchHostedZone" => ListTagsForResourcesError::NoSuchHostedZone(String::from(parsed_error.message)),"NoSuchHealthCheck" => ListTagsForResourcesError::NoSuchHealthCheck(String::from(parsed_error.message)),"ThrottlingException" => ListTagsForResourcesError::Throttling(String::from(parsed_error.message)),"PriorRequestNotComplete" => ListTagsForResourcesError::PriorRequestNotComplete(String::from(parsed_error.message)),_ => ListTagsForResourcesError::Unknown(String::from(body))
                                }
                           },
                ...
                impl ListTrafficPolicyInstancesByPolicyError {
                    pub fn from_body(body: &str) -> ListTrafficPolicyInstancesByPolicyError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "NoSuchTrafficPolicy" => ListTrafficPolicyInstancesByPolicyError::NoSuchTrafficPolicy(String::from(parsed_error.message)),"NoSuchTrafficPolicyInstance" => ListTrafficPolicyInstancesByPolicyError::NoSuchTrafficPolicyInstance(String::from(parsed_error.message)),"InvalidInput" => ListTrafficPolicyInstancesByPolicyError::InvalidInput(String::from(parsed_error.message)),_ => ListTrafficPolicyInstancesByPolicyError::Unknown(String::from(body))
                                }
                           },
                ...
                impl ListVPCAssociationAuthorizationsError {
                    pub fn from_body(body: &str) -> ListVPCAssociationAuthorizationsError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "InvalidPaginationToken" => ListVPCAssociationAuthorizationsError::InvalidPaginationToken(String::from(parsed_error.message)),"InvalidInput" => ListVPCAssociationAuthorizationsError::InvalidInput(String::from(parsed_error.message)),"NoSuchHostedZone" => ListVPCAssociationAuthorizationsError::NoSuchHostedZone(String::from(parsed_error.message)),_ => ListVPCAssociationAuthorizationsError::Unknown(String::from(body))
                                }
                           },
...
Unknown(String)
                ...
                impl UpdateHealthCheckError {
                    pub fn from_body(body: &str) -> UpdateHealthCheckError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "NoSuchHealthCheck" => UpdateHealthCheckError::NoSuchHealthCheck(String::from(parsed_error.message)),"InvalidInput" => UpdateHealthCheckError::InvalidInput(String::from(parsed_error.message)),"HealthCheckVersionMismatch" => UpdateHealthCheckError::HealthCheckVersionMismatch(String::from(parsed_error.message)),_ => UpdateHealthCheckError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for UpdateHealthCheckError {
                    fn description(&self) -> &str {
                        match *self {
                            UpdateHealthCheckError::NoSuchHealthCheck(ref cause) => cause,UpdateHealthCheckError::HealthCheckVersionMismatch(ref cause) => cause,UpdateHealthCheckError::InvalidInput(ref cause) => cause,UpdateHealthCheckError::Validation(ref cause) => cause,UpdateHealthCheckError::Credentials(ref err) => err.description(),UpdateHealthCheckError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),UpdateHealthCheckError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl UpdateTrafficPolicyInstanceError {
                    pub fn from_body(body: &str) -> UpdateTrafficPolicyInstanceError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ConflictingTypes" => UpdateTrafficPolicyInstanceError::ConflictingTypes(String::from(parsed_error.message)),"PriorRequestNotComplete" => UpdateTrafficPolicyInstanceError::PriorRequestNotComplete(String::from(parsed_error.message)),"NoSuchTrafficPolicyInstance" => UpdateTrafficPolicyInstanceError::NoSuchTrafficPolicyInstance(String::from(parsed_error.message)),"NoSuchTrafficPolicy" => UpdateTrafficPolicyInstanceError::NoSuchTrafficPolicy(String::from(parsed_error.message)),"InvalidInput" => UpdateTrafficPolicyInstanceError::InvalidInput(String::from(parsed_error.message)),_ => UpdateTrafficPolicyInstanceError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for UpdateTrafficPolicyInstanceError {
                    fn description(&self) -> &str {
                        match *self {
                            UpdateTrafficPolicyInstanceError::ConflictingTypes(ref cause) => cause,UpdateTrafficPolicyInstanceError::NoSuchTrafficPolicyInstance(ref cause) => cause,UpdateTrafficPolicyInstanceError::NoSuchTrafficPolicy(ref cause) => cause,UpdateTrafficPolicyInstanceError::InvalidInput(ref cause) => cause,UpdateTrafficPolicyInstanceError::PriorRequestNotComplete(ref cause) => cause,UpdateTrafficPolicyInstanceError::Validation(ref cause) => cause,UpdateTrafficPolicyInstanceError::Credentials(ref err) => err.description(),UpdateTrafficPolicyInstanceError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),UpdateTrafficPolicyInstanceError::Unknown(ref cause) => cause
                        }
                    }
                 }
