...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> CreateSnapshotError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InternalServerError" => CreateSnapshotError::InternalServerError(String::from(error_message)),"ServiceUnavailableError" => CreateSnapshotError::ServiceUnavailableError(String::from(error_message)),"InvalidGatewayRequestException" => CreateSnapshotError::InvalidGatewayRequest(String::from(error_message)),"ValidationException" => CreateSnapshotError::Validation(error_message.to_string()),_ => CreateSnapshotError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for CreateSnapshotError {
                    fn description(&self) -> &str {
                        match *self {
                            CreateSnapshotError::ServiceUnavailableError(ref cause) => cause,CreateSnapshotError::InternalServerError(ref cause) => cause,CreateSnapshotError::InvalidGatewayRequest(ref cause) => cause,CreateSnapshotError::Validation(ref cause) => cause,CreateSnapshotError::Credentials(ref err) => err.description(),CreateSnapshotError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),CreateSnapshotError::Unknown(ref cause) => cause
                        }
                    }
                 }
