...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> TagResourceError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "DirectConnectClientException" => TagResourceError::DirectConnectClient(String::from(error_message)),"DuplicateTagKeysException" => TagResourceError::DuplicateTagKeys(String::from(error_message)),"TooManyTagsException" => TagResourceError::TooManyTags(String::from(error_message)),"DirectConnectServerException" => TagResourceError::DirectConnectServer(String::from(error_message)),"ValidationException" => TagResourceError::Validation(error_message.to_string()),_ => TagResourceError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for TagResourceError {
                    fn description(&self) -> &str {
                        match *self {
                            TagResourceError::TooManyTags(ref cause) => cause,TagResourceError::DirectConnectServer(ref cause) => cause,TagResourceError::DuplicateTagKeys(ref cause) => cause,TagResourceError::DirectConnectClient(ref cause) => cause,TagResourceError::Validation(ref cause) => cause,TagResourceError::Credentials(ref err) => err.description(),TagResourceError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),TagResourceError::Unknown(ref cause) => cause
                        }
                    }
                 }
