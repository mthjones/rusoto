...
Unknown(String)
                ...
                impl Error for CreateAutoScalingGroupError {
                    fn description(&self) -> &str {
                        match *self {
                            CreateAutoScalingGroupError::AlreadyExistsFault(ref cause) => cause,CreateAutoScalingGroupError::ResourceContentionFault(ref cause) => cause,CreateAutoScalingGroupError::LimitExceededFault(ref cause) => cause,CreateAutoScalingGroupError::Validation(ref cause) => cause,CreateAutoScalingGroupError::Credentials(ref err) => err.description(),CreateAutoScalingGroupError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),CreateAutoScalingGroupError::Unknown(ref cause) => cause
                        }
                    }
                 }
                ...
                impl CreateLaunchConfigurationError {
                    pub fn from_body(body: &str) -> CreateLaunchConfigurationError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "LimitExceededFault" => CreateLaunchConfigurationError::LimitExceededFault(String::from(parsed_error.message)),"ResourceContentionFault" => CreateLaunchConfigurationError::ResourceContentionFault(String::from(parsed_error.message)),"AlreadyExistsFault" => CreateLaunchConfigurationError::AlreadyExistsFault(String::from(parsed_error.message)),_ => CreateLaunchConfigurationError::Unknown(String::from(body))
                                }
                           },
...
ResourceContentionFault(String),
///<p>You already have an Auto Scaling group or launch configuration with this name.</p>
AlreadyExistsFault(String),/// An error occurred dispatching the HTTP request
HttpDispatch(HttpDispatchError),/// An error was encountered with AWS credentials.
Credentials(CredentialsError),/// A validation error occurred.  Details from AWS are provided.
Validation(String),/// An unknown error occurred.  The raw HTTP response is provided.
Unknown(String)
                ...
                impl Error for CreateOrUpdateTagsError {
                    fn description(&self) -> &str {
                        match *self {
                            CreateOrUpdateTagsError::ResourceContentionFault(ref cause) => cause,CreateOrUpdateTagsError::LimitExceededFault(ref cause) => cause,CreateOrUpdateTagsError::AlreadyExistsFault(ref cause) => cause,CreateOrUpdateTagsError::Validation(ref cause) => cause,CreateOrUpdateTagsError::Credentials(ref err) => err.description(),CreateOrUpdateTagsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),CreateOrUpdateTagsError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl Error for DeleteAutoScalingGroupError {
                    fn description(&self) -> &str {
                        match *self {
                            DeleteAutoScalingGroupError::ScalingActivityInProgressFault(ref cause) => cause,DeleteAutoScalingGroupError::ResourceContentionFault(ref cause) => cause,DeleteAutoScalingGroupError::ResourceInUseFault(ref cause) => cause,DeleteAutoScalingGroupError::Validation(ref cause) => cause,DeleteAutoScalingGroupError::Credentials(ref err) => err.description(),DeleteAutoScalingGroupError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),DeleteAutoScalingGroupError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl DescribeAutoScalingGroupsError {
                    pub fn from_body(body: &str) -> DescribeAutoScalingGroupsError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ResourceContentionFault" => DescribeAutoScalingGroupsError::ResourceContentionFault(String::from(parsed_error.message)),"InvalidNextToken" => DescribeAutoScalingGroupsError::InvalidNextToken(String::from(parsed_error.message)),_ => DescribeAutoScalingGroupsError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for DescribeAutoScalingGroupsError {
                    fn description(&self) -> &str {
                        match *self {
                            DescribeAutoScalingGroupsError::ResourceContentionFault(ref cause) => cause,DescribeAutoScalingGroupsError::InvalidNextToken(ref cause) => cause,DescribeAutoScalingGroupsError::Validation(ref cause) => cause,DescribeAutoScalingGroupsError::Credentials(ref err) => err.description(),DescribeAutoScalingGroupsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),DescribeAutoScalingGroupsError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl Error for DescribeNotificationConfigurationsError {
                    fn description(&self) -> &str {
                        match *self {
                            DescribeNotificationConfigurationsError::ResourceContentionFault(ref cause) => cause,DescribeNotificationConfigurationsError::InvalidNextToken(ref cause) => cause,DescribeNotificationConfigurationsError::Validation(ref cause) => cause,DescribeNotificationConfigurationsError::Credentials(ref err) => err.description(),DescribeNotificationConfigurationsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),DescribeNotificationConfigurationsError::Unknown(ref cause) => cause
                        }
                    }
                 }
                ...
                impl DescribeTagsError {
                    pub fn from_body(body: &str) -> DescribeTagsError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ResourceContentionFault" => DescribeTagsError::ResourceContentionFault(String::from(parsed_error.message)),"InvalidNextToken" => DescribeTagsError::InvalidNextToken(String::from(parsed_error.message)),_ => DescribeTagsError::Unknown(String::from(body))
                                }
                           },
...
Unknown(String)
                ...
                impl Error for PutScheduledUpdateGroupActionError {
                    fn description(&self) -> &str {
                        match *self {
                            PutScheduledUpdateGroupActionError::AlreadyExistsFault(ref cause) => cause,PutScheduledUpdateGroupActionError::ResourceContentionFault(ref cause) => cause,PutScheduledUpdateGroupActionError::LimitExceededFault(ref cause) => cause,PutScheduledUpdateGroupActionError::Validation(ref cause) => cause,PutScheduledUpdateGroupActionError::Credentials(ref err) => err.description(),PutScheduledUpdateGroupActionError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),PutScheduledUpdateGroupActionError::Unknown(ref cause) => cause
                        }
                    }
                 }
