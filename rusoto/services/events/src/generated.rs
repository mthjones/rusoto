...
Unknown(String)
                ...
                impl Error for DescribeRuleError {
                    fn description(&self) -> &str {
                        match *self {
                            DescribeRuleError::Internal(ref cause) => cause,DescribeRuleError::ResourceNotFound(ref cause) => cause,DescribeRuleError::Validation(ref cause) => cause,DescribeRuleError::Credentials(ref err) => err.description(),DescribeRuleError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),DescribeRuleError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> DisableRuleError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InternalException" => DisableRuleError::Internal(String::from(error_message)),"ConcurrentModificationException" => DisableRuleError::ConcurrentModification(String::from(error_message)),"ResourceNotFoundException" => DisableRuleError::ResourceNotFound(String::from(error_message)),"ValidationException" => DisableRuleError::Validation(error_message.to_string()),_ => DisableRuleError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for DisableRuleError {
                    fn description(&self) -> &str {
                        match *self {
                            DisableRuleError::ConcurrentModification(ref cause) => cause,DisableRuleError::ResourceNotFound(ref cause) => cause,DisableRuleError::Internal(ref cause) => cause,DisableRuleError::Validation(ref cause) => cause,DisableRuleError::Credentials(ref err) => err.description(),DisableRuleError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),DisableRuleError::Unknown(ref cause) => cause
                        }
                    }
                 }
                    ...
                    pub fn from_body(body: &str) -> EnableRuleError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "ConcurrentModificationException" => EnableRuleError::ConcurrentModification(String::from(error_message)),"InternalException" => EnableRuleError::Internal(String::from(error_message)),"ResourceNotFoundException" => EnableRuleError::ResourceNotFound(String::from(error_message)),"ValidationException" => EnableRuleError::Validation(error_message.to_string()),_ => EnableRuleError::Unknown(String::from(body))
                                }
                            },
                    ...
                    pub fn from_body(body: &str) -> ListTargetsByRuleError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InternalException" => ListTargetsByRuleError::Internal(String::from(error_message)),"ResourceNotFoundException" => ListTargetsByRuleError::ResourceNotFound(String::from(error_message)),"ValidationException" => ListTargetsByRuleError::Validation(error_message.to_string()),_ => ListTargetsByRuleError::Unknown(String::from(body))
                                }
                            },
                    ...
                    pub fn from_body(body: &str) -> PutTargetsError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InternalException" => PutTargetsError::Internal(String::from(error_message)),"LimitExceededException" => PutTargetsError::LimitExceeded(String::from(error_message)),"ResourceNotFoundException" => PutTargetsError::ResourceNotFound(String::from(error_message)),"ConcurrentModificationException" => PutTargetsError::ConcurrentModification(String::from(error_message)),"ValidationException" => PutTargetsError::Validation(error_message.to_string()),_ => PutTargetsError::Unknown(String::from(body))
                                }
                            },
                    ...
                    pub fn from_body(body: &str) -> TestEventPatternError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InternalException" => TestEventPatternError::Internal(String::from(error_message)),"InvalidEventPatternException" => TestEventPatternError::InvalidEventPattern(String::from(error_message)),"ValidationException" => TestEventPatternError::Validation(error_message.to_string()),_ => TestEventPatternError::Unknown(String::from(body))
                                }
                            },
