...
Unknown(String)
                ...
                impl GetMetricStatisticsError {
                    pub fn from_body(body: &str) -> GetMetricStatisticsError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "InvalidParameterValueException" => GetMetricStatisticsError::InvalidParameterValue(String::from(parsed_error.message)),"MissingRequiredParameterException" => GetMetricStatisticsError::MissingRequiredParameter(String::from(parsed_error.message)),"InternalServiceFault" => GetMetricStatisticsError::InternalServiceFault(String::from(parsed_error.message)),"InvalidParameterCombinationException" => GetMetricStatisticsError::InvalidParameterCombination(String::from(parsed_error.message)),_ => GetMetricStatisticsError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for GetMetricStatisticsError {
                    fn description(&self) -> &str {
                        match *self {
                            GetMetricStatisticsError::InvalidParameterValue(ref cause) => cause,GetMetricStatisticsError::MissingRequiredParameter(ref cause) => cause,GetMetricStatisticsError::InternalServiceFault(ref cause) => cause,GetMetricStatisticsError::InvalidParameterCombination(ref cause) => cause,GetMetricStatisticsError::Validation(ref cause) => cause,GetMetricStatisticsError::Credentials(ref err) => err.description(),GetMetricStatisticsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),GetMetricStatisticsError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl PutMetricDataError {
                    pub fn from_body(body: &str) -> PutMetricDataError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "InvalidParameterCombinationException" => PutMetricDataError::InvalidParameterCombination(String::from(parsed_error.message)),"InternalServiceFault" => PutMetricDataError::InternalServiceFault(String::from(parsed_error.message)),"InvalidParameterValueException" => PutMetricDataError::InvalidParameterValue(String::from(parsed_error.message)),"MissingRequiredParameterException" => PutMetricDataError::MissingRequiredParameter(String::from(parsed_error.message)),_ => PutMetricDataError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for PutMetricDataError {
                    fn description(&self) -> &str {
                        match *self {
                            PutMetricDataError::InvalidParameterValue(ref cause) => cause,PutMetricDataError::InvalidParameterCombination(ref cause) => cause,PutMetricDataError::InternalServiceFault(ref cause) => cause,PutMetricDataError::MissingRequiredParameter(ref cause) => cause,PutMetricDataError::Validation(ref cause) => cause,PutMetricDataError::Credentials(ref err) => err.description(),PutMetricDataError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),PutMetricDataError::Unknown(ref cause) => cause
                        }
                    }
                 }
