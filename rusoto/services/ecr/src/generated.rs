                    ...
                    pub fn from_body(body: &str) -> BatchCheckLayerAvailabilityError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "ServerException" => BatchCheckLayerAvailabilityError::Server(String::from(error_message)),"RepositoryNotFoundException" => BatchCheckLayerAvailabilityError::RepositoryNotFound(String::from(error_message)),"InvalidParameterException" => BatchCheckLayerAvailabilityError::InvalidParameter(String::from(error_message)),"ValidationException" => BatchCheckLayerAvailabilityError::Validation(error_message.to_string()),_ => BatchCheckLayerAvailabilityError::Unknown(String::from(body))
                                }
                            },
...
Unknown(String)
                ...
                impl Error for BatchGetImageError {
                    fn description(&self) -> &str {
                        match *self {
                            BatchGetImageError::RepositoryNotFound(ref cause) => cause,BatchGetImageError::InvalidParameter(ref cause) => cause,BatchGetImageError::Server(ref cause) => cause,BatchGetImageError::Validation(ref cause) => cause,BatchGetImageError::Credentials(ref err) => err.description(),BatchGetImageError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),BatchGetImageError::Unknown(ref cause) => cause
                        }
                    }
                 }
                    ...
                    pub fn from_body(body: &str) -> CompleteLayerUploadError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "LayerAlreadyExistsException" => CompleteLayerUploadError::LayerAlreadyExists(String::from(error_message)),"EmptyUploadException" => CompleteLayerUploadError::EmptyUpload(String::from(error_message)),"ServerException" => CompleteLayerUploadError::Server(String::from(error_message)),"RepositoryNotFoundException" => CompleteLayerUploadError::RepositoryNotFound(String::from(error_message)),"InvalidParameterException" => CompleteLayerUploadError::InvalidParameter(String::from(error_message)),"LayerPartTooSmallException" => CompleteLayerUploadError::LayerPartTooSmall(String::from(error_message)),"InvalidLayerException" => CompleteLayerUploadError::InvalidLayer(String::from(error_message)),"UploadNotFoundException" => CompleteLayerUploadError::UploadNotFound(String::from(error_message)),"ValidationException" => CompleteLayerUploadError::Validation(error_message.to_string()),_ => CompleteLayerUploadError::Unknown(String::from(body))
                                }
                            },
...
RepositoryAlreadyExists(String),/// An error occurred dispatching the HTTP request
HttpDispatch(HttpDispatchError),/// An error was encountered with AWS credentials.
Credentials(CredentialsError),/// A validation error occurred.  Details from AWS are provided.
Validation(String),/// An unknown error occurred.  The raw HTTP response is provided.
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> CreateRepositoryError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "LimitExceededException" => CreateRepositoryError::LimitExceeded(String::from(error_message)),"InvalidParameterException" => CreateRepositoryError::InvalidParameter(String::from(error_message)),"RepositoryAlreadyExistsException" => CreateRepositoryError::RepositoryAlreadyExists(String::from(error_message)),"ServerException" => CreateRepositoryError::Server(String::from(error_message)),"ValidationException" => CreateRepositoryError::Validation(error_message.to_string()),_ => CreateRepositoryError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for CreateRepositoryError {
                    fn description(&self) -> &str {
                        match *self {
                            CreateRepositoryError::LimitExceeded(ref cause) => cause,CreateRepositoryError::InvalidParameter(ref cause) => cause,CreateRepositoryError::RepositoryAlreadyExists(ref cause) => cause,CreateRepositoryError::Server(ref cause) => cause,CreateRepositoryError::Validation(ref cause) => cause,CreateRepositoryError::Credentials(ref err) => err.description(),CreateRepositoryError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),CreateRepositoryError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> DeleteRepositoryError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "ServerException" => DeleteRepositoryError::Server(String::from(error_message)),"RepositoryNotEmptyException" => DeleteRepositoryError::RepositoryNotEmpty(String::from(error_message)),"RepositoryNotFoundException" => DeleteRepositoryError::RepositoryNotFound(String::from(error_message)),"InvalidParameterException" => DeleteRepositoryError::InvalidParameter(String::from(error_message)),"ValidationException" => DeleteRepositoryError::Validation(error_message.to_string()),_ => DeleteRepositoryError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for DeleteRepositoryError {
                    fn description(&self) -> &str {
                        match *self {
                            DeleteRepositoryError::InvalidParameter(ref cause) => cause,DeleteRepositoryError::RepositoryNotFound(ref cause) => cause,DeleteRepositoryError::Server(ref cause) => cause,DeleteRepositoryError::RepositoryNotEmpty(ref cause) => cause,DeleteRepositoryError::Validation(ref cause) => cause,DeleteRepositoryError::Credentials(ref err) => err.description(),DeleteRepositoryError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),DeleteRepositoryError::Unknown(ref cause) => cause
                        }
                    }
                 }
                    ...
                    pub fn from_body(body: &str) -> DeleteRepositoryPolicyError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "ServerException" => DeleteRepositoryPolicyError::Server(String::from(error_message)),"RepositoryNotFoundException" => DeleteRepositoryPolicyError::RepositoryNotFound(String::from(error_message)),"RepositoryPolicyNotFoundException" => DeleteRepositoryPolicyError::RepositoryPolicyNotFound(String::from(error_message)),"InvalidParameterException" => DeleteRepositoryPolicyError::InvalidParameter(String::from(error_message)),"ValidationException" => DeleteRepositoryPolicyError::Validation(error_message.to_string()),_ => DeleteRepositoryPolicyError::Unknown(String::from(body))
                                }
                            },
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> DescribeImagesError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InvalidParameterException" => DescribeImagesError::InvalidParameter(String::from(error_message)),"RepositoryNotFoundException" => DescribeImagesError::RepositoryNotFound(String::from(error_message)),"ServerException" => DescribeImagesError::Server(String::from(error_message)),"ImageNotFoundException" => DescribeImagesError::ImageNotFound(String::from(error_message)),"ValidationException" => DescribeImagesError::Validation(error_message.to_string()),_ => DescribeImagesError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for DescribeImagesError {
                    fn description(&self) -> &str {
                        match *self {
                            DescribeImagesError::Server(ref cause) => cause,DescribeImagesError::RepositoryNotFound(ref cause) => cause,DescribeImagesError::ImageNotFound(ref cause) => cause,DescribeImagesError::InvalidParameter(ref cause) => cause,DescribeImagesError::Validation(ref cause) => cause,DescribeImagesError::Credentials(ref err) => err.description(),DescribeImagesError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),DescribeImagesError::Unknown(ref cause) => cause
                        }
                    }
                 }
                    ...
                    pub fn from_body(body: &str) -> DescribeRepositoriesError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "RepositoryNotFoundException" => DescribeRepositoriesError::RepositoryNotFound(String::from(error_message)),"InvalidParameterException" => DescribeRepositoriesError::InvalidParameter(String::from(error_message)),"ServerException" => DescribeRepositoriesError::Server(String::from(error_message)),"ValidationException" => DescribeRepositoriesError::Validation(error_message.to_string()),_ => DescribeRepositoriesError::Unknown(String::from(body))
                                }
                            },
                    ...
                    pub fn from_body(body: &str) -> GetDownloadUrlForLayerError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "LayersNotFoundException" => GetDownloadUrlForLayerError::LayersNotFound(String::from(error_message)),"LayerInaccessibleException" => GetDownloadUrlForLayerError::LayerInaccessible(String::from(error_message)),"RepositoryNotFoundException" => GetDownloadUrlForLayerError::RepositoryNotFound(String::from(error_message)),"InvalidParameterException" => GetDownloadUrlForLayerError::InvalidParameter(String::from(error_message)),"ServerException" => GetDownloadUrlForLayerError::Server(String::from(error_message)),"ValidationException" => GetDownloadUrlForLayerError::Validation(error_message.to_string()),_ => GetDownloadUrlForLayerError::Unknown(String::from(body))
                                }
                            },
                    ...
                    pub fn from_body(body: &str) -> GetRepositoryPolicyError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InvalidParameterException" => GetRepositoryPolicyError::InvalidParameter(String::from(error_message)),"RepositoryPolicyNotFoundException" => GetRepositoryPolicyError::RepositoryPolicyNotFound(String::from(error_message)),"RepositoryNotFoundException" => GetRepositoryPolicyError::RepositoryNotFound(String::from(error_message)),"ServerException" => GetRepositoryPolicyError::Server(String::from(error_message)),"ValidationException" => GetRepositoryPolicyError::Validation(error_message.to_string()),_ => GetRepositoryPolicyError::Unknown(String::from(body))
                                }
                            },
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> ListImagesError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "RepositoryNotFoundException" => ListImagesError::RepositoryNotFound(String::from(error_message)),"InvalidParameterException" => ListImagesError::InvalidParameter(String::from(error_message)),"ServerException" => ListImagesError::Server(String::from(error_message)),"ValidationException" => ListImagesError::Validation(error_message.to_string()),_ => ListImagesError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for ListImagesError {
                    fn description(&self) -> &str {
                        match *self {
                            ListImagesError::RepositoryNotFound(ref cause) => cause,ListImagesError::Server(ref cause) => cause,ListImagesError::InvalidParameter(ref cause) => cause,ListImagesError::Validation(ref cause) => cause,ListImagesError::Credentials(ref err) => err.description(),ListImagesError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),ListImagesError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl Error for SetRepositoryPolicyError {
                    fn description(&self) -> &str {
                        match *self {
                            SetRepositoryPolicyError::Server(ref cause) => cause,SetRepositoryPolicyError::RepositoryNotFound(ref cause) => cause,SetRepositoryPolicyError::InvalidParameter(ref cause) => cause,SetRepositoryPolicyError::Validation(ref cause) => cause,SetRepositoryPolicyError::Credentials(ref err) => err.description(),SetRepositoryPolicyError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),SetRepositoryPolicyError::Unknown(ref cause) => cause
                        }
                    }
                 }
                    ...
                    pub fn from_body(body: &str) -> UploadLayerPartError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "UploadNotFoundException" => UploadLayerPartError::UploadNotFound(String::from(error_message)),"InvalidParameterException" => UploadLayerPartError::InvalidParameter(String::from(error_message)),"RepositoryNotFoundException" => UploadLayerPartError::RepositoryNotFound(String::from(error_message)),"ServerException" => UploadLayerPartError::Server(String::from(error_message)),"LimitExceededException" => UploadLayerPartError::LimitExceeded(String::from(error_message)),"InvalidLayerPartException" => UploadLayerPartError::InvalidLayerPart(String::from(error_message)),"ValidationException" => UploadLayerPartError::Validation(error_message.to_string()),_ => UploadLayerPartError::Unknown(String::from(body))
                                }
                            },
