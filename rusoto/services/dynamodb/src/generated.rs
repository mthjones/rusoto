...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> BatchGetItemError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "ResourceNotFoundException" => BatchGetItemError::ResourceNotFound(String::from(error_message)),"InternalServerError" => BatchGetItemError::InternalServerError(String::from(error_message)),"ProvisionedThroughputExceededException" => BatchGetItemError::ProvisionedThroughputExceeded(String::from(error_message)),"ValidationException" => BatchGetItemError::Validation(error_message.to_string()),_ => BatchGetItemError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for BatchGetItemError {
                    fn description(&self) -> &str {
                        match *self {
                            BatchGetItemError::InternalServerError(ref cause) => cause,BatchGetItemError::ResourceNotFound(ref cause) => cause,BatchGetItemError::ProvisionedThroughputExceeded(ref cause) => cause,BatchGetItemError::Validation(ref cause) => cause,BatchGetItemError::Credentials(ref err) => err.description(),BatchGetItemError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),BatchGetItemError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> BatchWriteItemError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "ItemCollectionSizeLimitExceededException" => BatchWriteItemError::ItemCollectionSizeLimitExceeded(String::from(error_message)),"InternalServerError" => BatchWriteItemError::InternalServerError(String::from(error_message)),"ProvisionedThroughputExceededException" => BatchWriteItemError::ProvisionedThroughputExceeded(String::from(error_message)),"ResourceNotFoundException" => BatchWriteItemError::ResourceNotFound(String::from(error_message)),"ValidationException" => BatchWriteItemError::Validation(error_message.to_string()),_ => BatchWriteItemError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for BatchWriteItemError {
                    fn description(&self) -> &str {
                        match *self {
                            BatchWriteItemError::ResourceNotFound(ref cause) => cause,BatchWriteItemError::InternalServerError(ref cause) => cause,BatchWriteItemError::ItemCollectionSizeLimitExceeded(ref cause) => cause,BatchWriteItemError::ProvisionedThroughputExceeded(ref cause) => cause,BatchWriteItemError::Validation(ref cause) => cause,BatchWriteItemError::Credentials(ref err) => err.description(),BatchWriteItemError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),BatchWriteItemError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
ConditionalCheckFailed(String),/// An error occurred dispatching the HTTP request
HttpDispatch(HttpDispatchError),/// An error was encountered with AWS credentials.
Credentials(CredentialsError),/// A validation error occurred.  Details from AWS are provided.
Validation(String),/// An unknown error occurred.  The raw HTTP response is provided.
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> DeleteItemError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "ConditionalCheckFailedException" => DeleteItemError::ConditionalCheckFailed(String::from(error_message)),"ResourceNotFoundException" => DeleteItemError::ResourceNotFound(String::from(error_message)),"ProvisionedThroughputExceededException" => DeleteItemError::ProvisionedThroughputExceeded(String::from(error_message)),"ItemCollectionSizeLimitExceededException" => DeleteItemError::ItemCollectionSizeLimitExceeded(String::from(error_message)),"InternalServerError" => DeleteItemError::InternalServerError(String::from(error_message)),"ValidationException" => DeleteItemError::Validation(error_message.to_string()),_ => DeleteItemError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for DeleteItemError {
                    fn description(&self) -> &str {
                        match *self {
                            DeleteItemError::ItemCollectionSizeLimitExceeded(ref cause) => cause,DeleteItemError::InternalServerError(ref cause) => cause,DeleteItemError::ConditionalCheckFailed(ref cause) => cause,DeleteItemError::ResourceNotFound(ref cause) => cause,DeleteItemError::ProvisionedThroughputExceeded(ref cause) => cause,DeleteItemError::Validation(ref cause) => cause,DeleteItemError::Credentials(ref err) => err.description(),DeleteItemError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),DeleteItemError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl Error for DeleteTableError {
                    fn description(&self) -> &str {
                        match *self {
                            DeleteTableError::ResourceInUse(ref cause) => cause,DeleteTableError::LimitExceeded(ref cause) => cause,DeleteTableError::ResourceNotFound(ref cause) => cause,DeleteTableError::InternalServerError(ref cause) => cause,DeleteTableError::Validation(ref cause) => cause,DeleteTableError::Credentials(ref err) => err.description(),DeleteTableError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),DeleteTableError::Unknown(ref cause) => cause
                        }
                    }
                 }
                    ...
                    pub fn from_body(body: &str) -> GetItemError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "ResourceNotFoundException" => GetItemError::ResourceNotFound(String::from(error_message)),"InternalServerError" => GetItemError::InternalServerError(String::from(error_message)),"ProvisionedThroughputExceededException" => GetItemError::ProvisionedThroughputExceeded(String::from(error_message)),"ValidationException" => GetItemError::Validation(error_message.to_string()),_ => GetItemError::Unknown(String::from(body))
                                }
                            },
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> PutItemError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "ProvisionedThroughputExceededException" => PutItemError::ProvisionedThroughputExceeded(String::from(error_message)),"ConditionalCheckFailedException" => PutItemError::ConditionalCheckFailed(String::from(error_message)),"ResourceNotFoundException" => PutItemError::ResourceNotFound(String::from(error_message)),"InternalServerError" => PutItemError::InternalServerError(String::from(error_message)),"ItemCollectionSizeLimitExceededException" => PutItemError::ItemCollectionSizeLimitExceeded(String::from(error_message)),"ValidationException" => PutItemError::Validation(error_message.to_string()),_ => PutItemError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for PutItemError {
                    fn description(&self) -> &str {
                        match *self {
                            PutItemError::ItemCollectionSizeLimitExceeded(ref cause) => cause,PutItemError::ConditionalCheckFailed(ref cause) => cause,PutItemError::ResourceNotFound(ref cause) => cause,PutItemError::InternalServerError(ref cause) => cause,PutItemError::ProvisionedThroughputExceeded(ref cause) => cause,PutItemError::Validation(ref cause) => cause,PutItemError::Credentials(ref err) => err.description(),PutItemError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),PutItemError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl Error for QueryError {
                    fn description(&self) -> &str {
                        match *self {
                            QueryError::InternalServerError(ref cause) => cause,QueryError::ResourceNotFound(ref cause) => cause,QueryError::ProvisionedThroughputExceeded(ref cause) => cause,QueryError::Validation(ref cause) => cause,QueryError::Credentials(ref err) => err.description(),QueryError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),QueryError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> UpdateItemError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InternalServerError" => UpdateItemError::InternalServerError(String::from(error_message)),"ProvisionedThroughputExceededException" => UpdateItemError::ProvisionedThroughputExceeded(String::from(error_message)),"ConditionalCheckFailedException" => UpdateItemError::ConditionalCheckFailed(String::from(error_message)),"ResourceNotFoundException" => UpdateItemError::ResourceNotFound(String::from(error_message)),"ItemCollectionSizeLimitExceededException" => UpdateItemError::ItemCollectionSizeLimitExceeded(String::from(error_message)),"ValidationException" => UpdateItemError::Validation(error_message.to_string()),_ => UpdateItemError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for UpdateItemError {
                    fn description(&self) -> &str {
                        match *self {
                            UpdateItemError::ConditionalCheckFailed(ref cause) => cause,UpdateItemError::InternalServerError(ref cause) => cause,UpdateItemError::ProvisionedThroughputExceeded(ref cause) => cause,UpdateItemError::ItemCollectionSizeLimitExceeded(ref cause) => cause,UpdateItemError::ResourceNotFound(ref cause) => cause,UpdateItemError::Validation(ref cause) => cause,UpdateItemError::Credentials(ref err) => err.description(),UpdateItemError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),UpdateItemError::Unknown(ref cause) => cause
                        }
                    }
                 }
                    ...
                    pub fn from_body(body: &str) -> UpdateTableError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InternalServerError" => UpdateTableError::InternalServerError(String::from(error_message)),"LimitExceededException" => UpdateTableError::LimitExceeded(String::from(error_message)),"ResourceNotFoundException" => UpdateTableError::ResourceNotFound(String::from(error_message)),"ResourceInUseException" => UpdateTableError::ResourceInUse(String::from(error_message)),"ValidationException" => UpdateTableError::Validation(error_message.to_string()),_ => UpdateTableError::Unknown(String::from(body))
                                }
                            },
