...
#[doc="Account Id of the customer. It should be a 12 digit number."]
...
pub struct Budget {
    ...
    pub cost_filters: Option<CostFilters>,
...
#[doc="A string represents the budget name. No \":\" character is allowed."]
pub type BudgetName = String;
...
#[doc="A map represents the cost filters applied to the budget."]
pub type CostFilters = ::std::collections::HashMap<GenericString, DimensionValues>;
#[doc="This includes the options for getting the cost of a budget."]
#[derive(Default,Debug,Clone,Serialize,Deserialize)]
pub struct CostTypes {
    #[serde(rename="IncludeSubscription")]
    pub include_subscription: GenericBoolean,
    #[serde(rename="IncludeTax")]
    pub include_tax: GenericBoolean,
    #[serde(rename="UseBlended")]
    pub use_blended: GenericBoolean,
}
...
pub struct CreateBudgetRequest {
    ...
    pub notifications_with_subscribers: Option<NotificationWithSubscribersList>,
}
...
pub type DimensionValues = Vec<GenericString>;
#[doc="The error message the exception carries."]
pub type ErrorMessage = String;
#[doc="A generic boolean value."]
pub type GenericBoolean = bool;
#[doc="A generic String."]
pub type GenericString = String;
#[doc="A generic timestamp. In Java it is transformed to a Date object."]
pub type GenericTimestamp = f64;
#[doc="An integer to represent how many entries should a pagianted response contains. Maxium is set to 100."]
...
#[doc="The threshold of the a notification. It should be a number between 0 and 100."]
pub type NotificationThreshold = f64;
...
#[doc="A list of Notifications, each with a list of subscribers."]
pub type NotificationWithSubscribersList = Vec<NotificationWithSubscribers>;
#[doc="A list of notifications."]
pub type Notifications = Vec<Notification>;
#[doc="A string to represent NumericValue."]
...
pub struct TimePeriod {
    #[serde(rename="End")]
    pub end: GenericTimestamp,
    #[serde(rename="Start")]
    pub start: GenericTimestamp,
}

#[doc="The time unit of the budget. e.g. weekly, monthly, etc."]
          ...
          D: DispatchSignedRequest
{
    ...
    fn create_budget(&self,
        ...
        match response.status {
            StatusCode::Ok => {
                            Ok(serde_json::from_str::<CreateBudgetResponse>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                        }
            _ => {
                Err(CreateBudgetError::from_body(String::from_utf8_lossy(&response.body).as_ref()))
            }
        }
    }
    ...
    fn create_notification(&self,
        ...
        match response.status {
            StatusCode::Ok => {
                            Ok(serde_json::from_str::<CreateNotificationResponse>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                        }
            _ => {
                Err(CreateNotificationError::from_body(String::from_utf8_lossy(&response.body)
                                                           .as_ref()))
            }
        }
    }
    ...
    fn create_subscriber(&self,
        ...
        match response.status {
            StatusCode::Ok => {
                            Ok(serde_json::from_str::<CreateSubscriberResponse>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                        }
            _ => {
                Err(CreateSubscriberError::from_body(String::from_utf8_lossy(&response.body)
                                                         .as_ref()))
            }
        }
    }
    ...
    fn delete_budget(&self,
        ...
        match response.status {
            StatusCode::Ok => {
                            Ok(serde_json::from_str::<DeleteBudgetResponse>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                        }
            _ => {
                Err(DeleteBudgetError::from_body(String::from_utf8_lossy(&response.body).as_ref()))
            }
        }
    }
    ...
    fn delete_notification(&self,
        ...
        match response.status {
            StatusCode::Ok => {
                            Ok(serde_json::from_str::<DeleteNotificationResponse>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                        }
            _ => {
                Err(DeleteNotificationError::from_body(String::from_utf8_lossy(&response.body)
                                                           .as_ref()))
            }
        }
    }
    ...
    fn delete_subscriber(&self,
        ...
        match response.status {
            StatusCode::Ok => {
                            Ok(serde_json::from_str::<DeleteSubscriberResponse>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                        }
            _ => {
                Err(DeleteSubscriberError::from_body(String::from_utf8_lossy(&response.body)
                                                         .as_ref()))
            }
        }
    }
    ...
    fn describe_budget(&self,
        ...
        match response.status {
            StatusCode::Ok => {
                            Ok(serde_json::from_str::<DescribeBudgetResponse>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                        }
            _ => {
                Err(DescribeBudgetError::from_body(String::from_utf8_lossy(&response.body)
                                                       .as_ref()))
            }
        }
    }
    ...
    fn describe_budgets(&self,
        ...
        match response.status {
            StatusCode::Ok => {
                            Ok(serde_json::from_str::<DescribeBudgetsResponse>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                        }
            _ => {
                Err(DescribeBudgetsError::from_body(String::from_utf8_lossy(&response.body)
                                                        .as_ref()))
            }
        }
    }
    ...
    fn describe_notifications_for_budget
        ...
        match response.status {
            StatusCode::Ok => {
                            Ok(serde_json::from_str::<DescribeNotificationsForBudgetResponse>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                        }
            _ => Err(DescribeNotificationsForBudgetError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
        }
    }
    ...
    fn describe_subscribers_for_notification
        ...
        match response.status {
            StatusCode::Ok => {
                            Ok(serde_json::from_str::<DescribeSubscribersForNotificationResponse>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                        }
            _ => Err(DescribeSubscribersForNotificationError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
        }
    }
    ...
    fn update_budget(&self,
        ...
        match response.status {
            StatusCode::Ok => {
                            Ok(serde_json::from_str::<UpdateBudgetResponse>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                        }
            _ => {
                Err(UpdateBudgetError::from_body(String::from_utf8_lossy(&response.body).as_ref()))
            }
        }
    }
    ...
    fn update_notification(&self,
        ...
        match response.status {
            StatusCode::Ok => {
                            Ok(serde_json::from_str::<UpdateNotificationResponse>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                        }
            _ => {
                Err(UpdateNotificationError::from_body(String::from_utf8_lossy(&response.body)
                                                           .as_ref()))
            }
        }
    }
    ...
    fn update_subscriber(&self,
        ...
        match response.status {
            StatusCode::Ok => {
                            Ok(serde_json::from_str::<UpdateSubscriberResponse>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                        }
            _ => {
                Err(UpdateSubscriberError::from_body(String::from_utf8_lossy(&response.body)
                                                         .as_ref()))
            }
        }
    }
