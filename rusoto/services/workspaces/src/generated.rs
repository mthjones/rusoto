...
Unknown(String)
                ...
                impl Error for CreateTagsError {
                    fn description(&self) -> &str {
                        match *self {
                            CreateTagsError::ResourceLimitExceeded(ref cause) => cause,CreateTagsError::InvalidParameterValues(ref cause) => cause,CreateTagsError::ResourceNotFound(ref cause) => cause,CreateTagsError::Validation(ref cause) => cause,CreateTagsError::Credentials(ref err) => err.description(),CreateTagsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),CreateTagsError::Unknown(ref cause) => cause
                        }
                    }
                 }
                    ...
                    pub fn from_body(body: &str) -> DescribeWorkspacesError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "ResourceUnavailableException" => DescribeWorkspacesError::ResourceUnavailable(String::from(error_message)),"InvalidParameterValuesException" => DescribeWorkspacesError::InvalidParameterValues(String::from(error_message)),"ValidationException" => DescribeWorkspacesError::Validation(error_message.to_string()),_ => DescribeWorkspacesError::Unknown(String::from(body))
                                }
                            },
                    ...
                    pub fn from_body(body: &str) -> ModifyWorkspacePropertiesError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "AccessDeniedException" => ModifyWorkspacePropertiesError::AccessDenied(String::from(error_message)),"InvalidParameterValuesException" => ModifyWorkspacePropertiesError::InvalidParameterValues(String::from(error_message)),"InvalidResourceStateException" => ModifyWorkspacePropertiesError::InvalidResourceState(String::from(error_message)),"ResourceNotFoundException" => ModifyWorkspacePropertiesError::ResourceNotFound(String::from(error_message)),"UnsupportedWorkspaceConfigurationException" => ModifyWorkspacePropertiesError::UnsupportedWorkspaceConfiguration(String::from(error_message)),"OperationInProgressException" => ModifyWorkspacePropertiesError::OperationInProgress(String::from(error_message)),"ResourceUnavailableException" => ModifyWorkspacePropertiesError::ResourceUnavailable(String::from(error_message)),"ValidationException" => ModifyWorkspacePropertiesError::Validation(error_message.to_string()),_ => ModifyWorkspacePropertiesError::Unknown(String::from(body))
                                }
                            },
