...
Unknown(String)
                ...
                impl CreateChangeSetError {
                    pub fn from_body(body: &str) -> CreateChangeSetError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "InsufficientCapabilitiesException" => CreateChangeSetError::InsufficientCapabilities(String::from(parsed_error.message)),"LimitExceededException" => CreateChangeSetError::LimitExceeded(String::from(parsed_error.message)),"AlreadyExistsException" => CreateChangeSetError::AlreadyExists(String::from(parsed_error.message)),_ => CreateChangeSetError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for CreateChangeSetError {
                    fn description(&self) -> &str {
                        match *self {
                            CreateChangeSetError::InsufficientCapabilities(ref cause) => cause,CreateChangeSetError::AlreadyExists(ref cause) => cause,CreateChangeSetError::LimitExceeded(ref cause) => cause,CreateChangeSetError::Validation(ref cause) => cause,CreateChangeSetError::Credentials(ref err) => err.description(),CreateChangeSetError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),CreateChangeSetError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl CreateStackError {
                    pub fn from_body(body: &str) -> CreateStackError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "LimitExceededException" => CreateStackError::LimitExceeded(String::from(parsed_error.message)),"InsufficientCapabilitiesException" => CreateStackError::InsufficientCapabilities(String::from(parsed_error.message)),"AlreadyExistsException" => CreateStackError::AlreadyExists(String::from(parsed_error.message)),_ => CreateStackError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for CreateStackError {
                    fn description(&self) -> &str {
                        match *self {
                            CreateStackError::InsufficientCapabilities(ref cause) => cause,CreateStackError::AlreadyExists(ref cause) => cause,CreateStackError::LimitExceeded(ref cause) => cause,CreateStackError::Validation(ref cause) => cause,CreateStackError::Credentials(ref err) => err.description(),CreateStackError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),CreateStackError::Unknown(ref cause) => cause
                        }
                    }
                 }
                ...
                impl ExecuteChangeSetError {
                    pub fn from_body(body: &str) -> ExecuteChangeSetError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ChangeSetNotFoundException" => ExecuteChangeSetError::ChangeSetNotFound(String::from(parsed_error.message)),"InvalidChangeSetStatusException" => ExecuteChangeSetError::InvalidChangeSetStatus(String::from(parsed_error.message)),"InsufficientCapabilitiesException" => ExecuteChangeSetError::InsufficientCapabilities(String::from(parsed_error.message)),_ => ExecuteChangeSetError::Unknown(String::from(body))
                                }
                           },
