...
Unknown(String)
                ...
                impl Error for AcknowledgeThirdPartyJobError {
                    fn description(&self) -> &str {
                        match *self {
                            AcknowledgeThirdPartyJobError::JobNotFound(ref cause) => cause,AcknowledgeThirdPartyJobError::InvalidClientToken(ref cause) => cause,AcknowledgeThirdPartyJobError::InvalidNonce(ref cause) => cause,AcknowledgeThirdPartyJobError::Validation(ref cause) => cause,AcknowledgeThirdPartyJobError::Credentials(ref err) => err.description(),AcknowledgeThirdPartyJobError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),AcknowledgeThirdPartyJobError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
InvalidActionDeclaration(String),/// An error occurred dispatching the HTTP request
HttpDispatch(HttpDispatchError),/// An error was encountered with AWS credentials.
Credentials(CredentialsError),/// A validation error occurred.  Details from AWS are provided.
Validation(String),/// An unknown error occurred.  The raw HTTP response is provided.
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> CreatePipelineError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "LimitExceededException" => CreatePipelineError::LimitExceeded(String::from(error_message)),"PipelineNameInUseException" => CreatePipelineError::PipelineNameInUse(String::from(error_message)),"InvalidActionDeclarationException" => CreatePipelineError::InvalidActionDeclaration(String::from(error_message)),"InvalidStructureException" => CreatePipelineError::InvalidStructure(String::from(error_message)),"InvalidStageDeclarationException" => CreatePipelineError::InvalidStageDeclaration(String::from(error_message)),"InvalidBlockerDeclarationException" => CreatePipelineError::InvalidBlockerDeclaration(String::from(error_message)),"ValidationException" => CreatePipelineError::Validation(error_message.to_string()),_ => CreatePipelineError::Unknown(String::from(body))
                                }
                            },
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> EnableStageTransitionError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "StageNotFoundException" => EnableStageTransitionError::StageNotFound(String::from(error_message)),"PipelineNotFoundException" => EnableStageTransitionError::PipelineNotFound(String::from(error_message)),"ValidationException" => EnableStageTransitionError::Validation(error_message.to_string()),_ => EnableStageTransitionError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for EnableStageTransitionError {
                    fn description(&self) -> &str {
                        match *self {
                            EnableStageTransitionError::StageNotFound(ref cause) => cause,EnableStageTransitionError::PipelineNotFound(ref cause) => cause,EnableStageTransitionError::Validation(ref cause) => cause,EnableStageTransitionError::Credentials(ref err) => err.description(),EnableStageTransitionError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),EnableStageTransitionError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> PutApprovalResultError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "PipelineNotFoundException" => PutApprovalResultError::PipelineNotFound(String::from(error_message)),"StageNotFoundException" => PutApprovalResultError::StageNotFound(String::from(error_message)),"ApprovalAlreadyCompletedException" => PutApprovalResultError::ApprovalAlreadyCompleted(String::from(error_message)),"ActionNotFoundException" => PutApprovalResultError::ActionNotFound(String::from(error_message)),"InvalidApprovalTokenException" => PutApprovalResultError::InvalidApprovalToken(String::from(error_message)),"ValidationException" => PutApprovalResultError::Validation(error_message.to_string()),_ => PutApprovalResultError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for PutApprovalResultError {
                    fn description(&self) -> &str {
                        match *self {
                            PutApprovalResultError::ApprovalAlreadyCompleted(ref cause) => cause,PutApprovalResultError::PipelineNotFound(ref cause) => cause,PutApprovalResultError::InvalidApprovalToken(ref cause) => cause,PutApprovalResultError::StageNotFound(ref cause) => cause,PutApprovalResultError::ActionNotFound(ref cause) => cause,PutApprovalResultError::Validation(ref cause) => cause,PutApprovalResultError::Credentials(ref err) => err.description(),PutApprovalResultError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),PutApprovalResultError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> PutThirdPartyJobFailureResultError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "JobNotFoundException" => PutThirdPartyJobFailureResultError::JobNotFound(String::from(error_message)),"InvalidClientTokenException" => PutThirdPartyJobFailureResultError::InvalidClientToken(String::from(error_message)),"InvalidJobStateException" => PutThirdPartyJobFailureResultError::InvalidJobState(String::from(error_message)),"ValidationException" => PutThirdPartyJobFailureResultError::Validation(error_message.to_string()),_ => PutThirdPartyJobFailureResultError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for PutThirdPartyJobFailureResultError {
                    fn description(&self) -> &str {
                        match *self {
                            PutThirdPartyJobFailureResultError::InvalidJobState(ref cause) => cause,PutThirdPartyJobFailureResultError::JobNotFound(ref cause) => cause,PutThirdPartyJobFailureResultError::InvalidClientToken(ref cause) => cause,PutThirdPartyJobFailureResultError::Validation(ref cause) => cause,PutThirdPartyJobFailureResultError::Credentials(ref err) => err.description(),PutThirdPartyJobFailureResultError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),PutThirdPartyJobFailureResultError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> PutThirdPartyJobSuccessResultError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InvalidClientTokenException" => PutThirdPartyJobSuccessResultError::InvalidClientToken(String::from(error_message)),"JobNotFoundException" => PutThirdPartyJobSuccessResultError::JobNotFound(String::from(error_message)),"InvalidJobStateException" => PutThirdPartyJobSuccessResultError::InvalidJobState(String::from(error_message)),"ValidationException" => PutThirdPartyJobSuccessResultError::Validation(error_message.to_string()),_ => PutThirdPartyJobSuccessResultError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for PutThirdPartyJobSuccessResultError {
                    fn description(&self) -> &str {
                        match *self {
                            PutThirdPartyJobSuccessResultError::InvalidJobState(ref cause) => cause,PutThirdPartyJobSuccessResultError::JobNotFound(ref cause) => cause,PutThirdPartyJobSuccessResultError::InvalidClientToken(ref cause) => cause,PutThirdPartyJobSuccessResultError::Validation(ref cause) => cause,PutThirdPartyJobSuccessResultError::Credentials(ref err) => err.description(),PutThirdPartyJobSuccessResultError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),PutThirdPartyJobSuccessResultError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl Error for RetryStageExecutionError {
                    fn description(&self) -> &str {
                        match *self {
                            RetryStageExecutionError::StageNotRetryable(ref cause) => cause,RetryStageExecutionError::StageNotFound(ref cause) => cause,RetryStageExecutionError::PipelineNotFound(ref cause) => cause,RetryStageExecutionError::NotLatestPipelineExecution(ref cause) => cause,RetryStageExecutionError::Validation(ref cause) => cause,RetryStageExecutionError::Credentials(ref err) => err.description(),RetryStageExecutionError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),RetryStageExecutionError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
InvalidStructure(String),
///<p>Reserved for future use.</p>
InvalidBlockerDeclaration(String),/// An error occurred dispatching the HTTP request
HttpDispatch(HttpDispatchError),/// An error was encountered with AWS credentials.
Credentials(CredentialsError),/// A validation error occurred.  Details from AWS are provided.
Validation(String),/// An unknown error occurred.  The raw HTTP response is provided.
Unknown(String)
                ...
                impl Error for UpdatePipelineError {
                    fn description(&self) -> &str {
                        match *self {
                            UpdatePipelineError::InvalidStructure(ref cause) => cause,UpdatePipelineError::InvalidActionDeclaration(ref cause) => cause,UpdatePipelineError::InvalidBlockerDeclaration(ref cause) => cause,UpdatePipelineError::InvalidStageDeclaration(ref cause) => cause,UpdatePipelineError::Validation(ref cause) => cause,UpdatePipelineError::Credentials(ref err) => err.description(),UpdatePipelineError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),UpdatePipelineError::Unknown(ref cause) => cause
                        }
                    }
                 }
