...
Unknown(String)
                ...
                impl Error for ChangeMessageVisibilityBatchError {
                    fn description(&self) -> &str {
                        match *self {
                            ChangeMessageVisibilityBatchError::EmptyBatchRequest(ref cause) => cause,ChangeMessageVisibilityBatchError::BatchEntryIdsNotDistinct(ref cause) => cause,ChangeMessageVisibilityBatchError::InvalidBatchEntryId(ref cause) => cause,ChangeMessageVisibilityBatchError::TooManyEntriesInBatchRequest(ref cause) => cause,ChangeMessageVisibilityBatchError::Validation(ref cause) => cause,ChangeMessageVisibilityBatchError::Credentials(ref err) => err.description(),ChangeMessageVisibilityBatchError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),ChangeMessageVisibilityBatchError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl SendMessageBatchError {
                    pub fn from_body(body: &str) -> SendMessageBatchError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "InvalidBatchEntryId" => SendMessageBatchError::InvalidBatchEntryId(String::from(parsed_error.message)),"EmptyBatchRequest" => SendMessageBatchError::EmptyBatchRequest(String::from(parsed_error.message)),"TooManyEntriesInBatchRequest" => SendMessageBatchError::TooManyEntriesInBatchRequest(String::from(parsed_error.message)),"BatchRequestTooLong" => SendMessageBatchError::BatchRequestTooLong(String::from(parsed_error.message)),"BatchEntryIdsNotDistinct" => SendMessageBatchError::BatchEntryIdsNotDistinct(String::from(parsed_error.message)),"UnsupportedOperation" => SendMessageBatchError::UnsupportedOperation(String::from(parsed_error.message)),_ => SendMessageBatchError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for SendMessageBatchError {
                    fn description(&self) -> &str {
                        match *self {
                            SendMessageBatchError::EmptyBatchRequest(ref cause) => cause,SendMessageBatchError::TooManyEntriesInBatchRequest(ref cause) => cause,SendMessageBatchError::BatchEntryIdsNotDistinct(ref cause) => cause,SendMessageBatchError::BatchRequestTooLong(ref cause) => cause,SendMessageBatchError::InvalidBatchEntryId(ref cause) => cause,SendMessageBatchError::UnsupportedOperation(ref cause) => cause,SendMessageBatchError::Validation(ref cause) => cause,SendMessageBatchError::Credentials(ref err) => err.description(),SendMessageBatchError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),SendMessageBatchError::Unknown(ref cause) => cause
                        }
                    }
                 }
