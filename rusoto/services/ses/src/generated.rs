...
Unknown(String)
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "LimitExceededException" => CloneReceiptRuleSetError::LimitExceeded(String::from(parsed_error.message)),"AlreadyExistsException" => CloneReceiptRuleSetError::AlreadyExists(String::from(parsed_error.message)),"RuleSetDoesNotExistException" => CloneReceiptRuleSetError::RuleSetDoesNotExist(String::from(parsed_error.message)),_ => CloneReceiptRuleSetError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for CloneReceiptRuleSetError {
                    fn description(&self) -> &str {
                        match *self {
                            CloneReceiptRuleSetError::RuleSetDoesNotExist(ref cause) => cause,CloneReceiptRuleSetError::LimitExceeded(ref cause) => cause,CloneReceiptRuleSetError::AlreadyExists(ref cause) => cause,CloneReceiptRuleSetError::Validation(ref cause) => cause,CloneReceiptRuleSetError::Credentials(ref err) => err.description(),CloneReceiptRuleSetError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),CloneReceiptRuleSetError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
InvalidConfigurationSet(String),/// An error occurred dispatching the HTTP request
HttpDispatch(HttpDispatchError),/// An error was encountered with AWS credentials.
Credentials(CredentialsError),/// A validation error occurred.  Details from AWS are provided.
Validation(String),/// An unknown error occurred.  The raw HTTP response is provided.
Unknown(String)
                ...
                impl Error for CreateConfigurationSetError {
                    fn description(&self) -> &str {
                        match *self {
                            CreateConfigurationSetError::ConfigurationSetAlreadyExists(ref cause) => cause,CreateConfigurationSetError::LimitExceeded(ref cause) => cause,CreateConfigurationSetError::InvalidConfigurationSet(ref cause) => cause,CreateConfigurationSetError::Validation(ref cause) => cause,CreateConfigurationSetError::Credentials(ref err) => err.description(),CreateConfigurationSetError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),CreateConfigurationSetError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
EventDestinationAlreadyExists(String),/// An error occurred dispatching the HTTP request
HttpDispatch(HttpDispatchError),/// An error was encountered with AWS credentials.
Credentials(CredentialsError),/// A validation error occurred.  Details from AWS are provided.
Validation(String),/// An unknown error occurred.  The raw HTTP response is provided.
Unknown(String)
                ...
                impl Error for CreateConfigurationSetEventDestinationError {
                    fn description(&self) -> &str {
                        match *self {
                            CreateConfigurationSetEventDestinationError::InvalidFirehoseDestination(ref cause) => cause,CreateConfigurationSetEventDestinationError::ConfigurationSetDoesNotExist(ref cause) => cause,CreateConfigurationSetEventDestinationError::EventDestinationAlreadyExists(ref cause) => cause,CreateConfigurationSetEventDestinationError::InvalidCloudWatchDestination(ref cause) => cause,CreateConfigurationSetEventDestinationError::LimitExceeded(ref cause) => cause,CreateConfigurationSetEventDestinationError::Validation(ref cause) => cause,CreateConfigurationSetEventDestinationError::Credentials(ref err) => err.description(),CreateConfigurationSetEventDestinationError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),CreateConfigurationSetEventDestinationError::Unknown(ref cause) => cause
                        }
                    }
                 }
                ...
                impl CreateReceiptRuleError {
                    pub fn from_body(body: &str) -> CreateReceiptRuleError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "InvalidLambdaFunctionException" => CreateReceiptRuleError::InvalidLambdaFunction(String::from(parsed_error.message)),"LimitExceededException" => CreateReceiptRuleError::LimitExceeded(String::from(parsed_error.message)),"RuleSetDoesNotExistException" => CreateReceiptRuleError::RuleSetDoesNotExist(String::from(parsed_error.message)),"InvalidS3ConfigurationException" => CreateReceiptRuleError::InvalidS3Configuration(String::from(parsed_error.message)),"RuleDoesNotExistException" => CreateReceiptRuleError::RuleDoesNotExist(String::from(parsed_error.message)),"InvalidSnsTopicException" => CreateReceiptRuleError::InvalidSnsTopic(String::from(parsed_error.message)),"AlreadyExistsException" => CreateReceiptRuleError::AlreadyExists(String::from(parsed_error.message)),_ => CreateReceiptRuleError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DeleteConfigurationSetEventDestinationError {
                    pub fn from_body(body: &str) -> DeleteConfigurationSetEventDestinationError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "EventDestinationDoesNotExistException" => DeleteConfigurationSetEventDestinationError::EventDestinationDoesNotExist(String::from(parsed_error.message)),"ConfigurationSetDoesNotExistException" => DeleteConfigurationSetEventDestinationError::ConfigurationSetDoesNotExist(String::from(parsed_error.message)),_ => DeleteConfigurationSetEventDestinationError::Unknown(String::from(body))
                                }
                           },
                ...
                impl SendEmailError {
                    pub fn from_body(body: &str) -> SendEmailError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "MailFromDomainNotVerifiedException" => SendEmailError::MailFromDomainNotVerified(String::from(parsed_error.message)),"MessageRejected" => SendEmailError::MessageRejected(String::from(parsed_error.message)),"ConfigurationSetDoesNotExistException" => SendEmailError::ConfigurationSetDoesNotExist(String::from(parsed_error.message)),_ => SendEmailError::Unknown(String::from(body))
                                }
                           },
                ...
                impl SendRawEmailError {
                    pub fn from_body(body: &str) -> SendRawEmailError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ConfigurationSetDoesNotExistException" => SendRawEmailError::ConfigurationSetDoesNotExist(String::from(parsed_error.message)),"MessageRejected" => SendRawEmailError::MessageRejected(String::from(parsed_error.message)),"MailFromDomainNotVerifiedException" => SendRawEmailError::MailFromDomainNotVerified(String::from(parsed_error.message)),_ => SendRawEmailError::Unknown(String::from(body))
                                }
                           },
                ...
                impl UpdateConfigurationSetEventDestinationError {
                    pub fn from_body(body: &str) -> UpdateConfigurationSetEventDestinationError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "InvalidFirehoseDestinationException" => UpdateConfigurationSetEventDestinationError::InvalidFirehoseDestination(String::from(parsed_error.message)),"InvalidCloudWatchDestinationException" => UpdateConfigurationSetEventDestinationError::InvalidCloudWatchDestination(String::from(parsed_error.message)),"EventDestinationDoesNotExistException" => UpdateConfigurationSetEventDestinationError::EventDestinationDoesNotExist(String::from(parsed_error.message)),"ConfigurationSetDoesNotExistException" => UpdateConfigurationSetEventDestinationError::ConfigurationSetDoesNotExist(String::from(parsed_error.message)),_ => UpdateConfigurationSetEventDestinationError::Unknown(String::from(body))
                                }
                           },
...
Unknown(String)
                ...
                impl UpdateReceiptRuleError {
                    pub fn from_body(body: &str) -> UpdateReceiptRuleError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "RuleSetDoesNotExistException" => UpdateReceiptRuleError::RuleSetDoesNotExist(String::from(parsed_error.message)),"RuleDoesNotExistException" => UpdateReceiptRuleError::RuleDoesNotExist(String::from(parsed_error.message)),"LimitExceededException" => UpdateReceiptRuleError::LimitExceeded(String::from(parsed_error.message)),"InvalidSnsTopicException" => UpdateReceiptRuleError::InvalidSnsTopic(String::from(parsed_error.message)),"InvalidLambdaFunctionException" => UpdateReceiptRuleError::InvalidLambdaFunction(String::from(parsed_error.message)),"InvalidS3ConfigurationException" => UpdateReceiptRuleError::InvalidS3Configuration(String::from(parsed_error.message)),_ => UpdateReceiptRuleError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for UpdateReceiptRuleError {
                    fn description(&self) -> &str {
                        match *self {
                            UpdateReceiptRuleError::InvalidSnsTopic(ref cause) => cause,UpdateReceiptRuleError::InvalidLambdaFunction(ref cause) => cause,UpdateReceiptRuleError::RuleDoesNotExist(ref cause) => cause,UpdateReceiptRuleError::LimitExceeded(ref cause) => cause,UpdateReceiptRuleError::RuleSetDoesNotExist(ref cause) => cause,UpdateReceiptRuleError::InvalidS3Configuration(ref cause) => cause,UpdateReceiptRuleError::Validation(ref cause) => cause,UpdateReceiptRuleError::Credentials(ref err) => err.description(),UpdateReceiptRuleError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),UpdateReceiptRuleError::Unknown(ref cause) => cause
                        }
                    }
                 }
