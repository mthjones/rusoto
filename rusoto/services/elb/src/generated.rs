                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "TooManyTagsException" => AddTagsError::TooManyTags(String::from(parsed_error.message)),"DuplicateTagKeysException" => AddTagsError::DuplicateTagKeys(String::from(parsed_error.message)),"AccessPointNotFoundException" => AddTagsError::AccessPointNotFound(String::from(parsed_error.message)),_ => AddTagsError::Unknown(String::from(body))
                                }
                           },
...
Unknown(String)
                ...
                impl AttachLoadBalancerToSubnetsError {
                    pub fn from_body(body: &str) -> AttachLoadBalancerToSubnetsError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "InvalidConfigurationRequestException" => AttachLoadBalancerToSubnetsError::InvalidConfigurationRequest(String::from(parsed_error.message)),"SubnetNotFoundException" => AttachLoadBalancerToSubnetsError::SubnetNotFound(String::from(parsed_error.message)),"AccessPointNotFoundException" => AttachLoadBalancerToSubnetsError::AccessPointNotFound(String::from(parsed_error.message)),"InvalidSubnetException" => AttachLoadBalancerToSubnetsError::InvalidSubnet(String::from(parsed_error.message)),_ => AttachLoadBalancerToSubnetsError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for AttachLoadBalancerToSubnetsError {
                    fn description(&self) -> &str {
                        match *self {
                            AttachLoadBalancerToSubnetsError::InvalidConfigurationRequest(ref cause) => cause,AttachLoadBalancerToSubnetsError::InvalidSubnet(ref cause) => cause,AttachLoadBalancerToSubnetsError::SubnetNotFound(ref cause) => cause,AttachLoadBalancerToSubnetsError::AccessPointNotFound(ref cause) => cause,AttachLoadBalancerToSubnetsError::Validation(ref cause) => cause,AttachLoadBalancerToSubnetsError::Credentials(ref err) => err.description(),AttachLoadBalancerToSubnetsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),AttachLoadBalancerToSubnetsError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl CreateLBCookieStickinessPolicyError {
                    pub fn from_body(body: &str) -> CreateLBCookieStickinessPolicyError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "TooManyPoliciesException" => CreateLBCookieStickinessPolicyError::TooManyPolicies(String::from(parsed_error.message)),"DuplicatePolicyNameException" => CreateLBCookieStickinessPolicyError::DuplicatePolicyName(String::from(parsed_error.message)),"AccessPointNotFoundException" => CreateLBCookieStickinessPolicyError::AccessPointNotFound(String::from(parsed_error.message)),"InvalidConfigurationRequestException" => CreateLBCookieStickinessPolicyError::InvalidConfigurationRequest(String::from(parsed_error.message)),_ => CreateLBCookieStickinessPolicyError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for CreateLBCookieStickinessPolicyError {
                    fn description(&self) -> &str {
                        match *self {
                            CreateLBCookieStickinessPolicyError::TooManyPolicies(ref cause) => cause,CreateLBCookieStickinessPolicyError::AccessPointNotFound(ref cause) => cause,CreateLBCookieStickinessPolicyError::InvalidConfigurationRequest(ref cause) => cause,CreateLBCookieStickinessPolicyError::DuplicatePolicyName(ref cause) => cause,CreateLBCookieStickinessPolicyError::Validation(ref cause) => cause,CreateLBCookieStickinessPolicyError::Credentials(ref err) => err.description(),CreateLBCookieStickinessPolicyError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),CreateLBCookieStickinessPolicyError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
InvalidScheme(String),/// An error occurred dispatching the HTTP request
HttpDispatch(HttpDispatchError),/// An error was encountered with AWS credentials.
Credentials(CredentialsError),/// A validation error occurred.  Details from AWS are provided.
Validation(String),/// An unknown error occurred.  The raw HTTP response is provided.
Unknown(String)
                ...
                impl CreateLoadBalancerError {
                    pub fn from_body(body: &str) -> CreateLoadBalancerError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "DuplicateTagKeysException" => CreateLoadBalancerError::DuplicateTagKeys(String::from(parsed_error.message)),"UnsupportedProtocolException" => CreateLoadBalancerError::UnsupportedProtocol(String::from(parsed_error.message)),"DuplicateAccessPointNameException" => CreateLoadBalancerError::DuplicateAccessPointName(String::from(parsed_error.message)),"InvalidSubnetException" => CreateLoadBalancerError::InvalidSubnet(String::from(parsed_error.message)),"InvalidSecurityGroupException" => CreateLoadBalancerError::InvalidSecurityGroup(String::from(parsed_error.message)),"InvalidConfigurationRequestException" => CreateLoadBalancerError::InvalidConfigurationRequest(String::from(parsed_error.message)),"TooManyTagsException" => CreateLoadBalancerError::TooManyTags(String::from(parsed_error.message)),"SubnetNotFoundException" => CreateLoadBalancerError::SubnetNotFound(String::from(parsed_error.message)),"TooManyAccessPointsException" => CreateLoadBalancerError::TooManyAccessPoints(String::from(parsed_error.message)),"InvalidSchemeException" => CreateLoadBalancerError::InvalidScheme(String::from(parsed_error.message)),"CertificateNotFoundException" => CreateLoadBalancerError::CertificateNotFound(String::from(parsed_error.message)),_ => CreateLoadBalancerError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for CreateLoadBalancerError {
                    fn description(&self) -> &str {
                        match *self {
                            CreateLoadBalancerError::DuplicateAccessPointName(ref cause) => cause,CreateLoadBalancerError::InvalidSecurityGroup(ref cause) => cause,CreateLoadBalancerError::CertificateNotFound(ref cause) => cause,CreateLoadBalancerError::TooManyTags(ref cause) => cause,CreateLoadBalancerError::InvalidScheme(ref cause) => cause,CreateLoadBalancerError::TooManyAccessPoints(ref cause) => cause,CreateLoadBalancerError::InvalidSubnet(ref cause) => cause,CreateLoadBalancerError::DuplicateTagKeys(ref cause) => cause,CreateLoadBalancerError::SubnetNotFound(ref cause) => cause,CreateLoadBalancerError::InvalidConfigurationRequest(ref cause) => cause,CreateLoadBalancerError::UnsupportedProtocol(ref cause) => cause,CreateLoadBalancerError::Validation(ref cause) => cause,CreateLoadBalancerError::Credentials(ref err) => err.description(),CreateLoadBalancerError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),CreateLoadBalancerError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl CreateLoadBalancerListenersError {
                    pub fn from_body(body: &str) -> CreateLoadBalancerListenersError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "AccessPointNotFoundException" => CreateLoadBalancerListenersError::AccessPointNotFound(String::from(parsed_error.message)),"DuplicateListenerException" => CreateLoadBalancerListenersError::DuplicateListener(String::from(parsed_error.message)),"UnsupportedProtocolException" => CreateLoadBalancerListenersError::UnsupportedProtocol(String::from(parsed_error.message)),"InvalidConfigurationRequestException" => CreateLoadBalancerListenersError::InvalidConfigurationRequest(String::from(parsed_error.message)),"CertificateNotFoundException" => CreateLoadBalancerListenersError::CertificateNotFound(String::from(parsed_error.message)),_ => CreateLoadBalancerListenersError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for CreateLoadBalancerListenersError {
                    fn description(&self) -> &str {
                        match *self {
                            CreateLoadBalancerListenersError::InvalidConfigurationRequest(ref cause) => cause,CreateLoadBalancerListenersError::DuplicateListener(ref cause) => cause,CreateLoadBalancerListenersError::AccessPointNotFound(ref cause) => cause,CreateLoadBalancerListenersError::CertificateNotFound(ref cause) => cause,CreateLoadBalancerListenersError::UnsupportedProtocol(ref cause) => cause,CreateLoadBalancerListenersError::Validation(ref cause) => cause,CreateLoadBalancerListenersError::Credentials(ref err) => err.description(),CreateLoadBalancerListenersError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),CreateLoadBalancerListenersError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl CreateLoadBalancerPolicyError {
                    pub fn from_body(body: &str) -> CreateLoadBalancerPolicyError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "InvalidConfigurationRequestException" => CreateLoadBalancerPolicyError::InvalidConfigurationRequest(String::from(parsed_error.message)),"DuplicatePolicyNameException" => CreateLoadBalancerPolicyError::DuplicatePolicyName(String::from(parsed_error.message)),"PolicyTypeNotFoundException" => CreateLoadBalancerPolicyError::PolicyTypeNotFound(String::from(parsed_error.message)),"AccessPointNotFoundException" => CreateLoadBalancerPolicyError::AccessPointNotFound(String::from(parsed_error.message)),"TooManyPoliciesException" => CreateLoadBalancerPolicyError::TooManyPolicies(String::from(parsed_error.message)),_ => CreateLoadBalancerPolicyError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for CreateLoadBalancerPolicyError {
                    fn description(&self) -> &str {
                        match *self {
                            CreateLoadBalancerPolicyError::PolicyTypeNotFound(ref cause) => cause,CreateLoadBalancerPolicyError::TooManyPolicies(ref cause) => cause,CreateLoadBalancerPolicyError::InvalidConfigurationRequest(ref cause) => cause,CreateLoadBalancerPolicyError::DuplicatePolicyName(ref cause) => cause,CreateLoadBalancerPolicyError::AccessPointNotFound(ref cause) => cause,CreateLoadBalancerPolicyError::Validation(ref cause) => cause,CreateLoadBalancerPolicyError::Credentials(ref err) => err.description(),CreateLoadBalancerPolicyError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),CreateLoadBalancerPolicyError::Unknown(ref cause) => cause
                        }
                    }
                 }
                ...
                impl DeleteLoadBalancerPolicyError {
                    pub fn from_body(body: &str) -> DeleteLoadBalancerPolicyError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "InvalidConfigurationRequestException" => DeleteLoadBalancerPolicyError::InvalidConfigurationRequest(String::from(parsed_error.message)),"AccessPointNotFoundException" => DeleteLoadBalancerPolicyError::AccessPointNotFound(String::from(parsed_error.message)),_ => DeleteLoadBalancerPolicyError::Unknown(String::from(body))
                                }
                           },
...
Unknown(String)
                ...
                impl Error for DescribeLoadBalancerAttributesError {
                    fn description(&self) -> &str {
                        match *self {
                            DescribeLoadBalancerAttributesError::LoadBalancerAttributeNotFound(ref cause) => cause,DescribeLoadBalancerAttributesError::AccessPointNotFound(ref cause) => cause,DescribeLoadBalancerAttributesError::Validation(ref cause) => cause,DescribeLoadBalancerAttributesError::Credentials(ref err) => err.description(),DescribeLoadBalancerAttributesError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),DescribeLoadBalancerAttributesError::Unknown(ref cause) => cause
                        }
                    }
                 }
                ...
                impl ModifyLoadBalancerAttributesError {
                    pub fn from_body(body: &str) -> ModifyLoadBalancerAttributesError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "InvalidConfigurationRequestException" => ModifyLoadBalancerAttributesError::InvalidConfigurationRequest(String::from(parsed_error.message)),"AccessPointNotFoundException" => ModifyLoadBalancerAttributesError::AccessPointNotFound(String::from(parsed_error.message)),"LoadBalancerAttributeNotFoundException" => ModifyLoadBalancerAttributesError::LoadBalancerAttributeNotFound(String::from(parsed_error.message)),_ => ModifyLoadBalancerAttributesError::Unknown(String::from(body))
                                }
                           },
...
Unknown(String)
                ...
                impl Error for RegisterInstancesWithLoadBalancerError {
                    fn description(&self) -> &str {
                        match *self {
                            RegisterInstancesWithLoadBalancerError::InvalidEndPoint(ref cause) => cause,RegisterInstancesWithLoadBalancerError::AccessPointNotFound(ref cause) => cause,RegisterInstancesWithLoadBalancerError::Validation(ref cause) => cause,RegisterInstancesWithLoadBalancerError::Credentials(ref err) => err.description(),RegisterInstancesWithLoadBalancerError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),RegisterInstancesWithLoadBalancerError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl SetLoadBalancerListenerSSLCertificateError {
                    pub fn from_body(body: &str) -> SetLoadBalancerListenerSSLCertificateError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "UnsupportedProtocolException" => SetLoadBalancerListenerSSLCertificateError::UnsupportedProtocol(String::from(parsed_error.message)),"ListenerNotFoundException" => SetLoadBalancerListenerSSLCertificateError::ListenerNotFound(String::from(parsed_error.message)),"AccessPointNotFoundException" => SetLoadBalancerListenerSSLCertificateError::AccessPointNotFound(String::from(parsed_error.message)),"InvalidConfigurationRequestException" => SetLoadBalancerListenerSSLCertificateError::InvalidConfigurationRequest(String::from(parsed_error.message)),"CertificateNotFoundException" => SetLoadBalancerListenerSSLCertificateError::CertificateNotFound(String::from(parsed_error.message)),_ => SetLoadBalancerListenerSSLCertificateError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for SetLoadBalancerListenerSSLCertificateError {
                    fn description(&self) -> &str {
                        match *self {
                            SetLoadBalancerListenerSSLCertificateError::InvalidConfigurationRequest(ref cause) => cause,SetLoadBalancerListenerSSLCertificateError::CertificateNotFound(ref cause) => cause,SetLoadBalancerListenerSSLCertificateError::AccessPointNotFound(ref cause) => cause,SetLoadBalancerListenerSSLCertificateError::ListenerNotFound(ref cause) => cause,SetLoadBalancerListenerSSLCertificateError::UnsupportedProtocol(ref cause) => cause,SetLoadBalancerListenerSSLCertificateError::Validation(ref cause) => cause,SetLoadBalancerListenerSSLCertificateError::Credentials(ref err) => err.description(),SetLoadBalancerListenerSSLCertificateError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),SetLoadBalancerListenerSSLCertificateError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl Error for SetLoadBalancerPoliciesForBackendServerError {
                    fn description(&self) -> &str {
                        match *self {
                            SetLoadBalancerPoliciesForBackendServerError::PolicyNotFound(ref cause) => cause,SetLoadBalancerPoliciesForBackendServerError::InvalidConfigurationRequest(ref cause) => cause,SetLoadBalancerPoliciesForBackendServerError::AccessPointNotFound(ref cause) => cause,SetLoadBalancerPoliciesForBackendServerError::Validation(ref cause) => cause,SetLoadBalancerPoliciesForBackendServerError::Credentials(ref err) => err.description(),SetLoadBalancerPoliciesForBackendServerError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),SetLoadBalancerPoliciesForBackendServerError::Unknown(ref cause) => cause
                        }
                    }
                 }
                ...
                impl SetLoadBalancerPoliciesOfListenerError {
                    pub fn from_body(body: &str) -> SetLoadBalancerPoliciesOfListenerError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "AccessPointNotFoundException" => SetLoadBalancerPoliciesOfListenerError::AccessPointNotFound(String::from(parsed_error.message)),"PolicyNotFoundException" => SetLoadBalancerPoliciesOfListenerError::PolicyNotFound(String::from(parsed_error.message)),"InvalidConfigurationRequestException" => SetLoadBalancerPoliciesOfListenerError::InvalidConfigurationRequest(String::from(parsed_error.message)),"ListenerNotFoundException" => SetLoadBalancerPoliciesOfListenerError::ListenerNotFound(String::from(parsed_error.message)),_ => SetLoadBalancerPoliciesOfListenerError::Unknown(String::from(body))
                                }
                           },
