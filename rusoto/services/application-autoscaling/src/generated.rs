...
pub struct Alarm {
    ...
    pub alarm_arn: ResourceId,
    #[doc="<p>The name of the alarm.</p>"]
    #[serde(rename="AlarmName")]
    pub alarm_name: ResourceId,
}
...
pub struct DeleteScalingPolicyRequest {
    ...
    pub policy_name: ResourceIdMaxLen1600,
    ...
    pub resource_id: ResourceIdMaxLen1600,
...
pub struct DescribeScalableTargetsRequest {
    ...
    pub resource_ids: Option<ResourceIdsMaxLen1600>,
...
pub struct DescribeScalableTargetsResponse {
    ...
    pub scalable_targets: Option<ScalableTargets>,
}
...
pub struct DescribeScalingActivitiesRequest {
    ...
    #[serde(rename="ResourceId")]
    pub resource_id: Option<ResourceIdMaxLen1600>,
...
pub struct DescribeScalingActivitiesResponse {
    ...
    pub scaling_activities: Option<ScalingActivities>,
}
...
pub struct DescribeScalingPoliciesRequest {
    ...
    pub policy_names: Option<ResourceIdsMaxLen1600>,
...
pub type MetricAggregationType = String;
...
pub struct PutScalingPolicyRequest {
    ...
    #[doc="<p>The policy type. If you are creating a new policy, this parameter is required. If you are updating a policy, this parameter is not required.</p>"]
    ...
    #[serde(rename="ServiceNamespace")]
    pub service_namespace: ServiceNamespace,
    #[doc="<p>The configuration for the step scaling policy. If you are creating a new policy, this parameter is required. If you are updating a policy, this parameter is not required. For more information, see <a>StepScalingPolicyConfiguration</a> and <a>StepAdjustment</a>.</p>"]
...
pub struct PutScalingPolicyResponse {
    ...
    pub policy_arn: ResourceIdMaxLen1600,
}
...
pub struct RegisterScalableTargetRequest {
    ...
    pub max_capacity: Option<ResourceCapacity>,
    ...
    pub min_capacity: Option<ResourceCapacity>,
    #[doc="<p>The identifier of the resource associated with the scalable target. This string consists of the resource type and unique identifier.</p> <ul> <li> <p>ECS service - The resource type is <code>service</code> and the unique identifier is the cluster name and service name. Example: <code>service/default/sample-webapp</code>.</p> </li> <li> <p>Spot fleet request - The resource type is <code>spot-fleet-request</code> and the unique identifier is the Spot fleet request ID. Example: <code>spot-fleet-request/sfr-73fbd2ce-aa30-494c-8788-1cee4EXAMPLE</code>.</p> </li> <li> <p>EMR cluster - The resource type is <code>instancegroup</code> and the unique identifier is the cluster ID and instance group ID. Example: <code>instancegroup/j-2EEZNYKUA1NTV/ig-1791Y4E1L8YI0</code>.</p> </li> <li> <p>AppStream 2.0 fleet - The resource type is <code>fleet</code> and the unique identifier is the fleet name. Example: <code>fleet/sample-fleet</code>.</p> </li> </ul>"]
    #[serde(rename="ResourceId")]
    pub resource_id: ResourceIdMaxLen1600,
    ...
    pub role_arn: Option<ResourceIdMaxLen1600>,
    #[doc="<p>The scalable dimension associated with the scalable target. This string consists of the service namespace, resource type, and scaling property.</p> <ul> <li> <p> <code>ecs:service:DesiredCount</code> - The desired task count of an ECS service.</p> </li> <li> <p> <code>ec2:spot-fleet-request:TargetCapacity</code> - The target capacity of a Spot fleet request.</p> </li> <li> <p> <code>elasticmapreduce:instancegroup:InstanceCount</code> - The instance count of an EMR Instance Group.</p> </li> <li> <p> <code>appstream:fleet:DesiredCapacity</code> - The desired capacity of an AppStream 2.0 fleet.</p> </li> </ul>"]
    #[serde(rename="ScalableDimension")]
    pub scalable_dimension: ScalableDimension,
    #[doc="<p>The namespace of the AWS service. For more information, see <a href=\"http://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html#genref-aws-service-namespaces\">AWS Service Namespaces</a> in the <i>Amazon Web Services General Reference</i>.</p>"]
...
pub type ResourceCapacity = i64;
pub type ResourceId = String;
pub type ResourceIdMaxLen1600 = String;
pub type ResourceIdsMaxLen1600 = Vec<ResourceIdMaxLen1600>;
pub type ScalableDimension = String;
...
pub struct ScalableTarget {
    ...
    #[serde(rename="RoleARN")]
    pub role_arn: ResourceIdMaxLen1600,
    #[doc="<p>The scalable dimension associated with the scalable target. This string consists of the service namespace, resource type, and scaling property.</p> <ul> <li> <p> <code>ecs:service:DesiredCount</code> - The desired task count of an ECS service.</p> </li> <li> <p> <code>ec2:spot-fleet-request:TargetCapacity</code> - The target capacity of a Spot fleet request.</p> </li> <li> <p> <code>elasticmapreduce:instancegroup:InstanceCount</code> - The instance count of an EMR Instance Group.</p> </li> <li> <p> <code>appstream:fleet:DesiredCapacity</code> - The desired capacity of an AppStream 2.0 fleet.</p> </li> </ul>"]
    #[serde(rename="ScalableDimension")]
    pub scalable_dimension: ScalableDimension,
    #[doc="<p>The namespace of the AWS service. For more information, see <a href=\"http://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html#genref-aws-service-namespaces\">AWS Service Namespaces</a> in the <i>Amazon Web Services General Reference</i>.</p>"]
...
pub type ScalableTargets = Vec<ScalableTarget>;
pub type ScalingActivities = Vec<ScalingActivity>;
...
pub struct ScalingActivity {
    ...
    pub status_message: Option<XmlString>,
}

pub type ScalingActivityStatusCode = String;
pub type ScalingAdjustment = i64;
...
pub struct ScalingPolicy {
    ...
    #[serde(rename="ServiceNamespace")]
    pub service_namespace: ServiceNamespace,
    #[doc="<p>The configuration for the step scaling policy.</p>"]
    #[serde(rename="StepScalingPolicyConfiguration")]
    pub step_scaling_policy_configuration: Option<StepScalingPolicyConfiguration>,
}

pub type ServiceNamespace = String;
          ...
          D: DispatchSignedRequest
{
    ...
    fn delete_scaling_policy(&self,
        ...
        match response.status {
            StatusCode::Ok => {
                            Ok(serde_json::from_str::<DeleteScalingPolicyResponse>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                        }
            _ => {
    ...
    fn deregister_scalable_target
        ...
        match response.status {
            StatusCode::Ok => {
                            Ok(serde_json::from_str::<DeregisterScalableTargetResponse>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                        }
            _ => Err(DeregisterScalableTargetError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
        }
    }
    ...
    fn describe_scalable_targets
        ...
        match response.status {
            StatusCode::Ok => {
                            Ok(serde_json::from_str::<DescribeScalableTargetsResponse>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                        }
            _ => Err(DescribeScalableTargetsError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
        }
    }
    ...
    fn describe_scaling_activities
        ...
        match response.status {
            StatusCode::Ok => {
                            Ok(serde_json::from_str::<DescribeScalingActivitiesResponse>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                        }
            _ => Err(DescribeScalingActivitiesError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
        }
    }
    ...
    fn describe_scaling_policies
        ...
        match response.status {
            StatusCode::Ok => {
                            Ok(serde_json::from_str::<DescribeScalingPoliciesResponse>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                        }
    ...
    fn put_scaling_policy(&self,
        ...
        match response.status {
            StatusCode::Ok => {
                            Ok(serde_json::from_str::<PutScalingPolicyResponse>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                        }
            _ => {
    ...
    fn register_scalable_target
        ...
        match response.status {
            StatusCode::Ok => {
                            Ok(serde_json::from_str::<RegisterScalableTargetResponse>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                        }
            _ => {
                Err(RegisterScalableTargetError::from_body(String::from_utf8_lossy(&response.body)
                                                               .as_ref()))
            }
        }
    }
