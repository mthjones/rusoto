...
Unknown(String)
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "PackedPolicyTooLargeException" => AssumeRoleError::PackedPolicyTooLarge(String::from(parsed_error.message)),"RegionDisabledException" => AssumeRoleError::RegionDisabled(String::from(parsed_error.message)),"MalformedPolicyDocumentException" => AssumeRoleError::MalformedPolicyDocument(String::from(parsed_error.message)),_ => AssumeRoleError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for AssumeRoleError {
                    fn description(&self) -> &str {
                        match *self {
                            AssumeRoleError::RegionDisabled(ref cause) => cause,AssumeRoleError::PackedPolicyTooLarge(ref cause) => cause,AssumeRoleError::MalformedPolicyDocument(ref cause) => cause,AssumeRoleError::Validation(ref cause) => cause,AssumeRoleError::Credentials(ref err) => err.description(),AssumeRoleError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),AssumeRoleError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
InvalidIdentityToken(String),/// An error occurred dispatching the HTTP request
HttpDispatch(HttpDispatchError),/// An error was encountered with AWS credentials.
Credentials(CredentialsError),/// A validation error occurred.  Details from AWS are provided.
Validation(String),/// An unknown error occurred.  The raw HTTP response is provided.
Unknown(String)
                ...
                impl AssumeRoleWithSAMLError {
                    pub fn from_body(body: &str) -> AssumeRoleWithSAMLError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "IDPRejectedClaimException" => AssumeRoleWithSAMLError::IDPRejectedClaim(String::from(parsed_error.message)),"MalformedPolicyDocumentException" => AssumeRoleWithSAMLError::MalformedPolicyDocument(String::from(parsed_error.message)),"RegionDisabledException" => AssumeRoleWithSAMLError::RegionDisabled(String::from(parsed_error.message)),"ExpiredTokenException" => AssumeRoleWithSAMLError::ExpiredToken(String::from(parsed_error.message)),"InvalidIdentityTokenException" => AssumeRoleWithSAMLError::InvalidIdentityToken(String::from(parsed_error.message)),"PackedPolicyTooLargeException" => AssumeRoleWithSAMLError::PackedPolicyTooLarge(String::from(parsed_error.message)),_ => AssumeRoleWithSAMLError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for AssumeRoleWithSAMLError {
                    fn description(&self) -> &str {
                        match *self {
                            AssumeRoleWithSAMLError::InvalidIdentityToken(ref cause) => cause,AssumeRoleWithSAMLError::RegionDisabled(ref cause) => cause,AssumeRoleWithSAMLError::MalformedPolicyDocument(ref cause) => cause,AssumeRoleWithSAMLError::IDPRejectedClaim(ref cause) => cause,AssumeRoleWithSAMLError::ExpiredToken(ref cause) => cause,AssumeRoleWithSAMLError::PackedPolicyTooLarge(ref cause) => cause,AssumeRoleWithSAMLError::Validation(ref cause) => cause,AssumeRoleWithSAMLError::Credentials(ref err) => err.description(),AssumeRoleWithSAMLError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),AssumeRoleWithSAMLError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl AssumeRoleWithWebIdentityError {
                    pub fn from_body(body: &str) -> AssumeRoleWithWebIdentityError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "PackedPolicyTooLargeException" => AssumeRoleWithWebIdentityError::PackedPolicyTooLarge(String::from(parsed_error.message)),"ExpiredTokenException" => AssumeRoleWithWebIdentityError::ExpiredToken(String::from(parsed_error.message)),"IDPCommunicationErrorException" => AssumeRoleWithWebIdentityError::IDPCommunicationError(String::from(parsed_error.message)),"IDPRejectedClaimException" => AssumeRoleWithWebIdentityError::IDPRejectedClaim(String::from(parsed_error.message)),"RegionDisabledException" => AssumeRoleWithWebIdentityError::RegionDisabled(String::from(parsed_error.message)),"InvalidIdentityTokenException" => AssumeRoleWithWebIdentityError::InvalidIdentityToken(String::from(parsed_error.message)),"MalformedPolicyDocumentException" => AssumeRoleWithWebIdentityError::MalformedPolicyDocument(String::from(parsed_error.message)),_ => AssumeRoleWithWebIdentityError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for AssumeRoleWithWebIdentityError {
                    fn description(&self) -> &str {
                        match *self {
                            AssumeRoleWithWebIdentityError::IDPRejectedClaim(ref cause) => cause,AssumeRoleWithWebIdentityError::ExpiredToken(ref cause) => cause,AssumeRoleWithWebIdentityError::MalformedPolicyDocument(ref cause) => cause,AssumeRoleWithWebIdentityError::PackedPolicyTooLarge(ref cause) => cause,AssumeRoleWithWebIdentityError::RegionDisabled(ref cause) => cause,AssumeRoleWithWebIdentityError::InvalidIdentityToken(ref cause) => cause,AssumeRoleWithWebIdentityError::IDPCommunicationError(ref cause) => cause,AssumeRoleWithWebIdentityError::Validation(ref cause) => cause,AssumeRoleWithWebIdentityError::Credentials(ref err) => err.description(),AssumeRoleWithWebIdentityError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),AssumeRoleWithWebIdentityError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl GetFederationTokenError {
                    pub fn from_body(body: &str) -> GetFederationTokenError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "PackedPolicyTooLargeException" => GetFederationTokenError::PackedPolicyTooLarge(String::from(parsed_error.message)),"MalformedPolicyDocumentException" => GetFederationTokenError::MalformedPolicyDocument(String::from(parsed_error.message)),"RegionDisabledException" => GetFederationTokenError::RegionDisabled(String::from(parsed_error.message)),_ => GetFederationTokenError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for GetFederationTokenError {
                    fn description(&self) -> &str {
                        match *self {
                            GetFederationTokenError::RegionDisabled(ref cause) => cause,GetFederationTokenError::PackedPolicyTooLarge(ref cause) => cause,GetFederationTokenError::MalformedPolicyDocument(ref cause) => cause,GetFederationTokenError::Validation(ref cause) => cause,GetFederationTokenError::Credentials(ref err) => err.description(),GetFederationTokenError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),GetFederationTokenError::Unknown(ref cause) => cause
                        }
                    }
                 }
