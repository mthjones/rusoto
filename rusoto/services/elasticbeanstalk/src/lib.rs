...
/// A client for the Elastic Beanstalk API.
        ...
        impl<P, D> ElasticBeanstalkClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
            pub fn new(request_dispatcher: D, credentials_provider: P, region: region::Region) -> Self {
                ...
                pub fn abort_environment_update(&self, input: &AbortEnvironmentUpdateMessage) -> Result<(), AbortEnvironmentUpdateError> {
                ...
                pub fn apply_environment_managed_action(&self, input: &ApplyEnvironmentManagedActionRequest) -> Result<ApplyEnvironmentManagedActionResult, ApplyEnvironmentManagedActionError> {
                    let mut request = SignedRequest::new("POST", "elasticbeanstalk", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn check_dns_availability(&self, input: &CheckDNSAvailabilityMessage) -> Result<CheckDNSAvailabilityResultMessage, CheckDNSAvailabilityError> {
                    let mut request = SignedRequest::new("POST", "elasticbeanstalk", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn compose_environments(&self, input: &ComposeEnvironmentsMessage) -> Result<EnvironmentDescriptionsMessage, ComposeEnvironmentsError> {
                    let mut request = SignedRequest::new("POST", "elasticbeanstalk", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn create_application(&self, input: &CreateApplicationMessage) -> Result<ApplicationDescriptionMessage, CreateApplicationError> {
                    let mut request = SignedRequest::new("POST", "elasticbeanstalk", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn create_application_version(&self, input: &CreateApplicationVersionMessage) -> Result<ApplicationVersionDescriptionMessage, CreateApplicationVersionError> {
                    let mut request = SignedRequest::new("POST", "elasticbeanstalk", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn create_configuration_template(&self, input: &CreateConfigurationTemplateMessage) -> Result<ConfigurationSettingsDescription, CreateConfigurationTemplateError> {
                    let mut request = SignedRequest::new("POST", "elasticbeanstalk", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn create_environment(&self, input: &CreateEnvironmentMessage) -> Result<EnvironmentDescription, CreateEnvironmentError> {
                    let mut request = SignedRequest::new("POST", "elasticbeanstalk", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn delete_application(&self, input: &DeleteApplicationMessage) -> Result<(), DeleteApplicationError> {
                    let mut request = SignedRequest::new("POST", "elasticbeanstalk", self.region, "/");
                    let mut params = Params::new();
                ...
                pub fn delete_application_version(&self, input: &DeleteApplicationVersionMessage) -> Result<(), DeleteApplicationVersionError> {
                    let mut request = SignedRequest::new("POST", "elasticbeanstalk", self.region, "/");
                    let mut params = Params::new();
                ...
                pub fn delete_configuration_template(&self, input: &DeleteConfigurationTemplateMessage) -> Result<(), DeleteConfigurationTemplateError> {
                    let mut request = SignedRequest::new("POST", "elasticbeanstalk", self.region, "/");
                    let mut params = Params::new();
                ...
                pub fn delete_environment_configuration(&self, input: &DeleteEnvironmentConfigurationMessage) -> Result<(), DeleteEnvironmentConfigurationError> {
                    let mut request = SignedRequest::new("POST", "elasticbeanstalk", self.region, "/");
                    let mut params = Params::new();
                ...
                pub fn describe_application_versions(&self, input: &DescribeApplicationVersionsMessage) -> Result<ApplicationVersionDescriptionsMessage, DescribeApplicationVersionsError> {
                    let mut request = SignedRequest::new("POST", "elasticbeanstalk", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn describe_applications(&self, input: &DescribeApplicationsMessage) -> Result<ApplicationDescriptionsMessage, DescribeApplicationsError> {
                    let mut request = SignedRequest::new("POST", "elasticbeanstalk", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn describe_configuration_options(&self, input: &DescribeConfigurationOptionsMessage) -> Result<ConfigurationOptionsDescription, DescribeConfigurationOptionsError> {
                    let mut request = SignedRequest::new("POST", "elasticbeanstalk", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn describe_configuration_settings(&self, input: &DescribeConfigurationSettingsMessage) -> Result<ConfigurationSettingsDescriptions, DescribeConfigurationSettingsError> {
                    let mut request = SignedRequest::new("POST", "elasticbeanstalk", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn describe_environment_health(&self, input: &DescribeEnvironmentHealthRequest) -> Result<DescribeEnvironmentHealthResult, DescribeEnvironmentHealthError> {
                    let mut request = SignedRequest::new("POST", "elasticbeanstalk", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn describe_environment_managed_action_history(&self, input: &DescribeEnvironmentManagedActionHistoryRequest) -> Result<DescribeEnvironmentManagedActionHistoryResult, DescribeEnvironmentManagedActionHistoryError> {
                    let mut request = SignedRequest::new("POST", "elasticbeanstalk", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn describe_environment_managed_actions(&self, input: &DescribeEnvironmentManagedActionsRequest) -> Result<DescribeEnvironmentManagedActionsResult, DescribeEnvironmentManagedActionsError> {
                    let mut request = SignedRequest::new("POST", "elasticbeanstalk", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn describe_environment_resources(&self, input: &DescribeEnvironmentResourcesMessage) -> Result<EnvironmentResourceDescriptionsMessage, DescribeEnvironmentResourcesError> {
                    let mut request = SignedRequest::new("POST", "elasticbeanstalk", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn describe_environments(&self, input: &DescribeEnvironmentsMessage) -> Result<EnvironmentDescriptionsMessage, DescribeEnvironmentsError> {
                    let mut request = SignedRequest::new("POST", "elasticbeanstalk", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn describe_events(&self, input: &DescribeEventsMessage) -> Result<EventDescriptionsMessage, DescribeEventsError> {
                    let mut request = SignedRequest::new("POST", "elasticbeanstalk", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn describe_instances_health(&self, input: &DescribeInstancesHealthRequest) -> Result<DescribeInstancesHealthResult, DescribeInstancesHealthError> {
                    let mut request = SignedRequest::new("POST", "elasticbeanstalk", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn rebuild_environment(&self, input: &RebuildEnvironmentMessage) -> Result<(), RebuildEnvironmentError> {
                    let mut request = SignedRequest::new("POST", "elasticbeanstalk", self.region, "/");
                    let mut params = Params::new();
                ...
                pub fn request_environment_info(&self, input: &RequestEnvironmentInfoMessage) -> Result<(), RequestEnvironmentInfoError> {
                    let mut request = SignedRequest::new("POST", "elasticbeanstalk", self.region, "/");
                    let mut params = Params::new();
                ...
                pub fn restart_app_server(&self, input: &RestartAppServerMessage) -> Result<(), RestartAppServerError> {
                    let mut request = SignedRequest::new("POST", "elasticbeanstalk", self.region, "/");
                    let mut params = Params::new();
                ...
                pub fn retrieve_environment_info(&self, input: &RetrieveEnvironmentInfoMessage) -> Result<RetrieveEnvironmentInfoResultMessage, RetrieveEnvironmentInfoError> {
                    let mut request = SignedRequest::new("POST", "elasticbeanstalk", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                #[doc="<p>Swaps the CNAMEs of two environments.</p>"]
                pub fn swap_environment_cnam_es(&self, input: &SwapEnvironmentCNAMEsMessage) -> Result<(), SwapEnvironmentCNAMEsError> {
                    let mut request = SignedRequest::new("POST", "elasticbeanstalk", self.region, "/");
                    let mut params = Params::new();
                ...
                pub fn terminate_environment(&self, input: &TerminateEnvironmentMessage) -> Result<EnvironmentDescription, TerminateEnvironmentError> {
                    let mut request = SignedRequest::new("POST", "elasticbeanstalk", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn update_application(&self, input: &UpdateApplicationMessage) -> Result<ApplicationDescriptionMessage, UpdateApplicationError> {
                    let mut request = SignedRequest::new("POST", "elasticbeanstalk", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn update_application_resource_lifecycle(&self, input: &UpdateApplicationResourceLifecycleMessage) -> Result<ApplicationResourceLifecycleDescriptionMessage, UpdateApplicationResourceLifecycleError> {
                    let mut request = SignedRequest::new("POST", "elasticbeanstalk", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn update_application_version(&self, input: &UpdateApplicationVersionMessage) -> Result<ApplicationVersionDescriptionMessage, UpdateApplicationVersionError> {
                    let mut request = SignedRequest::new("POST", "elasticbeanstalk", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn update_configuration_template(&self, input: &UpdateConfigurationTemplateMessage) -> Result<ConfigurationSettingsDescription, UpdateConfigurationTemplateError> {
                    let mut request = SignedRequest::new("POST", "elasticbeanstalk", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn update_environment(&self, input: &UpdateEnvironmentMessage) -> Result<EnvironmentDescription, UpdateEnvironmentError> {
                    let mut request = SignedRequest::new("POST", "elasticbeanstalk", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                ...
                pub fn validate_configuration_settings(&self, input: &ValidateConfigurationSettingsMessage) -> Result<ConfigurationSettingsValidationMessages, ValidateConfigurationSettingsError> {
                    let mut request = SignedRequest::new("POST", "elasticbeanstalk", self.region, "/");
                    let mut params = Params::new();
        ...
        fn test_parse_elasticbeanstalk_check_dns_availability() {
            let mock_response =  MockResponseReader::read_response("test_resources", "elasticbeanstalk-check-dns-availability.xml");
        ...
        fn test_parse_elasticbeanstalk_create_application_version() {
            let mock_response =  MockResponseReader::read_response("test_resources", "elasticbeanstalk-create-application-version.xml");
            let mock = MockRequestDispatcher::with_status(200).with_body(&mock_response);
            let client = ElasticBeanstalkClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
        ...
        fn test_parse_elasticbeanstalk_create_application() {
            let mock_response =  MockResponseReader::read_response("test_resources", "elasticbeanstalk-create-application.xml");
            let mock = MockRequestDispatcher::with_status(200).with_body(&mock_response);
            let client = ElasticBeanstalkClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
        ...
        fn test_parse_elasticbeanstalk_create_configuration_template() {
            let mock_response =  MockResponseReader::read_response("test_resources", "elasticbeanstalk-create-configuration-template.xml");
            let mock = MockRequestDispatcher::with_status(200).with_body(&mock_response);
            let client = ElasticBeanstalkClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
        ...
        fn test_parse_elasticbeanstalk_create_environment() {
            let mock_response =  MockResponseReader::read_response("test_resources", "elasticbeanstalk-create-environment.xml");
            let mock = MockRequestDispatcher::with_status(200).with_body(&mock_response);
            let client = ElasticBeanstalkClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
        ...
        fn test_parse_elasticbeanstalk_create_storage_location() {
            let mock_response =  MockResponseReader::read_response("test_resources", "elasticbeanstalk-create-storage-location.xml");
            let mock = MockRequestDispatcher::with_status(200).with_body(&mock_response);
            let client = ElasticBeanstalkClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
        ...
        fn test_parse_elasticbeanstalk_delete_application() {
            let mock_response =  MockResponseReader::read_response("test_resources", "elasticbeanstalk-delete-application.xml");
            let mock = MockRequestDispatcher::with_status(200).with_body(&mock_response);
            let client = ElasticBeanstalkClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
        ...
        fn test_parse_elasticbeanstalk_describe_application_versions() {
            let mock_response =  MockResponseReader::read_response("test_resources", "elasticbeanstalk-describe-application-versions.xml");
            let mock = MockRequestDispatcher::with_status(200).with_body(&mock_response);
            let client = ElasticBeanstalkClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
        ...
        fn test_parse_elasticbeanstalk_describe_applications() {
            let mock_response =  MockResponseReader::read_response("test_resources", "elasticbeanstalk-describe-applications.xml");
            let mock = MockRequestDispatcher::with_status(200).with_body(&mock_response);
            let client = ElasticBeanstalkClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
        ...
        fn test_parse_elasticbeanstalk_describe_configuration_options() {
            let mock_response =  MockResponseReader::read_response("test_resources", "elasticbeanstalk-describe-configuration-options.xml");
            let mock = MockRequestDispatcher::with_status(200).with_body(&mock_response);
            let client = ElasticBeanstalkClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
        ...
        fn test_parse_elasticbeanstalk_describe_environments() {
            let mock_response =  MockResponseReader::read_response("test_resources", "elasticbeanstalk-describe-environments.xml");
            let mock = MockRequestDispatcher::with_status(200).with_body(&mock_response);
            let client = ElasticBeanstalkClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
        ...
        fn test_parse_elasticbeanstalk_describe_events() {
            let mock_response =  MockResponseReader::read_response("test_resources", "elasticbeanstalk-describe-events.xml");
            let mock = MockRequestDispatcher::with_status(200).with_body(&mock_response);
            let client = ElasticBeanstalkClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
        ...
        fn test_parse_elasticbeanstalk_list_available_solution_stacks() {
            let mock_response =  MockResponseReader::read_response("test_resources", "elasticbeanstalk-list-available-solution-stacks.xml");
            let mock = MockRequestDispatcher::with_status(200).with_body(&mock_response);
            let client = ElasticBeanstalkClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
        ...
        fn test_parse_elasticbeanstalk_retrieve_environment_info() {
            let mock_response =  MockResponseReader::read_response("test_resources", "elasticbeanstalk-retrieve-environment-info.xml");
            let mock = MockRequestDispatcher::with_status(200).with_body(&mock_response);
            let client = ElasticBeanstalkClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
        ...
        fn test_parse_elasticbeanstalk_terminate_environment() {
            let mock_response =  MockResponseReader::read_response("test_resources", "elasticbeanstalk-terminate-environment.xml");
            let mock = MockRequestDispatcher::with_status(200).with_body(&mock_response);
            let client = ElasticBeanstalkClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
        ...
        fn test_parse_elasticbeanstalk_update_application_version() {
            let mock_response =  MockResponseReader::read_response("test_resources", "elasticbeanstalk-update-application-version.xml");
            let mock = MockRequestDispatcher::with_status(200).with_body(&mock_response);
            let client = ElasticBeanstalkClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
        ...
        fn test_parse_elasticbeanstalk_update_application() {
            let mock_response =  MockResponseReader::read_response("test_resources", "elasticbeanstalk-update-application.xml");
            let mock = MockRequestDispatcher::with_status(200).with_body(&mock_response);
            let client = ElasticBeanstalkClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
