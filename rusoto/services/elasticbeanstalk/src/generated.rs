...
Unknown(String)
                ...
                impl Error for ApplyEnvironmentManagedActionError {
                    fn description(&self) -> &str {
                        match *self {
                            ApplyEnvironmentManagedActionError::ManagedActionInvalidState(ref cause) => cause,ApplyEnvironmentManagedActionError::ElasticBeanstalkService(ref cause) => cause,ApplyEnvironmentManagedActionError::Validation(ref cause) => cause,ApplyEnvironmentManagedActionError::Credentials(ref err) => err.description(),ApplyEnvironmentManagedActionError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),ApplyEnvironmentManagedActionError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl CreateApplicationVersionError {
                    pub fn from_body(body: &str) -> CreateApplicationVersionError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "TooManyApplicationsException" => CreateApplicationVersionError::TooManyApplications(String::from(parsed_error.message)),"CodeBuildNotInServiceRegionException" => CreateApplicationVersionError::CodeBuildNotInServiceRegion(String::from(parsed_error.message)),"TooManyApplicationVersionsException" => CreateApplicationVersionError::TooManyApplicationVersions(String::from(parsed_error.message)),"S3LocationNotInServiceRegionException" => CreateApplicationVersionError::S3LocationNotInServiceRegion(String::from(parsed_error.message)),"InsufficientPrivilegesException" => CreateApplicationVersionError::InsufficientPrivileges(String::from(parsed_error.message)),_ => CreateApplicationVersionError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for CreateApplicationVersionError {
                    fn description(&self) -> &str {
                        match *self {
                            CreateApplicationVersionError::TooManyApplicationVersions(ref cause) => cause,CreateApplicationVersionError::TooManyApplications(ref cause) => cause,CreateApplicationVersionError::CodeBuildNotInServiceRegion(ref cause) => cause,CreateApplicationVersionError::InsufficientPrivileges(ref cause) => cause,CreateApplicationVersionError::S3LocationNotInServiceRegion(ref cause) => cause,CreateApplicationVersionError::Validation(ref cause) => cause,CreateApplicationVersionError::Credentials(ref err) => err.description(),CreateApplicationVersionError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),CreateApplicationVersionError::Unknown(ref cause) => cause
                        }
                    }
                 }
                ...
                impl CreateConfigurationTemplateError {
                    pub fn from_body(body: &str) -> CreateConfigurationTemplateError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "InsufficientPrivilegesException" => CreateConfigurationTemplateError::InsufficientPrivileges(String::from(parsed_error.message)),"TooManyConfigurationTemplatesException" => CreateConfigurationTemplateError::TooManyConfigurationTemplates(String::from(parsed_error.message)),"TooManyBucketsException" => CreateConfigurationTemplateError::TooManyBuckets(String::from(parsed_error.message)),_ => CreateConfigurationTemplateError::Unknown(String::from(body))
                                }
                           },
                ...
                impl CreateStorageLocationError {
                    pub fn from_body(body: &str) -> CreateStorageLocationError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "S3SubscriptionRequiredException" => CreateStorageLocationError::S3SubscriptionRequired(String::from(parsed_error.message)),"TooManyBucketsException" => CreateStorageLocationError::TooManyBuckets(String::from(parsed_error.message)),"InsufficientPrivilegesException" => CreateStorageLocationError::InsufficientPrivileges(String::from(parsed_error.message)),_ => CreateStorageLocationError::Unknown(String::from(body))
                                }
                           },
...
Unknown(String)
                ...
                impl DeleteApplicationVersionError {
                    pub fn from_body(body: &str) -> DeleteApplicationVersionError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "OperationInProgressException" => DeleteApplicationVersionError::OperationInProgress(String::from(parsed_error.message)),"SourceBundleDeletionException" => DeleteApplicationVersionError::SourceBundleDeletion(String::from(parsed_error.message)),"InsufficientPrivilegesException" => DeleteApplicationVersionError::InsufficientPrivileges(String::from(parsed_error.message)),"S3LocationNotInServiceRegionException" => DeleteApplicationVersionError::S3LocationNotInServiceRegion(String::from(parsed_error.message)),_ => DeleteApplicationVersionError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for DeleteApplicationVersionError {
                    fn description(&self) -> &str {
                        match *self {
                            DeleteApplicationVersionError::OperationInProgress(ref cause) => cause,DeleteApplicationVersionError::S3LocationNotInServiceRegion(ref cause) => cause,DeleteApplicationVersionError::InsufficientPrivileges(ref cause) => cause,DeleteApplicationVersionError::SourceBundleDeletion(ref cause) => cause,DeleteApplicationVersionError::Validation(ref cause) => cause,DeleteApplicationVersionError::Credentials(ref err) => err.description(),DeleteApplicationVersionError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),DeleteApplicationVersionError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl Error for UpdateConfigurationTemplateError {
                    fn description(&self) -> &str {
                        match *self {
                            UpdateConfigurationTemplateError::TooManyBuckets(ref cause) => cause,UpdateConfigurationTemplateError::InsufficientPrivileges(ref cause) => cause,UpdateConfigurationTemplateError::Validation(ref cause) => cause,UpdateConfigurationTemplateError::Credentials(ref err) => err.description(),UpdateConfigurationTemplateError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),UpdateConfigurationTemplateError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl Error for UpdateEnvironmentError {
                    fn description(&self) -> &str {
                        match *self {
                            UpdateEnvironmentError::TooManyBuckets(ref cause) => cause,UpdateEnvironmentError::InsufficientPrivileges(ref cause) => cause,UpdateEnvironmentError::Validation(ref cause) => cause,UpdateEnvironmentError::Credentials(ref err) => err.description(),UpdateEnvironmentError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),UpdateEnvironmentError::Unknown(ref cause) => cause
                        }
                    }
                 }
