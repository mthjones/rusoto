...
/// A client for the Amazon SWF API.
        ...
        impl<P, D> SwfClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
            pub fn new(request_dispatcher: D, credentials_provider: P, region: region::Region) -> Self {
                ...
                pub fn count_closed_workflow_executions(&self, input: &CountClosedWorkflowExecutionsInput)  -> Result<WorkflowExecutionCount, CountClosedWorkflowExecutionsError> {
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn count_open_workflow_executions(&self, input: &CountOpenWorkflowExecutionsInput)  -> Result<WorkflowExecutionCount, CountOpenWorkflowExecutionsError> {
                    let mut request = SignedRequest::new("POST", "swf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn count_pending_activity_tasks(&self, input: &CountPendingActivityTasksInput)  -> Result<PendingTaskCount, CountPendingActivityTasksError> {
                    let mut request = SignedRequest::new("POST", "swf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn count_pending_decision_tasks(&self, input: &CountPendingDecisionTasksInput)  -> Result<PendingTaskCount, CountPendingDecisionTasksError> {
                    let mut request = SignedRequest::new("POST", "swf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn deprecate_activity_type(&self, input: &DeprecateActivityTypeInput)  -> Result<(), DeprecateActivityTypeError> {
                    let mut request = SignedRequest::new("POST", "swf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn deprecate_domain(&self, input: &DeprecateDomainInput)  -> Result<(), DeprecateDomainError> {
                    let mut request = SignedRequest::new("POST", "swf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn deprecate_workflow_type(&self, input: &DeprecateWorkflowTypeInput)  -> Result<(), DeprecateWorkflowTypeError> {
                    let mut request = SignedRequest::new("POST", "swf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn describe_activity_type(&self, input: &DescribeActivityTypeInput)  -> Result<ActivityTypeDetail, DescribeActivityTypeError> {
                    let mut request = SignedRequest::new("POST", "swf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn describe_domain(&self, input: &DescribeDomainInput)  -> Result<DomainDetail, DescribeDomainError> {
                    let mut request = SignedRequest::new("POST", "swf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn describe_workflow_execution(&self, input: &DescribeWorkflowExecutionInput)  -> Result<WorkflowExecutionDetail, DescribeWorkflowExecutionError> {
                    let mut request = SignedRequest::new("POST", "swf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn describe_workflow_type(&self, input: &DescribeWorkflowTypeInput)  -> Result<WorkflowTypeDetail, DescribeWorkflowTypeError> {
                    let mut request = SignedRequest::new("POST", "swf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn get_workflow_execution_history(&self, input: &GetWorkflowExecutionHistoryInput)  -> Result<History, GetWorkflowExecutionHistoryError> {
                    let mut request = SignedRequest::new("POST", "swf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn list_activity_types(&self, input: &ListActivityTypesInput)  -> Result<ActivityTypeInfos, ListActivityTypesError> {
                    let mut request = SignedRequest::new("POST", "swf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn list_closed_workflow_executions(&self, input: &ListClosedWorkflowExecutionsInput)  -> Result<WorkflowExecutionInfos, ListClosedWorkflowExecutionsError> {
                    let mut request = SignedRequest::new("POST", "swf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn list_domains(&self, input: &ListDomainsInput)  -> Result<DomainInfos, ListDomainsError> {
                    let mut request = SignedRequest::new("POST", "swf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn list_open_workflow_executions(&self, input: &ListOpenWorkflowExecutionsInput)  -> Result<WorkflowExecutionInfos, ListOpenWorkflowExecutionsError> {
                    let mut request = SignedRequest::new("POST", "swf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn list_workflow_types(&self, input: &ListWorkflowTypesInput)  -> Result<WorkflowTypeInfos, ListWorkflowTypesError> {
                    let mut request = SignedRequest::new("POST", "swf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn poll_for_activity_task(&self, input: &PollForActivityTaskInput)  -> Result<ActivityTask, PollForActivityTaskError> {
                    let mut request = SignedRequest::new("POST", "swf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn poll_for_decision_task(&self, input: &PollForDecisionTaskInput)  -> Result<DecisionTask, PollForDecisionTaskError> {
                    let mut request = SignedRequest::new("POST", "swf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn record_activity_task_heartbeat(&self, input: &RecordActivityTaskHeartbeatInput)  -> Result<ActivityTaskStatus, RecordActivityTaskHeartbeatError> {
                    let mut request = SignedRequest::new("POST", "swf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn register_activity_type(&self, input: &RegisterActivityTypeInput)  -> Result<(), RegisterActivityTypeError> {
                    let mut request = SignedRequest::new("POST", "swf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn register_domain(&self, input: &RegisterDomainInput)  -> Result<(), RegisterDomainError> {
                    let mut request = SignedRequest::new("POST", "swf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn register_workflow_type(&self, input: &RegisterWorkflowTypeInput)  -> Result<(), RegisterWorkflowTypeError> {
                    let mut request = SignedRequest::new("POST", "swf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn request_cancel_workflow_execution(&self, input: &RequestCancelWorkflowExecutionInput)  -> Result<(), RequestCancelWorkflowExecutionError> {
                    let mut request = SignedRequest::new("POST", "swf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn respond_activity_task_canceled(&self, input: &RespondActivityTaskCanceledInput)  -> Result<(), RespondActivityTaskCanceledError> {
                    let mut request = SignedRequest::new("POST", "swf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn respond_activity_task_completed(&self, input: &RespondActivityTaskCompletedInput)  -> Result<(), RespondActivityTaskCompletedError> {
                    let mut request = SignedRequest::new("POST", "swf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn respond_activity_task_failed(&self, input: &RespondActivityTaskFailedInput)  -> Result<(), RespondActivityTaskFailedError> {
                    let mut request = SignedRequest::new("POST", "swf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn respond_decision_task_completed(&self, input: &RespondDecisionTaskCompletedInput)  -> Result<(), RespondDecisionTaskCompletedError> {
                    let mut request = SignedRequest::new("POST", "swf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn signal_workflow_execution(&self, input: &SignalWorkflowExecutionInput)  -> Result<(), SignalWorkflowExecutionError> {
                    let mut request = SignedRequest::new("POST", "swf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn start_workflow_execution(&self, input: &StartWorkflowExecutionInput)  -> Result<Run, StartWorkflowExecutionError> {
                    let mut request = SignedRequest::new("POST", "swf", self.region, "/");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                pub fn terminate_workflow_execution(&self, input: &TerminateWorkflowExecutionInput)  -> Result<(), TerminateWorkflowExecutionError> {
                    let mut request = SignedRequest::new("POST", "swf", self.region, "/");
