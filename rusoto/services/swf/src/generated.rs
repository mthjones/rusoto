...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> DeprecateDomainError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "DomainDeprecatedFault" => DeprecateDomainError::DomainDeprecatedFault(String::from(error_message)),"UnknownResourceFault" => DeprecateDomainError::UnknownResourceFault(String::from(error_message)),"OperationNotPermittedFault" => DeprecateDomainError::OperationNotPermittedFault(String::from(error_message)),"ValidationException" => DeprecateDomainError::Validation(error_message.to_string()),_ => DeprecateDomainError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for DeprecateDomainError {
                    fn description(&self) -> &str {
                        match *self {
                            DeprecateDomainError::OperationNotPermittedFault(ref cause) => cause,DeprecateDomainError::DomainDeprecatedFault(ref cause) => cause,DeprecateDomainError::UnknownResourceFault(ref cause) => cause,DeprecateDomainError::Validation(ref cause) => cause,DeprecateDomainError::Credentials(ref err) => err.description(),DeprecateDomainError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),DeprecateDomainError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> DeprecateWorkflowTypeError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "UnknownResourceFault" => DeprecateWorkflowTypeError::UnknownResourceFault(String::from(error_message)),"OperationNotPermittedFault" => DeprecateWorkflowTypeError::OperationNotPermittedFault(String::from(error_message)),"TypeDeprecatedFault" => DeprecateWorkflowTypeError::TypeDeprecatedFault(String::from(error_message)),"ValidationException" => DeprecateWorkflowTypeError::Validation(error_message.to_string()),_ => DeprecateWorkflowTypeError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for DeprecateWorkflowTypeError {
                    fn description(&self) -> &str {
                        match *self {
                            DeprecateWorkflowTypeError::TypeDeprecatedFault(ref cause) => cause,DeprecateWorkflowTypeError::OperationNotPermittedFault(ref cause) => cause,DeprecateWorkflowTypeError::UnknownResourceFault(ref cause) => cause,DeprecateWorkflowTypeError::Validation(ref cause) => cause,DeprecateWorkflowTypeError::Credentials(ref err) => err.description(),DeprecateWorkflowTypeError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),DeprecateWorkflowTypeError::Unknown(ref cause) => cause
                        }
                    }
                 }
                    ...
                    pub fn from_body(body: &str) -> ListActivityTypesError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "UnknownResourceFault" => ListActivityTypesError::UnknownResourceFault(String::from(error_message)),"OperationNotPermittedFault" => ListActivityTypesError::OperationNotPermittedFault(String::from(error_message)),"ValidationException" => ListActivityTypesError::Validation(error_message.to_string()),_ => ListActivityTypesError::Unknown(String::from(body))
                                }
                            },
                    ...
                    pub fn from_body(body: &str) -> ListWorkflowTypesError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "UnknownResourceFault" => ListWorkflowTypesError::UnknownResourceFault(String::from(error_message)),"OperationNotPermittedFault" => ListWorkflowTypesError::OperationNotPermittedFault(String::from(error_message)),"ValidationException" => ListWorkflowTypesError::Validation(error_message.to_string()),_ => ListWorkflowTypesError::Unknown(String::from(body))
                                }
                            },
...
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> PollForActivityTaskError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "UnknownResourceFault" => PollForActivityTaskError::UnknownResourceFault(String::from(error_message)),"LimitExceededFault" => PollForActivityTaskError::LimitExceededFault(String::from(error_message)),"OperationNotPermittedFault" => PollForActivityTaskError::OperationNotPermittedFault(String::from(error_message)),"ValidationException" => PollForActivityTaskError::Validation(error_message.to_string()),_ => PollForActivityTaskError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for PollForActivityTaskError {
                    fn description(&self) -> &str {
                        match *self {
                            PollForActivityTaskError::UnknownResourceFault(ref cause) => cause,PollForActivityTaskError::LimitExceededFault(ref cause) => cause,PollForActivityTaskError::OperationNotPermittedFault(ref cause) => cause,PollForActivityTaskError::Validation(ref cause) => cause,PollForActivityTaskError::Credentials(ref err) => err.description(),PollForActivityTaskError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),PollForActivityTaskError::Unknown(ref cause) => cause
                        }
                    }
                 }
                    ...
                    pub fn from_body(body: &str) -> PollForDecisionTaskError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "OperationNotPermittedFault" => PollForDecisionTaskError::OperationNotPermittedFault(String::from(error_message)),"LimitExceededFault" => PollForDecisionTaskError::LimitExceededFault(String::from(error_message)),"UnknownResourceFault" => PollForDecisionTaskError::UnknownResourceFault(String::from(error_message)),"ValidationException" => PollForDecisionTaskError::Validation(error_message.to_string()),_ => PollForDecisionTaskError::Unknown(String::from(body))
                                }
                            },
...
TypeAlreadyExistsFault(String),/// An error occurred dispatching the HTTP request
HttpDispatch(HttpDispatchError),/// An error was encountered with AWS credentials.
Credentials(CredentialsError),/// A validation error occurred.  Details from AWS are provided.
Validation(String),/// An unknown error occurred.  The raw HTTP response is provided.
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> RegisterActivityTypeError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "UnknownResourceFault" => RegisterActivityTypeError::UnknownResourceFault(String::from(error_message)),"TypeAlreadyExistsFault" => RegisterActivityTypeError::TypeAlreadyExistsFault(String::from(error_message)),"OperationNotPermittedFault" => RegisterActivityTypeError::OperationNotPermittedFault(String::from(error_message)),"LimitExceededFault" => RegisterActivityTypeError::LimitExceededFault(String::from(error_message)),"ValidationException" => RegisterActivityTypeError::Validation(error_message.to_string()),_ => RegisterActivityTypeError::Unknown(String::from(body))
                                }
                            },
...
DomainAlreadyExistsFault(String),/// An error occurred dispatching the HTTP request
HttpDispatch(HttpDispatchError),/// An error was encountered with AWS credentials.
Credentials(CredentialsError),/// A validation error occurred.  Details from AWS are provided.
Validation(String),/// An unknown error occurred.  The raw HTTP response is provided.
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> RegisterDomainError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "OperationNotPermittedFault" => RegisterDomainError::OperationNotPermittedFault(String::from(error_message)),"DomainAlreadyExistsFault" => RegisterDomainError::DomainAlreadyExistsFault(String::from(error_message)),"LimitExceededFault" => RegisterDomainError::LimitExceededFault(String::from(error_message)),"ValidationException" => RegisterDomainError::Validation(error_message.to_string()),_ => RegisterDomainError::Unknown(String::from(body))
                                }
                            },
                ...
                impl Error for RegisterDomainError {
                    fn description(&self) -> &str {
                        match *self {
                            RegisterDomainError::DomainAlreadyExistsFault(ref cause) => cause,RegisterDomainError::OperationNotPermittedFault(ref cause) => cause,RegisterDomainError::LimitExceededFault(ref cause) => cause,RegisterDomainError::Validation(ref cause) => cause,RegisterDomainError::Credentials(ref err) => err.description(),RegisterDomainError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),RegisterDomainError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl Error for RegisterWorkflowTypeError {
                    fn description(&self) -> &str {
                        match *self {
                            RegisterWorkflowTypeError::OperationNotPermittedFault(ref cause) => cause,RegisterWorkflowTypeError::LimitExceededFault(ref cause) => cause,RegisterWorkflowTypeError::UnknownResourceFault(ref cause) => cause,RegisterWorkflowTypeError::TypeAlreadyExistsFault(ref cause) => cause,RegisterWorkflowTypeError::Validation(ref cause) => cause,RegisterWorkflowTypeError::Credentials(ref err) => err.description(),RegisterWorkflowTypeError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),RegisterWorkflowTypeError::Unknown(ref cause) => cause
                        }
                    }
                 }
